...
class PaymentsServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.DepositResponse> deposit(
    $0.DepositRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Get the user's most-used destination banks (for the "Most used" bank-picker
  /// pill). Derived read-only aggregation over the existing transfer_recipients
  /// rows — no new write path, no money movement.
  ...
  /// Suggest matching bank(s) for a bare account number. The backend runs a
  /// CBN NUBAN check-digit pass to narrow candidate banks, then resolves the
  /// holder name against each via the admin-selected provider. Powers the
  /// send-funds "type account number → bank auto-suggests" UX.
  ...
  /// Informational, READ-ONLY transfer success prediction for an EXTERNAL
  /// (other-bank) transfer. Shown on the confirmation screen before PIN entry.
  /// NEVER moves money, blocks, or alters a transfer. Computed internally from
  /// our own historical data (no provider exposes a bank-availability API).
  ...
  /// Cancel a transfer that is still in "scheduled" status (before its asynq
  /// fire time). Pure DB CAS — the fire task's status-guard makes the queued
  /// task a no-op. The worker-side method existed but was never exposed, so
  /// users could schedule transfers they could never cancel.
  $grpc.ResponseFuture<$0.CancelScheduledTransferResponse>
      cancelScheduledTransfer(
    $0.CancelScheduledTransferRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.RefundFromPlatformWalletResponse>
    ...
    $0.RefundFromPlatformWalletRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.GetBatchTransferDetailResponse>
    ...
    $0.GetBatchTransferDetailRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.VerifyMultiCountryIdentityResponse>
    ...
    $0.VerifyMultiCountryIdentityRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.GetKYCVerificationStatusResponse>
    ...
    $0.GetKYCVerificationStatusRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.CreateRecurringTransferResponse>
    ...
    $0.CreateRecurringTransferRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.UpdateRecurringTransferResponse>
    ...
    $0.UpdateRecurringTransferRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.DeleteRecurringTransferResponse>
    ...
    $0.DeleteRecurringTransferRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Admin: Get reconciliation history
  ...
  /// Admin: Get last reconciliation result
  ...
  /// Admin: per-currency summary of active withdrawal-typed fund
  /// holds. Slice 10i — consumed by accounts-service's
  /// WalletReconWorker to derive the expected WITHDRAWAL_PENDING
  /// platform-wallet balance from this service's authoritative
  /// fund_holds table without DB-coupling.
  ...
  /// Admin: Auto-resolve stale holds by checking provider status
  ...
  /// Admin: Check a specific hold's provider status
  $grpc.ResponseFuture<$0.AdminProviderStatusResponse>
      adminCheckHoldProviderStatus(
    $0.AdminCheckHoldProviderRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Admin: List all transfers with filtering
  ...
  /// Admin: Get transfer by reference
  ...
  /// Admin: full audit detail for an INTERNAL C2C transfer — the payments row +
  /// the double-entry ledger legs (debit + credit) from accounts-service +
  /// family-spend records when the source is a family account. Powers the admin
  /// internal-transfer lifecycle flowchart.
  ...
  /// Admin: Get daily usage/spendings statistics
  ...
  /// Admin: Get provider balances for settlement reconciliation
  ...
  /// Admin: Get transfer async/sync configuration. Reads from system_settings.
  /// Returns the current sync vs async mode for external + batch transfers
  /// plus the Flutterwave webhook URL that's the source of truth for the
  /// (stable Cloudflare tunnel) URL operators paste into the Flutterwave dashboard.
  ...
  /// Admin: Update transfer async/sync configuration. Persists changes to
  /// system_settings — picked up by the next request via the 60s config cache.
  ...
  /// Admin: Force-refund a transfer the scheduled reconciler couldn't
  /// recover automatically (e.g. a row left at status=completed from a
  /// pre-fix webhook routing bug, or a stuck verification escalated to
  /// manual_review). Inserts a transfer_rollback_records row with
  /// status="refunding" and provider_verification_status="manual_admin_verified"
  /// so the existing TransferRollbackProcessor (3-phase pipeline) skips
  /// re-verification and proceeds straight to CreditBalance(REV-...) on
  /// accounts-service, then settlement reversal. Audit trail: rollback record
  /// carries admin_user_id + reason.
  $grpc.ResponseFuture<$0.AdminForceRefundTransferResponse>
      adminForceRefundTransfer(
    $0.AdminForceRefundTransferRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Admin: Manually trigger the stale-transfer reconciler for a single
  /// payment, bypassing the 5-minute schedule. Calls Flutterwave
  /// GET /v3/transfers/{provider_ref} for authoritative state and drives the
  /// CAS terminal-state update. Mirrors the electricity-bill ManualReconcile.
  ...
  /// Admin: estimate-vs-actual provider (Flutterwave) fee audit for completed
  /// external transfers over a date range. Compares the up-front estimated FW
  /// fee (metadata.provider_fee_minor_estimate) against the ACTUAL fee captured
  /// from the transfer submit response (metadata.provider_fee_minor_actual).
  /// delta = estimate - actual: +ve means we over-collected on the fee leg,
  /// -ve means we absorbed cost. Rows with no captured actual (legacy transfers
  /// submitted before capture shipped) report has_actual=false.
  ...
  /// ===== Behavioural fraud detection (per-user) =====
  /// Read the user's fraud-detection opt-out setting (default ON).
  ...
  /// Turn the user's fraud detection on/off.
  ...
  /// Is the user's account currently frozen for suspicious activity? Drives the
  /// in-app fraud modal + the chatbot's guided unfreeze.
  ...
  /// Self-unfreeze a fraud freeze after re-proving identity with the transaction
  /// PIN. Clears the money-movement freeze.
  ...
  static final _$sendFunds =
      $grpc.ClientMethod<$0.SendFundsRequest, $0.SendFundsResponse>(
          ...
          $0.SendFundsResponse.fromBuffer);
  static final _$batchTransfer =
      $grpc.ClientMethod<$0.BatchTransferRequest, $0.BatchTransferResponse>(
          ...
          $0.BatchTransferResponse.fromBuffer);
  ...
  static final _$payWithTag =
      $grpc.ClientMethod<$0.PayWithTagRequest, $0.PayWithTagResponse>(
          ...
          $0.PayWithTagResponse.fromBuffer);
  ...
  static final _$getFrequentBanks = $grpc.ClientMethod<
      ...
      $0.GetFrequentBanksResponse.fromBuffer);
  ...
  static final _$payWithBankDetails = $grpc.ClientMethod<
      ...
      $0.PayWithBankDetailsResponse.fromBuffer);
  static final _$resolveTag =
      $grpc.ClientMethod<$0.ResolveTagRequest, $0.ResolveTagResponse>(
          ...
          $0.ResolveTagResponse.fromBuffer);
  ...
  static final _$suggestBankAccounts = $grpc.ClientMethod<
      ...
      $0.SuggestBankAccountsResponse.fromBuffer);
  static final _$getTransferSuccessPrediction = $grpc.ClientMethod<
      ...
      $0.GetTransferSuccessPredictionResponse.fromBuffer);
  ...
  static final _$getUserTransfers = $grpc.ClientMethod<
      ...
      $0.GetUserTransfersResponse.fromBuffer);
  ...
  static final _$getDailyUsage =
      $grpc.ClientMethod<$0.GetDailyUsageRequest, $0.GetDailyUsageResponse>(
          ...
          $0.GetDailyUsageResponse.fromBuffer);
  ...
  static final _$handleTransferWebhook = $grpc.ClientMethod<
      ...
      $0.HandleTransferWebhookResponse.fromBuffer);
  static final _$payPlatformFee =
      $grpc.ClientMethod<$0.PayPlatformFeeRequest, $0.PayPlatformFeeResponse>(
          ...
          $0.PayPlatformFeeResponse.fromBuffer);
  static final _$refundFromPlatformWallet = $grpc.ClientMethod<
      ...
      $0.RefundFromPlatformWalletResponse.fromBuffer);
  static final _$generateQRPaymentToken =
      $grpc.ClientMethod<$0.GenerateQRTokenRequest, $0.GenerateQRTokenResponse>(
          ...
          $0.GenerateQRTokenResponse.fromBuffer);
  ...
  static final _$getBatchTransfers = $grpc.ClientMethod<
      ...
      $0.GetBatchTransfersResponse.fromBuffer);
  static final _$getBatchTransferDetail = $grpc.ClientMethod<
      ...
      $0.GetBatchTransferDetailResponse.fromBuffer);
  static final _$verifyMultiCountryIdentity = $grpc.ClientMethod<
      ...
      $0.VerifyMultiCountryIdentityResponse.fromBuffer);
  static final _$getIdentityVerificationStatus = $grpc.ClientMethod<
      ...
      $0.GetKYCVerificationStatusResponse.fromBuffer);
  static final _$createRecurringTransfer = $grpc.ClientMethod<
      ...
      $0.CreateRecurringTransferResponse.fromBuffer);
  static final _$getRecurringTransfers = $grpc.ClientMethod<
      ...
      $0.GetRecurringTransfersResponse.fromBuffer);
  static final _$getRecurringTransfer = $grpc.ClientMethod<
      ...
      $0.GetRecurringTransferResponse.fromBuffer);
  static final _$updateRecurringTransfer = $grpc.ClientMethod<
      ...
      $0.UpdateRecurringTransferResponse.fromBuffer);
  static final _$deleteRecurringTransfer = $grpc.ClientMethod<
      ...
      $0.DeleteRecurringTransferResponse.fromBuffer);
  static final _$getRecurringTransferExecutions = $grpc.ClientMethod<
      ...
      $0.GetRecurringTransferExecutionsResponse.fromBuffer);
  static final _$getRecurringTransfersByRecipient = $grpc.ClientMethod<
      ...
      ($0.GetRecurringTransfersByRecipientRequest value) =>
          value.writeToBuffer(),
      $0.GetRecurringTransfersByRecipientResponse.fromBuffer);
  static final _$adminRunReconciliation = $grpc.ClientMethod<
      ...
      $0.AdminReconciliationResult.fromBuffer);
  static final _$adminGetReconciliationHistory = $grpc.ClientMethod<
      ...
      $0.AdminReconciliationHistoryResponse.fromBuffer);
  ...
  static final _$adminGetWithdrawalHoldsSummary = $grpc.ClientMethod<
      ...
      $0.AdminGetWithdrawalHoldsSummaryResponse.fromBuffer);
  static final _$adminAutoResolveStaleHolds = $grpc.ClientMethod<
      ...
      $0.AdminAutoResolveResponse.fromBuffer);
  static final _$adminCheckHoldProviderStatus = $grpc.ClientMethod<
      ...
      $0.AdminProviderStatusResponse.fromBuffer);
  static final _$adminGetFailedOperations = $grpc.ClientMethod<
      ...
      $0.AdminGetFailedOperationsResponse.fromBuffer);
  ...
  static final _$adminGetTransferByReference = $grpc.ClientMethod<
      ...
      $0.AdminTransferDetail.fromBuffer);
  static final _$adminGetInternalTransferDetail = $grpc.ClientMethod<
      ...
      ($0.GetTransferByReferenceRequest value) => value.writeToBuffer(),
      $0.InternalTransferDetail.fromBuffer);
  ...
  static final _$adminGetDailyUsage = $grpc.ClientMethod<
      ...
      $0.AdminGetDailyUsageResponse.fromBuffer);
  ...
  static final _$adminGetWebhookAuditTrail = $grpc.ClientMethod<
      ...
      $0.WebhookAuditTrailResponse.fromBuffer);
  static final _$getTransferAsyncConfig = $grpc.ClientMethod<
      ...
      $0.TransferAsyncConfig.fromBuffer);
  ...
  static final _$adminForceRefundTransfer = $grpc.ClientMethod<
      ...
      $0.AdminForceRefundTransferResponse.fromBuffer);
  static final _$adminManualReconcileTransfer = $grpc.ClientMethod<
      ...
      $0.AdminManualReconcileTransferResponse.fromBuffer);
  static final _$adminGetExternalTransferFeeAudit = $grpc.ClientMethod<
      ...
      ($0.AdminGetExternalTransferFeeAuditRequest value) =>
          value.writeToBuffer(),
      $0.AdminGetExternalTransferFeeAuditResponse.fromBuffer);
  ...
  static final _$listSavedBatches = $grpc.ClientMethod<
      ...
      $0.ListSavedBatchesResponse.fromBuffer);
  ...
  static final _$deleteSavedBatch = $grpc.ClientMethod<
      ...
      $0.DeleteSavedBatchResponse.fromBuffer);
  ...
  static final _$getFraudDetectionSetting = $grpc.ClientMethod<
      ...
      $0.FraudDetectionSetting.fromBuffer);
  ...
  static final _$getFraudFreezeStatus =
      $grpc.ClientMethod<$0.GetFraudFreezeStatusRequest, $0.FraudFreezeStatus>(
          ...
          $0.FraudFreezeStatus.fromBuffer);
  static final _$requestFraudUnfreeze = $grpc.ClientMethod<
      ...
      $0.RequestFraudUnfreezeResponse.fromBuffer);
}
...
abstract class PaymentsServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.DepositResponse> deposit_Pre($grpc.ServiceCall $call,
      $async.Future<$0.DepositRequest> $request) async {
  ...
  $async.Future<$0.GetTransferSuccessPredictionResponse>
      getTransferSuccessPrediction_Pre(
          $grpc.ServiceCall $call,
          $async.Future<$0.GetTransferSuccessPredictionRequest>
              $request) async {
  ...
  $async.Future<$0.AdminManualReconcileTransferResponse>
      adminManualReconcileTransfer_Pre(
          $grpc.ServiceCall $call,
          $async.Future<$0.AdminManualReconcileTransferRequest>
              $request) async {
  ...
  $async.Future<$0.SavedBatch> applyCollectiveAmount_Pre(
      $grpc.ServiceCall $call,

...
class PaymentsServiceClient extends $grpc.Client {
  static final _$sendFunds = $grpc.ClientMethod<$0.SendFundsRequest, $0.SendFundsResponse>(
      '/payments.PaymentsService/SendFunds',
      ($0.SendFundsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.SendFundsResponse.fromBuffer(value));
  static final _$batchTransfer = $grpc.ClientMethod<$0.BatchTransferRequest, $0.BatchTransferResponse>(
      '/payments.PaymentsService/BatchTransfer',
      ($0.BatchTransferRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.BatchTransferResponse.fromBuffer(value));
  static final _$withdraw = $grpc.ClientMethod<$0.WithdrawRequest, $0.WithdrawResponse>(
      '/payments.PaymentsService/Withdraw',
      ($0.WithdrawRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.WithdrawResponse.fromBuffer(value));
  static final _$deposit = $grpc.ClientMethod<$0.DepositRequest, $0.DepositResponse>(
  ...
  static final _$payWithTag = $grpc.ClientMethod<$0.PayWithTagRequest, $0.PayWithTagResponse>(
      '/payments.PaymentsService/PayWithTag',
      ($0.PayWithTagRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PayWithTagResponse.fromBuffer(value));
  ...
  static final _$payWithBankDetails = $grpc.ClientMethod<$0.PayWithBankDetailsRequest, $0.PayWithBankDetailsResponse>(
      '/payments.PaymentsService/PayWithBankDetails',
      ($0.PayWithBankDetailsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PayWithBankDetailsResponse.fromBuffer(value));
  static final _$resolveTag = $grpc.ClientMethod<$0.ResolveTagRequest, $0.ResolveTagResponse>(
      '/payments.PaymentsService/ResolveTag',
      ($0.ResolveTagRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ResolveTagResponse.fromBuffer(value));
  ...
  static final _$initiateDomesticTransfer = $grpc.ClientMethod<$0.InitiateDomesticTransferRequest, $0.InitiateTransferResponse>(
  ...
  static final _$initiateInternalTransfer = $grpc.ClientMethod<$0.InitiateInternalTransferRequest, $0.InitiateTransferResponse>(
      '/payments.PaymentsService/InitiateInternalTransfer',
      ($0.InitiateInternalTransferRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.InitiateTransferResponse.fromBuffer(value));
  static final _$initiateInternationalTransfer = $grpc.ClientMethod<$0.InitiateInternationalTransferRequest, $0.InitiateTransferResponse>(
  ...
  static final _$initiatePhoneTransfer = $grpc.ClientMethod<$0.InitiatePhoneTransferRequest, $0.InitiateTransferResponse>(
      ...
      ($core.List<$core.int> value) => $0.InitiateTransferResponse.fromBuffer(value));
  static final _$getTransferStatus = $grpc.ClientMethod<$0.GetTransferStatusRequest, $0.GetTransferStatusResponse>(
      '/payments.PaymentsService/GetTransferStatus',
      ($0.GetTransferStatusRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetTransferStatusResponse.fromBuffer(value));
  static final _$getUserTransfers = $grpc.ClientMethod<$0.GetUserTransfersRequest, $0.GetUserTransfersResponse>(
      '/payments.PaymentsService/GetUserTransfers',
      ($0.GetUserTransfersRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetUserTransfersResponse.fromBuffer(value));
  ...
  static final _$getDailyUsage = $grpc.ClientMethod<$0.GetDailyUsageRequest, $0.GetDailyUsageResponse>(
      '/payments.PaymentsService/GetDailyUsage',
      ($0.GetDailyUsageRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetDailyUsageResponse.fromBuffer(value));
  ...
  static final _$handleTransferWebhook = $grpc.ClientMethod<$0.HandleTransferWebhookRequest, $0.HandleTransferWebhookResponse>(
      '/payments.PaymentsService/HandleTransferWebhook',
      ($0.HandleTransferWebhookRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.HandleTransferWebhookResponse.fromBuffer(value));
  static final _$payPlatformFee = $grpc.ClientMethod<$0.PayPlatformFeeRequest, $0.PayPlatformFeeResponse>(
      '/payments.PaymentsService/PayPlatformFee',
      ($0.PayPlatformFeeRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.PayPlatformFeeResponse.fromBuffer(value));
  static final _$refundFromPlatformWallet = $grpc.ClientMethod<$0.RefundFromPlatformWalletRequest, $0.RefundFromPlatformWalletResponse>(
      '/payments.PaymentsService/RefundFromPlatformWallet',
      ($0.RefundFromPlatformWalletRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.RefundFromPlatformWalletResponse.fromBuffer(value));
  static final _$generateQRPaymentToken = $grpc.ClientMethod<$0.GenerateQRTokenRequest, $0.GenerateQRTokenResponse>(
      '/payments.PaymentsService/GenerateQRPaymentToken',
      ($0.GenerateQRTokenRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GenerateQRTokenResponse.fromBuffer(value));
  static final _$validateQRPaymentToken = $grpc.ClientMethod<$0.ValidateQRTokenRequest, $0.ValidateQRTokenResponse>(
  ...
  static final _$adminRunReconciliation = $grpc.ClientMethod<$0.AdminRunReconciliationRequest, $0.AdminReconciliationResult>(
      '/payments.PaymentsService/AdminRunReconciliation',
      ($0.AdminRunReconciliationRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.AdminReconciliationResult.fromBuffer(value));
  static final _$adminGetReconciliationHistory = $grpc.ClientMethod<$0.AdminReconciliationHistoryRequest, $0.AdminReconciliationHistoryResponse>(
      '/payments.PaymentsService/AdminGetReconciliationHistory',
      ($0.AdminReconciliationHistoryRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.AdminReconciliationHistoryResponse.fromBuffer(value));
  static final _$adminGetLastReconciliation = $grpc.ClientMethod<$0.AdminGetLastReconciliationRequest, $0.AdminReconciliationResult>(
      '/payments.PaymentsService/AdminGetLastReconciliation',
      ($0.AdminGetLastReconciliationRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.AdminReconciliationResult.fromBuffer(value));
  static final _$adminAutoResolveStaleHolds = $grpc.ClientMethod<$0.AdminAutoResolveRequest, $0.AdminAutoResolveResponse>(
      '/payments.PaymentsService/AdminAutoResolveStaleHolds',
      ($0.AdminAutoResolveRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.AdminAutoResolveResponse.fromBuffer(value));
  static final _$adminCheckHoldProviderStatus = $grpc.ClientMethod<$0.AdminCheckHoldProviderRequest, $0.AdminProviderStatusResponse>(
      '/payments.PaymentsService/AdminCheckHoldProviderStatus',
      ($0.AdminCheckHoldProviderRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.AdminProviderStatusResponse.fromBuffer(value));
  static final _$adminGetFailedOperations = $grpc.ClientMethod<$0.AdminGetFailedOperationsRequest, $0.AdminGetFailedOperationsResponse>(
      '/payments.PaymentsService/AdminGetFailedOperations',
      ($0.AdminGetFailedOperationsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.AdminGetFailedOperationsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.SendFundsResponse> sendFunds($0.SendFundsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$sendFunds, request, options: options);
  }

  $grpc.ResponseFuture<$0.BatchTransferResponse> batchTransfer($0.BatchTransferRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$batchTransfer, request, options: options);
  }

  $grpc.ResponseFuture<$0.WithdrawResponse> withdraw($0.WithdrawRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$withdraw, request, options: options);
  }

  $grpc.ResponseFuture<$0.DepositResponse> deposit($0.DepositRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deposit, request, options: options);
  }

  $grpc.ResponseFuture<$0.PayWithTagResponse> payWithTag($0.PayWithTagRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.PayWithBankDetailsResponse> payWithBankDetails($0.PayWithBankDetailsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$payWithBankDetails, request, options: options);
  }

  $grpc.ResponseFuture<$0.ResolveTagResponse> resolveTag($0.ResolveTagRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.InitiateTransferResponse> initiateDomesticTransfer($0.InitiateDomesticTransferRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$initiateDomesticTransfer, request, options: options);
  }

  $grpc.ResponseFuture<$0.InitiateTransferResponse> initiateInternalTransfer($0.InitiateInternalTransferRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$initiateInternalTransfer, request, options: options);
  }

  $grpc.ResponseFuture<$0.InitiateTransferResponse> initiateInternationalTransfer($0.InitiateInternationalTransferRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.GetTransferStatusResponse> getTransferStatus($0.GetTransferStatusRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getTransferStatus, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetUserTransfersResponse> getUserTransfers($0.GetUserTransfersRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.GetDailyUsageResponse> getDailyUsage($0.GetDailyUsageRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.HandleTransferWebhookResponse> handleTransferWebhook($0.HandleTransferWebhookRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$handleTransferWebhook, request, options: options);
  }

  $grpc.ResponseFuture<$0.PayPlatformFeeResponse> payPlatformFee($0.PayPlatformFeeRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$payPlatformFee, request, options: options);
  }

  $grpc.ResponseFuture<$0.RefundFromPlatformWalletResponse> refundFromPlatformWallet($0.RefundFromPlatformWalletRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$refundFromPlatformWallet, request, options: options);
  }

  $grpc.ResponseFuture<$0.GenerateQRTokenResponse> generateQRPaymentToken($0.GenerateQRTokenRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$generateQRPaymentToken, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.AdminReconciliationResult> adminRunReconciliation($0.AdminRunReconciliationRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$adminRunReconciliation, request, options: options);
  }

  $grpc.ResponseFuture<$0.AdminReconciliationHistoryResponse> adminGetReconciliationHistory($0.AdminReconciliationHistoryRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$adminGetReconciliationHistory, request, options: options);
  }

  $grpc.ResponseFuture<$0.AdminReconciliationResult> adminGetLastReconciliation($0.AdminGetLastReconciliationRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$adminGetLastReconciliation, request, options: options);
  }

  $grpc.ResponseFuture<$0.AdminAutoResolveResponse> adminAutoResolveStaleHolds($0.AdminAutoResolveRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$adminAutoResolveStaleHolds, request, options: options);
  }

  $grpc.ResponseFuture<$0.AdminProviderStatusResponse> adminCheckHoldProviderStatus($0.AdminCheckHoldProviderRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$adminCheckHoldProviderStatus, request, options: options);
  }

  $grpc.ResponseFuture<$0.AdminGetFailedOperationsResponse> adminGetFailedOperations($0.AdminGetFailedOperationsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$adminGetFailedOperations, request, options: options);
  }
}
...
abstract class PaymentsServiceBase extends $grpc.Service {
  ...
  PaymentsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.BatchTransferRequest, $0.BatchTransferResponse>(
        'BatchTransfer',
        batchTransfer_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.BatchTransferRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.PayWithBankDetailsRequest, $0.PayWithBankDetailsResponse>(
        'PayWithBankDetails',
        payWithBankDetails_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.PayWithBankDetailsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.InitiateDomesticTransferRequest, $0.InitiateTransferResponse>(
        'InitiateDomesticTransfer',
        initiateDomesticTransfer_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.InitiateDomesticTransferRequest.fromBuffer(value),
        ($0.InitiateTransferResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.InitiateInternalTransferRequest, $0.InitiateTransferResponse>(
        'InitiateInternalTransfer',
        initiateInternalTransfer_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.InitiateInternalTransferRequest.fromBuffer(value),
        ($0.InitiateTransferResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.InitiateInternationalTransferRequest, $0.InitiateTransferResponse>(
    ...
    $addMethod($grpc.ServiceMethod<$0.InitiatePhoneTransferRequest, $0.InitiateTransferResponse>(
        ...
        false,
        false,
        ($core.List<$core.int> value) => $0.InitiatePhoneTransferRequest.fromBuffer(value),
        ($0.InitiateTransferResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetTransferStatusRequest, $0.GetTransferStatusResponse>(
        'GetTransferStatus',
    ...
    $addMethod($grpc.ServiceMethod<$0.GetUserTransfersRequest, $0.GetUserTransfersResponse>(
        'GetUserTransfers',
    ...
    $addMethod($grpc.ServiceMethod<$0.GetDailyUsageRequest, $0.GetDailyUsageResponse>(
        'GetDailyUsage',
        getDailyUsage_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.HandleTransferWebhookRequest, $0.HandleTransferWebhookResponse>(
        'HandleTransferWebhook',
        handleTransferWebhook_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.HandleTransferWebhookRequest.fromBuffer(value),
        ($0.HandleTransferWebhookResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.PayPlatformFeeRequest, $0.PayPlatformFeeResponse>(
        'PayPlatformFee',
        payPlatformFee_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.PayPlatformFeeRequest.fromBuffer(value),
        ($0.PayPlatformFeeResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RefundFromPlatformWalletRequest, $0.RefundFromPlatformWalletResponse>(
        'RefundFromPlatformWallet',
        refundFromPlatformWallet_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.RefundFromPlatformWalletRequest.fromBuffer(value),
        ($0.RefundFromPlatformWalletResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GenerateQRTokenRequest, $0.GenerateQRTokenResponse>(
        'GenerateQRPaymentToken',
        generateQRPaymentToken_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GenerateQRTokenRequest.fromBuffer(value),
        ($0.GenerateQRTokenResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ValidateQRTokenRequest, $0.ValidateQRTokenResponse>(
    ...
    $addMethod($grpc.ServiceMethod<$0.AdminRunReconciliationRequest, $0.AdminReconciliationResult>(
        'AdminRunReconciliation',
        adminRunReconciliation_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AdminRunReconciliationRequest.fromBuffer(value),
        ($0.AdminReconciliationResult value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AdminReconciliationHistoryRequest, $0.AdminReconciliationHistoryResponse>(
        'AdminGetReconciliationHistory',
        adminGetReconciliationHistory_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AdminReconciliationHistoryRequest.fromBuffer(value),
        ($0.AdminReconciliationHistoryResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AdminGetLastReconciliationRequest, $0.AdminReconciliationResult>(
        'AdminGetLastReconciliation',
        adminGetLastReconciliation_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AdminGetLastReconciliationRequest.fromBuffer(value),
        ($0.AdminReconciliationResult value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AdminAutoResolveRequest, $0.AdminAutoResolveResponse>(
        'AdminAutoResolveStaleHolds',
        adminAutoResolveStaleHolds_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AdminAutoResolveRequest.fromBuffer(value),
        ($0.AdminAutoResolveResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AdminCheckHoldProviderRequest, $0.AdminProviderStatusResponse>(
        'AdminCheckHoldProviderStatus',
        adminCheckHoldProviderStatus_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AdminCheckHoldProviderRequest.fromBuffer(value),
        ($0.AdminProviderStatusResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AdminGetFailedOperationsRequest, $0.AdminGetFailedOperationsResponse>(
        'AdminGetFailedOperations',
        adminGetFailedOperations_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.AdminGetFailedOperationsRequest.fromBuffer(value),
  ...
  $async.Future<$0.BatchTransferResponse> batchTransfer_Pre($grpc.ServiceCall call, $async.Future<$0.BatchTransferRequest> request) async {
    return batchTransfer(call, await request);
  }

  $async.Future<$0.WithdrawResponse> withdraw_Pre($grpc.ServiceCall call, $async.Future<$0.WithdrawRequest> request) async {
    return withdraw(call, await request);
  }

  $async.Future<$0.DepositResponse> deposit_Pre($grpc.ServiceCall call, $async.Future<$0.DepositRequest> request) async {
    return deposit(call, await request);
  }

  $async.Future<$0.PayWithTagResponse> payWithTag_Pre($grpc.ServiceCall call, $async.Future<$0.PayWithTagRequest> request) async {
  ...
  $async.Future<$0.PayWithBankDetailsResponse> payWithBankDetails_Pre($grpc.ServiceCall call, $async.Future<$0.PayWithBankDetailsRequest> request) async {
    return payWithBankDetails(call, await request);
  }

  $async.Future<$0.ResolveTagResponse> resolveTag_Pre($grpc.ServiceCall call, $async.Future<$0.ResolveTagRequest> request) async {
  ...
  $async.Future<$0.InitiateTransferResponse> initiateDomesticTransfer_Pre($grpc.ServiceCall call, $async.Future<$0.InitiateDomesticTransferRequest> request) async {
    return initiateDomesticTransfer(call, await request);
  }

  $async.Future<$0.InitiateTransferResponse> initiateInternalTransfer_Pre($grpc.ServiceCall call, $async.Future<$0.InitiateInternalTransferRequest> request) async {
    return initiateInternalTransfer(call, await request);
  }

  $async.Future<$0.InitiateTransferResponse> initiateInternationalTransfer_Pre($grpc.ServiceCall call, $async.Future<$0.InitiateInternationalTransferRequest> request) async {
  ...
  $async.Future<$0.GetTransferStatusResponse> getTransferStatus_Pre($grpc.ServiceCall call, $async.Future<$0.GetTransferStatusRequest> request) async {
    return getTransferStatus(call, await request);
  }

  $async.Future<$0.GetUserTransfersResponse> getUserTransfers_Pre($grpc.ServiceCall call, $async.Future<$0.GetUserTransfersRequest> request) async {
  ...
  $async.Future<$0.GetDailyUsageResponse> getDailyUsage_Pre($grpc.ServiceCall call, $async.Future<$0.GetDailyUsageRequest> request) async {
  ...
  $async.Future<$0.HandleTransferWebhookResponse> handleTransferWebhook_Pre($grpc.ServiceCall call, $async.Future<$0.HandleTransferWebhookRequest> request) async {
    return handleTransferWebhook(call, await request);
  }

  $async.Future<$0.PayPlatformFeeResponse> payPlatformFee_Pre($grpc.ServiceCall call, $async.Future<$0.PayPlatformFeeRequest> request) async {
    return payPlatformFee(call, await request);
  }

  $async.Future<$0.RefundFromPlatformWalletResponse> refundFromPlatformWallet_Pre($grpc.ServiceCall call, $async.Future<$0.RefundFromPlatformWalletRequest> request) async {
    return refundFromPlatformWallet(call, await request);
  }

  $async.Future<$0.GenerateQRTokenResponse> generateQRPaymentToken_Pre($grpc.ServiceCall call, $async.Future<$0.GenerateQRTokenRequest> request) async {
    return generateQRPaymentToken(call, await request);
  }

  $async.Future<$0.ValidateQRTokenResponse> validateQRPaymentToken_Pre($grpc.ServiceCall call, $async.Future<$0.ValidateQRTokenRequest> request) async {
  ...
  $async.Future<$0.AdminReconciliationResult> adminRunReconciliation_Pre($grpc.ServiceCall call, $async.Future<$0.AdminRunReconciliationRequest> request) async {
    return adminRunReconciliation(call, await request);
  }

  $async.Future<$0.AdminReconciliationHistoryResponse> adminGetReconciliationHistory_Pre($grpc.ServiceCall call, $async.Future<$0.AdminReconciliationHistoryRequest> request) async {
    return adminGetReconciliationHistory(call, await request);
  }

  $async.Future<$0.AdminReconciliationResult> adminGetLastReconciliation_Pre($grpc.ServiceCall call, $async.Future<$0.AdminGetLastReconciliationRequest> request) async {
    return adminGetLastReconciliation(call, await request);
  }

  $async.Future<$0.AdminAutoResolveResponse> adminAutoResolveStaleHolds_Pre($grpc.ServiceCall call, $async.Future<$0.AdminAutoResolveRequest> request) async {
    return adminAutoResolveStaleHolds(call, await request);
  }

  $async.Future<$0.AdminProviderStatusResponse> adminCheckHoldProviderStatus_Pre($grpc.ServiceCall call, $async.Future<$0.AdminCheckHoldProviderRequest> request) async {
    return adminCheckHoldProviderStatus(call, await request);
  }

  $async.Future<$0.AdminGetFailedOperationsResponse> adminGetFailedOperations_Pre($grpc.ServiceCall call, $async.Future<$0.AdminGetFailedOperationsRequest> request) async {
  ...
  $async.Future<$0.DepositResponse> deposit($grpc.ServiceCall call, $0.DepositRequest request);
  $async.Future<$0.PayWithTagResponse> payWithTag($grpc.ServiceCall call, $0.PayWithTagRequest request);
  ...
  $async.Future<$0.PayWithBankDetailsResponse> payWithBankDetails($grpc.ServiceCall call, $0.PayWithBankDetailsRequest request);
  $async.Future<$0.ResolveTagResponse> resolveTag($grpc.ServiceCall call, $0.ResolveTagRequest request);
  ...
  $async.Future<$0.GetDailyUsageResponse> getDailyUsage($grpc.ServiceCall call, $0.GetDailyUsageRequest request);
  $async.Future<$0.GetExchangeRateResponse> getExchangeRate($grpc.ServiceCall call, $0.GetExchangeRateRequest request);
  $async.Future<$0.HandleTransferWebhookResponse> handleTransferWebhook($grpc.ServiceCall call, $0.HandleTransferWebhookRequest request);
  $async.Future<$0.PayPlatformFeeResponse> payPlatformFee($grpc.ServiceCall call, $0.PayPlatformFeeRequest request);
  ...
  $async.Future<$0.AdminReconciliationResult> adminRunReconciliation($grpc.ServiceCall call, $0.AdminRunReconciliationRequest request);
  $async.Future<$0.AdminReconciliationHistoryResponse> adminGetReconciliationHistory($grpc.ServiceCall call, $0.AdminReconciliationHistoryRequest request);
  $async.Future<$0.AdminReconciliationResult> adminGetLastReconciliation($grpc.ServiceCall call, $0.AdminGetLastReconciliationRequest request);
  $async.Future<$0.AdminAutoResolveResponse> adminAutoResolveStaleHolds($grpc.ServiceCall call, $0.AdminAutoResolveRequest request);
  $async.Future<$0.AdminProviderStatusResponse> adminCheckHoldProviderStatus($grpc.ServiceCall call, $0.AdminCheckHoldProviderRequest request);
  $async.Future<$0.AdminGetFailedOperationsResponse> adminGetFailedOperations($grpc.ServiceCall call, $0.AdminGetFailedOperationsRequest request);
}

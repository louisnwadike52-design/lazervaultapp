...
const Account$json = const {
  ...
  '2': const [
    ...
    const {'1': 'allow_international_transfers', '3': 29, '4': 1, '5': 8, '10': 'allowInternationalTransfers'},
  ],
};

/// Descriptor for `Account`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List accountDescriptor = $convert.base64Decode('');
...
const AccountSummary$json = const {
  ...
  '2': const [
    ...
    const {'1': 'bank_code', '3': 15, '4': 1, '5': 9, '10': 'bankCode'},
  ],
};

/// Descriptor for `AccountSummary`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List accountSummaryDescriptor = $convert.base64Decode('');
...
const LockFunds$json = const {
  ...
  '2': const [
    ...
    const {'1': 'config_id', '3': 14, '4': 1, '5': 9, '10': 'configId'},
  ],
};

/// Descriptor for `LockFunds`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List lockFundsDescriptor = $convert.base64Decode('');
...
const CreateLockFundsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'config_id', '3': 13, '4': 1, '5': 9, '10': 'configId'},
  ],
};

/// Descriptor for `CreateLockFundsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createLockFundsRequestDescriptor = $convert.base64Decode('');
...
const GetLockFundsSettlementsRequest$json = const {
...
final $typed_data.Uint8List getLockFundsSettlementsRequestDescriptor = $convert.base64Decode('Ch5HZXRMb2NrRnVuZHNTZXR0bGVtZW50c1JlcXVlc3QSIQoMbG9ja2Z1bmRzX2lkGAEgASgJUgtsb2NrZnVuZHNJZBIUCgVsaW1pdBgCIAEoBVIFbGltaXQSFgoGb2Zmc2V0GAMgASgFUgZvZmZzZXQ=');
@$core.Deprecated('Use lockFundsSettlementProtoDescriptor instead')
const LockFundsSettlementProto$json = const {
  '1': 'LockFundsSettlementProto',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'lockfunds_id', '3': 2, '4': 1, '5': 9, '10': 'lockfundsId'},
    const {'1': 'leg', '3': 3, '4': 1, '5': 9, '10': 'leg'},
    const {'1': 'status', '3': 4, '4': 1, '5': 9, '10': 'status'},
    const {'1': 'amount', '3': 5, '4': 1, '5': 1, '10': 'amount'},
    const {'1': 'currency', '3': 6, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'reference', '3': 7, '4': 1, '5': 9, '10': 'reference'},
    const {'1': 'scheduled_at', '3': 8, '4': 1, '5': 9, '10': 'scheduledAt'},
    const {'1': 'completed_at', '3': 9, '4': 1, '5': 9, '10': 'completedAt'},
...
final $typed_data.Uint8List lockFundsSettlementProtoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use getLockFundsSettlementsResponseDescriptor instead')
const GetLockFundsSettlementsResponse$json = const {
  '1': 'GetLockFundsSettlementsResponse',
  '2': const [
    const {'1': 'settlements', '3': 1, '4': 3, '5': 11, '6': '.accounts.LockFundsSettlementProto', '10': 'settlements'},
...
final $typed_data.Uint8List getLockFundsSettlementsResponseDescriptor = $convert.base64Decode('Ch9HZXRMb2NrRnVuZHNTZXR0bGVtZW50c1Jlc3BvbnNlEkQKC3NldHRsZW1lbnRzGAEgAygLMiIuYWNjb3VudHMuTG9ja0Z1bmRzU2V0dGxlbWVudFByb3RvUgtzZXR0bGVtZW50cxIfCgt0b3RhbF9jb3VudBgCIAEoBVIKdG90YWxDb3VudA==');
...
const GetLedgerEntriesByReferenceRequest$json = const {
...
final $typed_data.Uint8List getLedgerEntriesByReferenceRequestDescriptor = $convert.base64Decode('CiJHZXRMZWRnZXJFbnRyaWVzQnlSZWZlcmVuY2VSZXF1ZXN0EhwKCXJlZmVyZW5jZRgBIAEoCVIJcmVmZXJlbmNlEicKD2lkZW1wb3RlbmN5X2tleRgCIAEoCVIOaWRlbXBvdGVuY3lLZXk=');
@$core.Deprecated('Use getLedgerEntriesByReferenceResponseDescriptor instead')
const GetLedgerEntriesByReferenceResponse$json = const {
  '1': 'GetLedgerEntriesByReferenceResponse',
  '2': const [
    const {'1': 'entries', '3': 1, '4': 3, '5': 11, '6': '.accounts.Transaction', '10': 'entries'},
  ],
};

/// Descriptor for `GetLedgerEntriesByReferenceResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getLedgerEntriesByReferenceResponseDescriptor = $convert.base64Decode('CiNHZXRMZWRnZXJFbnRyaWVzQnlSZWZlcmVuY2VSZXNwb25zZRIvCgdlbnRyaWVzGAEgAygLMhUuYWNjb3VudHMuVHJhbnNhY3Rpb25SB2VudHJpZXM=');
...
const HoldFundsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enforce_spending_limit', '3': 10, '4': 1, '5': 8, '10': 'enforceSpendingLimit'},
  ],
};

/// Descriptor for `HoldFundsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List holdFundsRequestDescriptor = $convert.base64Decode('');
...
const GetSpendingUsageRequest$json = const {
...
final $typed_data.Uint8List getSpendingUsageRequestDescriptor = $convert.base64Decode('ChdHZXRTcGVuZGluZ1VzYWdlUmVxdWVzdBIdCgphY2NvdW50X2lkGAEgASgJUglhY2NvdW50SWQ=');
@$core.Deprecated('Use getSpendingUsageResponseDescriptor instead')
const GetSpendingUsageResponse$json = const {
  '1': 'GetSpendingUsageResponse',
  '2': const [
    const {'1': 'currency', '3': 1, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'daily_limit', '3': 2, '4': 1, '5': 1, '10': 'dailyLimit'},
    const {'1': 'monthly_limit', '3': 3, '4': 1, '5': 1, '10': 'monthlyLimit'},
    const {'1': 'single_transaction_limit', '3': 4, '4': 1, '5': 1, '10': 'singleTransactionLimit'},
    const {'1': 'daily_spent', '3': 5, '4': 1, '5': 1, '10': 'dailySpent'},
    const {'1': 'monthly_spent', '3': 6, '4': 1, '5': 1, '10': 'monthlySpent'},
    const {'1': 'remaining_daily', '3': 7, '4': 1, '5': 1, '10': 'remainingDaily'},
    const {'1': 'remaining_monthly', '3': 8, '4': 1, '5': 1, '10': 'remainingMonthly'},
  ],
};

/// Descriptor for `GetSpendingUsageResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSpendingUsageResponseDescriptor = $convert.base64Decode('');

...
class QRCode extends $pb.GeneratedMessage {
  factory QRCode({
    ...
    if (usageMode != null) result.usageMode = usageMode;
    if (noExpiry != null) result.noExpiry = noExpiry;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Timestamp>(13, _omitFieldNames ? '' : 'paidAt',
        subBuilder: $1.Timestamp.create)
    ..aOS(14, _omitFieldNames ? '' : 'usageMode')
    ..aOB(15, _omitFieldNames ? '' : 'noExpiry')
  ...
  /// Unset when the code never expires (no_expiry = true).
  @$pb.TagNumber(12)
  ...
  /// "one_time" | "reusable". Dynamic codes are always reusable.
  @$pb.TagNumber(14)
  $core.String get usageMode => $_getSZ(13);
  @$pb.TagNumber(14)
  set usageMode($core.String value) => $_setString(13, value);
  @$pb.TagNumber(14)
  $core.bool hasUsageMode() => $_has(13);
  @$pb.TagNumber(14)
  void clearUsageMode() => $_clearField(14);

  @$pb.TagNumber(15)
  $core.bool get noExpiry => $_getBF(14);
  @$pb.TagNumber(15)
  set noExpiry($core.bool value) => $_setBool(14, value);
  @$pb.TagNumber(15)
  $core.bool hasNoExpiry() => $_has(14);
  @$pb.TagNumber(15)
  void clearNoExpiry() => $_clearField(15);
}
...
class GenerateQRRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(6, _omitFieldNames ? '' : 'usageMode')
    ..hasRequiredFields = false;
  ...
  /// 0 = no expiry (the default). Editable later via UpdateQRExpiry.
  @$pb.TagNumber(5)
  ...
  /// "one_time" (default for static) | "reusable". Dynamic is always reusable.
  @$pb.TagNumber(6)
  $core.String get usageMode => $_getSZ(5);
  @$pb.TagNumber(6)
  set usageMode($core.String value) => $_setString(5, value);
  @$pb.TagNumber(6)
  $core.bool hasUsageMode() => $_has(5);
  @$pb.TagNumber(6)
  void clearUsageMode() => $_clearField(6);
}
...
class GetMyGeneratedQRCodesRequest extends $pb.GeneratedMessage {
  factory GetMyGeneratedQRCodesRequest({
    ...
    $core.bool? includeAll,
  }) {
    final result = create();
    if (limit != null) result.limit = limit;
    if (offset != null) result.offset = offset;
    if (statusFilter != null) result.statusFilter = statusFilter;
    if (includeAll != null) result.includeAll = includeAll;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<QRStatus>(3, _omitFieldNames ? '' : 'statusFilter', $pb.PbFieldType.OE,
        ...
        valueOf: QRStatus.valueOf,
        enumValues: QRStatus.values)
    ..aOB(4, _omitFieldNames ? '' : 'includeAll')
    ..hasRequiredFields = false;
  ...
  /// QR_STATUS_PENDING is enum value 0 == the proto3 default, so an UNSET
  /// filter is indistinguishable from "pending" — which silently hid every
  /// paid/cancelled/expired QR from the history screen. Set include_all to
  /// list every status regardless of status_filter.
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $core.bool get includeAll => $_getBF(3);
  @$pb.TagNumber(4)
  set includeAll($core.bool value) => $_setBool(3, value);
  @$pb.TagNumber(4)
  $core.bool hasIncludeAll() => $_has(3);
  @$pb.TagNumber(4)
  void clearIncludeAll() => $_clearField(4);
}
...
class UpdateQRExpiryRequest extends $pb.GeneratedMessage {
  factory UpdateQRExpiryRequest({
    $core.String? qrId,
    $core.int? validityMinutes,
  }) {
    final result = create();
  ...
  UpdateQRExpiryRequest._();

  factory UpdateQRExpiryRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory UpdateQRExpiryRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UpdateQRExpiryRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'qr_pay'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'qrId')
    ..a<$core.int>(
        2, _omitFieldNames ? '' : 'validityMinutes', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UpdateQRExpiryRequest clone() =>
      UpdateQRExpiryRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UpdateQRExpiryRequest copyWith(
          void Function(UpdateQRExpiryRequest) updates) =>
      super.copyWith((message) => updates(message as UpdateQRExpiryRequest))
          as UpdateQRExpiryRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UpdateQRExpiryRequest create() => UpdateQRExpiryRequest._();
  @$core.override
  UpdateQRExpiryRequest createEmptyInstance() => create();
  static $pb.PbList<UpdateQRExpiryRequest> createRepeated() =>
      $pb.PbList<UpdateQRExpiryRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateQRExpiryRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UpdateQRExpiryRequest>(create);
  static UpdateQRExpiryRequest? _defaultInstance;
  ...
  /// Minutes from NOW until expiry; 0 clears the expiry (never expires).
  @$pb.TagNumber(2)
  $core.int get validityMinutes => $_getIZ(1);
  @$pb.TagNumber(2)
  set validityMinutes($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  $core.bool hasValidityMinutes() => $_has(1);
  @$pb.TagNumber(2)
  void clearValidityMinutes() => $_clearField(2);
}

class UpdateQRExpiryResponse extends $pb.GeneratedMessage {
  factory UpdateQRExpiryResponse({
    QRCode? qrCode,
    $core.String? message,
  }) {
    final result = create();
  ...
  UpdateQRExpiryResponse._();

  factory UpdateQRExpiryResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory UpdateQRExpiryResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'UpdateQRExpiryResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'qr_pay'),
      createEmptyInstance: create)
    ..aOM<QRCode>(1, _omitFieldNames ? '' : 'qrCode', subBuilder: QRCode.create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UpdateQRExpiryResponse clone() =>
      UpdateQRExpiryResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  UpdateQRExpiryResponse copyWith(
          void Function(UpdateQRExpiryResponse) updates) =>
      super.copyWith((message) => updates(message as UpdateQRExpiryResponse))
          as UpdateQRExpiryResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static UpdateQRExpiryResponse create() => UpdateQRExpiryResponse._();
  @$core.override
  UpdateQRExpiryResponse createEmptyInstance() => create();
  static $pb.PbList<UpdateQRExpiryResponse> createRepeated() =>
      $pb.PbList<UpdateQRExpiryResponse>();
  @$core.pragma('dart2js:noInline')
  static UpdateQRExpiryResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<UpdateQRExpiryResponse>(create);
  static UpdateQRExpiryResponse? _defaultInstance;
...
class GetQRPayersRequest extends $pb.GeneratedMessage {
  factory GetQRPayersRequest({
    $core.String? qrId,
    $core.int? limit,
    $core.int? offset,
  }) {
  ...
  GetQRPayersRequest._();

  factory GetQRPayersRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetQRPayersRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetQRPayersRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'qr_pay'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'qrId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetQRPayersRequest clone() => GetQRPayersRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetQRPayersRequest copyWith(void Function(GetQRPayersRequest) updates) =>
      super.copyWith((message) => updates(message as GetQRPayersRequest))
          as GetQRPayersRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetQRPayersRequest create() => GetQRPayersRequest._();
  @$core.override
  GetQRPayersRequest createEmptyInstance() => create();
  static $pb.PbList<GetQRPayersRequest> createRepeated() =>
      $pb.PbList<GetQRPayersRequest>();
  @$core.pragma('dart2js:noInline')
  static GetQRPayersRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetQRPayersRequest>(create);
  static GetQRPayersRequest? _defaultInstance;
...
class GetQRPayersResponse extends $pb.GeneratedMessage {
  factory GetQRPayersResponse({
    $core.Iterable<QRTransaction>? transactions,
    $core.int? total,
    $core.double? totalCollected,
  }) {
    final result = create();
    if (transactions != null) result.transactions.addAll(transactions);
    if (total != null) result.total = total;
    if (totalCollected != null) result.totalCollected = totalCollected;
    return result;
  }

  GetQRPayersResponse._();

  factory GetQRPayersResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetQRPayersResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetQRPayersResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'qr_pay'),
      createEmptyInstance: create)
    ..pc<QRTransaction>(
        1, _omitFieldNames ? '' : 'transactions', $pb.PbFieldType.PM,
    ...
    ..a<$core.int>(2, _omitFieldNames ? '' : 'total', $pb.PbFieldType.O3)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'totalCollected', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetQRPayersResponse clone() => GetQRPayersResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetQRPayersResponse copyWith(void Function(GetQRPayersResponse) updates) =>
      super.copyWith((message) => updates(message as GetQRPayersResponse))
          as GetQRPayersResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetQRPayersResponse create() => GetQRPayersResponse._();
  @$core.override
  GetQRPayersResponse createEmptyInstance() => create();
  static $pb.PbList<GetQRPayersResponse> createRepeated() =>
      $pb.PbList<GetQRPayersResponse>();
  @$core.pragma('dart2js:noInline')
  static GetQRPayersResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetQRPayersResponse>(create);
  static GetQRPayersResponse? _defaultInstance;
  ...
  /// Sum of completed payments on this code, major units.
  @$pb.TagNumber(3)
  $core.double get totalCollected => $_getN(2);
  @$pb.TagNumber(3)
  set totalCollected($core.double value) => $_setDouble(2, value);
  @$pb.TagNumber(3)
  $core.bool hasTotalCollected() => $_has(2);
  @$pb.TagNumber(3)
  void clearTotalCollected() => $_clearField(3);
}

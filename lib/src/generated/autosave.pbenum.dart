...
class TriggerType extends $pb.ProtobufEnum {
  ...
  static const TriggerType TRIGGER_EXTERNAL_INFLOW =
      TriggerType._(4, _omitEnumNames ? '' : 'TRIGGER_EXTERNAL_INFLOW');
  static const TriggerType TRIGGER_SCHEDULED_EXTERNAL =
      TriggerType._(5, _omitEnumNames ? '' : 'TRIGGER_SCHEDULED_EXTERNAL');

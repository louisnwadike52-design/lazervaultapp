...
const $core.Map<$core.String, $core.dynamic> BankingServiceBase$json = const {
  '1': 'BankingService',
  '2': const [
    const {'1': 'CreateVirtualAccount', '2': '.banking.CreateVirtualAccountRequest', '3': '.banking.VirtualAccountResponse', '4': const {}},
    const {'1': 'GetVirtualAccount', '2': '.banking.GetVirtualAccountRequest', '3': '.banking.VirtualAccountResponse', '4': const {}},
    const {'1': 'GetUserVirtualAccounts', '2': '.banking.GetUserVirtualAccountsRequest', '3': '.banking.VirtualAccountsResponse', '4': const {}},
    const {'1': 'InitiateDomesticTransfer', '2': '.banking.DomesticTransferRequest', '3': '.banking.TransferResponse', '4': const {}},
    const {'1': 'GetTransferStatus', '2': '.banking.GetTransferStatusRequest', '3': '.banking.TransferResponse', '4': const {}},
    const {'1': 'GetUserTransfers', '2': '.banking.GetUserTransfersRequest', '3': '.banking.TransfersResponse', '4': const {}},
    const {'1': 'InitiateInternalTransfer', '2': '.banking.InternalTransferRequest', '3': '.banking.TransferResponse', '4': const {}},
    const {'1': 'InitiateInternationalTransfer', '2': '.banking.InternationalTransferRequest', '3': '.banking.TransferResponse', '4': const {}},
    const {'1': 'GetExchangeRate', '2': '.banking.GetExchangeRateRequest', '3': '.banking.ExchangeRateResponse', '4': const {}},
    const {'1': 'GetSupportedCountries', '2': '.banking.GetSupportedCountriesRequest', '3': '.banking.SupportedCountriesResponse', '4': const {}},
    const {'1': 'VerifyBankAccount', '2': '.banking.VerifyBankAccountRequest', '3': '.banking.VerifyBankAccountResponse', '4': const {}},
    const {'1': 'GetBanks', '2': '.banking.GetBanksRequest', '3': '.banking.BanksResponse', '4': const {}},
    const {'1': 'VerifyBVN', '2': '.banking.VerifyBVNRequest', '3': '.banking.IdentityVerificationResponse', '4': const {}},
    const {'1': 'GetVerificationStatus', '2': '.banking.GetVerificationStatusRequest', '3': '.banking.IdentityVerificationResponse', '4': const {}},
    const {'1': 'VerifyBVNForSignup', '2': '.banking.VerifyBVNForSignupRequest', '3': '.banking.SignupIdentityVerificationResponse', '4': const {}},
    const {'1': 'VerifyNINForSignup', '2': '.banking.VerifyNINForSignupRequest', '3': '.banking.SignupIdentityVerificationResponse', '4': const {}},
    const {'1': 'CreateVirtualAccountForUser', '2': '.banking.CreateVirtualAccountForUserRequest', '3': '.banking.VirtualAccountResponse', '4': const {}},
    const {'1': 'InitiateUsernameTransfer', '2': '.banking.UsernameTransferRequest', '3': '.banking.TransferResponse', '4': const {}},
    const {'1': 'InitiatePhoneTransfer', '2': '.banking.PhoneTransferRequest', '3': '.banking.TransferResponse', '4': const {}},
    const {'1': 'SearchRecipients', '2': '.banking.SearchRecipientsRequest', '3': '.banking.RecipientsResponse', '4': const {}},
    const {'1': 'GetRecentRecipients', '2': '.banking.GetRecentRecipientsRequest', '3': '.banking.RecipientsResponse', '4': const {}},
    const {'1': 'GetProviderStatus', '2': '.banking.GetProviderStatusRequest', '3': '.banking.ProviderStatusResponse', '4': const {}},
    const {'1': 'GetActiveProviders', '2': '.banking.GetActiveProvidersRequest', '3': '.banking.ActiveProvidersResponse', '4': const {}},
    const {'1': 'GetAccountBalance', '2': '.banking.GetAccountBalanceRequest', '3': '.banking.AccountBalanceResponse', '4': const {}},
    const {'1': 'GetAccountTransactions', '2': '.banking.GetAccountTransactionsRequest', '3': '.banking.TransactionsResponse', '4': const {}},
    const {'1': 'GetPrimaryAccount', '2': '.banking.GetPrimaryAccountRequest', '3': '.banking.VirtualAccountResponse', '4': const {}},
    const {'1': 'FreezeAccount', '2': '.banking.FreezeAccountRequest', '3': '.banking.FreezeAccountResponse', '4': const {}},
    const {'1': 'UnfreezeAccount', '2': '.banking.UnfreezeAccountRequest', '3': '.banking.UnfreezeAccountResponse', '4': const {}},
    const {'1': 'GetDailyUsage', '2': '.banking.GetDailyUsageRequest', '3': '.banking.DailyUsageResponse', '4': const {}},
    const {'1': 'RunReconciliation', '2': '.banking.RunReconciliationRequest', '3': '.banking.ReconciliationResponse', '4': const {}},
    const {'1': 'GetReconciliationHistory', '2': '.banking.GetReconciliationHistoryRequest', '3': '.banking.ReconciliationHistoryResponse', '4': const {}},
    const {'1': 'GetDailyReport', '2': '.banking.GetDailyReportRequest', '3': '.banking.DailyReportResponse', '4': const {}},
    const {'1': 'GetMonoInstitutions', '2': '.banking.GetMonoInstitutionsRequest', '3': '.banking.MonoInstitutionsResponse', '4': const {}},
    const {'1': 'GetConnectWidgetConfig', '2': '.banking.GetConnectWidgetConfigRequest', '3': '.banking.ConnectWidgetConfigResponse', '4': const {}},
    const {'1': 'LinkBankAccount', '2': '.banking.LinkBankAccountRequest', '3': '.banking.LinkBankAccountResponse', '4': const {}},
    const {'1': 'GetLinkedAccounts', '2': '.banking.GetLinkedAccountsRequest', '3': '.banking.LinkedAccountsResponse', '4': const {}},
    const {'1': 'GetLinkedAccount', '2': '.banking.GetLinkedAccountRequest', '3': '.banking.LinkedAccountResponse', '4': const {}},
    const {'1': 'UnlinkBankAccount', '2': '.banking.UnlinkBankAccountRequest', '3': '.banking.UnlinkBankAccountResponse', '4': const {}},
    const {'1': 'SetDefaultLinkedAccount', '2': '.banking.SetDefaultLinkedAccountRequest', '3': '.banking.SetDefaultLinkedAccountResponse', '4': const {}},
    const {'1': 'RefreshLinkedAccountBalance', '2': '.banking.RefreshLinkedAccountBalanceRequest', '3': '.banking.RefreshLinkedAccountBalanceResponse', '4': const {}},
    const {'1': 'GetReauthorizationToken', '2': '.banking.GetReauthorizationTokenRequest', '3': '.banking.GetReauthorizationTokenResponse', '4': const {}},
    const {'1': 'InitiateDeposit', '2': '.banking.InitiateDepositRequest', '3': '.banking.DepositResponse', '4': const {}},
    const {'1': 'GetDepositStatus', '2': '.banking.GetDepositStatusRequest', '3': '.banking.DepositResponse', '4': const {}},
    const {'1': 'GetUserDeposits', '2': '.banking.GetUserDepositsRequest', '3': '.banking.DepositsResponse', '4': const {}},
    const {'1': 'CancelDeposit', '2': '.banking.CancelDepositRequest', '3': '.banking.CancelDepositResponse', '4': const {}},
    const {'1': 'CalculateDepositFee', '2': '.banking.CalculateDepositFeeRequest', '3': '.banking.CalculateDepositFeeResponse', '4': const {}},
    const {'1': 'CreateMandate', '2': '.banking.CreateMandateRequest', '3': '.banking.MandateResponse', '4': const {}},
    const {'1': 'GetMandate', '2': '.banking.GetMandateRequest', '3': '.banking.MandateResponse', '4': const {}},
    const {'1': 'GetUserMandates', '2': '.banking.GetUserMandatesRequest', '3': '.banking.MandatesResponse', '4': const {}},
    const {'1': 'PauseMandate', '2': '.banking.PauseMandateRequest', '3': '.banking.PauseMandateResponse', '4': const {}},
    const {'1': 'ReinstateMandate', '2': '.banking.ReinstateMandateRequest', '3': '.banking.ReinstateMandateResponse', '4': const {}},
    const {'1': 'CancelMandate', '2': '.banking.CancelMandateRequest', '3': '.banking.CancelMandateResponse', '4': const {}},
    const {'1': 'CheckMandateBalance', '2': '.banking.CheckMandateBalanceRequest', '3': '.banking.CheckMandateBalanceResponse', '4': const {}},
    const {'1': 'InitiateWithdrawal', '2': '.banking.InitiateWithdrawalRequest', '3': '.banking.WithdrawalResponse', '4': const {}},
    const {'1': 'GetWithdrawalStatus', '2': '.banking.GetWithdrawalStatusRequest', '3': '.banking.WithdrawalResponse', '4': const {}},
    const {'1': 'GetUserWithdrawals', '2': '.banking.GetUserWithdrawalsRequest', '3': '.banking.WithdrawalsResponse', '4': const {}},
    const {'1': 'CalculateWithdrawalFee', '2': '.banking.CalculateWithdrawalFeeRequest', '3': '.banking.CalculateWithdrawalFeeResponse', '4': const {}},
    const {'1': 'GetTransferFee', '2': '.banking.GetTransferFeeRequest', '3': '.banking.GetTransferFeeResponse', '4': const {}},
  ],
};

@$core.Deprecated('Use bankingServiceDescriptor instead')
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> BankingServiceBase$messageJson = const {
  '.banking.CreateVirtualAccountRequest': CreateVirtualAccountRequest$json,
  '.banking.VirtualAccountResponse': VirtualAccountResponse$json,
  '.banking.VirtualAccount': VirtualAccount$json,
  '.google.protobuf.Timestamp': $0.Timestamp$json,
  '.banking.GetVirtualAccountRequest': GetVirtualAccountRequest$json,
  '.banking.GetUserVirtualAccountsRequest': GetUserVirtualAccountsRequest$json,
  '.banking.VirtualAccountsResponse': VirtualAccountsResponse$json,
  '.banking.DomesticTransferRequest': DomesticTransferRequest$json,
  '.banking.TransferResponse': TransferResponse$json,
  '.banking.Transfer': Transfer$json,
  '.banking.GetTransferStatusRequest': GetTransferStatusRequest$json,
  '.banking.GetUserTransfersRequest': GetUserTransfersRequest$json,
  '.banking.TransfersResponse': TransfersResponse$json,
  '.banking.InternalTransferRequest': InternalTransferRequest$json,
  '.banking.RecipientDetails': RecipientDetails$json,
  '.banking.InternationalTransferRequest': InternationalTransferRequest$json,
  '.banking.InternationalTransferRequest.RecipientDetailsEntry': InternationalTransferRequest_RecipientDetailsEntry$json,
  '.banking.GetExchangeRateRequest': GetExchangeRateRequest$json,
  '.banking.ExchangeRateResponse': ExchangeRateResponse$json,
  '.banking.GetSupportedCountriesRequest': GetSupportedCountriesRequest$json,
  '.banking.SupportedCountriesResponse': SupportedCountriesResponse$json,
  '.banking.VerifyBankAccountRequest': VerifyBankAccountRequest$json,
  '.banking.VerifyBankAccountResponse': VerifyBankAccountResponse$json,
  '.banking.GetBanksRequest': GetBanksRequest$json,
  '.banking.BanksResponse': BanksResponse$json,
  '.banking.Bank': Bank$json,
  '.banking.VerifyBVNRequest': VerifyBVNRequest$json,
  '.banking.IdentityVerificationResponse': IdentityVerificationResponse$json,
  '.banking.IdentityVerification': IdentityVerification$json,
  '.banking.GetVerificationStatusRequest': GetVerificationStatusRequest$json,
  '.banking.VerifyBVNForSignupRequest': VerifyBVNForSignupRequest$json,
  '.banking.SignupIdentityVerificationResponse': SignupIdentityVerificationResponse$json,
  '.banking.VerifiedIdentityDetails': VerifiedIdentityDetails$json,
  '.banking.VerifyNINForSignupRequest': VerifyNINForSignupRequest$json,
  '.banking.CreateVirtualAccountForUserRequest': CreateVirtualAccountForUserRequest$json,
  '.banking.UsernameTransferRequest': UsernameTransferRequest$json,
  '.banking.PhoneTransferRequest': PhoneTransferRequest$json,
  '.banking.SearchRecipientsRequest': SearchRecipientsRequest$json,
  '.banking.RecipientsResponse': RecipientsResponse$json,
  '.banking.TransferRecipient': TransferRecipient$json,
  '.banking.GetRecentRecipientsRequest': GetRecentRecipientsRequest$json,
  '.banking.GetProviderStatusRequest': GetProviderStatusRequest$json,
  '.banking.ProviderStatusResponse': ProviderStatusResponse$json,
  '.banking.ProviderStatusResponse.ProvidersEntry': ProviderStatusResponse_ProvidersEntry$json,
  '.banking.ProviderHealth': ProviderHealth$json,
  '.banking.GetActiveProvidersRequest': GetActiveProvidersRequest$json,
  '.banking.ActiveProvidersResponse': ActiveProvidersResponse$json,
  '.banking.GetAccountBalanceRequest': GetAccountBalanceRequest$json,
  '.banking.AccountBalanceResponse': AccountBalanceResponse$json,
  '.banking.GetAccountTransactionsRequest': GetAccountTransactionsRequest$json,
  '.banking.TransactionsResponse': TransactionsResponse$json,
  '.banking.Transaction': Transaction$json,
  '.banking.GetPrimaryAccountRequest': GetPrimaryAccountRequest$json,
  '.banking.FreezeAccountRequest': FreezeAccountRequest$json,
  '.banking.FreezeAccountResponse': FreezeAccountResponse$json,
  '.banking.UnfreezeAccountRequest': UnfreezeAccountRequest$json,
  '.banking.UnfreezeAccountResponse': UnfreezeAccountResponse$json,
  '.banking.GetDailyUsageRequest': GetDailyUsageRequest$json,
  '.banking.DailyUsageResponse': DailyUsageResponse$json,
  '.banking.RunReconciliationRequest': RunReconciliationRequest$json,
  '.banking.ReconciliationResponse': ReconciliationResponse$json,
  '.banking.GetReconciliationHistoryRequest': GetReconciliationHistoryRequest$json,
  '.banking.ReconciliationHistoryResponse': ReconciliationHistoryResponse$json,
  '.banking.ReconciliationLog': ReconciliationLog$json,
  '.banking.GetDailyReportRequest': GetDailyReportRequest$json,
  '.banking.DailyReportResponse': DailyReportResponse$json,
  '.banking.GetMonoInstitutionsRequest': GetMonoInstitutionsRequest$json,
  '.banking.MonoInstitutionsResponse': MonoInstitutionsResponse$json,
  '.banking.MonoInstitution': MonoInstitution$json,
  '.banking.MonoAuthMethod': MonoAuthMethod$json,
  '.banking.GetConnectWidgetConfigRequest': GetConnectWidgetConfigRequest$json,
  '.banking.ConnectWidgetConfigResponse': ConnectWidgetConfigResponse$json,
  '.banking.LinkBankAccountRequest': LinkBankAccountRequest$json,
  '.banking.LinkBankAccountResponse': LinkBankAccountResponse$json,
  '.banking.LinkedBankAccount': LinkedBankAccount$json,
  '.banking.GetLinkedAccountsRequest': GetLinkedAccountsRequest$json,
  '.banking.LinkedAccountsResponse': LinkedAccountsResponse$json,
  '.banking.GetLinkedAccountRequest': GetLinkedAccountRequest$json,
  '.banking.LinkedAccountResponse': LinkedAccountResponse$json,
  '.banking.UnlinkBankAccountRequest': UnlinkBankAccountRequest$json,
  '.banking.UnlinkBankAccountResponse': UnlinkBankAccountResponse$json,
  '.banking.SetDefaultLinkedAccountRequest': SetDefaultLinkedAccountRequest$json,
  '.banking.SetDefaultLinkedAccountResponse': SetDefaultLinkedAccountResponse$json,
  '.banking.RefreshLinkedAccountBalanceRequest': RefreshLinkedAccountBalanceRequest$json,
  '.banking.RefreshLinkedAccountBalanceResponse': RefreshLinkedAccountBalanceResponse$json,
  '.banking.GetReauthorizationTokenRequest': GetReauthorizationTokenRequest$json,
  '.banking.GetReauthorizationTokenResponse': GetReauthorizationTokenResponse$json,
  '.banking.InitiateDepositRequest': InitiateDepositRequest$json,
  '.banking.DepositResponse': DepositResponse$json,
  '.banking.Deposit': Deposit$json,
  '.banking.GetDepositStatusRequest': GetDepositStatusRequest$json,
  '.banking.GetUserDepositsRequest': GetUserDepositsRequest$json,
  '.banking.DepositsResponse': DepositsResponse$json,
  '.banking.CancelDepositRequest': CancelDepositRequest$json,
  '.banking.CancelDepositResponse': CancelDepositResponse$json,
  '.banking.CalculateDepositFeeRequest': CalculateDepositFeeRequest$json,
  '.banking.CalculateDepositFeeResponse': CalculateDepositFeeResponse$json,
  '.banking.CreateMandateRequest': CreateMandateRequest$json,
  '.banking.MandateResponse': MandateResponse$json,
  '.banking.DirectDebitMandate': DirectDebitMandate$json,
  '.banking.GetMandateRequest': GetMandateRequest$json,
  '.banking.GetUserMandatesRequest': GetUserMandatesRequest$json,
  '.banking.MandatesResponse': MandatesResponse$json,
  '.banking.PauseMandateRequest': PauseMandateRequest$json,
  '.banking.PauseMandateResponse': PauseMandateResponse$json,
  '.banking.ReinstateMandateRequest': ReinstateMandateRequest$json,
  '.banking.ReinstateMandateResponse': ReinstateMandateResponse$json,
  '.banking.CancelMandateRequest': CancelMandateRequest$json,
  '.banking.CancelMandateResponse': CancelMandateResponse$json,
  '.banking.CheckMandateBalanceRequest': CheckMandateBalanceRequest$json,
  '.banking.CheckMandateBalanceResponse': CheckMandateBalanceResponse$json,
  '.banking.InitiateWithdrawalRequest': InitiateWithdrawalRequest$json,
  '.banking.WithdrawalResponse': WithdrawalResponse$json,
  '.banking.Withdrawal': Withdrawal$json,
  '.banking.GetWithdrawalStatusRequest': GetWithdrawalStatusRequest$json,
  '.banking.GetUserWithdrawalsRequest': GetUserWithdrawalsRequest$json,
  '.banking.WithdrawalsResponse': WithdrawalsResponse$json,
  '.banking.CalculateWithdrawalFeeRequest': CalculateWithdrawalFeeRequest$json,
  '.banking.CalculateWithdrawalFeeResponse': CalculateWithdrawalFeeResponse$json,
  '.banking.GetTransferFeeRequest': GetTransferFeeRequest$json,
  '.banking.GetTransferFeeResponse': GetTransferFeeResponse$json,
  '.banking.FeeItem': FeeItem$json,
};

/// Descriptor for `BankingService`. Decode as a `google.protobuf.ServiceDescriptorProto`.
final $typed_data.Uint8List bankingServiceDescriptor = $convert.base64Decode('');

...
const VoiceAudioChunk$json = const {
  '1': 'VoiceAudioChunk',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'audio_data', '3': 2, '4': 1, '5': 12, '10': 'audioData'},
    const {'1': 'sequence_number', '3': 3, '4': 1, '5': 3, '10': 'sequenceNumber'},
    const {'1': 'is_final', '3': 4, '4': 1, '5': 8, '10': 'isFinal'},
    const {'1': 'format', '3': 5, '4': 1, '5': 11, '6': '.voicebiometrics.AudioFormat', '10': 'format'},
    const {'1': 'metadata', '3': 6, '4': 3, '5': 11, '6': '.voicebiometrics.VoiceAudioChunk.MetadataEntry', '10': 'metadata'},
  ],
  '3': const [VoiceAudioChunk_MetadataEntry$json],
};

@$core.Deprecated('Use voiceAudioChunkDescriptor instead')
const VoiceAudioChunk_MetadataEntry$json = const {
  '1': 'MetadataEntry',
  '2': const [
...
final $typed_data.Uint8List voiceAudioChunkDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use verifyVoiceStreamResponseDescriptor instead')
const VerifyVoiceStreamResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'needs_more_audio', '3': 6, '4': 1, '5': 8, '10': 'needsMoreAudio'},
    const {'1': 'chunks_processed', '3': 7, '4': 1, '5': 5, '10': 'chunksProcessed'},
  ],
};

/// Descriptor for `VerifyVoiceStreamResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List verifyVoiceStreamResponseDescriptor = $convert.base64Decode('');
...
const VoiceProfile$json = const {
  ...
  '2': const [
    ...
    const {'1': 'custom_voice_id', '3': 9, '4': 1, '5': 9, '10': 'customVoiceId'},
    const {'1': 'custom_voice_provider', '3': 10, '4': 1, '5': 9, '10': 'customVoiceProvider'},
    const {'1': 'custom_voice_status', '3': 11, '4': 1, '5': 9, '10': 'customVoiceStatus'},
    const {'1': 'custom_voice_created_at', '3': 12, '4': 1, '5': 3, '10': 'customVoiceCreatedAt'},
    const {'1': 'custom_voice_error', '3': 13, '4': 1, '5': 9, '10': 'customVoiceError'},
  ],
};

/// Descriptor for `VoiceProfile`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List voiceProfileDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use getCustomVoiceStatusRequestDescriptor instead')
const GetCustomVoiceStatusRequest$json = const {
  '1': 'GetCustomVoiceStatusRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
  ],
};
...
final $typed_data.Uint8List getCustomVoiceStatusRequestDescriptor = $convert.base64Decode('ChtHZXRDdXN0b21Wb2ljZVN0YXR1c1JlcXVlc3QSFwoHdXNlcl9pZBgBIAEoCVIGdXNlcklk');
@$core.Deprecated('Use getCustomVoiceStatusResponseDescriptor instead')
const GetCustomVoiceStatusResponse$json = const {
  '1': 'GetCustomVoiceStatusResponse',
  '2': const [
    const {'1': 'has_custom_voice', '3': 1, '4': 1, '5': 8, '10': 'hasCustomVoice'},
    const {'1': 'custom_voice_id', '3': 2, '4': 1, '5': 9, '10': 'customVoiceId'},
    const {'1': 'custom_voice_provider', '3': 3, '4': 1, '5': 9, '10': 'customVoiceProvider'},
    const {'1': 'custom_voice_status', '3': 4, '4': 1, '5': 9, '10': 'customVoiceStatus'},
    const {'1': 'custom_voice_created_at', '3': 5, '4': 1, '5': 3, '10': 'customVoiceCreatedAt'},
    const {'1': 'custom_voice_error', '3': 6, '4': 1, '5': 9, '10': 'customVoiceError'},
    const {'1': 'enabled', '3': 7, '4': 1, '5': 8, '10': 'enabled'},
  ],
};

/// Descriptor for `GetCustomVoiceStatusResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCustomVoiceStatusResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use setCustomVoiceEnabledRequestDescriptor instead')
const SetCustomVoiceEnabledRequest$json = const {
  '1': 'SetCustomVoiceEnabledRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
...
final $typed_data.Uint8List setCustomVoiceEnabledRequestDescriptor = $convert.base64Decode('ChxTZXRDdXN0b21Wb2ljZUVuYWJsZWRSZXF1ZXN0EhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZBIYCgdlbmFibGVkGAIgASgIUgdlbmFibGVk');
@$core.Deprecated('Use setCustomVoiceEnabledResponseDescriptor instead')
const SetCustomVoiceEnabledResponse$json = const {
  '1': 'SetCustomVoiceEnabledResponse',
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'custom_voice_status', '3': 3, '4': 1, '5': 9, '10': 'customVoiceStatus'},
  ],
};

/// Descriptor for `SetCustomVoiceEnabledResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List setCustomVoiceEnabledResponseDescriptor = $convert.base64Decode('Ch1TZXRDdXN0b21Wb2ljZUVuYWJsZWRSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USLgoTY3VzdG9tX3ZvaWNlX3N0YXR1cxgDIAEoCVIRY3VzdG9tVm9pY2VTdGF0dXM=');
@$core.Deprecated('Use retriggerVoiceCloningRequestDescriptor instead')
const RetriggerVoiceCloningRequest$json = const {
  '1': 'RetriggerVoiceCloningRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
  ],
};
...
final $typed_data.Uint8List retriggerVoiceCloningRequestDescriptor = $convert.base64Decode('ChxSZXRyaWdnZXJWb2ljZUNsb25pbmdSZXF1ZXN0EhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZA==');
@$core.Deprecated('Use retriggerVoiceCloningResponseDescriptor instead')
const RetriggerVoiceCloningResponse$json = const {
  '1': 'RetriggerVoiceCloningResponse',
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'custom_voice_status', '3': 3, '4': 1, '5': 9, '10': 'customVoiceStatus'},
...
final $typed_data.Uint8List retriggerVoiceCloningResponseDescriptor = $convert.base64Decode('Ch1SZXRyaWdnZXJWb2ljZUNsb25pbmdSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USLgoTY3VzdG9tX3ZvaWNlX3N0YXR1cxgDIAEoCVIRY3VzdG9tVm9pY2VTdGF0dXM=');
@$core.Deprecated('Use updateCloningStatusRequestDescriptor instead')
const UpdateCloningStatusRequest$json = const {
  '1': 'UpdateCloningStatusRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'voice_id', '3': 2, '4': 1, '5': 9, '10': 'voiceId'},
...
final $typed_data.Uint8List updateCloningStatusRequestDescriptor = $convert.base64Decode('ChpVcGRhdGVDbG9uaW5nU3RhdHVzUmVxdWVzdBIXCgd1c2VyX2lkGAEgASgJUgZ1c2VySWQSGQoIdm9pY2VfaWQYAiABKAlSB3ZvaWNlSWQSGgoIcHJvdmlkZXIYAyABKAlSCHByb3ZpZGVyEhYKBnN0YXR1cxgEIAEoCVIGc3RhdHVzEhQKBWVycm9yGAUgASgJUgVlcnJvcg==');
@$core.Deprecated('Use updateCloningStatusResponseDescriptor instead')
const UpdateCloningStatusResponse$json = const {
  '1': 'UpdateCloningStatusResponse',
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'custom_voice_status', '3': 3, '4': 1, '5': 9, '10': 'customVoiceStatus'},
...
final $typed_data.Uint8List updateCloningStatusResponseDescriptor = $convert.base64Decode('ChtVcGRhdGVDbG9uaW5nU3RhdHVzUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdlEi4KE2N1c3RvbV92b2ljZV9zdGF0dXMYAyABKAlSEWN1c3RvbVZvaWNlU3RhdHVz');

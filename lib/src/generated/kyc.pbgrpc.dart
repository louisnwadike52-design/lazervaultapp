...
class KYCServiceClient extends $grpc.Client {
  ...
  KYCServiceClient(super.channel, {super.options, super.interceptors});
  ...
  $grpc.ResponseFuture<$0.VerifyIDResponse> verifyID(
    $0.VerifyIDRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Get presigned GCS upload URL for documents (Tier 3)
  ...
  static final _$getPendingReviews = $grpc.ClientMethod<
      ...
      $0.GetPendingReviewsResponse.fromBuffer);
  static final _$reviewDocument =
      $grpc.ClientMethod<$0.ReviewDocumentRequest, $0.ReviewDocumentResponse>(
          ...
          $0.ReviewDocumentResponse.fromBuffer);
}
...
abstract class KYCServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.VerifyIDResponse> verifyID_Pre($grpc.ServiceCall $call,
      $async.Future<$0.VerifyIDRequest> $request) async {
  ...
  $async.Future<$0.SkipKYCResponse> skipKYCUpgrade_Pre($grpc.ServiceCall $call,
      $async.Future<$0.SkipKYCRequest> $request) async {

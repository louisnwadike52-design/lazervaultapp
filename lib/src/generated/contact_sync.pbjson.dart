...
const SyncContactsRequest$json = {
  ...
  '2': [
    {'1': 'contacts', '3': 1, '4': 3, '5': 11, '6': '.pb.ContactToSync', '10': 'contacts'},
...
final $typed_data.Uint8List syncContactsRequestDescriptor = $convert.base64Decode(
    'ChNTeW5jQ29udGFjdHNSZXF1ZXN0Ei0KCGNvbnRhY3RzGAEgAygLMhEucGIuQ29udGFjdFRvU3'
    'luY1IIY29udGFjdHMSHwoLcmVwbGFjZV9hbGwYAiABKAhSCnJlcGxhY2VBbGw=');
...
const SyncContactsResponse$json = {
  ...
  '2': [
    {'1': 'synced_contacts', '3': 1, '4': 3, '5': 11, '6': '.pb.SyncedContact', '10': 'syncedContacts'},
    {'1': 'total_synced', '3': 2, '4': 1, '5': 5, '10': 'totalSynced'},
    {'1': 'total_matched_users', '3': 3, '4': 1, '5': 5, '10': 'totalMatchedUsers'},
    {'1': 'matched_users', '3': 4, '4': 3, '5': 11, '6': '.pb.LazerVaultUserMatch', '10': 'matchedUsers'},
  ],
};
...
final $typed_data.Uint8List syncContactsResponseDescriptor = $convert.base64Decode(
    'ChRTeW5jQ29udGFjdHNSZXNwb25zZRI6Cg9zeW5jZWRfY29udGFjdHMYASADKAsyES5wYi5TeW'
    '5jZWRDb250YWN0Ug5zeW5jZWRDb250YWN0cxIhCgx0b3RhbF9zeW5jZWQYAiABKAVSC3RvdGFs'
    'U3luY2VkEi4KE3RvdGFsX21hdGNoZWRfdXNlcnMYAyABKAVSEXRvdGFsTWF0Y2hlZFVzZXJzEj'
    'wKDW1hdGNoZWRfdXNlcnMYBCADKAsyFy5wYi5MYXplclZhdWx0VXNlck1hdGNoUgxtYXRjaGVk'
    'VXNlcnM=');
...
const GetSyncedContactsResponse$json = {
  ...
  '2': [
    {'1': 'contacts', '3': 1, '4': 3, '5': 11, '6': '.pb.SyncedContact', '10': 'contacts'},
...
final $typed_data.Uint8List getSyncedContactsResponseDescriptor = $convert.base64Decode(
    'ChlHZXRTeW5jZWRDb250YWN0c1Jlc3BvbnNlEi0KCGNvbnRhY3RzGAEgAygLMhEucGIuU3luY2'
    'VkQ29udGFjdFIIY29udGFjdHMSHwoLdG90YWxfY291bnQYAiABKAVSCnRvdGFsQ291bnQSEgoE'
...
const ConvertContactToRecipientResponse$json = {
  ...
  '2': [
    ...
    {'1': 'recipient', '3': 5, '4': 1, '5': 11, '6': '.pb.RecipientDetails', '10': 'recipient'},
  ],
};
...
final $typed_data.Uint8List convertContactToRecipientResponseDescriptor = $convert.base64Decode(
    ...
    'xhemVydmF1bHRfdXNlcm5hbWUYBCABKAlSEmxhemVydmF1bHRVc2VybmFtZRIyCglyZWNpcGll'
    'bnQYBSABKAsyFC5wYi5SZWNpcGllbnREZXRhaWxzUglyZWNpcGllbnQ=');
...
const FindLazerVaultUsersResponse$json = {
  ...
  '2': [
    {'1': 'matched_users', '3': 1, '4': 3, '5': 11, '6': '.pb.LazerVaultUserMatch', '10': 'matchedUsers'},
...
final $typed_data.Uint8List findLazerVaultUsersResponseDescriptor = $convert.base64Decode(
    'ChtGaW5kTGF6ZXJWYXVsdFVzZXJzUmVzcG9uc2USPAoNbWF0Y2hlZF91c2VycxgBIAMoCzIXLn'
    'BiLkxhemVyVmF1bHRVc2VyTWF0Y2hSDG1hdGNoZWRVc2VycxIjCg10b3RhbF9tYXRjaGVzGAIg'
    'ASgFUgx0b3RhbE1hdGNoZXM=');
...
const UpdateSyncPreferencesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'sync_frequency', '3': 2, '4': 1, '5': 14, '6': '.pb.SyncFrequency', '10': 'syncFrequency'},
...
final $typed_data.Uint8List updateSyncPreferencesRequestDescriptor = $convert.base64Decode(
    ...
    'gIUg9hdXRvU3luY0VuYWJsZWQSOAoOc3luY19mcmVxdWVuY3kYAiABKA4yES5wYi5TeW5jRnJl'
    'cXVlbmN5Ug1zeW5jRnJlcXVlbmN5EigKEG1hdGNoX3dpdGhfdXNlcnMYAyABKAhSDm1hdGNoV2'
    'l0aFVzZXJzEh8KC3N5bmNfcGhvdG9zGAQgASgIUgpzeW5jUGhvdG9z');
...
const UpdateSyncPreferencesResponse$json = {
  ...
  '2': [
    {'1': 'preferences', '3': 1, '4': 1, '5': 11, '6': '.pb.SyncPreferences', '10': 'preferences'},
    {'1': 'success', '3': 2, '4': 1, '5': 8, '10': 'success'},
  ],
};
...
final $typed_data.Uint8List updateSyncPreferencesResponseDescriptor = $convert.base64Decode(
    'Ch1VcGRhdGVTeW5jUHJlZmVyZW5jZXNSZXNwb25zZRI1CgtwcmVmZXJlbmNlcxgBIAEoCzITLn'
    'BiLlN5bmNQcmVmZXJlbmNlc1ILcHJlZmVyZW5jZXMSGAoHc3VjY2VzcxgCIAEoCFIHc3VjY2Vz'
    'cw==');
...
const SyncPreferences$json = {
  ...
  '2': [
    ...
    {'1': 'sync_frequency', '3': 3, '4': 1, '5': 14, '6': '.pb.SyncFrequency', '10': 'syncFrequency'},
...
final $typed_data.Uint8List syncPreferencesDescriptor = $convert.base64Decode(
    ...
    '9lbmFibGVkGAIgASgIUg9hdXRvU3luY0VuYWJsZWQSOAoOc3luY19mcmVxdWVuY3kYAyABKA4y'
    'ES5wYi5TeW5jRnJlcXVlbmN5Ug1zeW5jRnJlcXVlbmN5EigKEG1hdGNoX3dpdGhfdXNlcnMYBC'
    'ABKAhSDm1hdGNoV2l0aFVzZXJzEh8KC3N5bmNfcGhvdG9zGAUgASgIUgpzeW5jUGhvdG9zEjwK'
    'DGxhc3Rfc3luY19hdBgGIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCmxhc3RTeW'
    '5jQXQSMgoVdG90YWxfc3luY2VkX2NvbnRhY3RzGAcgASgFUhN0b3RhbFN5bmNlZENvbnRhY3Rz'
    'Ei4KE3RvdGFsX21hdGNoZWRfdXNlcnMYCCABKAVSEXRvdGFsTWF0Y2hlZFVzZXJz');

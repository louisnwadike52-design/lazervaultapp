...
const SyncContactsRequest$json = const {
  ...
  '2': const [
    const {'1': 'contacts', '3': 1, '4': 3, '5': 11, '6': '.pb.ContactToSync', '10': 'contacts'},
...
final $typed_data.Uint8List syncContactsRequestDescriptor = $convert.base64Decode('ChNTeW5jQ29udGFjdHNSZXF1ZXN0Ei0KCGNvbnRhY3RzGAEgAygLMhEucGIuQ29udGFjdFRvU3luY1IIY29udGFjdHMSHwoLcmVwbGFjZV9hbGwYAiABKAhSCnJlcGxhY2VBbGw=');
...
const SyncContactsResponse$json = const {
  ...
  '2': const [
    const {'1': 'synced_contacts', '3': 1, '4': 3, '5': 11, '6': '.pb.SyncedContact', '10': 'syncedContacts'},
    const {'1': 'total_synced', '3': 2, '4': 1, '5': 5, '10': 'totalSynced'},
    const {'1': 'total_matched_users', '3': 3, '4': 1, '5': 5, '10': 'totalMatchedUsers'},
    const {'1': 'matched_users', '3': 4, '4': 3, '5': 11, '6': '.pb.LazerVaultUserMatch', '10': 'matchedUsers'},
  ],
};

/// Descriptor for `SyncContactsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List syncContactsResponseDescriptor = $convert.base64Decode('');
...
const GetSyncedContactsResponse$json = const {
  ...
  '2': const [
    const {'1': 'contacts', '3': 1, '4': 3, '5': 11, '6': '.pb.SyncedContact', '10': 'contacts'},
...
final $typed_data.Uint8List getSyncedContactsResponseDescriptor = $convert.base64Decode('ChlHZXRTeW5jZWRDb250YWN0c1Jlc3BvbnNlEi0KCGNvbnRhY3RzGAEgAygLMhEucGIuU3luY2VkQ29udGFjdFIIY29udGFjdHMSHwoLdG90YWxfY291bnQYAiABKAVSCnRvdGFsQ291bnQSEgoEcGFnZRgDIAEoBVIEcGFnZRIbCglwYWdlX3NpemUYBCABKAVSCHBhZ2VTaXpl');
...
const ConvertContactToRecipientResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'recipient', '3': 5, '4': 1, '5': 11, '6': '.pb.RecipientDetails', '10': 'recipient'},
  ],
};

/// Descriptor for `ConvertContactToRecipientResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List convertContactToRecipientResponseDescriptor = $convert.base64Decode('');
...
const FindLazerVaultUsersResponse$json = const {
  ...
  '2': const [
    const {'1': 'matched_users', '3': 1, '4': 3, '5': 11, '6': '.pb.LazerVaultUserMatch', '10': 'matchedUsers'},
...
final $typed_data.Uint8List findLazerVaultUsersResponseDescriptor = $convert.base64Decode('ChtGaW5kTGF6ZXJWYXVsdFVzZXJzUmVzcG9uc2USPAoNbWF0Y2hlZF91c2VycxgBIAMoCzIXLnBiLkxhemVyVmF1bHRVc2VyTWF0Y2hSDG1hdGNoZWRVc2VycxIjCg10b3RhbF9tYXRjaGVzGAIgASgFUgx0b3RhbE1hdGNoZXM=');
...
const UpdateSyncPreferencesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sync_frequency', '3': 2, '4': 1, '5': 14, '6': '.pb.SyncFrequency', '10': 'syncFrequency'},
...
final $typed_data.Uint8List updateSyncPreferencesRequestDescriptor = $convert.base64Decode('');
...
const UpdateSyncPreferencesResponse$json = const {
  ...
  '2': const [
    const {'1': 'preferences', '3': 1, '4': 1, '5': 11, '6': '.pb.SyncPreferences', '10': 'preferences'},
    const {'1': 'success', '3': 2, '4': 1, '5': 8, '10': 'success'},
  ],
};

/// Descriptor for `UpdateSyncPreferencesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateSyncPreferencesResponseDescriptor = $convert.base64Decode('Ch1VcGRhdGVTeW5jUHJlZmVyZW5jZXNSZXNwb25zZRI1CgtwcmVmZXJlbmNlcxgBIAEoCzITLnBiLlN5bmNQcmVmZXJlbmNlc1ILcHJlZmVyZW5jZXMSGAoHc3VjY2VzcxgCIAEoCFIHc3VjY2Vzcw==');
...
const SyncPreferences$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sync_frequency', '3': 3, '4': 1, '5': 14, '6': '.pb.SyncFrequency', '10': 'syncFrequency'},
...
final $typed_data.Uint8List syncPreferencesDescriptor = $convert.base64Decode('');

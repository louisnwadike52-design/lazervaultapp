...
const CryptoMessage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'has_local_direct', '3': 33, '4': 1, '5': 8, '10': 'hasLocalDirect'},
  ],
...
final $typed_data.Uint8List cryptoMessageDescriptor = $convert.base64Decode('');
...
const GetGlobalMarketDataResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'learn_more_url', '3': 9, '4': 1, '5': 9, '10': 'learnMoreUrl'},
  ],
};

/// Descriptor for `GetGlobalMarketDataResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getGlobalMarketDataResponseDescriptor = $convert.base64Decode('');
...
const AdminSwapTransactionListItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'spread_minor_units', '3': 14, '4': 1, '5': 3, '10': 'spreadMinorUnits'},
    const {'1': 'error_class', '3': 15, '4': 1, '5': 9, '10': 'errorClass'},
    const {'1': 'delivery_status', '3': 16, '4': 1, '5': 9, '10': 'deliveryStatus'},
    const {'1': 'settlement_status', '3': 17, '4': 1, '5': 9, '10': 'settlementStatus'},
  ],
};

/// Descriptor for `AdminSwapTransactionListItem`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminSwapTransactionListItemDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use adminGetCryptoRevenueSummaryRequestDescriptor instead')
const AdminGetCryptoRevenueSummaryRequest$json = const {
  '1': 'AdminGetCryptoRevenueSummaryRequest',
  '2': const [
    const {'1': 'from_date', '3': 1, '4': 1, '5': 9, '10': 'fromDate'},
    const {'1': 'to_date', '3': 2, '4': 1, '5': 9, '10': 'toDate'},
  ],
};

/// Descriptor for `AdminGetCryptoRevenueSummaryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminGetCryptoRevenueSummaryRequestDescriptor = $convert.base64Decode('CiNBZG1pbkdldENyeXB0b1JldmVudWVTdW1tYXJ5UmVxdWVzdBIbCglmcm9tX2RhdGUYASABKAlSCGZyb21EYXRlEhcKB3RvX2RhdGUYAiABKAlSBnRvRGF0ZQ==');
@$core.Deprecated('Use cryptoRevenueByCurrencyDescriptor instead')
const CryptoRevenueByCurrency$json = const {
  '1': 'CryptoRevenueByCurrency',
  '2': const [
    const {'1': 'currency', '3': 1, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'swap_spread_minor', '3': 2, '4': 1, '5': 3, '10': 'swapSpreadMinor'},
    const {'1': 'send_fee_minor', '3': 3, '4': 1, '5': 3, '10': 'sendFeeMinor'},
    const {'1': 'total_minor', '3': 4, '4': 1, '5': 3, '10': 'totalMinor'},
    const {'1': 'swap_count', '3': 5, '4': 1, '5': 3, '10': 'swapCount'},
    const {'1': 'send_count', '3': 6, '4': 1, '5': 3, '10': 'sendCount'},
  ],
};

/// Descriptor for `CryptoRevenueByCurrency`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List cryptoRevenueByCurrencyDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use cryptoRevenueByOpDescriptor instead')
const CryptoRevenueByOp$json = const {
  '1': 'CryptoRevenueByOp',
  '2': const [
    const {'1': 'op_type', '3': 1, '4': 1, '5': 9, '10': 'opType'},
    const {'1': 'currency', '3': 2, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'total_minor', '3': 3, '4': 1, '5': 3, '10': 'totalMinor'},
    const {'1': 'txn_count', '3': 4, '4': 1, '5': 3, '10': 'txnCount'},
  ],
};

/// Descriptor for `CryptoRevenueByOp`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List cryptoRevenueByOpDescriptor = $convert.base64Decode('ChFDcnlwdG9SZXZlbnVlQnlPcBIXCgdvcF90eXBlGAEgASgJUgZvcFR5cGUSGgoIY3VycmVuY3kYAiABKAlSCGN1cnJlbmN5Eh8KC3RvdGFsX21pbm9yGAMgASgDUgp0b3RhbE1pbm9yEhsKCXR4bl9jb3VudBgEIAEoA1IIdHhuQ291bnQ=');
@$core.Deprecated('Use adminGetCryptoRevenueSummaryResponseDescriptor instead')
const AdminGetCryptoRevenueSummaryResponse$json = const {
  '1': 'AdminGetCryptoRevenueSummaryResponse',
  '2': const [
    const {'1': 'by_currency', '3': 1, '4': 3, '5': 11, '6': '.pb.CryptoRevenueByCurrency', '10': 'byCurrency'},
    const {'1': 'swap_count_total', '3': 2, '4': 1, '5': 3, '10': 'swapCountTotal'},
    const {'1': 'send_count_total', '3': 3, '4': 1, '5': 3, '10': 'sendCountTotal'},
    const {'1': 'by_op', '3': 4, '4': 3, '5': 11, '6': '.pb.CryptoRevenueByOp', '10': 'byOp'},
    const {'1': 'grand_total_by_currency', '3': 5, '4': 3, '5': 11, '6': '.pb.CryptoRevenueByCurrency', '10': 'grandTotalByCurrency'},
    const {'1': 'txn_count_total', '3': 6, '4': 1, '5': 3, '10': 'txnCountTotal'},
  ],
};

/// Descriptor for `AdminGetCryptoRevenueSummaryResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminGetCryptoRevenueSummaryResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListStuckSwapsRequestDescriptor instead')
const AdminListStuckSwapsRequest$json = const {
  '1': 'AdminListStuckSwapsRequest',
  '2': const [
    const {'1': 'page', '3': 1, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'per_page', '3': 2, '4': 1, '5': 5, '10': 'perPage'},
  ],
...
/// Descriptor for `AdminListStuckSwapsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListStuckSwapsRequestDescriptor = $convert.base64Decode('ChpBZG1pbkxpc3RTdHVja1N3YXBzUmVxdWVzdBISCgRwYWdlGAEgASgFUgRwYWdlEhkKCHBlcl9wYWdlGAIgASgFUgdwZXJQYWdl');
@$core.Deprecated('Use adminStuckSwapItemDescriptor instead')
const AdminStuckSwapItem$json = const {
  '1': 'AdminStuckSwapItem',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'reference', '3': 2, '4': 1, '5': 9, '10': 'reference'},
    const {'1': 'user_id', '3': 3, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'side', '3': 4, '4': 1, '5': 9, '10': 'side'},
    const {'1': 'status', '3': 5, '4': 1, '5': 9, '10': 'status'},
    const {'1': 'from_currency', '3': 6, '4': 1, '5': 9, '10': 'fromCurrency'},
    const {'1': 'to_currency', '3': 7, '4': 1, '5': 9, '10': 'toCurrency'},
    const {'1': 'from_amount', '3': 8, '4': 1, '5': 9, '10': 'fromAmount'},
    const {'1': 'created_at', '3': 9, '4': 1, '5': 9, '10': 'createdAt'},
    const {'1': 'updated_at', '3': 10, '4': 1, '5': 9, '10': 'updatedAt'},
    const {'1': 'age_seconds', '3': 11, '4': 1, '5': 3, '10': 'ageSeconds'},
    const {'1': 'recon_attempts', '3': 12, '4': 1, '5': 5, '10': 'reconAttempts'},
    const {'1': 'last_error', '3': 13, '4': 1, '5': 9, '10': 'lastError'},
    const {'1': 'quidax_swap_id', '3': 14, '4': 1, '5': 9, '10': 'quidaxSwapId'},
  ],
};

/// Descriptor for `AdminStuckSwapItem`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminStuckSwapItemDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListStuckSwapsResponseDescriptor instead')
const AdminListStuckSwapsResponse$json = const {
  '1': 'AdminListStuckSwapsResponse',
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.pb.AdminStuckSwapItem', '10': 'items'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
    const {'1': 'stale_after_seconds', '3': 3, '4': 1, '5': 3, '10': 'staleAfterSeconds'},
  ],
};

/// Descriptor for `AdminListStuckSwapsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListStuckSwapsResponseDescriptor = $convert.base64Decode('ChtBZG1pbkxpc3RTdHVja1N3YXBzUmVzcG9uc2USLAoFaXRlbXMYASADKAsyFi5wYi5BZG1pblN0dWNrU3dhcEl0ZW1SBWl0ZW1zEhQKBXRvdGFsGAIgASgFUgV0b3RhbBIuChNzdGFsZV9hZnRlcl9zZWNvbmRzGAMgASgDUhFzdGFsZUFmdGVyU2Vjb25kcw==');
@$core.Deprecated('Use adminGetCryptoRevenueTimeseriesRequestDescriptor instead')
const AdminGetCryptoRevenueTimeseriesRequest$json = const {
  '1': 'AdminGetCryptoRevenueTimeseriesRequest',
  '2': const [
    const {'1': 'from_date', '3': 1, '4': 1, '5': 9, '10': 'fromDate'},
    const {'1': 'to_date', '3': 2, '4': 1, '5': 9, '10': 'toDate'},
...
/// Descriptor for `AdminGetCryptoRevenueTimeseriesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminGetCryptoRevenueTimeseriesRequestDescriptor = $convert.base64Decode('CiZBZG1pbkdldENyeXB0b1JldmVudWVUaW1lc2VyaWVzUmVxdWVzdBIbCglmcm9tX2RhdGUYASABKAlSCGZyb21EYXRlEhcKB3RvX2RhdGUYAiABKAlSBnRvRGF0ZRIaCghjdXJyZW5jeRgDIAEoCVIIY3VycmVuY3k=');
@$core.Deprecated('Use cryptoRevenueDayPointDescriptor instead')
const CryptoRevenueDayPoint$json = const {
  '1': 'CryptoRevenueDayPoint',
  '2': const [
    const {'1': 'day', '3': 1, '4': 1, '5': 9, '10': 'day'},
    const {'1': 'currency', '3': 2, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'net_minor', '3': 3, '4': 1, '5': 3, '10': 'netMinor'},
    const {'1': 'txn_count', '3': 4, '4': 1, '5': 3, '10': 'txnCount'},
  ],
};

/// Descriptor for `CryptoRevenueDayPoint`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List cryptoRevenueDayPointDescriptor = $convert.base64Decode('ChVDcnlwdG9SZXZlbnVlRGF5UG9pbnQSEAoDZGF5GAEgASgJUgNkYXkSGgoIY3VycmVuY3kYAiABKAlSCGN1cnJlbmN5EhsKCW5ldF9taW5vchgDIAEoA1IIbmV0TWlub3ISGwoJdHhuX2NvdW50GAQgASgDUgh0eG5Db3VudA==');
@$core.Deprecated('Use adminGetCryptoRevenueTimeseriesResponseDescriptor instead')
const AdminGetCryptoRevenueTimeseriesResponse$json = const {
  '1': 'AdminGetCryptoRevenueTimeseriesResponse',
  '2': const [
    const {'1': 'points', '3': 1, '4': 3, '5': 11, '6': '.pb.CryptoRevenueDayPoint', '10': 'points'},
    const {'1': 'net_total_minor', '3': 2, '4': 1, '5': 3, '10': 'netTotalMinor'},
  ],
};

/// Descriptor for `AdminGetCryptoRevenueTimeseriesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminGetCryptoRevenueTimeseriesResponseDescriptor = $convert.base64Decode('CidBZG1pbkdldENyeXB0b1JldmVudWVUaW1lc2VyaWVzUmVzcG9uc2USMQoGcG9pbnRzGAEgAygLMhkucGIuQ3J5cHRvUmV2ZW51ZURheVBvaW50UgZwb2ludHMSJgoPbmV0X3RvdGFsX21pbm9yGAIgASgDUg1uZXRUb3RhbE1pbm9y');
@$core.Deprecated('Use adminListTriageQueueRequestDescriptor instead')
const AdminListTriageQueueRequest$json = const {
  '1': 'AdminListTriageQueueRequest',
  '2': const [
    const {'1': 'page', '3': 1, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'per_page', '3': 2, '4': 1, '5': 5, '10': 'perPage'},
  ],
...
/// Descriptor for `AdminListTriageQueueRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListTriageQueueRequestDescriptor = $convert.base64Decode('ChtBZG1pbkxpc3RUcmlhZ2VRdWV1ZVJlcXVlc3QSEgoEcGFnZRgBIAEoBVIEcGFnZRIZCghwZXJfcGFnZRgCIAEoBVIHcGVyUGFnZQ==');
@$core.Deprecated('Use adminTriageItemDescriptor instead')
const AdminTriageItem$json = const {
  '1': 'AdminTriageItem',
  '2': const [
    ...
    const {'1': 'amount', '3': 8, '4': 1, '5': 9, '10': 'amount'},
    const {'1': 'last_error', '3': 9, '4': 1, '5': 9, '10': 'lastError'},
    const {'1': 'created_at', '3': 10, '4': 1, '5': 9, '10': 'createdAt'},
    const {'1': 'updated_at', '3': 11, '4': 1, '5': 9, '10': 'updatedAt'},
  ],
};

/// Descriptor for `AdminTriageItem`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminTriageItemDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListTriageQueueResponseDescriptor instead')
const AdminListTriageQueueResponse$json = const {
  '1': 'AdminListTriageQueueResponse',
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.pb.AdminTriageItem', '10': 'items'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
  ],
};

/// Descriptor for `AdminListTriageQueueResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListTriageQueueResponseDescriptor = $convert.base64Decode('ChxBZG1pbkxpc3RUcmlhZ2VRdWV1ZVJlc3BvbnNlEikKBWl0ZW1zGAEgAygLMhMucGIuQWRtaW5UcmlhZ2VJdGVtUgVpdGVtcxIUCgV0b3RhbBgCIAEoBVIFdG90YWw=');
...
const AdminGetSwapTransactionDetailResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'delivery_last_error', '3': 12, '4': 1, '5': 9, '10': 'deliveryLastError'},
    const {'1': 'settlement_last_error', '3': 13, '4': 1, '5': 9, '10': 'settlementLastError'},
  ],
};

/// Descriptor for `AdminGetSwapTransactionDetailResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminGetSwapTransactionDetailResponseDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use adminCryptoUserWithdrawalDescriptor instead')
const AdminCryptoUserWithdrawal$json = const {
  '1': 'AdminCryptoUserWithdrawal',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'user_id', '3': 2, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'reference', '3': 3, '4': 1, '5': 9, '10': 'reference'},
    const {'1': 'recipient_type', '3': 4, '4': 1, '5': 9, '10': 'recipientType'},
    const {'1': 'currency', '3': 5, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'amount_minor_units', '3': 6, '4': 1, '5': 3, '10': 'amountMinorUnits'},
    const {'1': 'fee_minor_units', '3': 7, '4': 1, '5': 3, '10': 'feeMinorUnits'},
    const {'1': 'fiat_fee_minor_units', '3': 8, '4': 1, '5': 3, '10': 'fiatFeeMinorUnits'},
    const {'1': 'fiat_fee_currency', '3': 9, '4': 1, '5': 9, '10': 'fiatFeeCurrency'},
    const {'1': 'network', '3': 10, '4': 1, '5': 9, '10': 'network'},
    const {'1': 'status', '3': 11, '4': 1, '5': 9, '10': 'status'},
    const {'1': 'fail_reason', '3': 12, '4': 1, '5': 9, '10': 'failReason'},
    const {'1': 'quidax_withdraw_id', '3': 13, '4': 1, '5': 9, '10': 'quidaxWithdrawId'},
    const {'1': 'created_at', '3': 14, '4': 1, '5': 9, '10': 'createdAt'},
    const {'1': 'submitted_at', '3': 15, '4': 1, '5': 9, '10': 'submittedAt'},
    const {'1': 'done_at', '3': 16, '4': 1, '5': 9, '10': 'doneAt'},
    const {'1': 'recipient_user_id', '3': 17, '4': 1, '5': 9, '10': 'recipientUserId'},
    const {'1': 'recipient_username', '3': 18, '4': 1, '5': 9, '10': 'recipientUsername'},
  ],
};

/// Descriptor for `AdminCryptoUserWithdrawal`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminCryptoUserWithdrawalDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListUserWithdrawalsRequestDescriptor instead')
const AdminListUserWithdrawalsRequest$json = const {
  '1': 'AdminListUserWithdrawalsRequest',
  '2': const [
    const {'1': 'status', '3': 1, '4': 1, '5': 9, '10': 'status'},
    const {'1': 'currency', '3': 2, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'user_id', '3': 3, '4': 1, '5': 9, '10': 'userId'},
...
/// Descriptor for `AdminListUserWithdrawalsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListUserWithdrawalsRequestDescriptor = $convert.base64Decode('Ch9BZG1pbkxpc3RVc2VyV2l0aGRyYXdhbHNSZXF1ZXN0EhYKBnN0YXR1cxgBIAEoCVIGc3RhdHVzEhoKCGN1cnJlbmN5GAIgASgJUghjdXJyZW5jeRIXCgd1c2VyX2lkGAMgASgJUgZ1c2VySWQSEgoEcGFnZRgEIAEoBVIEcGFnZRIZCghwZXJfcGFnZRgFIAEoBVIHcGVyUGFnZQ==');
@$core.Deprecated('Use adminListUserWithdrawalsResponseDescriptor instead')
const AdminListUserWithdrawalsResponse$json = const {
  '1': 'AdminListUserWithdrawalsResponse',
  '2': const [
    const {'1': 'withdrawals', '3': 1, '4': 3, '5': 11, '6': '.pb.AdminCryptoUserWithdrawal', '10': 'withdrawals'},
    const {'1': 'total', '3': 2, '4': 1, '5': 3, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'per_page', '3': 4, '4': 1, '5': 5, '10': 'perPage'},
  ],
...
/// Descriptor for `AdminListUserWithdrawalsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListUserWithdrawalsResponseDescriptor = $convert.base64Decode('CiBBZG1pbkxpc3RVc2VyV2l0aGRyYXdhbHNSZXNwb25zZRI/Cgt3aXRoZHJhd2FscxgBIAMoCzIdLnBiLkFkbWluQ3J5cHRvVXNlcldpdGhkcmF3YWxSC3dpdGhkcmF3YWxzEhQKBXRvdGFsGAIgASgDUgV0b3RhbBISCgRwYWdlGAMgASgFUgRwYWdlEhkKCHBlcl9wYWdlGAQgASgFUgdwZXJQYWdl');
@$core.Deprecated('Use adminWalletAddressDescriptor instead')
const AdminWalletAddress$json = const {
  '1': 'AdminWalletAddress',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'user_id', '3': 2, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'currency', '3': 3, '4': 1, '5': 9, '10': 'currency'},
    ...
    const {'1': 'destination_tag', '3': 6, '4': 1, '5': 9, '10': 'destinationTag'},
    const {'1': 'creation_status', '3': 7, '4': 1, '5': 9, '10': 'creationStatus'},
    const {'1': 'is_active', '3': 8, '4': 1, '5': 8, '10': 'isActive'},
    const {'1': 'created_at', '3': 9, '4': 1, '5': 9, '10': 'createdAt'},
    const {'1': 'updated_at', '3': 10, '4': 1, '5': 9, '10': 'updatedAt'},
  ],
...
/// Descriptor for `AdminWalletAddress`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminWalletAddressDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListWalletAddressesRequestDescriptor instead')
const AdminListWalletAddressesRequest$json = const {
  '1': 'AdminListWalletAddressesRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'currency', '3': 2, '4': 1, '5': 9, '10': 'currency'},
...
/// Descriptor for `AdminListWalletAddressesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListWalletAddressesRequestDescriptor = $convert.base64Decode('Ch9BZG1pbkxpc3RXYWxsZXRBZGRyZXNzZXNSZXF1ZXN0EhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZBIaCghjdXJyZW5jeRgCIAEoCVIIY3VycmVuY3kSGAoHbmV0d29yaxgDIAEoCVIHbmV0d29yaxISCgRwYWdlGAQgASgFUgRwYWdlEhkKCHBlcl9wYWdlGAUgASgFUgdwZXJQYWdl');
@$core.Deprecated('Use adminListWalletAddressesResponseDescriptor instead')
const AdminListWalletAddressesResponse$json = const {
  '1': 'AdminListWalletAddressesResponse',
  '2': const [
    const {'1': 'addresses', '3': 1, '4': 3, '5': 11, '6': '.pb.AdminWalletAddress', '10': 'addresses'},
    const {'1': 'total', '3': 2, '4': 1, '5': 3, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'per_page', '3': 4, '4': 1, '5': 5, '10': 'perPage'},
  ],
...
/// Descriptor for `AdminListWalletAddressesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListWalletAddressesResponseDescriptor = $convert.base64Decode('CiBBZG1pbkxpc3RXYWxsZXRBZGRyZXNzZXNSZXNwb25zZRI0CglhZGRyZXNzZXMYASADKAsyFi5wYi5BZG1pbldhbGxldEFkZHJlc3NSCWFkZHJlc3NlcxIUCgV0b3RhbBgCIAEoA1IFdG90YWwSEgoEcGFnZRgDIAEoBVIEcGFnZRIZCghwZXJfcGFnZRgEIAEoBVIHcGVyUGFnZQ==');
...
const GetCryptoConfigResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'op_fee', '3': 9, '4': 3, '5': 11, '6': '.pb.GetCryptoConfigResponse.OpFeeEntry', '10': 'opFee'},
    const {'1': 'min_deliverable_amounts', '3': 10, '4': 3, '5': 11, '6': '.pb.GetCryptoConfigResponse.MinDeliverableAmountsEntry', '10': 'minDeliverableAmounts'},
  ],
  '3': const [GetCryptoConfigResponse_MinOrderMinorUnitsEntry$json, GetCryptoConfigResponse_CurrencyDecimalsEntry$json, GetCryptoConfigResponse_QuickAmountsCsvEntry$json, GetCryptoConfigResponse_OpFeeEntry$json, GetCryptoConfigResponse_MinDeliverableAmountsEntry$json],
};
...
@$core.Deprecated('Use getCryptoConfigResponseDescriptor instead')
const GetCryptoConfigResponse_OpFeeEntry$json = const {
  '1': 'OpFeeEntry',
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 9, '10': 'value'},
...
@$core.Deprecated('Use getCryptoConfigResponseDescriptor instead')
const GetCryptoConfigResponse_MinDeliverableAmountsEntry$json = const {
  '1': 'MinDeliverableAmountsEntry',
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 9, '10': 'value'},
  ],
...
final $typed_data.Uint8List getCryptoConfigResponseDescriptor = $convert.base64Decode('');
...
const WithdrawRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'recipient_user_id', '3': 12, '4': 1, '5': 9, '10': 'recipientUserId'},
    const {'1': 'recipient_username', '3': 13, '4': 1, '5': 9, '10': 'recipientUsername'},
  ],
};

/// Descriptor for `WithdrawRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List withdrawRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getCryptoWithdrawalStatusRequestDescriptor = $convert.base64Decode('CiBHZXRDcnlwdG9XaXRoZHJhd2FsU3RhdHVzUmVxdWVzdBIlCg50cmFuc2FjdGlvbl9pZBgBIAEoCVINdHJhbnNhY3Rpb25JZBIcCglyZWZlcmVuY2UYAiABKAlSCXJlZmVyZW5jZQ==');
...
const GetCryptoWithdrawalStatusResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'transaction_note', '3': 16, '4': 1, '5': 9, '10': 'transactionNote'},
    const {'1': 'narration', '3': 17, '4': 1, '5': 9, '10': 'narration'},
    const {'1': 'recipient_user_id', '3': 18, '4': 1, '5': 9, '10': 'recipientUserId'},
    const {'1': 'recipient_username', '3': 19, '4': 1, '5': 9, '10': 'recipientUsername'},
    const {'1': 'sender_user_id', '3': 20, '4': 1, '5': 9, '10': 'senderUserId'},
  ],
};

/// Descriptor for `GetCryptoWithdrawalStatusResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCryptoWithdrawalStatusResponseDescriptor = $convert.base64Decode('');
...
const QuidaxAssetNetwork$json = const {
  ...
  '2': const [
    ...
    const {'1': 'min_withdraw_decimal', '3': 12, '4': 1, '5': 9, '10': 'minWithdrawDecimal'},
  ],
};

/// Descriptor for `QuidaxAssetNetwork`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List quidaxAssetNetworkDescriptor = $convert.base64Decode('');
...
const AssetNetworkStatusEntry$json = const {
  '1': 'AssetNetworkStatusEntry',
  '2': const [
    const {'1': 'network', '3': 1, '4': 1, '5': 11, '6': '.pb.QuidaxAssetNetwork', '10': 'network'},
    const {'1': 'provisioned', '3': 2, '4': 1, '5': 8, '10': 'provisioned'},
    const {'1': 'active', '3': 3, '4': 1, '5': 8, '10': 'active'},
  ],
};

/// Descriptor for `AssetNetworkStatusEntry`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List assetNetworkStatusEntryDescriptor = $convert.base64Decode('ChdBc3NldE5ldHdvcmtTdGF0dXNFbnRyeRIwCgduZXR3b3JrGAEgASgLMhYucGIuUXVpZGF4QXNzZXROZXR3b3JrUgduZXR3b3JrEiAKC3Byb3Zpc2lvbmVkGAIgASgIUgtwcm92aXNpb25lZBIWCgZhY3RpdmUYAyABKAhSBmFjdGl2ZQ==');
@$core.Deprecated('Use getAssetNetworkStatusRequestDescriptor instead')
const GetAssetNetworkStatusRequest$json = const {
...
final $typed_data.Uint8List getAssetNetworkStatusRequestDescriptor = $convert.base64Decode('ChxHZXRBc3NldE5ldHdvcmtTdGF0dXNSZXF1ZXN0EhoKCGN1cnJlbmN5GAEgASgJUghjdXJyZW5jeQ==');
@$core.Deprecated('Use getAssetNetworkStatusResponseDescriptor instead')
const GetAssetNetworkStatusResponse$json = const {
  '1': 'GetAssetNetworkStatusResponse',
  '2': const [
    const {'1': 'currency', '3': 1, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'held', '3': 2, '4': 1, '5': 8, '10': 'held'},
    const {'1': 'active_network', '3': 3, '4': 1, '5': 9, '10': 'activeNetwork'},
    const {'1': 'networks', '3': 4, '4': 3, '5': 11, '6': '.pb.AssetNetworkStatusEntry', '10': 'networks'},
  ],
};

/// Descriptor for `GetAssetNetworkStatusResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAssetNetworkStatusResponseDescriptor = $convert.base64Decode('Ch1HZXRBc3NldE5ldHdvcmtTdGF0dXNSZXNwb25zZRIaCghjdXJyZW5jeRgBIAEoCVIIY3VycmVuY3kSEgoEaGVsZBgCIAEoCFIEaGVsZBIlCg5hY3RpdmVfbmV0d29yaxgDIAEoCVINYWN0aXZlTmV0d29yaxI3CghuZXR3b3JrcxgEIAMoCzIbLnBiLkFzc2V0TmV0d29ya1N0YXR1c0VudHJ5UghuZXR3b3Jrcw==');
@$core.Deprecated('Use getCryptoEligibilityRequestDescriptor instead')
const GetCryptoEligibilityRequest$json = const {
  '1': 'GetCryptoEligibilityRequest',
};

/// Descriptor for `GetCryptoEligibilityRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCryptoEligibilityRequestDescriptor = $convert.base64Decode('ChtHZXRDcnlwdG9FbGlnaWJpbGl0eVJlcXVlc3Q=');
@$core.Deprecated('Use getCryptoEligibilityResponseDescriptor instead')
const GetCryptoEligibilityResponse$json = const {
  '1': 'GetCryptoEligibilityResponse',
  '2': const [
    const {'1': 'can_use_crypto', '3': 1, '4': 1, '5': 8, '10': 'canUseCrypto'},
    const {'1': 'can_create_wallet', '3': 2, '4': 1, '5': 8, '10': 'canCreateWallet'},
    const {'1': 'can_trade', '3': 3, '4': 1, '5': 8, '10': 'canTrade'},
    const {'1': 'can_withdraw', '3': 4, '4': 1, '5': 8, '10': 'canWithdraw'},
    const {'1': 'current_tier', '3': 5, '4': 1, '5': 5, '10': 'currentTier'},
    const {'1': 'required_tier', '3': 6, '4': 1, '5': 5, '10': 'requiredTier'},
    const {'1': 'kyc_status', '3': 7, '4': 1, '5': 9, '10': 'kycStatus'},
...
final $typed_data.Uint8List getCryptoEligibilityResponseDescriptor = $convert.base64Decode('');
...
const ResolveRecipientWalletRequest$json = const {
  '1': 'ResolveRecipientWalletRequest',
  '2': const [
    const {'1': 'recipient_user_id', '3': 1, '4': 1, '5': 9, '10': 'recipientUserId'},
    const {'1': 'currency', '3': 2, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'network', '3': 3, '4': 1, '5': 9, '10': 'network'},
  ],
};
...
final $typed_data.Uint8List resolveRecipientWalletRequestDescriptor = $convert.base64Decode('Ch1SZXNvbHZlUmVjaXBpZW50V2FsbGV0UmVxdWVzdBIqChFyZWNpcGllbnRfdXNlcl9pZBgBIAEoCVIPcmVjaXBpZW50VXNlcklkEhoKCGN1cnJlbmN5GAIgASgJUghjdXJyZW5jeRIYCgduZXR3b3JrGAMgASgJUgduZXR3b3Jr');
@$core.Deprecated('Use resolveRecipientWalletResponseDescriptor instead')
const ResolveRecipientWalletResponse$json = const {
  '1': 'ResolveRecipientWalletResponse',
  '2': const [
    const {'1': 'address', '3': 1, '4': 1, '5': 9, '10': 'address'},
    const {'1': 'destination_tag', '3': 2, '4': 1, '5': 9, '10': 'destinationTag'},
    const {'1': 'ready', '3': 3, '4': 1, '5': 8, '10': 'ready'},
    const {'1': 'creation_status', '3': 4, '4': 1, '5': 9, '10': 'creationStatus'},
  ],
};

/// Descriptor for `ResolveRecipientWalletResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resolveRecipientWalletResponseDescriptor = $convert.base64Decode('Ch5SZXNvbHZlUmVjaXBpZW50V2FsbGV0UmVzcG9uc2USGAoHYWRkcmVzcxgBIAEoCVIHYWRkcmVzcxInCg9kZXN0aW5hdGlvbl90YWcYAiABKAlSDmRlc3RpbmF0aW9uVGFnEhQKBXJlYWR5GAMgASgIUgVyZWFkeRInCg9jcmVhdGlvbl9zdGF0dXMYBCABKAlSDmNyZWF0aW9uU3RhdHVz');
...
const AutoOrder$json = const {
  ...
  '2': const [
    ...
    const {'1': 'crypto_id', '3': 3, '4': 1, '5': 9, '10': 'cryptoId'},
    const {'1': 'crypto_symbol', '3': 4, '4': 1, '5': 9, '10': 'cryptoSymbol'},
    const {'1': 'fiat_currency', '3': 5, '4': 1, '5': 9, '10': 'fiatCurrency'},
    const {'1': 'trigger_direction', '3': 6, '4': 1, '5': 9, '10': 'triggerDirection'},
    const {'1': 'target_price', '3': 7, '4': 1, '5': 1, '10': 'targetPrice'},
    const {'1': 'amount_minor', '3': 8, '4': 1, '5': 3, '10': 'amountMinor'},
    const {'1': 'status', '3': 9, '4': 1, '5': 9, '10': 'status'},
    const {'1': 'swap_transaction_id', '3': 10, '4': 1, '5': 9, '10': 'swapTransactionId'},
    const {'1': 'last_error', '3': 11, '4': 1, '5': 9, '10': 'lastError'},
    const {'1': 'created_at', '3': 12, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createdAt'},
    const {'1': 'triggered_at', '3': 13, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'triggeredAt'},
    const {'1': 'completed_at', '3': 14, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'completedAt'},
...
final $typed_data.Uint8List autoOrderDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use createAutoOrderRequestDescriptor instead')
const CreateAutoOrderRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'crypto_id', '3': 3, '4': 1, '5': 9, '10': 'cryptoId'},
    const {'1': 'fiat_currency', '3': 4, '4': 1, '5': 9, '10': 'fiatCurrency'},
    const {'1': 'trigger_direction', '3': 5, '4': 1, '5': 9, '10': 'triggerDirection'},
    const {'1': 'target_price', '3': 6, '4': 1, '5': 1, '10': 'targetPrice'},
    const {'1': 'amount_minor', '3': 7, '4': 1, '5': 3, '10': 'amountMinor'},
    const {'1': 'transaction_pin', '3': 8, '4': 1, '5': 9, '10': 'transactionPin'},
    const {'1': 'idempotency_key', '3': 9, '4': 1, '5': 9, '10': 'idempotencyKey'},
    const {'1': 'expires_in_seconds', '3': 10, '4': 1, '5': 3, '10': 'expiresInSeconds'},
  ],
};

/// Descriptor for `CreateAutoOrderRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createAutoOrderRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use createAutoOrderResponseDescriptor instead')
const CreateAutoOrderResponse$json = const {
  '1': 'CreateAutoOrderResponse',
  '2': const [
    const {'1': 'order', '3': 1, '4': 1, '5': 11, '6': '.pb.AutoOrder', '10': 'order'},
  ],
};

/// Descriptor for `CreateAutoOrderResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createAutoOrderResponseDescriptor = $convert.base64Decode('ChdDcmVhdGVBdXRvT3JkZXJSZXNwb25zZRIjCgVvcmRlchgBIAEoCzINLnBiLkF1dG9PcmRlclIFb3JkZXI=');
@$core.Deprecated('Use listAutoOrdersRequestDescriptor instead')
const ListAutoOrdersRequest$json = const {
...
final $typed_data.Uint8List listAutoOrdersRequestDescriptor = $convert.base64Decode('ChVMaXN0QXV0b09yZGVyc1JlcXVlc3QSFgoGc3RhdHVzGAEgASgJUgZzdGF0dXM=');
@$core.Deprecated('Use listAutoOrdersResponseDescriptor instead')
const ListAutoOrdersResponse$json = const {
  '1': 'ListAutoOrdersResponse',
  '2': const [
    const {'1': 'orders', '3': 1, '4': 3, '5': 11, '6': '.pb.AutoOrder', '10': 'orders'},
  ],
};

/// Descriptor for `ListAutoOrdersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listAutoOrdersResponseDescriptor = $convert.base64Decode('ChZMaXN0QXV0b09yZGVyc1Jlc3BvbnNlEiUKBm9yZGVycxgBIAMoCzINLnBiLkF1dG9PcmRlclIGb3JkZXJz');
@$core.Deprecated('Use cancelAutoOrderRequestDescriptor instead')
const CancelAutoOrderRequest$json = const {
...
final $typed_data.Uint8List cancelAutoOrderRequestDescriptor = $convert.base64Decode('ChZDYW5jZWxBdXRvT3JkZXJSZXF1ZXN0EhkKCG9yZGVyX2lkGAEgASgJUgdvcmRlcklk');
@$core.Deprecated('Use cancelAutoOrderResponseDescriptor instead')
const CancelAutoOrderResponse$json = const {
...
final $typed_data.Uint8List cancelAutoOrderResponseDescriptor = $convert.base64Decode('ChdDYW5jZWxBdXRvT3JkZXJSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNz');
@$core.Deprecated('Use autoOrderWorkerRunDescriptor instead')
const AutoOrderWorkerRun$json = const {
  '1': 'AutoOrderWorkerRun',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'started_at', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'startedAt'},
    const {'1': 'finished_at', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'finishedAt'},
...
/// Descriptor for `AutoOrderWorkerRun`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List autoOrderWorkerRunDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use getAutoOrderWorkerStatusRequestDescriptor instead')
const GetAutoOrderWorkerStatusRequest$json = const {
  '1': 'GetAutoOrderWorkerStatusRequest',
  '2': const [
    const {'1': 'limit', '3': 1, '4': 1, '5': 5, '10': 'limit'},
  ],
};

/// Descriptor for `GetAutoOrderWorkerStatusRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAutoOrderWorkerStatusRequestDescriptor = $convert.base64Decode('Ch9HZXRBdXRvT3JkZXJXb3JrZXJTdGF0dXNSZXF1ZXN0EhQKBWxpbWl0GAEgASgFUgVsaW1pdA==');
@$core.Deprecated('Use getAutoOrderWorkerStatusResponseDescriptor instead')
const GetAutoOrderWorkerStatusResponse$json = const {
  '1': 'GetAutoOrderWorkerStatusResponse',
  '2': const [
    const {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    const {'1': 'poll_interval_seconds', '3': 2, '4': 1, '5': 5, '10': 'pollIntervalSeconds'},
    const {'1': 'batch_size', '3': 3, '4': 1, '5': 5, '10': 'batchSize'},
    const {'1': 'total_active_orders', '3': 4, '4': 1, '5': 5, '10': 'totalActiveOrders'},
    const {'1': 'last_run', '3': 5, '4': 1, '5': 11, '6': '.pb.AutoOrderWorkerRun', '10': 'lastRun'},
    const {'1': 'recent_runs', '3': 6, '4': 3, '5': 11, '6': '.pb.AutoOrderWorkerRun', '10': 'recentRuns'},
  ],
};

/// Descriptor for `GetAutoOrderWorkerStatusResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAutoOrderWorkerStatusResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use updateAutoOrderWorkerConfigRequestDescriptor instead')
const UpdateAutoOrderWorkerConfigRequest$json = const {
  '1': 'UpdateAutoOrderWorkerConfigRequest',
  '2': const [
    const {'1': 'has_enabled', '3': 1, '4': 1, '5': 8, '10': 'hasEnabled'},
    const {'1': 'enabled', '3': 2, '4': 1, '5': 8, '10': 'enabled'},
    const {'1': 'has_poll_interval_seconds', '3': 3, '4': 1, '5': 8, '10': 'hasPollIntervalSeconds'},
...
/// Descriptor for `UpdateAutoOrderWorkerConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateAutoOrderWorkerConfigRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use updateAutoOrderWorkerConfigResponseDescriptor instead')
const UpdateAutoOrderWorkerConfigResponse$json = const {
  '1': 'UpdateAutoOrderWorkerConfigResponse',
  '2': const [
    const {'1': 'enabled', '3': 1, '4': 1, '5': 8, '10': 'enabled'},
    const {'1': 'poll_interval_seconds', '3': 2, '4': 1, '5': 5, '10': 'pollIntervalSeconds'},
    const {'1': 'batch_size', '3': 3, '4': 1, '5': 5, '10': 'batchSize'},
...
/// Descriptor for `UpdateAutoOrderWorkerConfigResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateAutoOrderWorkerConfigResponseDescriptor = $convert.base64Decode('CiNVcGRhdGVBdXRvT3JkZXJXb3JrZXJDb25maWdSZXNwb25zZRIYCgdlbmFibGVkGAEgASgIUgdlbmFibGVkEjIKFXBvbGxfaW50ZXJ2YWxfc2Vjb25kcxgCIAEoBVITcG9sbEludGVydmFsU2Vjb25kcxIdCgpiYXRjaF9zaXplGAMgASgFUgliYXRjaFNpemU=');
@$core.Deprecated('Use triggerAutoOrderWorkerNowRequestDescriptor instead')
const TriggerAutoOrderWorkerNowRequest$json = const {
  '1': 'TriggerAutoOrderWorkerNowRequest',
};

/// Descriptor for `TriggerAutoOrderWorkerNowRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List triggerAutoOrderWorkerNowRequestDescriptor = $convert.base64Decode('CiBUcmlnZ2VyQXV0b09yZGVyV29ya2VyTm93UmVxdWVzdA==');
@$core.Deprecated('Use triggerAutoOrderWorkerNowResponseDescriptor instead')
const TriggerAutoOrderWorkerNowResponse$json = const {
  '1': 'TriggerAutoOrderWorkerNowResponse',
  '2': const [
    const {'1': 'run', '3': 1, '4': 1, '5': 11, '6': '.pb.AutoOrderWorkerRun', '10': 'run'},
  ],
};

/// Descriptor for `TriggerAutoOrderWorkerNowResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List triggerAutoOrderWorkerNowResponseDescriptor = $convert.base64Decode('CiFUcmlnZ2VyQXV0b09yZGVyV29ya2VyTm93UmVzcG9uc2USKAoDcnVuGAEgASgLMhYucGIuQXV0b09yZGVyV29ya2VyUnVuUgNydW4=');
@$core.Deprecated('Use adminAutoOrderRecordDescriptor instead')
const AdminAutoOrderRecord$json = const {
  '1': 'AdminAutoOrderRecord',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'user_id', '3': 2, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'side', '3': 3, '4': 1, '5': 9, '10': 'side'},
    const {'1': 'crypto_id', '3': 4, '4': 1, '5': 9, '10': 'cryptoId'},
    const {'1': 'crypto_symbol', '3': 5, '4': 1, '5': 9, '10': 'cryptoSymbol'},
    const {'1': 'fiat_currency', '3': 6, '4': 1, '5': 9, '10': 'fiatCurrency'},
    const {'1': 'trigger_direction', '3': 7, '4': 1, '5': 9, '10': 'triggerDirection'},
    const {'1': 'target_price', '3': 8, '4': 1, '5': 1, '10': 'targetPrice'},
    const {'1': 'amount_minor', '3': 9, '4': 1, '5': 3, '10': 'amountMinor'},
    const {'1': 'status', '3': 10, '4': 1, '5': 9, '10': 'status'},
    const {'1': 'swap_transaction_id', '3': 11, '4': 1, '5': 9, '10': 'swapTransactionId'},
    const {'1': 'last_error', '3': 12, '4': 1, '5': 9, '10': 'lastError'},
    const {'1': 'created_at', '3': 13, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createdAt'},
    const {'1': 'triggered_at', '3': 14, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'triggeredAt'},
    const {'1': 'completed_at', '3': 15, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'completedAt'},
  ],
};

/// Descriptor for `AdminAutoOrderRecord`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminAutoOrderRecordDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListAutoOrdersRequestDescriptor instead')
const AdminListAutoOrdersRequest$json = const {
  '1': 'AdminListAutoOrdersRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'symbol', '3': 2, '4': 1, '5': 9, '10': 'symbol'},
    const {'1': 'status', '3': 3, '4': 1, '5': 9, '10': 'status'},
...
/// Descriptor for `AdminListAutoOrdersRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListAutoOrdersRequestDescriptor = $convert.base64Decode('ChpBZG1pbkxpc3RBdXRvT3JkZXJzUmVxdWVzdBIXCgd1c2VyX2lkGAEgASgJUgZ1c2VySWQSFgoGc3ltYm9sGAIgASgJUgZzeW1ib2wSFgoGc3RhdHVzGAMgASgJUgZzdGF0dXMSEgoEcGFnZRgEIAEoBVIEcGFnZRIZCghwZXJfcGFnZRgFIAEoBVIHcGVyUGFnZQ==');
@$core.Deprecated('Use adminListAutoOrdersResponseDescriptor instead')
const AdminListAutoOrdersResponse$json = const {
  '1': 'AdminListAutoOrdersResponse',
  '2': const [
    const {'1': 'orders', '3': 1, '4': 3, '5': 11, '6': '.pb.AdminAutoOrderRecord', '10': 'orders'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'per_page', '3': 4, '4': 1, '5': 5, '10': 'perPage'},
  ],
...
/// Descriptor for `AdminListAutoOrdersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListAutoOrdersResponseDescriptor = $convert.base64Decode('ChtBZG1pbkxpc3RBdXRvT3JkZXJzUmVzcG9uc2USMAoGb3JkZXJzGAEgAygLMhgucGIuQWRtaW5BdXRvT3JkZXJSZWNvcmRSBm9yZGVycxIUCgV0b3RhbBgCIAEoBVIFdG90YWwSEgoEcGFnZRgDIAEoBVIEcGFnZRIZCghwZXJfcGFnZRgEIAEoBVIHcGVyUGFnZQ==');
@$core.Deprecated('Use adminCancelAutoOrderRequestDescriptor instead')
const AdminCancelAutoOrderRequest$json = const {
  '1': 'AdminCancelAutoOrderRequest',
  '2': const [
    const {'1': 'order_id', '3': 1, '4': 1, '5': 9, '10': 'orderId'},
  ],
};

/// Descriptor for `AdminCancelAutoOrderRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminCancelAutoOrderRequestDescriptor = $convert.base64Decode('ChtBZG1pbkNhbmNlbEF1dG9PcmRlclJlcXVlc3QSGQoIb3JkZXJfaWQYASABKAlSB29yZGVySWQ=');
@$core.Deprecated('Use adminCancelAutoOrderResponseDescriptor instead')
const AdminCancelAutoOrderResponse$json = const {
  '1': 'AdminCancelAutoOrderResponse',
  '2': const [
    const {'1': 'order', '3': 1, '4': 1, '5': 11, '6': '.pb.AdminAutoOrderRecord', '10': 'order'},
  ],
};

/// Descriptor for `AdminCancelAutoOrderResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminCancelAutoOrderResponseDescriptor = $convert.base64Decode('ChxBZG1pbkNhbmNlbEF1dG9PcmRlclJlc3BvbnNlEi4KBW9yZGVyGAEgASgLMhgucGIuQWRtaW5BdXRvT3JkZXJSZWNvcmRSBW9yZGVy');
@$core.Deprecated('Use adminWatchlistRecordDescriptor instead')
const AdminWatchlistRecord$json = const {
  '1': 'AdminWatchlistRecord',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'user_id', '3': 2, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'name', '3': 3, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'description', '3': 4, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'item_count', '3': 5, '4': 1, '5': 5, '10': 'itemCount'},
    const {'1': 'created_at', '3': 6, '4': 1, '5': 9, '10': 'createdAt'},
    const {'1': 'updated_at', '3': 7, '4': 1, '5': 9, '10': 'updatedAt'},
  ],
};

/// Descriptor for `AdminWatchlistRecord`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminWatchlistRecordDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListWatchlistsRequestDescriptor instead')
const AdminListWatchlistsRequest$json = const {
  '1': 'AdminListWatchlistsRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'page', '3': 2, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'per_page', '3': 3, '4': 1, '5': 5, '10': 'perPage'},
...
/// Descriptor for `AdminListWatchlistsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListWatchlistsRequestDescriptor = $convert.base64Decode('ChpBZG1pbkxpc3RXYXRjaGxpc3RzUmVxdWVzdBIXCgd1c2VyX2lkGAEgASgJUgZ1c2VySWQSEgoEcGFnZRgCIAEoBVIEcGFnZRIZCghwZXJfcGFnZRgDIAEoBVIHcGVyUGFnZQ==');
@$core.Deprecated('Use adminListWatchlistsResponseDescriptor instead')
const AdminListWatchlistsResponse$json = const {
  '1': 'AdminListWatchlistsResponse',
  '2': const [
    const {'1': 'watchlists', '3': 1, '4': 3, '5': 11, '6': '.pb.AdminWatchlistRecord', '10': 'watchlists'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'per_page', '3': 4, '4': 1, '5': 5, '10': 'perPage'},
  ],
...
/// Descriptor for `AdminListWatchlistsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminListWatchlistsResponseDescriptor = $convert.base64Decode('ChtBZG1pbkxpc3RXYXRjaGxpc3RzUmVzcG9uc2USOAoKd2F0Y2hsaXN0cxgBIAMoCzIYLnBiLkFkbWluV2F0Y2hsaXN0UmVjb3JkUgp3YXRjaGxpc3RzEhQKBXRvdGFsGAIgASgFUgV0b3RhbBISCgRwYWdlGAMgASgFUgRwYWdlEhkKCHBlcl9wYWdlGAQgASgFUgdwZXJQYWdl');

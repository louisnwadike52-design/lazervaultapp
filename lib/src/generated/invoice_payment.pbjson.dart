...
const UserAccountBalance$json = const {
  ...
  '2': const [
    ...
    const {'1': 'account_type', '3': 6, '4': 1, '5': 14, '6': '.pb.VirtualAccountType', '10': 'accountType'},
...
final $typed_data.Uint8List userAccountBalanceDescriptor = $convert.base64Decode('');
...
const InvoiceCryptoWallet$json = const {
...
final $typed_data.Uint8List invoiceCryptoWalletDescriptor = $convert.base64Decode('');
...
const GetUserAccountBalanceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'account_type', '3': 2, '4': 1, '5': 14, '6': '.pb.VirtualAccountType', '10': 'accountType'},
  ],
};

/// Descriptor for `GetUserAccountBalanceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getUserAccountBalanceRequestDescriptor = $convert.base64Decode('ChxHZXRVc2VyQWNjb3VudEJhbGFuY2VSZXF1ZXN0EhoKCGN1cnJlbmN5GAEgASgJUghjdXJyZW5jeRI5CgxhY2NvdW50X3R5cGUYAiABKA4yFi5wYi5WaXJ0dWFsQWNjb3VudFR5cGVSC2FjY291bnRUeXBl');
...
const GetInvoiceCryptoWalletBalanceRequest$json = const {
...
final $typed_data.Uint8List getInvoiceCryptoWalletBalanceRequestDescriptor = $convert.base64Decode('CiRHZXRJbnZvaWNlQ3J5cHRvV2FsbGV0QmFsYW5jZVJlcXVlc3QSJQoOd2FsbGV0X2FkZHJlc3MYASABKAlSDXdhbGxldEFkZHJlc3MSGgoIY3VycmVuY3kYAiABKAlSCGN1cnJlbmN5EhgKB25ldHdvcmsYAyABKAlSB25ldHdvcms=');
@$core.Deprecated('Use getInvoiceCryptoWalletBalanceResponseDescriptor instead')
const GetInvoiceCryptoWalletBalanceResponse$json = const {
...
final $typed_data.Uint8List getInvoiceCryptoWalletBalanceResponseDescriptor = $convert.base64Decode('CiVHZXRJbnZvaWNlQ3J5cHRvV2FsbGV0QmFsYW5jZVJlc3BvbnNlEhgKB2JhbGFuY2UYASABKAFSB2JhbGFuY2USGgoIY3VycmVuY3kYAiABKAlSCGN1cnJlbmN5Ej0KDGxhc3RfdXBkYXRlZBgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSC2xhc3RVcGRhdGVkEhgKB25ldHdvcmsYBCABKAlSB25ldHdvcms=');
@$core.Deprecated('Use validateInvoiceCryptoWalletRequestDescriptor instead')
const ValidateInvoiceCryptoWalletRequest$json = const {
...
final $typed_data.Uint8List validateInvoiceCryptoWalletRequestDescriptor = $convert.base64Decode('CiJWYWxpZGF0ZUludm9pY2VDcnlwdG9XYWxsZXRSZXF1ZXN0EiUKDndhbGxldF9hZGRyZXNzGAEgASgJUg13YWxsZXRBZGRyZXNzEhoKCGN1cnJlbmN5GAIgASgJUghjdXJyZW5jeRIYCgduZXR3b3JrGAMgASgJUgduZXR3b3Jr');
@$core.Deprecated('Use validateInvoiceCryptoWalletResponseDescriptor instead')
const ValidateInvoiceCryptoWalletResponse$json = const {
...
final $typed_data.Uint8List validateInvoiceCryptoWalletResponseDescriptor = $convert.base64Decode('CiNWYWxpZGF0ZUludm9pY2VDcnlwdG9XYWxsZXRSZXNwb25zZRIZCghpc192YWxpZBgBIAEoCFIHaXNWYWxpZBItChJ2YWxpZGF0aW9uX21lc3NhZ2UYAiABKAlSEXZhbGlkYXRpb25NZXNzYWdlEh8KC2lzX2NvbnRyYWN0GAMgASgIUgppc0NvbnRyYWN0Eh8KC3dhbGxldF90eXBlGAQgASgJUgp3YWxsZXRUeXBl');

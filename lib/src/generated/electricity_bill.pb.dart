...
class BillPayment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$1.Timestamp>(25, _omitFieldNames ? '' : 'failedAt',
        subBuilder: $1.Timestamp.create)
    ..aOS(26, _omitFieldNames ? '' : 'phoneNumber')
    ..aOS(27, _omitFieldNames ? '' : 'refundSource')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(26)
  set phoneNumber($core.String value) => $_setString(25, value);
  @$pb.TagNumber(26)
  $core.bool hasPhoneNumber() => $_has(25);
  @$pb.TagNumber(26)
  void clearPhoneNumber() => $_clearField(26);

  /// Non-empty when the user's money was returned even though status is
  /// still `failed`. Values mirror bill_payments.refund_source (e.g.
  /// `auto_released`, `vtpass_failed`, `reloadly_refunded_upstream`,
  /// `admin_manual`, `pre_charge_release`). Empty = no refund recorded.
  @$pb.TagNumber(27)
  $core.String get refundSource => $_getSZ(26);
  @$pb.TagNumber(27)
  set refundSource($core.String value) => $_setString(26, value);
  @$pb.TagNumber(27)
  $core.bool hasRefundSource() => $_has(26);
  @$pb.TagNumber(27)
  void clearRefundSource() => $_clearField(27);
}
...
class CreateAutoRechargeRequest extends $pb.GeneratedMessage {
  factory CreateAutoRechargeRequest({
    ...
    if (dayOfMonth != null) result.dayOfMonth = dayOfMonth;
    if (maxRetries != null) result.maxRetries = maxRetries;
    if (executionHour != null) result.executionHour = executionHour;
    if (executionMinute != null) result.executionMinute = executionMinute;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        8, _omitFieldNames ? '' : 'executionHour', $pb.PbFieldType.O3)
    ..a<$core.int>(
        9, _omitFieldNames ? '' : 'executionMinute', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(8)
  set executionHour($core.int value) => $_setSignedInt32(7, value);
  @$pb.TagNumber(8)
  $core.bool hasExecutionHour() => $_has(7);
  @$pb.TagNumber(8)
  void clearExecutionHour() => $_clearField(8);

  @$pb.TagNumber(9)
  $core.int get executionMinute => $_getIZ(8);
  @$pb.TagNumber(9)
  set executionMinute($core.int value) => $_setSignedInt32(8, value);
  @$pb.TagNumber(9)
  $core.bool hasExecutionMinute() => $_has(8);
  @$pb.TagNumber(9)
  void clearExecutionMinute() => $_clearField(9);
}
...
class UpdateAutoRechargeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(
        7, _omitFieldNames ? '' : 'executionHour', $pb.PbFieldType.O3)
    ..a<$core.int>(
        8, _omitFieldNames ? '' : 'executionMinute', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(7)
  set executionHour($core.int value) => $_setSignedInt32(6, value);
  @$pb.TagNumber(7)
  $core.bool hasExecutionHour() => $_has(6);
  @$pb.TagNumber(7)
  void clearExecutionHour() => $_clearField(7);

  @$pb.TagNumber(8)
  $core.int get executionMinute => $_getIZ(7);
  @$pb.TagNumber(8)
  set executionMinute($core.int value) => $_setSignedInt32(7, value);
  @$pb.TagNumber(8)
  $core.bool hasExecutionMinute() => $_has(7);
  @$pb.TagNumber(8)
  void clearExecutionMinute() => $_clearField(8);
}

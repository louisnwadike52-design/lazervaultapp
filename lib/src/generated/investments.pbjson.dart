...
final $typed_data.Uint8List portfolioHistoryPointDescriptor = $convert.base64Decode(
    'ChVQb3J0Zm9saW9IaXN0b3J5UG9pbnQSHAoJdGltZXN0YW1wGAEgASgDUgl0aW1lc3RhbXASFA'
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.investments.PortfolioHistoryPoint',
      '10': 'history'
    },
  ],
};
...
final $typed_data.Uint8List getPortfolioHistoryResponseDescriptor =
    $convert.base64Decode(
        'ChtHZXRQb3J0Zm9saW9IaXN0b3J5UmVzcG9uc2USPAoHaGlzdG9yeRgBIAMoCzIiLmludmVzdG'
        '1lbnRzLlBvcnRmb2xpb0hpc3RvcnlQb2ludFIHaGlzdG9yeQ==');
...
final $typed_data.Uint8List ensureBrokerAccountRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List ensureBrokerAccountResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getBrokerOnboardingStatusRequestDescriptor =
    $convert.base64Decode(
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.investments.BrokerAccountLink',
      '10': 'links'
    },
  ],
};
...
final $typed_data.Uint8List getBrokerOnboardingStatusResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getAssetDetailsRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getFeaturedAssetsRequestDescriptor =
    $convert.base64Decode('ChhHZXRGZWF0dXJlZEFzc2V0c1JlcXVlc3Q=');
...
final $typed_data.Uint8List getAssetCategoriesRequestDescriptor =
    $convert.base64Decode('ChlHZXRBc3NldENhdGVnb3JpZXNSZXF1ZXN0');
...
final $typed_data.Uint8List getAssetCategoriesResponseDescriptor =
    $convert.base64Decode(
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.investments.FXTransactionInfo',
      '10': 'transactions'
    },
...
final $typed_data.Uint8List getIncomeHistoryRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getIncomeHistoryResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getTotalIncomeRequestDescriptor =
    $convert.base64Decode('ChVHZXRUb3RhbEluY29tZVJlcXVlc3Q=');
...
final $typed_data.Uint8List getTotalIncomeResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getCommissionRatesRequestDescriptor =
    $convert.base64Decode('ChlHZXRDb21taXNzaW9uUmF0ZXNSZXF1ZXN0');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.investments.CommissionTierInfo',
      '10': 'tiers'
    },
  ],
};
...
final $typed_data.Uint8List getCommissionRatesResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List calculateCommissionRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getTreasuryBillsRequestDescriptor =
    $convert.base64Decode('ChdHZXRUcmVhc3VyeUJpbGxzUmVxdWVzdA==');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.investments.TreasuryBillInfo',
      '10': 'bills'
    },
  ],
};
...
final $typed_data.Uint8List getTreasuryBillsResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getMutualFundsRequestDescriptor =
    $convert.base64Decode('ChVHZXRNdXR1YWxGdW5kc1JlcXVlc3Q=');
...
final $typed_data.Uint8List getMutualFundsResponseDescriptor =
    $convert.base64Decode(

...
class AccountServiceClient extends $grpc.Client {
  ...
  static final _$getAccountDetails = $grpc.ClientMethod<$0.GetAccountDetailsRequest, $0.GetAccountDetailsResponse>(
      '/pb.AccountService/GetAccountDetails',
      ($0.GetAccountDetailsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetAccountDetailsResponse.fromBuffer(value));
  static final _$updateAccountStatus = $grpc.ClientMethod<$0.UpdateAccountStatusRequest, $0.UpdateAccountStatusResponse>(
      '/pb.AccountService/UpdateAccountStatus',
      ($0.UpdateAccountStatusRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UpdateAccountStatusResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetAccountDetailsResponse> getAccountDetails($0.GetAccountDetailsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getAccountDetails, request, options: options);
  }

  $grpc.ResponseFuture<$0.UpdateAccountStatusResponse> updateAccountStatus($0.UpdateAccountStatusRequest request, {$grpc.CallOptions? options}) {
...
abstract class AccountServiceBase extends $grpc.Service {
  ...
  AccountServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetAccountDetailsRequest, $0.GetAccountDetailsResponse>(
        'GetAccountDetails',
        getAccountDetails_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetAccountDetailsRequest.fromBuffer(value),
        ($0.GetAccountDetailsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpdateAccountStatusRequest, $0.UpdateAccountStatusResponse>(
        'UpdateAccountStatus',
        updateAccountStatus_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.UpdateAccountStatusRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetAccountDetailsResponse> getAccountDetails_Pre($grpc.ServiceCall call, $async.Future<$0.GetAccountDetailsRequest> request) async {
    return getAccountDetails(call, await request);
  }

  $async.Future<$0.UpdateAccountStatusResponse> updateAccountStatus_Pre($grpc.ServiceCall call, $async.Future<$0.UpdateAccountStatusRequest> request) async {
  ...
  $async.Future<$0.GetAccountDetailsResponse> getAccountDetails($grpc.ServiceCall call, $0.GetAccountDetailsRequest request);
  $async.Future<$0.UpdateAccountStatusResponse> updateAccountStatus($grpc.ServiceCall call, $0.UpdateAccountStatusRequest request);

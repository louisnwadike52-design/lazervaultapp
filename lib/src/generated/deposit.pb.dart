...
class InitiateDepositRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(7, _omitFieldNames ? '' : 'payment_method')
  ...
  /// payment_method restricts the Flutterwave hosted checkout to a single rail.
  /// Empty = let Flutterwave decide. Known values: "apple_pay", "google_pay",

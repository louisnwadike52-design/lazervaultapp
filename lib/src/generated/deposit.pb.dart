...
class InitiateDepositRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InitiateDepositRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, _omitFieldNames ? '' : 'target_account_id', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
...
class InitiateDepositResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  set status(DepositStatus v) { $_setField(2, v); }
  @$pb.TagNumber(2)
...
class GetDepositDetailsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetDepositDetailsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'deposit_id')
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'target_account_id', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..aOM<$15.Timestamp>(7, _omitFieldNames ? '' : 'created_at', subBuilder: $15.Timestamp.create)
    ..aOM<$15.Timestamp>(8, _omitFieldNames ? '' : 'processing_at', subBuilder: $15.Timestamp.create)
    ..aOM<$15.Timestamp>(9, _omitFieldNames ? '' : 'completed_at', subBuilder: $15.Timestamp.create)
    ..aOM<$15.Timestamp>(10, _omitFieldNames ? '' : 'failed_at', subBuilder: $15.Timestamp.create)
    ..aOS(11, _omitFieldNames ? '' : 'failure_reason')
    ..aOS(12, _omitFieldNames ? '' : 'external_transaction_id')
    ..aOM<$2.AccountDetails>(13, _omitFieldNames ? '' : 'updated_account', subBuilder: $2.AccountDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set status(DepositStatus v) { $_setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  $15.Timestamp get processingAt => $_getN(7);
  @$pb.TagNumber(8)
  set processingAt($15.Timestamp v) { $_setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasProcessingAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearProcessingAt() => $_clearField(8);
  @$pb.TagNumber(8)
  $15.Timestamp ensureProcessingAt() => $_ensure(7);

  @$pb.TagNumber(9)
  $15.Timestamp get completedAt => $_getN(8);
  @$pb.TagNumber(9)
  set completedAt($15.Timestamp v) { $_setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasCompletedAt() => $_has(8);
  @$pb.TagNumber(9)
  void clearCompletedAt() => $_clearField(9);
  @$pb.TagNumber(9)
  $15.Timestamp ensureCompletedAt() => $_ensure(8);

  @$pb.TagNumber(10)
  $15.Timestamp get failedAt => $_getN(9);
  @$pb.TagNumber(10)
  set failedAt($15.Timestamp v) { $_setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasFailedAt() => $_has(9);
  @$pb.TagNumber(10)
  void clearFailedAt() => $_clearField(10);
  @$pb.TagNumber(10)
  $15.Timestamp ensureFailedAt() => $_ensure(9);
  ...
  @$pb.TagNumber(13)
  set updatedAccount($2.AccountDetails v) { $_setField(13, v); }
  @$pb.TagNumber(13)

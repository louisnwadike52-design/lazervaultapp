...
class GetDepositDetailsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetDepositDetailsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<$28.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'created_at', subBuilder: $28.Timestamp.create)
    ..aOM<$28.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'processing_at', subBuilder: $28.Timestamp.create)
    ..aOM<$28.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completed_at', subBuilder: $28.Timestamp.create)
    ..aOM<$28.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failed_at', subBuilder: $28.Timestamp.create)
    ...
    ..aOM<$2.AccountDetails>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updated_account', subBuilder: $2.AccountDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  $28.Timestamp get processingAt => $_getN(7);
  @$pb.TagNumber(8)
  set processingAt($28.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasProcessingAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearProcessingAt() => clearField(8);
  @$pb.TagNumber(8)
  $28.Timestamp ensureProcessingAt() => $_ensure(7);

  @$pb.TagNumber(9)
  $28.Timestamp get completedAt => $_getN(8);
  @$pb.TagNumber(9)
  set completedAt($28.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasCompletedAt() => $_has(8);
  @$pb.TagNumber(9)
  void clearCompletedAt() => clearField(9);
  @$pb.TagNumber(9)
  $28.Timestamp ensureCompletedAt() => $_ensure(8);

  @$pb.TagNumber(10)
  $28.Timestamp get failedAt => $_getN(9);
  @$pb.TagNumber(10)
  set failedAt($28.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasFailedAt() => $_has(9);
  @$pb.TagNumber(10)
  void clearFailedAt() => clearField(10);
  @$pb.TagNumber(10)
  $28.Timestamp ensureFailedAt() => $_ensure(9);
  ...
  @$pb.TagNumber(13)
  set updatedAccount($2.AccountDetails v) { setField(13, v); }
  @$pb.TagNumber(13)

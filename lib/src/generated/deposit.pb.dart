...
class GetDepositDetailsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetDepositDetailsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<$26.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'created_at', subBuilder: $26.Timestamp.create)
    ..aOM<$26.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'processing_at', subBuilder: $26.Timestamp.create)
    ..aOM<$26.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completed_at', subBuilder: $26.Timestamp.create)
    ..aOM<$26.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failed_at', subBuilder: $26.Timestamp.create)
  ...
  @$pb.TagNumber(8)
  $26.Timestamp get processingAt => $_getN(7);
  @$pb.TagNumber(8)
  set processingAt($26.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasProcessingAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearProcessingAt() => clearField(8);
  @$pb.TagNumber(8)
  $26.Timestamp ensureProcessingAt() => $_ensure(7);

  @$pb.TagNumber(9)
  $26.Timestamp get completedAt => $_getN(8);
  @$pb.TagNumber(9)
  set completedAt($26.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasCompletedAt() => $_has(8);
  @$pb.TagNumber(9)
  void clearCompletedAt() => clearField(9);
  @$pb.TagNumber(9)
  $26.Timestamp ensureCompletedAt() => $_ensure(8);

  @$pb.TagNumber(10)
  $26.Timestamp get failedAt => $_getN(9);
  @$pb.TagNumber(10)
  set failedAt($26.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasFailedAt() => $_has(9);
  @$pb.TagNumber(10)
  void clearFailedAt() => clearField(10);
  @$pb.TagNumber(10)
  $26.Timestamp ensureFailedAt() => $_ensure(9);

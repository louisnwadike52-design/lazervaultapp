...
class AutoSaveServiceClient extends $grpc.Client {
  ...
  static final _$triggerAutoSave =
      $grpc.ClientMethod<$0.TriggerAutoSaveRequest, $0.TriggerAutoSaveResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.TriggerAutoSaveResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetAutoSaveTransactionsResponse>
      getAutoSaveTransactions($0.GetAutoSaveTransactionsRequest request,
          {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.TriggerAutoSaveResponse> triggerAutoSave(
      $0.TriggerAutoSaveRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class AutoSaveServiceBase extends $grpc.Service {
  ...
  AutoSaveServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.CreateAutoSaveRuleRequest,
            $0.CreateAutoSaveRuleResponse>(
        'CreateAutoSaveRule',
        createAutoSaveRule_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.CreateAutoSaveRuleRequest.fromBuffer(value),
        ($0.CreateAutoSaveRuleResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetAutoSaveRulesRequest,
            $0.GetAutoSaveRulesResponse>(
        'GetAutoSaveRules',
        getAutoSaveRules_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetAutoSaveRulesRequest.fromBuffer(value),
        ($0.GetAutoSaveRulesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpdateAutoSaveRuleRequest,
            $0.UpdateAutoSaveRuleResponse>(
        'UpdateAutoSaveRule',
        updateAutoSaveRule_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.UpdateAutoSaveRuleRequest.fromBuffer(value),
        ($0.UpdateAutoSaveRuleResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.ToggleAutoSaveRuleRequest,
            $0.ToggleAutoSaveRuleResponse>(
        'ToggleAutoSaveRule',
        toggleAutoSaveRule_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ToggleAutoSaveRuleRequest.fromBuffer(value),
        ($0.ToggleAutoSaveRuleResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.DeleteAutoSaveRuleRequest,
            $0.DeleteAutoSaveRuleResponse>(
        'DeleteAutoSaveRule',
        deleteAutoSaveRule_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.DeleteAutoSaveRuleRequest.fromBuffer(value),
        ($0.DeleteAutoSaveRuleResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetAutoSaveTransactionsRequest,
            $0.GetAutoSaveTransactionsResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.GetAutoSaveTransactionsRequest.fromBuffer(value),
        ($0.GetAutoSaveTransactionsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetAutoSaveStatisticsRequest,
            $0.GetAutoSaveStatisticsResponse>(
        'GetAutoSaveStatistics',
        getAutoSaveStatistics_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetAutoSaveStatisticsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.TriggerAutoSaveRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.TriggerAutoSaveRequest.fromBuffer(value),
        ($0.TriggerAutoSaveResponse value) => value.writeToBuffer()));
  }

  $async.Future<$0.CreateAutoSaveRuleResponse> createAutoSaveRule_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.CreateAutoSaveRuleRequest> request) async {
    return createAutoSaveRule(call, await request);
  }

  $async.Future<$0.GetAutoSaveRulesResponse> getAutoSaveRules_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetAutoSaveRulesRequest> request) async {
    return getAutoSaveRules(call, await request);
  }

  $async.Future<$0.UpdateAutoSaveRuleResponse> updateAutoSaveRule_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.UpdateAutoSaveRuleRequest> request) async {
    return updateAutoSaveRule(call, await request);
  }

  $async.Future<$0.ToggleAutoSaveRuleResponse> toggleAutoSaveRule_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ToggleAutoSaveRuleRequest> request) async {
    return toggleAutoSaveRule(call, await request);
  }

  $async.Future<$0.DeleteAutoSaveRuleResponse> deleteAutoSaveRule_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.DeleteAutoSaveRuleRequest> request) async {
    return deleteAutoSaveRule(call, await request);
  }

  $async.Future<$0.GetAutoSaveTransactionsResponse> getAutoSaveTransactions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetAutoSaveTransactionsRequest> request) async {
    return getAutoSaveTransactions(call, await request);
  }

  $async.Future<$0.GetAutoSaveStatisticsResponse> getAutoSaveStatistics_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetAutoSaveStatisticsRequest> request) async {
    return getAutoSaveStatistics(call, await request);
  }

  $async.Future<$0.TriggerAutoSaveResponse> triggerAutoSave_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.TriggerAutoSaveRequest> request) async {
    return triggerAutoSave(call, await request);
  }

  $async.Future<$0.CreateAutoSaveRuleResponse> createAutoSaveRule(
      $grpc.ServiceCall call, $0.CreateAutoSaveRuleRequest request);
  $async.Future<$0.GetAutoSaveRulesResponse> getAutoSaveRules(
      $grpc.ServiceCall call, $0.GetAutoSaveRulesRequest request);
  $async.Future<$0.UpdateAutoSaveRuleResponse> updateAutoSaveRule(
      $grpc.ServiceCall call, $0.UpdateAutoSaveRuleRequest request);
  $async.Future<$0.ToggleAutoSaveRuleResponse> toggleAutoSaveRule(
      $grpc.ServiceCall call, $0.ToggleAutoSaveRuleRequest request);
  $async.Future<$0.DeleteAutoSaveRuleResponse> deleteAutoSaveRule(
      $grpc.ServiceCall call, $0.DeleteAutoSaveRuleRequest request);
  $async.Future<$0.GetAutoSaveTransactionsResponse> getAutoSaveTransactions(
      $grpc.ServiceCall call, $0.GetAutoSaveTransactionsRequest request);
  $async.Future<$0.GetAutoSaveStatisticsResponse> getAutoSaveStatistics(
      $grpc.ServiceCall call, $0.GetAutoSaveStatisticsRequest request);
  $async.Future<$0.TriggerAutoSaveResponse> triggerAutoSave(
      $grpc.ServiceCall call, $0.TriggerAutoSaveRequest request);
}

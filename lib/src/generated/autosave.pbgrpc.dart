...
class AutoSaveServiceClient extends $grpc.Client {
  ...
  static final _$getAutoSaveFeeQuote = $grpc.ClientMethod<
          $0.GetAutoSaveFeeQuoteRequest, $0.GetAutoSaveFeeQuoteResponse>(
...
abstract class AutoSaveServiceBase extends $grpc.Service {
  ...
  AutoSaveServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetAutoSaveFeeQuoteRequest,
            $0.GetAutoSaveFeeQuoteResponse>(
        'GetAutoSaveFeeQuote',
        getAutoSaveFeeQuote_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
  ...
  $async.Future<$0.GetAutoSaveFeeQuoteResponse> getAutoSaveFeeQuote_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetAutoSaveFeeQuoteRequest> $request) async {
    return getAutoSaveFeeQuote($call, await $request);
  }

...
const TriggerType$json = {
  ...
  '2': [
    ...
    {'1': 'TRIGGER_EXTERNAL_INFLOW', '2': 4},
    {'1': 'TRIGGER_SCHEDULED_EXTERNAL', '2': 5},
  ],
};
...
final $typed_data.Uint8List triggerTypeDescriptor = $convert.base64Decode(
    ...
    'QQARIVChFUUklHR0VSX1NDSEVEVUxFRBACEhQKEFRSSUdHRVJfUk9VTkRfVVAQAxIbChdUUklH'
    'R0VSX0VYVEVSTkFMX0lORkxPVxAEEh4KGlRSSUdHRVJfU0NIRURVTEVEX0VYVEVSTkFMEAU=');
...
const AutoSaveRule$json = {
  ...
  '2': [
    ...
    {'1': 'source_bank_name', '3': 24, '4': 1, '5': 9, '10': 'sourceBankName'},
    {
      '1': 'pending_inflow_kobo',
      '3': 25,
      '4': 1,
      '5': 3,
      '10': 'pendingInflowKobo'
    },
    {
      '1': 'pending_inflow_ext_txn_id',
      '3': 26,
      '4': 1,
      '5': 9,
      '10': 'pendingInflowExtTxnId'
    },
    {
      '1': 'pending_inflow_at',
      '3': 27,
...
final $typed_data.Uint8List autoSaveRuleDescriptor = $convert.base64Decode(
    ...
    'dW50Eh8KC3RvdGFsX3NhdmVkGBYgASgBUgp0b3RhbFNhdmVkEjcKGHNvdXJjZV9saW5rZWRfYW'
    'Njb3VudF9pZBgXIAEoCVIVc291cmNlTGlua2VkQWNjb3VudElkEigKEHNvdXJjZV9iYW5rX25h'
    'bWUYGCABKAlSDnNvdXJjZUJhbmtOYW1lEi4KE3BlbmRpbmdfaW5mbG93X2tvYm8YGSABKANSEX'
    'BlbmRpbmdJbmZsb3dLb2JvEjgKGXBlbmRpbmdfaW5mbG93X2V4dF90eG5faWQYGiABKAlSFXBl'
    'bmRpbmdJbmZsb3dFeHRUeG5JZBIqChFwZW5kaW5nX2luZmxvd19hdBgbIAEoCVIPcGVuZGluZ0'
    'luZmxvd0F0');
...
final $typed_data.Uint8List getAutoSaveRulesRequestDescriptor = $convert.base64Decode(
    ...
    'QSKgoGc3RhdHVzGAIgASgOMhIucGIuQXV0b1NhdmVTdGF0dXNSBnN0YXR1cxIWCgZzZWFyY2gY'
    'AyABKAlSBnNlYXJjaBIXCgdzb3J0X2J5GAQgASgJUgZzb3J0QnkSGQoIc29ydF9kaXIYBSABKA'
    'lSB3NvcnREaXISFAoFbGltaXQYBiABKAVSBWxpbWl0EhYKBm9mZnNldBgHIAEoBVIGb2Zmc2V0'
    'EiEKDHRyaWdnZXJfdHlwZRgIIAEoCVILdHJpZ2dlclR5cGU=');
...
final $typed_data.Uint8List getAutoSaveRulesResponseDescriptor = $convert.base64Decode(
    ...
    'Ntc2cYAiABKAlSA21zZxImCgVydWxlcxgDIAMoCzIQLnBiLkF1dG9TYXZlUnVsZVIFcnVsZXMS'
    'FAoFdG90YWwYBCABKAVSBXRvdGFsEhkKCGhhc19tb3JlGAUgASgIUgdoYXNNb3Jl');
...
const AutoSaveTransaction$json = {
  ...
  '2': [
    ...
    {'1': 'gross_amount', '3': 14, '4': 1, '5': 1, '10': 'grossAmount'},
    {'1': 'deposit_status', '3': 15, '4': 1, '5': 9, '10': 'depositStatus'},
    {'1': 'fee_settled_at', '3': 16, '4': 1, '5': 9, '10': 'feeSettledAt'},
  ],
};
...
final $typed_data.Uint8List autoSaveTransactionDescriptor = $convert.base64Decode(
    ...
    '9nbGUucHJvdG9idWYuVGltZXN0YW1wUgljcmVhdGVkQXQSGgoIbWV0YWRhdGEYDCABKAlSCG1l'
    'dGFkYXRhEhAKA2ZlZRgNIAEoAVIDZmVlEiEKDGdyb3NzX2Ftb3VudBgOIAEoAVILZ3Jvc3NBbW'
    '91bnQSJQoOZGVwb3NpdF9zdGF0dXMYDyABKAlSDWRlcG9zaXRTdGF0dXMSJAoOZmVlX3NldHRs'
    'ZWRfYXQYECABKAlSDGZlZVNldHRsZWRBdA==');

@$core.Deprecated('Use getAutoSaveFeeQuoteRequestDescriptor instead')
const GetAutoSaveFeeQuoteRequest$json = {
  '1': 'GetAutoSaveFeeQuoteRequest',
  '2': [
    {'1': 'amount_kobo', '3': 1, '4': 1, '5': 3, '10': 'amountKobo'},
    {'1': 'trigger_type', '3': 2, '4': 1, '5': 9, '10': 'triggerType'},
  ],
};

/// Descriptor for `GetAutoSaveFeeQuoteRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAutoSaveFeeQuoteRequestDescriptor =
    $convert.base64Decode(
        'ChpHZXRBdXRvU2F2ZUZlZVF1b3RlUmVxdWVzdBIfCgthbW91bnRfa29ibxgBIAEoA1IKYW1vdW'
        '50S29ibxIhCgx0cmlnZ2VyX3R5cGUYAiABKAlSC3RyaWdnZXJUeXBl');

@$core.Deprecated('Use getAutoSaveFeeQuoteResponseDescriptor instead')
const GetAutoSaveFeeQuoteResponse$json = {
  '1': 'GetAutoSaveFeeQuoteResponse',
  '2': [
    {'1': 'fee_enabled', '3': 1, '4': 1, '5': 8, '10': 'feeEnabled'},
    {'1': 'fee_kobo', '3': 2, '4': 1, '5': 3, '10': 'feeKobo'},
    {'1': 'net_kobo', '3': 3, '4': 1, '5': 3, '10': 'netKobo'},
    {'1': 'fee_type', '3': 4, '4': 1, '5': 9, '10': 'feeType'},
    {'1': 'percent_bps', '3': 5, '4': 1, '5': 3, '10': 'percentBps'},
    {'1': 'cap_kobo', '3': 6, '4': 1, '5': 3, '10': 'capKobo'},
    {'1': 'fixed_kobo', '3': 7, '4': 1, '5': 3, '10': 'fixedKobo'},
  ],
};

/// Descriptor for `GetAutoSaveFeeQuoteResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getAutoSaveFeeQuoteResponseDescriptor = $convert.base64Decode(
    'ChtHZXRBdXRvU2F2ZUZlZVF1b3RlUmVzcG9uc2USHwoLZmVlX2VuYWJsZWQYASABKAhSCmZlZU'
    'VuYWJsZWQSGQoIZmVlX2tvYm8YAiABKANSB2ZlZUtvYm8SGQoIbmV0X2tvYm8YAyABKANSB25l'
...
final $typed_data.Uint8List autoSaveStatisticsDescriptor = $convert.base64Decode(
    ...
    'RBY3RpdmVSdWxlEkYKF3RvcF9ydWxlX2J5X3RvdGFsX3NhdmVkGAkgASgLMhAucGIuQXV0b1Nh'
    'dmVSdWxlUhN0b3BSdWxlQnlUb3RhbFNhdmVkEiwKEnBhdXNlZF9ydWxlc19jb3VudBgKIAEoBV'
    'IQcGF1c2VkUnVsZXNDb3VudBIyChVjb21wbGV0ZWRfcnVsZXNfY291bnQYCyABKAVSE2NvbXBs'
    'ZXRlZFJ1bGVzQ291bnQSMgoVY2FuY2VsbGVkX3J1bGVzX2NvdW50GAwgASgFUhNjYW5jZWxsZW'
    'RSdWxlc0NvdW50');

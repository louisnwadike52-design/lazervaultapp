...
const TriggerType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'TRIGGER_SCHEDULED_EXTERNAL', '2': 5},
  ],
};

/// Descriptor for `TriggerType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List triggerTypeDescriptor = $convert.base64Decode('CgtUcmlnZ2VyVHlwZRITCg9UUklHR0VSX1VOS05PV04QABIWChJUUklHR0VSX09OX0RFUE9TSVQQARIVChFUUklHR0VSX1NDSEVEVUxFRBACEhQKEFRSSUdHRVJfUk9VTkRfVVAQAxIbChdUUklHR0VSX0VYVEVSTkFMX0lORkxPVxAEEh4KGlRSSUdHRVJfU0NIRURVTEVEX0VYVEVSTkFMEAU=');
...
final $typed_data.Uint8List autoSaveRuleDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getAutoSaveRulesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getAutoSaveRulesResponseDescriptor = $convert.base64Decode('ChhHZXRBdXRvU2F2ZVJ1bGVzUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIQCgNtc2cYAiABKAlSA21zZxImCgVydWxlcxgDIAMoCzIQLnBiLkF1dG9TYXZlUnVsZVIFcnVsZXMSFAoFdG90YWwYBCABKAVSBXRvdGFsEhkKCGhhc19tb3JlGAUgASgIUgdoYXNNb3Jl');
...
const AutoSaveStatistics$json = const {
  ...
  '2': const [
    ...
    const {'1': 'top_rule_by_total_saved', '3': 9, '4': 1, '5': 11, '6': '.pb.AutoSaveRule', '10': 'topRuleByTotalSaved'},
...
final $typed_data.Uint8List autoSaveStatisticsDescriptor = $convert.base64Decode('');
...
const TriggerAutoSaveRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'transaction_pin_token', '3': 15, '4': 1, '5': 9, '10': 'transactionPinToken'},
  ],
  '7': const {},
};

/// Descriptor for `TriggerAutoSaveRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List triggerAutoSaveRequestDescriptor = $convert.base64Decode('ChZUcmlnZ2VyQXV0b1NhdmVSZXF1ZXN0EhcKB3J1bGVfaWQYASABKAlSBnJ1bGVJZBIjCg1jdXN0b21fYW1vdW50GAIgASgBUgxjdXN0b21BbW91bnQSMgoVdHJhbnNhY3Rpb25fcGluX3Rva2VuGA8gASgJUhN0cmFuc2FjdGlvblBpblRva2VuOg+SQQwKCtIBB3J1bGVfaWQ=');

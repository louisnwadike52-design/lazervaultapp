...
class Account extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(29)
  $core.bool get allowInternationalTransfers => $_getBF(28);
  @$pb.TagNumber(29)
  set allowInternationalTransfers($core.bool value) => $_setBool(28, value);
  @$pb.TagNumber(29)
...
class AccountSummary extends $pb.GeneratedMessage {
  factory AccountSummary({
    ...
    if (reservedBalance != null) result.reservedBalance = reservedBalance;
    if (accountName != null) result.accountName = accountName;
    if (trendPercentage != null) result.trendPercentage = trendPercentage;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        12, _omitFieldNames ? '' : 'trendPercentage', $pb.PbFieldType.OD)
  ...
  /// Balance % change over the requested period (see GetUserAccountsRequest.period).
  /// Signed: positive = increase, negative = decrease. The baseline is the balance
  /// at the window start, reconstructed from transaction history (last completed
  /// txn at/before the cutoff, else the earliest txn's balance_before). Returns
  /// 100.0 for new-money growth that started the window at a 0 balance, and 0.0
  /// only when the account had no activity in/before the window (flat).
  @$pb.TagNumber(12)
  $core.double get trendPercentage => $_getN(11);
  @$pb.TagNumber(12)
  set trendPercentage($core.double value) => $_setDouble(11, value);
  @$pb.TagNumber(12)
  $core.bool hasTrendPercentage() => $_has(11);
  @$pb.TagNumber(12)
  void clearTrendPercentage() => $_clearField(12);

  /// Echoes the period the trend_percentage was computed for ("day"/"week"/"month"/"year").
  @$pb.TagNumber(13)
  $core.String get trendPeriod => $_getSZ(12);
  @$pb.TagNumber(13)
  set trendPeriod($core.String value) => $_setString(12, value);
  @$pb.TagNumber(13)
  $core.bool hasTrendPeriod() => $_has(12);
  @$pb.TagNumber(13)
  void clearTrendPeriod() => $_clearField(13);

  /// Deposit bank identity for a REAL provisioned virtual account (NUBAN) — the
  /// EXACT values the provider returned. Surfaced (same gate as account_number:
  /// is_virtual && provider_ref) so the dashboard carousel + "Pay by transfer"
  /// card show the bank the payer must transfer to. Empty until a real NUBAN is
  /// minted. Mirrors Account.bank_name / bank_code.
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  $core.String get bankCode => $_getSZ(14);
  @$pb.TagNumber(15)
  set bankCode($core.String value) => $_setString(14, value);
  @$pb.TagNumber(15)
...
class GetUserAccountsRequest extends $pb.GeneratedMessage {
  factory GetUserAccountsRequest({
    ...
    if (includeAllCurrencies != null)
      result.includeAllCurrencies = includeAllCurrencies;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(2, _omitFieldNames ? '' : 'includeAllCurrencies')
  ...
  /// When false (default), the handler returns only accounts whose currency
  /// matches the caller's x-locale header — the dashboard-carousel default:
  /// an en-NG user sees their NGN cards, not their dormant USD/GBP wallets.
  /// Set true on flows that NEED every wallet the user holds across all
  /// currencies: currency-exchange source picker, balance validators,
  /// cross-locale dialogs. Without this opt-in those flows silently lost
  /// the user's foreign-currency balance and (for example) refused a
  /// perfectly funded USD → NGN international transfer because the
  /// response never included the USD wallet.
  @$pb.TagNumber(2)
  $core.bool get includeAllCurrencies => $_getBF(1);
  @$pb.TagNumber(2)
  set includeAllCurrencies($core.bool value) => $_setBool(1, value);
  @$pb.TagNumber(2)
  $core.bool hasIncludeAllCurrencies() => $_has(1);
  @$pb.TagNumber(2)
  void clearIncludeAllCurrencies() => $_clearField(2);

  /// Rolling window for the per-account balance trend percentage returned in
  /// AccountSummary.trend_percentage. One of "day" (24h), "week" (7d),
  /// "month" (30d, default), "year" (365d). Unset/empty defaults to "month".
  @$pb.TagNumber(3)
...
/// ===== Get Account By Provider Reference =====
class GetAccountByProviderRefRequest extends $pb.GeneratedMessage {
  ...
  GetAccountByProviderRefRequest._();

  factory GetAccountByProviderRefRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetAccountByProviderRefRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetAccountByProviderRefRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'provider')
    ..aOS(2, _omitFieldNames ? '' : 'providerRef')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetAccountByProviderRefRequest clone() =>
      GetAccountByProviderRefRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetAccountByProviderRefRequest copyWith(
          void Function(GetAccountByProviderRefRequest) updates) =>
      super.copyWith(
              (message) => updates(message as GetAccountByProviderRefRequest))
          as GetAccountByProviderRefRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetAccountByProviderRefRequest create() =>
      GetAccountByProviderRefRequest._();
  @$core.override
  GetAccountByProviderRefRequest createEmptyInstance() => create();
  static $pb.PbList<GetAccountByProviderRefRequest> createRepeated() =>
      $pb.PbList<GetAccountByProviderRefRequest>();
  @$core.pragma('dart2js:noInline')
  static GetAccountByProviderRefRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAccountByProviderRefRequest>(create);
  ...
  @$pb.TagNumber(2)
  set providerRef($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasProviderRef() => $_has(1);
  @$pb.TagNumber(2)
  void clearProviderRef() => $_clearField(2);
}
...
class GetAccountByProviderRefResponse extends $pb.GeneratedMessage {
  ...
  GetAccountByProviderRefResponse._();

  factory GetAccountByProviderRefResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetAccountByProviderRefResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetAccountByProviderRefResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOM<Account>(1, _omitFieldNames ? '' : 'account',
        subBuilder: Account.create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetAccountByProviderRefResponse clone() =>
      GetAccountByProviderRefResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetAccountByProviderRefResponse copyWith(
          void Function(GetAccountByProviderRefResponse) updates) =>
      super.copyWith(
              (message) => updates(message as GetAccountByProviderRefResponse))
          as GetAccountByProviderRefResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetAccountByProviderRefResponse create() =>
      GetAccountByProviderRefResponse._();
  @$core.override
  GetAccountByProviderRefResponse createEmptyInstance() => create();
  static $pb.PbList<GetAccountByProviderRefResponse> createRepeated() =>
      $pb.PbList<GetAccountByProviderRefResponse>();
  @$core.pragma('dart2js:noInline')
  static GetAccountByProviderRefResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetAccountByProviderRefResponse>(
          create);
...
class GetTotalLedgerBalanceRequest extends $pb.GeneratedMessage {
  ...
  GetTotalLedgerBalanceRequest._();

  factory GetTotalLedgerBalanceRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetTotalLedgerBalanceRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetTotalLedgerBalanceRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTotalLedgerBalanceRequest clone() =>
      GetTotalLedgerBalanceRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTotalLedgerBalanceRequest copyWith(
          void Function(GetTotalLedgerBalanceRequest) updates) =>
      super.copyWith(
              (message) => updates(message as GetTotalLedgerBalanceRequest))
          as GetTotalLedgerBalanceRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetTotalLedgerBalanceRequest create() =>
      GetTotalLedgerBalanceRequest._();
  @$core.override
  GetTotalLedgerBalanceRequest createEmptyInstance() => create();
  static $pb.PbList<GetTotalLedgerBalanceRequest> createRepeated() =>
      $pb.PbList<GetTotalLedgerBalanceRequest>();
  @$core.pragma('dart2js:noInline')
  static GetTotalLedgerBalanceRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetTotalLedgerBalanceRequest>(create);
...
class GetTotalLedgerBalanceResponse extends $pb.GeneratedMessage {
  factory GetTotalLedgerBalanceResponse({
    ...
    final result = create();
    if (totalBalanceMinor != null) result.totalBalanceMinor = totalBalanceMinor;
    if (accountCount != null) result.accountCount = accountCount;
    return result;
  }

  GetTotalLedgerBalanceResponse._();

  factory GetTotalLedgerBalanceResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetTotalLedgerBalanceResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetTotalLedgerBalanceResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'totalBalanceMinor')
    ..aInt64(2, _omitFieldNames ? '' : 'accountCount')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTotalLedgerBalanceResponse clone() =>
      GetTotalLedgerBalanceResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTotalLedgerBalanceResponse copyWith(
          void Function(GetTotalLedgerBalanceResponse) updates) =>
      super.copyWith(
              (message) => updates(message as GetTotalLedgerBalanceResponse))
          as GetTotalLedgerBalanceResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetTotalLedgerBalanceResponse create() =>
      GetTotalLedgerBalanceResponse._();
  @$core.override
  GetTotalLedgerBalanceResponse createEmptyInstance() => create();
  static $pb.PbList<GetTotalLedgerBalanceResponse> createRepeated() =>
      $pb.PbList<GetTotalLedgerBalanceResponse>();
  @$core.pragma('dart2js:noInline')
  static GetTotalLedgerBalanceResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetTotalLedgerBalanceResponse>(create);
  static GetTotalLedgerBalanceResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get totalBalanceMinor => $_getI64(0);
  @$pb.TagNumber(1)
  set totalBalanceMinor($fixnum.Int64 value) => $_setInt64(0, value);
  @$pb.TagNumber(1)
  $core.bool hasTotalBalanceMinor() => $_has(0);
  @$pb.TagNumber(1)
  void clearTotalBalanceMinor() => $_clearField(1);

  @$pb.TagNumber(2)
  $fixnum.Int64 get accountCount => $_getI64(1);
  @$pb.TagNumber(2)
  set accountCount($fixnum.Int64 value) => $_setInt64(1, value);
  @$pb.TagNumber(2)
  $core.bool hasAccountCount() => $_has(1);
  @$pb.TagNumber(2)
  void clearAccountCount() => $_clearField(2);
}
...
class UpdateBalanceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(7, _omitFieldNames ? '' : 'reactive')
    ..hasRequiredFields = false;
  ...
  /// When true (and operation == "subtract"), this debit is a
  /// system-initiated reactive operation — e.g. provider clawback,
  /// refund pipeline — and is allowed to drive available_balance
  /// below zero down to the per-account overdraft floor (bounded by
  /// global system_settings cap). User-initiated debits (transfer,
  /// bill, buy) MUST leave reactive=false. Ignored for "add".
  @$pb.TagNumber(7)
  $core.bool get reactive => $_getBF(6);
  @$pb.TagNumber(7)
  set reactive($core.bool value) => $_setBool(6, value);
  @$pb.TagNumber(7)
  $core.bool hasReactive() => $_has(6);
  @$pb.TagNumber(7)
  void clearReactive() => $_clearField(7);
}
...
class LockFunds extends $pb.GeneratedMessage {
  ...
  /// UUID of the PiggyVaultConfig this lock was created from. The
  /// stable plan identity — `lock_type` above is a denormalized
  /// display/category label derived from this config. Empty for
  /// legacy rows created before ID-based plan identity.
  @$pb.TagNumber(14)
  $core.String get configId => $_getSZ(13);
  @$pb.TagNumber(14)
  set configId($core.String value) => $_setString(13, value);
  @$pb.TagNumber(14)
...
class CreateLockFundsRequest extends $pb.GeneratedMessage {
  factory CreateLockFundsRequest({
    ...
    if (interestDestinationAccountId != null)
      result.interestDestinationAccountId = interestDestinationAccountId;
    if (currency != null) result.currency = currency;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(10, _omitFieldNames ? '' : 'interestDestinationAccountId')
    ..aOS(11, _omitFieldNames ? '' : 'currency')
    ..aOS(12, _omitFieldNames ? '' : 'idempotencyKey')
    ..aOS(13, _omitFieldNames ? '' : 'configId')
    ..hasRequiredFields = false;
  ...
  /// Wallet that receives upfront interest. If empty or
  /// supports_upfront_interest is false on the resolved
  /// PiggyVaultConfig, no upfront payout occurs.
  @$pb.TagNumber(10)
  $core.String get interestDestinationAccountId => $_getSZ(9);
  @$pb.TagNumber(10)
  set interestDestinationAccountId($core.String value) => $_setString(9, value);
  @$pb.TagNumber(10)
  $core.bool hasInterestDestinationAccountId() => $_has(9);
  @$pb.TagNumber(10)
  void clearInterestDestinationAccountId() => $_clearField(10);

  /// Currency the gateway resolved for this lock — used to look up
  /// the correct PiggyVaultConfig row when computing upfront
  /// interest. Empty falls back to the source account's currency.
  @$pb.TagNumber(11)
  ...
  /// Dedup key. A retried POST with the same key returns the
  /// existing lock instead of creating a duplicate. Required for
  /// production retries from the gateway / flutter on network
  /// flake. Empty is allowed but loses retry safety.
  @$pb.TagNumber(12)
  ...
  /// UUID of the PiggyVaultConfig (piggyvault_configs.id) the caller
  /// selected. This is the plan's stable identity: the service
  /// resolves the plan by this PK, ignoring `lock_type`. When empty
  /// (legacy callers), the service falls back to resolving by
  /// (lock_type, currency). When set but no active plan matches, the
  /// create fails loudly instead of silently defaulting.
  @$pb.TagNumber(13)
  $core.String get configId => $_getSZ(12);
  @$pb.TagNumber(13)
  set configId($core.String value) => $_setString(12, value);
  @$pb.TagNumber(13)
  $core.bool hasConfigId() => $_has(12);
  @$pb.TagNumber(13)
  void clearConfigId() => $_clearField(13);
}
...
class CreateLockFundsResponse extends $pb.GeneratedMessage {
  factory CreateLockFundsResponse({
    ...
    if (upfrontInterestPaid != null)
      result.upfrontInterestPaid = upfrontInterestPaid;
    if (upfrontInterestDestination != null)
      result.upfrontInterestDestination = upfrontInterestDestination;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'upfrontInterestPaid', $pb.PbFieldType.OD)
    ..aOS(6, _omitFieldNames ? '' : 'upfrontInterestDestination')
    ..hasRequiredFields = false;
  ...
  /// Populated when an upfront interest payout occurred. Zero
  /// when the plan doesn't support upfront interest.
  @$pb.TagNumber(5)
  $core.double get upfrontInterestPaid => $_getN(4);
  @$pb.TagNumber(5)
  set upfrontInterestPaid($core.double value) => $_setDouble(4, value);
  @$pb.TagNumber(5)
  $core.bool hasUpfrontInterestPaid() => $_has(4);
  @$pb.TagNumber(5)
  void clearUpfrontInterestPaid() => $_clearField(5);

  @$pb.TagNumber(6)
  $core.String get upfrontInterestDestination => $_getSZ(5);
  @$pb.TagNumber(6)
  set upfrontInterestDestination($core.String value) => $_setString(5, value);
  @$pb.TagNumber(6)
  $core.bool hasUpfrontInterestDestination() => $_has(5);
  @$pb.TagNumber(6)
  void clearUpfrontInterestDestination() => $_clearField(6);
}
...
class GetLockFundsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.int>(6, _omitFieldNames ? '' : 'perPage', $pb.PbFieldType.O3)
    ..a<$core.int>(7, _omitFieldNames ? '' : 'totalPages', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  $core.int get perPage => $_getIZ(5);
  @$pb.TagNumber(6)
  set perPage($core.int value) => $_setSignedInt32(5, value);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set totalPages($core.int value) => $_setSignedInt32(6, value);
  @$pb.TagNumber(7)
...
class PiggyVaultConfigProto extends $pb.GeneratedMessage {
  factory PiggyVaultConfigProto({
    ...
    if (description != null) result.description = description;
    if (isFixedAmount != null) result.isFixedAmount = isFixedAmount;
    if (fixedAmount != null) result.fixedAmount = fixedAmount;
    if (durationOptions != null) result.durationOptions = durationOptions;
    if (quickAmountOptions != null)
      result.quickAmountOptions = quickAmountOptions;
    if (confirmationNotes != null) result.confirmationNotes = confirmationNotes;
    if (confirmationNotesRenewOn != null)
      result.confirmationNotesRenewOn = confirmationNotesRenewOn;
    if (confirmationNotesRenewOff != null)
      result.confirmationNotesRenewOff = confirmationNotesRenewOff;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(20, _omitFieldNames ? '' : 'isFixedAmount')
    ..a<$core.double>(
        21, _omitFieldNames ? '' : 'fixedAmount', $pb.PbFieldType.OD)
    ..aOS(22, _omitFieldNames ? '' : 'durationOptions')
    ..aOS(23, _omitFieldNames ? '' : 'quickAmountOptions')
    ..aOS(24, _omitFieldNames ? '' : 'confirmationNotes')
    ..aOS(25, _omitFieldNames ? '' : 'confirmationNotesRenewOn')
    ..aOS(26, _omitFieldNames ? '' : 'confirmationNotesRenewOff')
    ..hasRequiredFields = false;
  ...
  /// is_fixed_amount=true forces the wizard to deposit exactly
  /// fixed_amount; the amount input is hidden and the user just
  /// confirms the headline figure.
  @$pb.TagNumber(20)
  $core.bool get isFixedAmount => $_getBF(19);
  @$pb.TagNumber(20)
  set isFixedAmount($core.bool value) => $_setBool(19, value);
  @$pb.TagNumber(20)
  $core.bool hasIsFixedAmount() => $_has(19);
  @$pb.TagNumber(20)
  void clearIsFixedAmount() => $_clearField(20);

  @$pb.TagNumber(21)
  $core.double get fixedAmount => $_getN(20);
  @$pb.TagNumber(21)
  set fixedAmount($core.double value) => $_setDouble(20, value);
  @$pb.TagNumber(21)
  $core.bool hasFixedAmount() => $_has(20);
  @$pb.TagNumber(21)
  void clearFixedAmount() => $_clearField(21);

  /// JSON array of integers (days) — wizard renders these as
  /// quick-pick duration chips. Empty array → client falls back
  /// to a generic preset filtered by min/max.
  @$pb.TagNumber(22)
  $core.String get durationOptions => $_getSZ(21);
  @$pb.TagNumber(22)
  set durationOptions($core.String value) => $_setString(21, value);
  @$pb.TagNumber(22)
  $core.bool hasDurationOptions() => $_has(21);
  @$pb.TagNumber(22)
  void clearDurationOptions() => $_clearField(22);

  /// JSON array of decimals — wizard renders these as quick-pick
  /// amount pills. Empty array → no pills, free-form amount only.
  @$pb.TagNumber(23)
  $core.String get quickAmountOptions => $_getSZ(22);
  @$pb.TagNumber(23)
  set quickAmountOptions($core.String value) => $_setString(22, value);
  @$pb.TagNumber(23)
  $core.bool hasQuickAmountOptions() => $_has(22);
  @$pb.TagNumber(23)
  void clearQuickAmountOptions() => $_clearField(23);

  /// Newline-separated bullets rendered on the Pay & confirm slide's
  /// "Before you confirm" panel. confirmation_notes shows always;
  /// confirmation_notes_renew_on/off are appended below it based on
  /// the user's auto-renew toggle. Empty strings → no extra notes.
  @$pb.TagNumber(24)
  $core.String get confirmationNotes => $_getSZ(23);
  @$pb.TagNumber(24)
  set confirmationNotes($core.String value) => $_setString(23, value);
  @$pb.TagNumber(24)
  $core.bool hasConfirmationNotes() => $_has(23);
  @$pb.TagNumber(24)
  void clearConfirmationNotes() => $_clearField(24);

  @$pb.TagNumber(25)
  $core.String get confirmationNotesRenewOn => $_getSZ(24);
  @$pb.TagNumber(25)
  set confirmationNotesRenewOn($core.String value) => $_setString(24, value);
  @$pb.TagNumber(25)
  $core.bool hasConfirmationNotesRenewOn() => $_has(24);
  @$pb.TagNumber(25)
  void clearConfirmationNotesRenewOn() => $_clearField(25);

  @$pb.TagNumber(26)
  $core.String get confirmationNotesRenewOff => $_getSZ(25);
  @$pb.TagNumber(26)
  set confirmationNotesRenewOff($core.String value) => $_setString(25, value);
  @$pb.TagNumber(26)
  $core.bool hasConfirmationNotesRenewOff() => $_has(25);
  @$pb.TagNumber(26)
  void clearConfirmationNotesRenewOff() => $_clearField(26);
}
...
class GetPiggyVaultConfigRequest extends $pb.GeneratedMessage {
  ...
  /// BCP-47 locale tag (e.g. "fr", "fr-CA"). When set, the response's
  /// user-facing strings (display_name, description, confirmation_notes,
  /// confirmation_notes_renew_on/off) are returned in the matching
  /// localized variant. Falls back to base language, then to default
  /// strings, when the requested locale has no override.
  @$pb.TagNumber(3)
...
class GetAllPiggyVaultConfigsRequest extends $pb.GeneratedMessage {
  ...
  /// BCP-47 locale; see GetPiggyVaultConfigRequest.locale. Applied to
  /// every config in the response.
  @$pb.TagNumber(2)
...
class UpdatePiggyVaultConfigRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(19, _omitFieldNames ? '' : 'isFixedAmount')
    ..a<$core.double>(
        20, _omitFieldNames ? '' : 'fixedAmount', $pb.PbFieldType.OD)
    ..aOS(21, _omitFieldNames ? '' : 'durationOptions')
    ..aOS(22, _omitFieldNames ? '' : 'quickAmountOptions')
    ..aOS(23, _omitFieldNames ? '' : 'confirmationNotes')
    ..aOS(24, _omitFieldNames ? '' : 'confirmationNotesRenewOn')
    ..aOS(25, _omitFieldNames ? '' : 'confirmationNotesRenewOff')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(19)
  set isFixedAmount($core.bool value) => $_setBool(18, value);
  @$pb.TagNumber(19)
  $core.bool hasIsFixedAmount() => $_has(18);
  @$pb.TagNumber(19)
  void clearIsFixedAmount() => $_clearField(19);

  @$pb.TagNumber(20)
  $core.double get fixedAmount => $_getN(19);
  @$pb.TagNumber(20)
  set fixedAmount($core.double value) => $_setDouble(19, value);
  @$pb.TagNumber(20)
  $core.bool hasFixedAmount() => $_has(19);
  @$pb.TagNumber(20)
  void clearFixedAmount() => $_clearField(20);

  @$pb.TagNumber(21)
  $core.String get durationOptions => $_getSZ(20);
  @$pb.TagNumber(21)
  set durationOptions($core.String value) => $_setString(20, value);
  @$pb.TagNumber(21)
  $core.bool hasDurationOptions() => $_has(20);
  @$pb.TagNumber(21)
  void clearDurationOptions() => $_clearField(21);

  @$pb.TagNumber(22)
  $core.String get quickAmountOptions => $_getSZ(21);
  @$pb.TagNumber(22)
  set quickAmountOptions($core.String value) => $_setString(21, value);
  @$pb.TagNumber(22)
  $core.bool hasQuickAmountOptions() => $_has(21);
  @$pb.TagNumber(22)
  void clearQuickAmountOptions() => $_clearField(22);

  @$pb.TagNumber(23)
  $core.String get confirmationNotes => $_getSZ(22);
  @$pb.TagNumber(23)
  set confirmationNotes($core.String value) => $_setString(22, value);
  @$pb.TagNumber(23)
  $core.bool hasConfirmationNotes() => $_has(22);
  @$pb.TagNumber(23)
  void clearConfirmationNotes() => $_clearField(23);

  @$pb.TagNumber(24)
  $core.String get confirmationNotesRenewOn => $_getSZ(23);
  @$pb.TagNumber(24)
  set confirmationNotesRenewOn($core.String value) => $_setString(23, value);
  @$pb.TagNumber(24)
  $core.bool hasConfirmationNotesRenewOn() => $_has(23);
  @$pb.TagNumber(24)
  void clearConfirmationNotesRenewOn() => $_clearField(24);

  @$pb.TagNumber(25)
  $core.String get confirmationNotesRenewOff => $_getSZ(24);
  @$pb.TagNumber(25)
  set confirmationNotesRenewOff($core.String value) => $_setString(24, value);
  @$pb.TagNumber(25)
  $core.bool hasConfirmationNotesRenewOff() => $_has(24);
  @$pb.TagNumber(25)
  void clearConfirmationNotesRenewOff() => $_clearField(25);
}
...
/// === TopUp Lock Fund ===
/// Renew / cancel an active lock fund.
///
/// RenewLockFunds extends the unlock_date by new_duration_days and
/// (when the plan's supports_upfront_interest is on) re-pays the
/// interest for the new term from the platform REVENUE wallet.
/// Same bail-to-mature semantics as the auto-renew worker: a
/// frozen destination / underfunded REVENUE / deactivated plan
/// causes the renewal to be rejected with InvalidArgument so the
/// user can investigate before the lock matures naturally.
class RenewLockFundsRequest extends $pb.GeneratedMessage {
  factory RenewLockFundsRequest({
    $core.String? lockfundsId,
  ...
  RenewLockFundsRequest._();

  factory RenewLockFundsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RenewLockFundsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RenewLockFundsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'lockfundsId')
    ..a<$core.int>(
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RenewLockFundsRequest clone() =>
      RenewLockFundsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RenewLockFundsRequest copyWith(
          void Function(RenewLockFundsRequest) updates) =>
      super.copyWith((message) => updates(message as RenewLockFundsRequest))
          as RenewLockFundsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RenewLockFundsRequest create() => RenewLockFundsRequest._();
  @$core.override
  RenewLockFundsRequest createEmptyInstance() => create();
  static $pb.PbList<RenewLockFundsRequest> createRepeated() =>
      $pb.PbList<RenewLockFundsRequest>();
  @$core.pragma('dart2js:noInline')
  static RenewLockFundsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RenewLockFundsRequest>(create);
  static RenewLockFundsRequest? _defaultInstance;
...
class RenewLockFundsResponse extends $pb.GeneratedMessage {
  factory RenewLockFundsResponse({
    LockFunds? lockfunds,
    $core.double? upfrontInterestPaid,
    $core.String? upfrontInterestDestination,
    $core.String? message,
  ...
  RenewLockFundsResponse._();

  factory RenewLockFundsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RenewLockFundsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RenewLockFundsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOM<LockFunds>(1, _omitFieldNames ? '' : 'lockfunds',
        subBuilder: LockFunds.create)
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'upfrontInterestPaid', $pb.PbFieldType.OD)
    ..aOS(3, _omitFieldNames ? '' : 'upfrontInterestDestination')
    ..aOS(4, _omitFieldNames ? '' : 'message')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RenewLockFundsResponse clone() =>
      RenewLockFundsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RenewLockFundsResponse copyWith(
          void Function(RenewLockFundsResponse) updates) =>
      super.copyWith((message) => updates(message as RenewLockFundsResponse))
          as RenewLockFundsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RenewLockFundsResponse create() => RenewLockFundsResponse._();
  @$core.override
  RenewLockFundsResponse createEmptyInstance() => create();
  static $pb.PbList<RenewLockFundsResponse> createRepeated() =>
      $pb.PbList<RenewLockFundsResponse>();
  @$core.pragma('dart2js:noInline')
  static RenewLockFundsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RenewLockFundsResponse>(create);
  static RenewLockFundsResponse? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.double get upfrontInterestPaid => $_getN(1);
  @$pb.TagNumber(2)
  set upfrontInterestPaid($core.double value) => $_setDouble(1, value);
  @$pb.TagNumber(2)
  $core.bool hasUpfrontInterestPaid() => $_has(1);
  @$pb.TagNumber(2)
  void clearUpfrontInterestPaid() => $_clearField(2);

  @$pb.TagNumber(3)
  $core.String get upfrontInterestDestination => $_getSZ(2);
  @$pb.TagNumber(3)
  set upfrontInterestDestination($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasUpfrontInterestDestination() => $_has(2);
  @$pb.TagNumber(3)
  void clearUpfrontInterestDestination() => $_clearField(3);
...
class CancelLockFundsRequest extends $pb.GeneratedMessage {
  factory CancelLockFundsRequest({
    $core.String? lockfundsId,
    $core.String? reason,
    $core.String? idempotencyKey,
  }) {
  ...
  CancelLockFundsRequest._();

  factory CancelLockFundsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CancelLockFundsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CancelLockFundsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'lockfundsId')
    ..aOS(2, _omitFieldNames ? '' : 'reason')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CancelLockFundsRequest clone() =>
      CancelLockFundsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CancelLockFundsRequest copyWith(
          void Function(CancelLockFundsRequest) updates) =>
      super.copyWith((message) => updates(message as CancelLockFundsRequest))
          as CancelLockFundsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CancelLockFundsRequest create() => CancelLockFundsRequest._();
  @$core.override
  CancelLockFundsRequest createEmptyInstance() => create();
  static $pb.PbList<CancelLockFundsRequest> createRepeated() =>
      $pb.PbList<CancelLockFundsRequest>();
  @$core.pragma('dart2js:noInline')
  static CancelLockFundsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CancelLockFundsRequest>(create);
  static CancelLockFundsRequest? _defaultInstance;
...
class CancelLockFundsResponse extends $pb.GeneratedMessage {
  factory CancelLockFundsResponse({
    LockFunds? lockfunds,
  ...
  CancelLockFundsResponse._();

  factory CancelLockFundsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory CancelLockFundsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'CancelLockFundsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOM<LockFunds>(1, _omitFieldNames ? '' : 'lockfunds',
        subBuilder: LockFunds.create)
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'refundAmount', $pb.PbFieldType.OD)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'penaltyAmount', $pb.PbFieldType.OD)
    ..aOS(4, _omitFieldNames ? '' : 'message')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CancelLockFundsResponse clone() =>
      CancelLockFundsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  CancelLockFundsResponse copyWith(
          void Function(CancelLockFundsResponse) updates) =>
      super.copyWith((message) => updates(message as CancelLockFundsResponse))
          as CancelLockFundsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static CancelLockFundsResponse create() => CancelLockFundsResponse._();
  @$core.override
  CancelLockFundsResponse createEmptyInstance() => create();
  static $pb.PbList<CancelLockFundsResponse> createRepeated() =>
      $pb.PbList<CancelLockFundsResponse>();
  @$core.pragma('dart2js:noInline')
  static CancelLockFundsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<CancelLockFundsResponse>(create);
  static CancelLockFundsResponse? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.double get refundAmount => $_getN(1);
  @$pb.TagNumber(2)
  set refundAmount($core.double value) => $_setDouble(1, value);
  @$pb.TagNumber(2)
...
class GetLockFundsSettlementsRequest extends $pb.GeneratedMessage {
  factory GetLockFundsSettlementsRequest({
    $core.String? lockfundsId,
    $core.int? limit,
    $core.int? offset,
  }) {
  ...
  GetLockFundsSettlementsRequest._();

  factory GetLockFundsSettlementsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetLockFundsSettlementsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetLockFundsSettlementsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'lockfundsId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLockFundsSettlementsRequest clone() =>
      GetLockFundsSettlementsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLockFundsSettlementsRequest copyWith(
          void Function(GetLockFundsSettlementsRequest) updates) =>
      super.copyWith(
              (message) => updates(message as GetLockFundsSettlementsRequest))
          as GetLockFundsSettlementsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetLockFundsSettlementsRequest create() =>
      GetLockFundsSettlementsRequest._();
  @$core.override
  GetLockFundsSettlementsRequest createEmptyInstance() => create();
  static $pb.PbList<GetLockFundsSettlementsRequest> createRepeated() =>
      $pb.PbList<GetLockFundsSettlementsRequest>();
  @$core.pragma('dart2js:noInline')
  static GetLockFundsSettlementsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetLockFundsSettlementsRequest>(create);
  static GetLockFundsSettlementsRequest? _defaultInstance;
...
class LockFundsSettlementProto extends $pb.GeneratedMessage {
  factory LockFundsSettlementProto({
    $core.String? id,
    $core.String? lockfundsId,
    $core.String? leg,
    $core.String? status,
  ...
  LockFundsSettlementProto._();

  factory LockFundsSettlementProto.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory LockFundsSettlementProto.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LockFundsSettlementProto',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'lockfundsId')
    ..aOS(3, _omitFieldNames ? '' : 'leg')
    ..aOS(4, _omitFieldNames ? '' : 'status')
    ..a<$core.double>(5, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OD)
    ..aOS(6, _omitFieldNames ? '' : 'currency')
    ..aOS(7, _omitFieldNames ? '' : 'reference')
    ..aOS(8, _omitFieldNames ? '' : 'scheduledAt')
    ..aOS(9, _omitFieldNames ? '' : 'completedAt')
    ..aOS(10, _omitFieldNames ? '' : 'createdAt')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LockFundsSettlementProto clone() =>
      LockFundsSettlementProto()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LockFundsSettlementProto copyWith(
          void Function(LockFundsSettlementProto) updates) =>
      super.copyWith((message) => updates(message as LockFundsSettlementProto))
          as LockFundsSettlementProto;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static LockFundsSettlementProto create() => LockFundsSettlementProto._();
  @$core.override
  LockFundsSettlementProto createEmptyInstance() => create();
  static $pb.PbList<LockFundsSettlementProto> createRepeated() =>
      $pb.PbList<LockFundsSettlementProto>();
  @$core.pragma('dart2js:noInline')
  static LockFundsSettlementProto getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<LockFundsSettlementProto>(create);
  static LockFundsSettlementProto? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.String get lockfundsId => $_getSZ(1);
  @$pb.TagNumber(2)
  set lockfundsId($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasLockfundsId() => $_has(1);
  @$pb.TagNumber(2)
  void clearLockfundsId() => $_clearField(2);

  @$pb.TagNumber(3)
  $core.String get leg => $_getSZ(2);
  @$pb.TagNumber(3)
  set leg($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasLeg() => $_has(2);
  @$pb.TagNumber(3)
  void clearLeg() => $_clearField(3);
  ...
  @$pb.TagNumber(8)
  $core.String get scheduledAt => $_getSZ(7);
  @$pb.TagNumber(8)
  set scheduledAt($core.String value) => $_setString(7, value);
  @$pb.TagNumber(8)
...
class GetLockFundsSettlementsResponse extends $pb.GeneratedMessage {
  factory GetLockFundsSettlementsResponse({
    $core.Iterable<LockFundsSettlementProto>? settlements,
    $core.int? totalCount,
  }) {
    final result = create();
  ...
  GetLockFundsSettlementsResponse._();

  factory GetLockFundsSettlementsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetLockFundsSettlementsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetLockFundsSettlementsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..pc<LockFundsSettlementProto>(
        1, _omitFieldNames ? '' : 'settlements', $pb.PbFieldType.PM,
        subBuilder: LockFundsSettlementProto.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'totalCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLockFundsSettlementsResponse clone() =>
      GetLockFundsSettlementsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLockFundsSettlementsResponse copyWith(
          void Function(GetLockFundsSettlementsResponse) updates) =>
      super.copyWith(
              (message) => updates(message as GetLockFundsSettlementsResponse))
          as GetLockFundsSettlementsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetLockFundsSettlementsResponse create() =>
      GetLockFundsSettlementsResponse._();
  @$core.override
  GetLockFundsSettlementsResponse createEmptyInstance() => create();
  static $pb.PbList<GetLockFundsSettlementsResponse> createRepeated() =>
      $pb.PbList<GetLockFundsSettlementsResponse>();
  @$core.pragma('dart2js:noInline')
  static GetLockFundsSettlementsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetLockFundsSettlementsResponse>(
          create);
  static GetLockFundsSettlementsResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<LockFundsSettlementProto> get settlements => $_getList(0);
...
/// Admin force-action requests.
///
/// admin_user_id is captured separately from the gRPC auth context so
/// the audit row records who triggered the override. Reason is
/// required — typed strings preferred ("regulatory_close",
/// "kyc_revoked", "plan_discontinued") but free-form accepted so
/// novel ops cases aren't blocked.
class AdminForceMatureLockFundsRequest extends $pb.GeneratedMessage {
  factory AdminForceMatureLockFundsRequest({
    $core.String? lockfundsId,
  ...
  AdminForceMatureLockFundsRequest._();

  factory AdminForceMatureLockFundsRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminForceMatureLockFundsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminForceMatureLockFundsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'lockfundsId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceMatureLockFundsRequest clone() =>
      AdminForceMatureLockFundsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceMatureLockFundsRequest copyWith(
          void Function(AdminForceMatureLockFundsRequest) updates) =>
      super.copyWith(
              (message) => updates(message as AdminForceMatureLockFundsRequest))
          as AdminForceMatureLockFundsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminForceMatureLockFundsRequest create() =>
      AdminForceMatureLockFundsRequest._();
  @$core.override
  AdminForceMatureLockFundsRequest createEmptyInstance() => create();
  static $pb.PbList<AdminForceMatureLockFundsRequest> createRepeated() =>
      $pb.PbList<AdminForceMatureLockFundsRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminForceMatureLockFundsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminForceMatureLockFundsRequest>(
          create);
  static AdminForceMatureLockFundsRequest? _defaultInstance;
...
class AdminForceMatureLockFundsResponse extends $pb.GeneratedMessage {
  factory AdminForceMatureLockFundsResponse({
    LockFunds? lockfunds,
    $core.double? refundAmount,
    $core.String? message,
  }) {
  ...
  AdminForceMatureLockFundsResponse._();

  factory AdminForceMatureLockFundsResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminForceMatureLockFundsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminForceMatureLockFundsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOM<LockFunds>(1, _omitFieldNames ? '' : 'lockfunds',
        subBuilder: LockFunds.create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceMatureLockFundsResponse clone() =>
      AdminForceMatureLockFundsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceMatureLockFundsResponse copyWith(
          void Function(AdminForceMatureLockFundsResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminForceMatureLockFundsResponse))
          as AdminForceMatureLockFundsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminForceMatureLockFundsResponse create() =>
      AdminForceMatureLockFundsResponse._();
  @$core.override
  AdminForceMatureLockFundsResponse createEmptyInstance() => create();
  static $pb.PbList<AdminForceMatureLockFundsResponse> createRepeated() =>
      $pb.PbList<AdminForceMatureLockFundsResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminForceMatureLockFundsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminForceMatureLockFundsResponse>(
          create);
  static AdminForceMatureLockFundsResponse? _defaultInstance;
...
class AdminForceCancelLockFundsRequest extends $pb.GeneratedMessage {
  factory AdminForceCancelLockFundsRequest({
    $core.String? lockfundsId,
    $core.String? adminUserId,
    $core.String? reason,
  }) {
  ...
  AdminForceCancelLockFundsRequest._();

  factory AdminForceCancelLockFundsRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminForceCancelLockFundsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminForceCancelLockFundsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'lockfundsId')
    ..aOS(2, _omitFieldNames ? '' : 'adminUserId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceCancelLockFundsRequest clone() =>
      AdminForceCancelLockFundsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceCancelLockFundsRequest copyWith(
          void Function(AdminForceCancelLockFundsRequest) updates) =>
      super.copyWith(
              (message) => updates(message as AdminForceCancelLockFundsRequest))
          as AdminForceCancelLockFundsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminForceCancelLockFundsRequest create() =>
      AdminForceCancelLockFundsRequest._();
  @$core.override
  AdminForceCancelLockFundsRequest createEmptyInstance() => create();
  static $pb.PbList<AdminForceCancelLockFundsRequest> createRepeated() =>
      $pb.PbList<AdminForceCancelLockFundsRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminForceCancelLockFundsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminForceCancelLockFundsRequest>(
          create);
  static AdminForceCancelLockFundsRequest? _defaultInstance;
...
class AdminForceCancelLockFundsResponse extends $pb.GeneratedMessage {
  factory AdminForceCancelLockFundsResponse({
    LockFunds? lockfunds,
    $core.double? refundAmount,
    $core.double? penaltyAmount,
    $core.String? message,
  ...
  AdminForceCancelLockFundsResponse._();

  factory AdminForceCancelLockFundsResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminForceCancelLockFundsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminForceCancelLockFundsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOM<LockFunds>(1, _omitFieldNames ? '' : 'lockfunds',
        subBuilder: LockFunds.create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceCancelLockFundsResponse clone() =>
      AdminForceCancelLockFundsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminForceCancelLockFundsResponse copyWith(
          void Function(AdminForceCancelLockFundsResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminForceCancelLockFundsResponse))
          as AdminForceCancelLockFundsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminForceCancelLockFundsResponse create() =>
      AdminForceCancelLockFundsResponse._();
  @$core.override
  AdminForceCancelLockFundsResponse createEmptyInstance() => create();
  static $pb.PbList<AdminForceCancelLockFundsResponse> createRepeated() =>
      $pb.PbList<AdminForceCancelLockFundsResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminForceCancelLockFundsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminForceCancelLockFundsResponse>(
          create);
  static AdminForceCancelLockFundsResponse? _defaultInstance;
...
class TopUpLockFundsRequest extends $pb.GeneratedMessage {
  ...
  /// Dedup key. A retry with the same key returns the existing
  /// top-up settlement row instead of executing a second debit.
  @$pb.TagNumber(5)
...
/// LookupTransactionByReference — read-only verification probe.
///
/// Background reconcilers must distinguish "the debit committed" from "the
/// debit was never attempted at the service" before deciding whether to
/// retry, refund, or fail a payment. Using DebitBalance again with the same
/// idempotency key will return the cached outcome IF the original committed,
/// but if it didn't commit it will start a FRESH debit — moving money the
/// caller may no longer want to move. This RPC is the side-effect-free path.
class LookupTransactionByReferenceRequest extends $pb.GeneratedMessage {
  ...
  LookupTransactionByReferenceRequest._();

  factory LookupTransactionByReferenceRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory LookupTransactionByReferenceRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LookupTransactionByReferenceRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reference')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LookupTransactionByReferenceRequest clone() =>
      LookupTransactionByReferenceRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LookupTransactionByReferenceRequest copyWith(
          void Function(LookupTransactionByReferenceRequest) updates) =>
      super.copyWith((message) =>
              updates(message as LookupTransactionByReferenceRequest))
          as LookupTransactionByReferenceRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static LookupTransactionByReferenceRequest create() =>
      LookupTransactionByReferenceRequest._();
  @$core.override
  LookupTransactionByReferenceRequest createEmptyInstance() => create();
  static $pb.PbList<LookupTransactionByReferenceRequest> createRepeated() =>
      $pb.PbList<LookupTransactionByReferenceRequest>();
  @$core.pragma('dart2js:noInline')
  static LookupTransactionByReferenceRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          LookupTransactionByReferenceRequest>(create);
  static LookupTransactionByReferenceRequest? _defaultInstance;

  /// Full reference string. For idempotency-key probes pass the canonical
  /// "IDEM-DR-{key}" or "IDEM-CR-{key}" reference the original call would
  /// have used.
  @$pb.TagNumber(1)
  $core.String get reference => $_getSZ(0);
  @$pb.TagNumber(1)
...
class LookupTransactionByReferenceResponse extends $pb.GeneratedMessage {
  ...
  LookupTransactionByReferenceResponse._();

  factory LookupTransactionByReferenceResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory LookupTransactionByReferenceResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'LookupTransactionByReferenceResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LookupTransactionByReferenceResponse clone() =>
      LookupTransactionByReferenceResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  LookupTransactionByReferenceResponse copyWith(
          void Function(LookupTransactionByReferenceResponse) updates) =>
      super.copyWith((message) =>
              updates(message as LookupTransactionByReferenceResponse))
          as LookupTransactionByReferenceResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static LookupTransactionByReferenceResponse create() =>
      LookupTransactionByReferenceResponse._();
  @$core.override
  LookupTransactionByReferenceResponse createEmptyInstance() => create();
  static $pb.PbList<LookupTransactionByReferenceResponse> createRepeated() =>
      $pb.PbList<LookupTransactionByReferenceResponse>();
  @$core.pragma('dart2js:noInline')
  static LookupTransactionByReferenceResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          LookupTransactionByReferenceResponse>(create);
  static LookupTransactionByReferenceResponse? _defaultInstance;

  /// True iff a transaction with the supplied reference exists.
  @$pb.TagNumber(1)
  ...
  /// Populated when found=true. Status field is the authoritative outcome.
  @$pb.TagNumber(2)
  Transaction get transaction => $_getN(1);
  @$pb.TagNumber(2)
  set transaction(Transaction value) => $_setField(2, value);
...
class GetLedgerEntriesByReferenceRequest extends $pb.GeneratedMessage {
  factory GetLedgerEntriesByReferenceRequest({
    $core.String? reference,
    $core.String? idempotencyKey,
  }) {
    final result = create();
  ...
  GetLedgerEntriesByReferenceRequest._();

  factory GetLedgerEntriesByReferenceRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetLedgerEntriesByReferenceRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetLedgerEntriesByReferenceRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'reference')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLedgerEntriesByReferenceRequest clone() =>
      GetLedgerEntriesByReferenceRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLedgerEntriesByReferenceRequest copyWith(
          void Function(GetLedgerEntriesByReferenceRequest) updates) =>
      super.copyWith((message) =>
              updates(message as GetLedgerEntriesByReferenceRequest))
          as GetLedgerEntriesByReferenceRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetLedgerEntriesByReferenceRequest create() =>
      GetLedgerEntriesByReferenceRequest._();
  @$core.override
  GetLedgerEntriesByReferenceRequest createEmptyInstance() => create();
  static $pb.PbList<GetLedgerEntriesByReferenceRequest> createRepeated() =>
      $pb.PbList<GetLedgerEntriesByReferenceRequest>();
  @$core.pragma('dart2js:noInline')
  static GetLedgerEntriesByReferenceRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetLedgerEntriesByReferenceRequest>(
          create);
  static GetLedgerEntriesByReferenceRequest? _defaultInstance;

  /// Canonical logical reference for the money movement (e.g. "TRF-{txnId}").
  @$pb.TagNumber(1)
  $core.String get reference => $_getSZ(0);
  @$pb.TagNumber(1)
  set reference($core.String value) => $_setString(0, value);
  ...
  /// Idempotency key the original call used (usually == reference). Used to
  /// derive the "IDEM-XFER-{key}-FROM/-TO" leg references. Optional; when empty
  /// the service derives candidates from `reference` alone.
  @$pb.TagNumber(2)
...
class GetLedgerEntriesByReferenceResponse extends $pb.GeneratedMessage {
  factory GetLedgerEntriesByReferenceResponse({
    $core.Iterable<Transaction>? entries,
  }) {
    final result = create();
  ...
  GetLedgerEntriesByReferenceResponse._();

  factory GetLedgerEntriesByReferenceResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetLedgerEntriesByReferenceResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetLedgerEntriesByReferenceResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..pc<Transaction>(1, _omitFieldNames ? '' : 'entries', $pb.PbFieldType.PM,
        subBuilder: Transaction.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLedgerEntriesByReferenceResponse clone() =>
      GetLedgerEntriesByReferenceResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetLedgerEntriesByReferenceResponse copyWith(
          void Function(GetLedgerEntriesByReferenceResponse) updates) =>
      super.copyWith((message) =>
              updates(message as GetLedgerEntriesByReferenceResponse))
          as GetLedgerEntriesByReferenceResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetLedgerEntriesByReferenceResponse create() =>
      GetLedgerEntriesByReferenceResponse._();
  @$core.override
  GetLedgerEntriesByReferenceResponse createEmptyInstance() => create();
  static $pb.PbList<GetLedgerEntriesByReferenceResponse> createRepeated() =>
      $pb.PbList<GetLedgerEntriesByReferenceResponse>();
  @$core.pragma('dart2js:noInline')
  static GetLedgerEntriesByReferenceResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          GetLedgerEntriesByReferenceResponse>(create);
  static GetLedgerEntriesByReferenceResponse? _defaultInstance;

  /// All matching legs (typically the debit + credit of an internal transfer).
  /// Empty when none match.
  @$pb.TagNumber(1)
  $pb.PbList<Transaction> get entries => $_getList(0);
}
...
class DebitBalanceRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(15, _omitFieldNames ? '' : 'reactive')
    ..hasRequiredFields = false;
  ...
  /// Reactive: when true, this debit is system-initiated (e.g. provider
  /// chargeback / clawback / refund-pipeline) and is allowed to drive
  /// the available_balance below zero, down to the per-account
  /// overdraft floor (bounded by the global system_settings cap).
  /// Proactive (user-initiated) debits MUST leave reactive=false; they
  /// continue to enforce the strict balance >= amount check.
  @$pb.TagNumber(15)
  $core.bool get reactive => $_getBF(14);
  @$pb.TagNumber(15)
  set reactive($core.bool value) => $_setBool(14, value);
  @$pb.TagNumber(15)
  $core.bool hasReactive() => $_has(14);
  @$pb.TagNumber(15)
  void clearReactive() => $_clearField(15);
}
...
class TransferBalanceResponse extends $pb.GeneratedMessage {
  factory TransferBalanceResponse({
    ...
    $fixnum.Int64? fromNewAvailableBalance,
    $fixnum.Int64? toNewAvailableBalance,
  }) {
    final result = create();
    if (success != null) result.success = success;
    if (errorCode != null) result.errorCode = errorCode;
    ...
    if (fromNewAvailableBalance != null)
      result.fromNewAvailableBalance = fromNewAvailableBalance;
    if (toNewAvailableBalance != null)
      result.toNewAvailableBalance = toNewAvailableBalance;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(8, _omitFieldNames ? '' : 'fromNewAvailableBalance')
    ..aInt64(9, _omitFieldNames ? '' : 'toNewAvailableBalance')
    ..hasRequiredFields = false;
  ...
  /// Post-transfer AVAILABLE balances (balance minus active holds), minor units.
  /// The service layer has always computed these (TransferBalanceResult) but they
  /// had nowhere to go on the wire, so every caller that wanted to push a live
  /// balance to the app had to re-fetch the account. Callers that only need the
  /// ledger balance can keep using from_new_balance/to_new_balance.
  @$pb.TagNumber(8)
  $fixnum.Int64 get fromNewAvailableBalance => $_getI64(7);
  @$pb.TagNumber(8)
  set fromNewAvailableBalance($fixnum.Int64 value) => $_setInt64(7, value);
  @$pb.TagNumber(8)
  $core.bool hasFromNewAvailableBalance() => $_has(7);
  @$pb.TagNumber(8)
  void clearFromNewAvailableBalance() => $_clearField(8);

  @$pb.TagNumber(9)
  $fixnum.Int64 get toNewAvailableBalance => $_getI64(8);
  @$pb.TagNumber(9)
  set toNewAvailableBalance($fixnum.Int64 value) => $_setInt64(8, value);
  @$pb.TagNumber(9)
  $core.bool hasToNewAvailableBalance() => $_has(8);
  @$pb.TagNumber(9)
  void clearToNewAvailableBalance() => $_clearField(9);
}
...
class HoldFundsRequest extends $pb.GeneratedMessage {
  factory HoldFundsRequest({
    ...
    $core.String? serviceName,
    $core.String? idempotencyKey,
    $core.bool? enforceSpendingLimit,
  }) {
    final result = create();
    if (accountId != null) result.accountId = accountId;
    if (userId != null) result.userId = userId;
    ...
    if (serviceName != null) result.serviceName = serviceName;
    if (idempotencyKey != null) result.idempotencyKey = idempotencyKey;
    if (enforceSpendingLimit != null)
      result.enforceSpendingLimit = enforceSpendingLimit;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(10, _omitFieldNames ? '' : 'enforceSpendingLimit')
    ..hasRequiredFields = false;
  ...
  /// enforce_spending_limit meters this hold against the account's personal
  /// daily/monthly/per-transaction caps (external transfers set it true). Checked
  /// at hold time; the spend is tracked at CaptureHold. Other holds omit it.
  @$pb.TagNumber(10)
  $core.bool get enforceSpendingLimit => $_getBF(9);
  @$pb.TagNumber(10)
  set enforceSpendingLimit($core.bool value) => $_setBool(9, value);
  @$pb.TagNumber(10)
  $core.bool hasEnforceSpendingLimit() => $_has(9);
  @$pb.TagNumber(10)
  void clearEnforceSpendingLimit() => $_clearField(10);
}
...
class CaptureHoldRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'actualAmount', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;
  ...
  /// actual_amount: when > 0, capture this amount instead of the held
  /// amount. Lets a saga settle execute-time slippage atomically:
  ///   actual_amount > hold_amount → capture full hold + extra debit
  ///                                  for the overage (overdraft allowed)
  ///   actual_amount < hold_amount → capture actual_amount, refund the
  ///                                  unspent portion to available_balance
  /// 0 = unset = capture exactly hold_amount (legacy behavior).
  @$pb.TagNumber(5)
  $core.double get actualAmount => $_getN(4);
  @$pb.TagNumber(5)
  set actualAmount($core.double value) => $_setDouble(4, value);
  @$pb.TagNumber(5)
  $core.bool hasActualAmount() => $_has(4);
  @$pb.TagNumber(5)
  void clearActualAmount() => $_clearField(5);
}
...
class CaptureHoldResponse extends $pb.GeneratedMessage {
  factory CaptureHoldResponse({
    ...
    if (transactionId != null) result.transactionId = transactionId;
    if (newBalance != null) result.newBalance = newBalance;
    if (capturedAmount != null) result.capturedAmount = capturedAmount;
    if (overageAmount != null) result.overageAmount = overageAmount;
    if (refundAmount != null) result.refundAmount = refundAmount;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(5, _omitFieldNames ? '' : 'newBalance')
    ..a<$core.double>(
        6, _omitFieldNames ? '' : 'capturedAmount', $pb.PbFieldType.OD)
    ..a<$core.double>(
        7, _omitFieldNames ? '' : 'overageAmount', $pb.PbFieldType.OD)
    ..a<$core.double>(
        8, _omitFieldNames ? '' : 'refundAmount', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  set capturedAmount($core.double value) => $_setDouble(5, value);
  @$pb.TagNumber(6)
  $core.bool hasCapturedAmount() => $_has(5);
  @$pb.TagNumber(6)
  void clearCapturedAmount() => $_clearField(6);

  @$pb.TagNumber(7)
  $core.double get overageAmount => $_getN(6);
  @$pb.TagNumber(7)
  set overageAmount($core.double value) => $_setDouble(6, value);
  @$pb.TagNumber(7)
  $core.bool hasOverageAmount() => $_has(6);
  @$pb.TagNumber(7)
  void clearOverageAmount() => $_clearField(7);

  @$pb.TagNumber(8)
  $core.double get refundAmount => $_getN(7);
  @$pb.TagNumber(8)
  set refundAmount($core.double value) => $_setDouble(7, value);
  @$pb.TagNumber(8)
  $core.bool hasRefundAmount() => $_has(7);
  @$pb.TagNumber(8)
  void clearRefundAmount() => $_clearField(8);
}
...
class GetPlatformWalletRequest extends $pb.GeneratedMessage {
  ...
  /// Currency of the wallet row to read. A wallet_code has ONE ROW PER
  /// CURRENCY (GIFTCARD_FLOAT exists in USD, NGN, GBP, ...), and resolving by
  /// code alone returns an arbitrary one — the same defect the write path
  /// already fixed by resolving on (wallet_code, currency). Empty keeps the
  /// legacy code-only behaviour so existing callers are unaffected.
  @$pb.TagNumber(3)
  $core.String get currency => $_getSZ(2);
  @$pb.TagNumber(3)
  set currency($core.String value) => $_setString(2, value);
...
class GetMonthlyTrendsRequest extends $pb.GeneratedMessage {
  ...
  /// Mirrors the other analytics reads. Absent, this query blended wallet and
  /// linked-bank rows and returned the same numbers on every source tab.
  @$pb.TagNumber(4)
  $core.bool get includeExternalBanks => $_getBF(3);
  @$pb.TagNumber(4)
  set includeExternalBanks($core.bool value) => $_setBool(3, value);
...
/// Get spending usage request/response — read-only view of limits + spend.
class GetSpendingUsageRequest extends $pb.GeneratedMessage {
  factory GetSpendingUsageRequest({
    $core.String? accountId,
  }) {
    final result = create();
    if (accountId != null) result.accountId = accountId;
  ...
  GetSpendingUsageRequest._();

  factory GetSpendingUsageRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetSpendingUsageRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetSpendingUsageRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'accountId')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetSpendingUsageRequest clone() =>
      GetSpendingUsageRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetSpendingUsageRequest copyWith(
          void Function(GetSpendingUsageRequest) updates) =>
      super.copyWith((message) => updates(message as GetSpendingUsageRequest))
          as GetSpendingUsageRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetSpendingUsageRequest create() => GetSpendingUsageRequest._();
  @$core.override
  GetSpendingUsageRequest createEmptyInstance() => create();
  static $pb.PbList<GetSpendingUsageRequest> createRepeated() =>
      $pb.PbList<GetSpendingUsageRequest>();
  @$core.pragma('dart2js:noInline')
  static GetSpendingUsageRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetSpendingUsageRequest>(create);
  static GetSpendingUsageRequest? _defaultInstance;
...
class GetSpendingUsageResponse extends $pb.GeneratedMessage {
  factory GetSpendingUsageResponse({
    $core.String? currency,
    $core.double? dailyLimit,
    $core.double? monthlyLimit,
    $core.double? singleTransactionLimit,
    $core.double? dailySpent,
    $core.double? monthlySpent,
    $core.double? remainingDaily,
    $core.double? remainingMonthly,
  }) {
    final result = create();
    if (currency != null) result.currency = currency;
    if (dailyLimit != null) result.dailyLimit = dailyLimit;
    ...
    if (singleTransactionLimit != null)
      result.singleTransactionLimit = singleTransactionLimit;
    if (dailySpent != null) result.dailySpent = dailySpent;
    if (monthlySpent != null) result.monthlySpent = monthlySpent;
    if (remainingDaily != null) result.remainingDaily = remainingDaily;
    if (remainingMonthly != null) result.remainingMonthly = remainingMonthly;
    return result;
  }

  GetSpendingUsageResponse._();

  factory GetSpendingUsageResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetSpendingUsageResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetSpendingUsageResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'currency')
    ..a<$core.double>(
    ...
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'singleTransactionLimit', $pb.PbFieldType.OD)
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'dailySpent', $pb.PbFieldType.OD)
    ..a<$core.double>(
        6, _omitFieldNames ? '' : 'monthlySpent', $pb.PbFieldType.OD)
    ..a<$core.double>(
        7, _omitFieldNames ? '' : 'remainingDaily', $pb.PbFieldType.OD)
    ..a<$core.double>(
        8, _omitFieldNames ? '' : 'remainingMonthly', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetSpendingUsageResponse clone() =>
      GetSpendingUsageResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetSpendingUsageResponse copyWith(
          void Function(GetSpendingUsageResponse) updates) =>
      super.copyWith((message) => updates(message as GetSpendingUsageResponse))
          as GetSpendingUsageResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetSpendingUsageResponse create() => GetSpendingUsageResponse._();
  @$core.override
  GetSpendingUsageResponse createEmptyInstance() => create();
  static $pb.PbList<GetSpendingUsageResponse> createRepeated() =>
      $pb.PbList<GetSpendingUsageResponse>();
  @$core.pragma('dart2js:noInline')
  static GetSpendingUsageResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetSpendingUsageResponse>(create);
  static GetSpendingUsageResponse? _defaultInstance;
  ...
  @$pb.TagNumber(5)
  $core.double get dailySpent => $_getN(4);
  @$pb.TagNumber(5)
  set dailySpent($core.double value) => $_setDouble(4, value);
  @$pb.TagNumber(5)
  $core.bool hasDailySpent() => $_has(4);
  @$pb.TagNumber(5)
  void clearDailySpent() => $_clearField(5);

  @$pb.TagNumber(6)
  $core.double get monthlySpent => $_getN(5);
  @$pb.TagNumber(6)
  set monthlySpent($core.double value) => $_setDouble(5, value);
  @$pb.TagNumber(6)
  $core.bool hasMonthlySpent() => $_has(5);
  @$pb.TagNumber(6)
  void clearMonthlySpent() => $_clearField(6);

  @$pb.TagNumber(7)
  $core.double get remainingDaily => $_getN(6);
  @$pb.TagNumber(7)
  set remainingDaily($core.double value) => $_setDouble(6, value);
  @$pb.TagNumber(7)
  $core.bool hasRemainingDaily() => $_has(6);
  @$pb.TagNumber(7)
  void clearRemainingDaily() => $_clearField(7);

  @$pb.TagNumber(8)
  $core.double get remainingMonthly => $_getN(7);
  @$pb.TagNumber(8)
  set remainingMonthly($core.double value) => $_setDouble(7, value);
  @$pb.TagNumber(8)
  $core.bool hasRemainingMonthly() => $_has(7);
  @$pb.TagNumber(8)
  void clearRemainingMonthly() => $_clearField(8);
}
...
class GenerateStatementResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aInt64(6, _omitFieldNames ? '' : 'generatedAt')
    ..aOS(7, _omitFieldNames ? '' : 'format')
    ..aOB(8, _omitFieldNames ? '' : 'cached')
    ..aInt64(9, _omitFieldNames ? '' : 'transactionCount')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(6)
  set generatedAt($fixnum.Int64 value) => $_setInt64(5, value);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set cached($core.bool value) => $_setBool(7, value);
  @$pb.TagNumber(8)
  $core.bool hasCached() => $_has(7);
  @$pb.TagNumber(8)
  void clearCached() => $_clearField(8);

  @$pb.TagNumber(9)
  $fixnum.Int64 get transactionCount => $_getI64(8);
  @$pb.TagNumber(9)
  set transactionCount($fixnum.Int64 value) => $_setInt64(8, value);
  @$pb.TagNumber(9)
  $core.bool hasTransactionCount() => $_has(8);
  @$pb.TagNumber(9)
  void clearTransactionCount() => $_clearField(9);
}
...
class AdminListWalletReconciliationsRequest extends $pb.GeneratedMessage {
  factory AdminListWalletReconciliationsRequest({
    $core.String? walletCode,
    $core.String? currency,
  }) {
    final result = create();
  ...
  AdminListWalletReconciliationsRequest._();

  factory AdminListWalletReconciliationsRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminListWalletReconciliationsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminListWalletReconciliationsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'walletCode')
    ..aOS(2, _omitFieldNames ? '' : 'currency')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListWalletReconciliationsRequest clone() =>
      AdminListWalletReconciliationsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListWalletReconciliationsRequest copyWith(
          void Function(AdminListWalletReconciliationsRequest) updates) =>
      super.copyWith((message) =>
              updates(message as AdminListWalletReconciliationsRequest))
          as AdminListWalletReconciliationsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminListWalletReconciliationsRequest create() =>
      AdminListWalletReconciliationsRequest._();
  @$core.override
  AdminListWalletReconciliationsRequest createEmptyInstance() => create();
  static $pb.PbList<AdminListWalletReconciliationsRequest> createRepeated() =>
      $pb.PbList<AdminListWalletReconciliationsRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminListWalletReconciliationsRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminListWalletReconciliationsRequest>(create);
  static AdminListWalletReconciliationsRequest? _defaultInstance;
...
class AdminListWalletReconciliationsResponse extends $pb.GeneratedMessage {
  factory AdminListWalletReconciliationsResponse({
    $core.Iterable<AdminWalletReconciliation>? rows,
  }) {
    final result = create();
  ...
  AdminListWalletReconciliationsResponse._();

  factory AdminListWalletReconciliationsResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminListWalletReconciliationsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminListWalletReconciliationsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..pc<AdminWalletReconciliation>(
        1, _omitFieldNames ? '' : 'rows', $pb.PbFieldType.PM,
        subBuilder: AdminWalletReconciliation.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListWalletReconciliationsResponse clone() =>
      AdminListWalletReconciliationsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListWalletReconciliationsResponse copyWith(
          void Function(AdminListWalletReconciliationsResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminListWalletReconciliationsResponse))
          as AdminListWalletReconciliationsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminListWalletReconciliationsResponse create() =>
      AdminListWalletReconciliationsResponse._();
  @$core.override
  AdminListWalletReconciliationsResponse createEmptyInstance() => create();
  static $pb.PbList<AdminListWalletReconciliationsResponse> createRepeated() =>
      $pb.PbList<AdminListWalletReconciliationsResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminListWalletReconciliationsResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminListWalletReconciliationsResponse>(create);
  static AdminListWalletReconciliationsResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<AdminWalletReconciliation> get rows => $_getList(0);
}

class AdminWalletReconciliation extends $pb.GeneratedMessage {
  factory AdminWalletReconciliation({
    $core.String? id,
    $core.String? walletCode,
    $core.String? currency,
    $core.String? reconAt,
    $core.double? actualBalance,
    $core.double? derivedBalance,
    $core.double? driftAmount,
    $core.String? status,
    $core.String? derivedSource,
    $core.String? notes,
  }) {
    final result = create();
    if (id != null) result.id = id;
    ...
    if (actualBalance != null) result.actualBalance = actualBalance;
    if (derivedBalance != null) result.derivedBalance = derivedBalance;
    if (driftAmount != null) result.driftAmount = driftAmount;
    if (status != null) result.status = status;
    if (derivedSource != null) result.derivedSource = derivedSource;
    if (notes != null) result.notes = notes;
    return result;
  }

  AdminWalletReconciliation._();

  factory AdminWalletReconciliation.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminWalletReconciliation.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminWalletReconciliation',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'walletCode')
    ..aOS(3, _omitFieldNames ? '' : 'currency')
    ..aOS(4, _omitFieldNames ? '' : 'reconAt')
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'actualBalance', $pb.PbFieldType.OD)
    ..a<$core.double>(
        6, _omitFieldNames ? '' : 'derivedBalance', $pb.PbFieldType.OD)
    ..a<$core.double>(
        7, _omitFieldNames ? '' : 'driftAmount', $pb.PbFieldType.OD)
    ..aOS(8, _omitFieldNames ? '' : 'status')
    ..aOS(9, _omitFieldNames ? '' : 'derivedSource')
    ..aOS(10, _omitFieldNames ? '' : 'notes')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminWalletReconciliation clone() =>
      AdminWalletReconciliation()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminWalletReconciliation copyWith(
          void Function(AdminWalletReconciliation) updates) =>
      super.copyWith((message) => updates(message as AdminWalletReconciliation))
          as AdminWalletReconciliation;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminWalletReconciliation create() => AdminWalletReconciliation._();
  @$core.override
  AdminWalletReconciliation createEmptyInstance() => create();
  static $pb.PbList<AdminWalletReconciliation> createRepeated() =>
      $pb.PbList<AdminWalletReconciliation>();
  @$core.pragma('dart2js:noInline')
  static AdminWalletReconciliation getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminWalletReconciliation>(create);
  static AdminWalletReconciliation? _defaultInstance;
  ...
  @$pb.TagNumber(4)
  $core.String get reconAt => $_getSZ(3);
  @$pb.TagNumber(4)
  set reconAt($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasReconAt() => $_has(3);
  @$pb.TagNumber(4)
  void clearReconAt() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.double get actualBalance => $_getN(4);
  @$pb.TagNumber(5)
  set actualBalance($core.double value) => $_setDouble(4, value);
  @$pb.TagNumber(5)
  $core.bool hasActualBalance() => $_has(4);
  @$pb.TagNumber(5)
  void clearActualBalance() => $_clearField(5);

  @$pb.TagNumber(6)
  $core.double get derivedBalance => $_getN(5);
  @$pb.TagNumber(6)
  set derivedBalance($core.double value) => $_setDouble(5, value);
  @$pb.TagNumber(6)
  $core.bool hasDerivedBalance() => $_has(5);
  @$pb.TagNumber(6)
  void clearDerivedBalance() => $_clearField(6);

  @$pb.TagNumber(7)
  $core.double get driftAmount => $_getN(6);
  @$pb.TagNumber(7)
  set driftAmount($core.double value) => $_setDouble(6, value);
  @$pb.TagNumber(7)
  $core.bool hasDriftAmount() => $_has(6);
  @$pb.TagNumber(7)
  void clearDriftAmount() => $_clearField(7);
  ...
  @$pb.TagNumber(9)
  $core.String get derivedSource => $_getSZ(8);
  @$pb.TagNumber(9)
  set derivedSource($core.String value) => $_setString(8, value);
  @$pb.TagNumber(9)
  $core.bool hasDerivedSource() => $_has(8);
  @$pb.TagNumber(9)
  void clearDerivedSource() => $_clearField(9);
...
class AdminRunWalletReconciliationRequest extends $pb.GeneratedMessage {
  factory AdminRunWalletReconciliationRequest() => create();

  AdminRunWalletReconciliationRequest._();

  factory AdminRunWalletReconciliationRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminRunWalletReconciliationRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminRunWalletReconciliationRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminRunWalletReconciliationRequest clone() =>
      AdminRunWalletReconciliationRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminRunWalletReconciliationRequest copyWith(
          void Function(AdminRunWalletReconciliationRequest) updates) =>
      super.copyWith((message) =>
              updates(message as AdminRunWalletReconciliationRequest))
          as AdminRunWalletReconciliationRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminRunWalletReconciliationRequest create() =>
      AdminRunWalletReconciliationRequest._();
  @$core.override
  AdminRunWalletReconciliationRequest createEmptyInstance() => create();
  static $pb.PbList<AdminRunWalletReconciliationRequest> createRepeated() =>
      $pb.PbList<AdminRunWalletReconciliationRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminRunWalletReconciliationRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminRunWalletReconciliationRequest>(create);
  static AdminRunWalletReconciliationRequest? _defaultInstance;
}

class AdminRunWalletReconciliationResponse extends $pb.GeneratedMessage {
  factory AdminRunWalletReconciliationResponse({
    $core.int? rowsWritten,
    $core.String? message,
  }) {
    final result = create();
    if (rowsWritten != null) result.rowsWritten = rowsWritten;
    if (message != null) result.message = message;
    return result;
  }

  AdminRunWalletReconciliationResponse._();

  factory AdminRunWalletReconciliationResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminRunWalletReconciliationResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminRunWalletReconciliationResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..a<$core.int>(1, _omitFieldNames ? '' : 'rowsWritten', $pb.PbFieldType.O3)
    ..aOS(2, _omitFieldNames ? '' : 'message')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminRunWalletReconciliationResponse clone() =>
      AdminRunWalletReconciliationResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminRunWalletReconciliationResponse copyWith(
          void Function(AdminRunWalletReconciliationResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminRunWalletReconciliationResponse))
          as AdminRunWalletReconciliationResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminRunWalletReconciliationResponse create() =>
      AdminRunWalletReconciliationResponse._();
  @$core.override
  AdminRunWalletReconciliationResponse createEmptyInstance() => create();
  static $pb.PbList<AdminRunWalletReconciliationResponse> createRepeated() =>
      $pb.PbList<AdminRunWalletReconciliationResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminRunWalletReconciliationResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminRunWalletReconciliationResponse>(create);
  static AdminRunWalletReconciliationResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get rowsWritten => $_getIZ(0);
  @$pb.TagNumber(1)
  set rowsWritten($core.int value) => $_setSignedInt32(0, value);
  @$pb.TagNumber(1)
  $core.bool hasRowsWritten() => $_has(0);
  @$pb.TagNumber(1)
  void clearRowsWritten() => $_clearField(1);
...
class AdminGetRevenueBalanceSnapshotsRequest extends $pb.GeneratedMessage {
  factory AdminGetRevenueBalanceSnapshotsRequest({
    $core.String? currency,
    $core.int? days,
  }) {
    final result = create();
  ...
  AdminGetRevenueBalanceSnapshotsRequest._();

  factory AdminGetRevenueBalanceSnapshotsRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminGetRevenueBalanceSnapshotsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminGetRevenueBalanceSnapshotsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'currency')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetRevenueBalanceSnapshotsRequest clone() =>
      AdminGetRevenueBalanceSnapshotsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetRevenueBalanceSnapshotsRequest copyWith(
          void Function(AdminGetRevenueBalanceSnapshotsRequest) updates) =>
      super.copyWith((message) =>
              updates(message as AdminGetRevenueBalanceSnapshotsRequest))
          as AdminGetRevenueBalanceSnapshotsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminGetRevenueBalanceSnapshotsRequest create() =>
      AdminGetRevenueBalanceSnapshotsRequest._();
  @$core.override
  AdminGetRevenueBalanceSnapshotsRequest createEmptyInstance() => create();
  static $pb.PbList<AdminGetRevenueBalanceSnapshotsRequest> createRepeated() =>
      $pb.PbList<AdminGetRevenueBalanceSnapshotsRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminGetRevenueBalanceSnapshotsRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminGetRevenueBalanceSnapshotsRequest>(create);
  static AdminGetRevenueBalanceSnapshotsRequest? _defaultInstance;
...
class AdminGetRevenueBalanceSnapshotsResponse extends $pb.GeneratedMessage {
  factory AdminGetRevenueBalanceSnapshotsResponse({
    $core.Iterable<RevenueSnapshotSeries>? series,
  }) {
    final result = create();
  ...
  AdminGetRevenueBalanceSnapshotsResponse._();

  factory AdminGetRevenueBalanceSnapshotsResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminGetRevenueBalanceSnapshotsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminGetRevenueBalanceSnapshotsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..pc<RevenueSnapshotSeries>(
        1, _omitFieldNames ? '' : 'series', $pb.PbFieldType.PM,
        subBuilder: RevenueSnapshotSeries.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetRevenueBalanceSnapshotsResponse clone() =>
      AdminGetRevenueBalanceSnapshotsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetRevenueBalanceSnapshotsResponse copyWith(
          void Function(AdminGetRevenueBalanceSnapshotsResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminGetRevenueBalanceSnapshotsResponse))
          as AdminGetRevenueBalanceSnapshotsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminGetRevenueBalanceSnapshotsResponse create() =>
      AdminGetRevenueBalanceSnapshotsResponse._();
  @$core.override
  AdminGetRevenueBalanceSnapshotsResponse createEmptyInstance() => create();
  static $pb.PbList<AdminGetRevenueBalanceSnapshotsResponse> createRepeated() =>
      $pb.PbList<AdminGetRevenueBalanceSnapshotsResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminGetRevenueBalanceSnapshotsResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminGetRevenueBalanceSnapshotsResponse>(create);
  static AdminGetRevenueBalanceSnapshotsResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<RevenueSnapshotSeries> get series => $_getList(0);
}

class RevenueSnapshotSeries extends $pb.GeneratedMessage {
  factory RevenueSnapshotSeries({
    $core.String? currency,
    $core.Iterable<RevenueSnapshotPoint>? points,
    $core.double? currentBalance,
    $core.double? windowStartBalance,
    $core.double? windowGrowthPct,
  }) {
    final result = create();
    if (currency != null) result.currency = currency;
    if (points != null) result.points.addAll(points);
    if (currentBalance != null) result.currentBalance = currentBalance;
    if (windowStartBalance != null)
      result.windowStartBalance = windowStartBalance;
    if (windowGrowthPct != null) result.windowGrowthPct = windowGrowthPct;
    return result;
  }

  RevenueSnapshotSeries._();

  factory RevenueSnapshotSeries.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RevenueSnapshotSeries.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RevenueSnapshotSeries',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'currency')
    ..pc<RevenueSnapshotPoint>(
        2, _omitFieldNames ? '' : 'points', $pb.PbFieldType.PM,
        subBuilder: RevenueSnapshotPoint.create)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'currentBalance', $pb.PbFieldType.OD)
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'windowStartBalance', $pb.PbFieldType.OD)
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'windowGrowthPct', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RevenueSnapshotSeries clone() =>
      RevenueSnapshotSeries()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RevenueSnapshotSeries copyWith(
          void Function(RevenueSnapshotSeries) updates) =>
      super.copyWith((message) => updates(message as RevenueSnapshotSeries))
          as RevenueSnapshotSeries;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RevenueSnapshotSeries create() => RevenueSnapshotSeries._();
  @$core.override
  RevenueSnapshotSeries createEmptyInstance() => create();
  static $pb.PbList<RevenueSnapshotSeries> createRepeated() =>
      $pb.PbList<RevenueSnapshotSeries>();
  @$core.pragma('dart2js:noInline')
  static RevenueSnapshotSeries getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RevenueSnapshotSeries>(create);
  static RevenueSnapshotSeries? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $pb.PbList<RevenueSnapshotPoint> get points => $_getList(1);
  ...
  @$pb.TagNumber(4)
  $core.double get windowStartBalance => $_getN(3);
  @$pb.TagNumber(4)
  set windowStartBalance($core.double value) => $_setDouble(3, value);
  @$pb.TagNumber(4)
  $core.bool hasWindowStartBalance() => $_has(3);
  @$pb.TagNumber(4)
  void clearWindowStartBalance() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.double get windowGrowthPct => $_getN(4);
  @$pb.TagNumber(5)
  set windowGrowthPct($core.double value) => $_setDouble(4, value);
  @$pb.TagNumber(5)
  $core.bool hasWindowGrowthPct() => $_has(4);
  @$pb.TagNumber(5)
  void clearWindowGrowthPct() => $_clearField(5);
}

class RevenueSnapshotPoint extends $pb.GeneratedMessage {
  factory RevenueSnapshotPoint({
  ...
  RevenueSnapshotPoint._();

  factory RevenueSnapshotPoint.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RevenueSnapshotPoint.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RevenueSnapshotPoint',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'snapshotAt')
    ..a<$core.double>(2, _omitFieldNames ? '' : 'balance', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RevenueSnapshotPoint clone() =>
      RevenueSnapshotPoint()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RevenueSnapshotPoint copyWith(void Function(RevenueSnapshotPoint) updates) =>
      super.copyWith((message) => updates(message as RevenueSnapshotPoint))
          as RevenueSnapshotPoint;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RevenueSnapshotPoint create() => RevenueSnapshotPoint._();
  @$core.override
  RevenueSnapshotPoint createEmptyInstance() => create();
  static $pb.PbList<RevenueSnapshotPoint> createRepeated() =>
      $pb.PbList<RevenueSnapshotPoint>();
  @$core.pragma('dart2js:noInline')
  static RevenueSnapshotPoint getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<RevenueSnapshotPoint>(create);
  static RevenueSnapshotPoint? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get snapshotAt => $_getSZ(0);
  @$pb.TagNumber(1)
  set snapshotAt($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
...
class AdminListOpsAlertsRequest extends $pb.GeneratedMessage {
  factory AdminListOpsAlertsRequest({
    $core.String? status,
    $core.String? source,
    $core.String? dedupKey,
    $core.int? limit,
    $core.int? offset,
  }) {
    final result = create();
    ...
    if (dedupKey != null) result.dedupKey = dedupKey;
    if (limit != null) result.limit = limit;
    if (offset != null) result.offset = offset;
    return result;
  }

  AdminListOpsAlertsRequest._();

  factory AdminListOpsAlertsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminListOpsAlertsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminListOpsAlertsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'status')
    ..aOS(2, _omitFieldNames ? '' : 'source')
    ..aOS(3, _omitFieldNames ? '' : 'dedupKey')
    ..a<$core.int>(4, _omitFieldNames ? '' : 'limit', $pb.PbFieldType.O3)
    ..a<$core.int>(5, _omitFieldNames ? '' : 'offset', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListOpsAlertsRequest clone() =>
      AdminListOpsAlertsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListOpsAlertsRequest copyWith(
          void Function(AdminListOpsAlertsRequest) updates) =>
      super.copyWith((message) => updates(message as AdminListOpsAlertsRequest))
          as AdminListOpsAlertsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminListOpsAlertsRequest create() => AdminListOpsAlertsRequest._();
  @$core.override
  AdminListOpsAlertsRequest createEmptyInstance() => create();
  static $pb.PbList<AdminListOpsAlertsRequest> createRepeated() =>
      $pb.PbList<AdminListOpsAlertsRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminListOpsAlertsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminListOpsAlertsRequest>(create);
  static AdminListOpsAlertsRequest? _defaultInstance;

  /// Filters — empty means "any".
  @$pb.TagNumber(1)
  $core.String get status => $_getSZ(0);
  @$pb.TagNumber(1)
  set status($core.String value) => $_setString(0, value);
  ...
  @$pb.TagNumber(3)
  $core.String get dedupKey => $_getSZ(2);
  @$pb.TagNumber(3)
  set dedupKey($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasDedupKey() => $_has(2);
  @$pb.TagNumber(3)
  void clearDedupKey() => $_clearField(3);
...
class AdminListOpsAlertsResponse extends $pb.GeneratedMessage {
  factory AdminListOpsAlertsResponse({
    $core.Iterable<OpsAlertRow>? rows,
    $core.int? total,
  }) {
    final result = create();
    if (rows != null) result.rows.addAll(rows);
  ...
  AdminListOpsAlertsResponse._();

  factory AdminListOpsAlertsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminListOpsAlertsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminListOpsAlertsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..pc<OpsAlertRow>(1, _omitFieldNames ? '' : 'rows', $pb.PbFieldType.PM,
        subBuilder: OpsAlertRow.create)
    ..a<$core.int>(2, _omitFieldNames ? '' : 'total', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListOpsAlertsResponse clone() =>
      AdminListOpsAlertsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListOpsAlertsResponse copyWith(
          void Function(AdminListOpsAlertsResponse) updates) =>
      super.copyWith(
              (message) => updates(message as AdminListOpsAlertsResponse))
          as AdminListOpsAlertsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminListOpsAlertsResponse create() => AdminListOpsAlertsResponse._();
  @$core.override
  AdminListOpsAlertsResponse createEmptyInstance() => create();
  static $pb.PbList<AdminListOpsAlertsResponse> createRepeated() =>
      $pb.PbList<AdminListOpsAlertsResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminListOpsAlertsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminListOpsAlertsResponse>(create);
  static AdminListOpsAlertsResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<OpsAlertRow> get rows => $_getList(0);
...
class OpsAlertRow extends $pb.GeneratedMessage {
  factory OpsAlertRow({
    $core.String? id,
    $core.String? dedupKey,
    ...
    $core.String? idempotencyKey,
    $core.String? createdAt,
    $core.String? acknowledgedAt,
    $core.String? acknowledgedBy,
    $core.String? silencedUntil,
  }) {
    final result = create();
    if (id != null) result.id = id;
    if (dedupKey != null) result.dedupKey = dedupKey;
    ...
    if (silencedUntil != null) result.silencedUntil = silencedUntil;
    return result;
  }

  OpsAlertRow._();

  factory OpsAlertRow.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory OpsAlertRow.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OpsAlertRow',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'dedupKey')
    ...
    ..aOS(9, _omitFieldNames ? '' : 'createdAt')
    ..aOS(10, _omitFieldNames ? '' : 'acknowledgedAt')
    ..aOS(11, _omitFieldNames ? '' : 'acknowledgedBy')
    ..aOS(12, _omitFieldNames ? '' : 'silencedUntil')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OpsAlertRow clone() => OpsAlertRow()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OpsAlertRow copyWith(void Function(OpsAlertRow) updates) =>
      super.copyWith((message) => updates(message as OpsAlertRow))
          as OpsAlertRow;
  ...
  @$core.pragma('dart2js:noInline')
  static OpsAlertRow create() => OpsAlertRow._();
  @$core.override
  OpsAlertRow createEmptyInstance() => create();
  static $pb.PbList<OpsAlertRow> createRepeated() => $pb.PbList<OpsAlertRow>();
  @$core.pragma('dart2js:noInline')
  static OpsAlertRow getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OpsAlertRow>(create);
  static OpsAlertRow? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.String get dedupKey => $_getSZ(1);
  @$pb.TagNumber(2)
  set dedupKey($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasDedupKey() => $_has(1);
  @$pb.TagNumber(2)
  void clearDedupKey() => $_clearField(2);
  ...
  /// Slice 10h
  @$pb.TagNumber(10)
  $core.String get acknowledgedAt => $_getSZ(9);
  @$pb.TagNumber(10)
  set acknowledgedAt($core.String value) => $_setString(9, value);
  @$pb.TagNumber(10)
  $core.bool hasAcknowledgedAt() => $_has(9);
  @$pb.TagNumber(10)
  void clearAcknowledgedAt() => $_clearField(10);

  @$pb.TagNumber(11)
  $core.String get acknowledgedBy => $_getSZ(10);
  @$pb.TagNumber(11)
  set acknowledgedBy($core.String value) => $_setString(10, value);
  @$pb.TagNumber(11)
  $core.bool hasAcknowledgedBy() => $_has(10);
  @$pb.TagNumber(11)
  void clearAcknowledgedBy() => $_clearField(11);

  @$pb.TagNumber(12)
  $core.String get silencedUntil => $_getSZ(11);
  @$pb.TagNumber(12)
  set silencedUntil($core.String value) => $_setString(11, value);
  @$pb.TagNumber(12)
  $core.bool hasSilencedUntil() => $_has(11);
  @$pb.TagNumber(12)
  void clearSilencedUntil() => $_clearField(12);
}

class AdminAckOpsAlertRequest extends $pb.GeneratedMessage {
  factory AdminAckOpsAlertRequest({
    $core.String? id,
  }) {
    final result = create();
    if (id != null) result.id = id;
  ...
  AdminAckOpsAlertRequest._();

  factory AdminAckOpsAlertRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminAckOpsAlertRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminAckOpsAlertRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminAckOpsAlertRequest clone() =>
      AdminAckOpsAlertRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminAckOpsAlertRequest copyWith(
          void Function(AdminAckOpsAlertRequest) updates) =>
      super.copyWith((message) => updates(message as AdminAckOpsAlertRequest))
          as AdminAckOpsAlertRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminAckOpsAlertRequest create() => AdminAckOpsAlertRequest._();
  @$core.override
  AdminAckOpsAlertRequest createEmptyInstance() => create();
  static $pb.PbList<AdminAckOpsAlertRequest> createRepeated() =>
      $pb.PbList<AdminAckOpsAlertRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminAckOpsAlertRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminAckOpsAlertRequest>(create);
  static AdminAckOpsAlertRequest? _defaultInstance;
...
class AdminAckOpsAlertResponse extends $pb.GeneratedMessage {
  factory AdminAckOpsAlertResponse({
    $core.bool? ok,
    $core.String? acknowledgedAt,
  }) {
    final result = create();
  ...
  AdminAckOpsAlertResponse._();

  factory AdminAckOpsAlertResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminAckOpsAlertResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminAckOpsAlertResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'ok')
    ..aOS(2, _omitFieldNames ? '' : 'acknowledgedAt')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminAckOpsAlertResponse clone() =>
      AdminAckOpsAlertResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminAckOpsAlertResponse copyWith(
          void Function(AdminAckOpsAlertResponse) updates) =>
      super.copyWith((message) => updates(message as AdminAckOpsAlertResponse))
          as AdminAckOpsAlertResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminAckOpsAlertResponse create() => AdminAckOpsAlertResponse._();
  @$core.override
  AdminAckOpsAlertResponse createEmptyInstance() => create();
  static $pb.PbList<AdminAckOpsAlertResponse> createRepeated() =>
      $pb.PbList<AdminAckOpsAlertResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminAckOpsAlertResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminAckOpsAlertResponse>(create);
  static AdminAckOpsAlertResponse? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.String get acknowledgedAt => $_getSZ(1);
  @$pb.TagNumber(2)
  set acknowledgedAt($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasAcknowledgedAt() => $_has(1);
  @$pb.TagNumber(2)
  void clearAcknowledgedAt() => $_clearField(2);
}

class AdminSilenceOpsAlertRequest extends $pb.GeneratedMessage {
  factory AdminSilenceOpsAlertRequest({
    $core.String? dedupKey,
  ...
  AdminSilenceOpsAlertRequest._();

  factory AdminSilenceOpsAlertRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminSilenceOpsAlertRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminSilenceOpsAlertRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'dedupKey')
    ..a<$core.int>(
        2, _omitFieldNames ? '' : 'durationMinutes', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminSilenceOpsAlertRequest clone() =>
      AdminSilenceOpsAlertRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminSilenceOpsAlertRequest copyWith(
          void Function(AdminSilenceOpsAlertRequest) updates) =>
      super.copyWith(
              (message) => updates(message as AdminSilenceOpsAlertRequest))
          as AdminSilenceOpsAlertRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminSilenceOpsAlertRequest create() =>
      AdminSilenceOpsAlertRequest._();
  @$core.override
  AdminSilenceOpsAlertRequest createEmptyInstance() => create();
  static $pb.PbList<AdminSilenceOpsAlertRequest> createRepeated() =>
      $pb.PbList<AdminSilenceOpsAlertRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminSilenceOpsAlertRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminSilenceOpsAlertRequest>(create);
  static AdminSilenceOpsAlertRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get dedupKey => $_getSZ(0);
  @$pb.TagNumber(1)
  set dedupKey($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasDedupKey() => $_has(0);
  @$pb.TagNumber(1)
  void clearDedupKey() => $_clearField(1);
...
class AdminSilenceOpsAlertResponse extends $pb.GeneratedMessage {
  factory AdminSilenceOpsAlertResponse({
    $core.bool? ok,
    $core.String? silencedUntil,
    $core.int? rowsAffected,
  }) {
    final result = create();
    if (ok != null) result.ok = ok;
    if (silencedUntil != null) result.silencedUntil = silencedUntil;
  ...
  AdminSilenceOpsAlertResponse._();

  factory AdminSilenceOpsAlertResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminSilenceOpsAlertResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminSilenceOpsAlertResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'ok')
    ..aOS(2, _omitFieldNames ? '' : 'silencedUntil')
    ..a<$core.int>(3, _omitFieldNames ? '' : 'rowsAffected', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminSilenceOpsAlertResponse clone() =>
      AdminSilenceOpsAlertResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminSilenceOpsAlertResponse copyWith(
          void Function(AdminSilenceOpsAlertResponse) updates) =>
      super.copyWith(
              (message) => updates(message as AdminSilenceOpsAlertResponse))
          as AdminSilenceOpsAlertResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminSilenceOpsAlertResponse create() =>
      AdminSilenceOpsAlertResponse._();
  @$core.override
  AdminSilenceOpsAlertResponse createEmptyInstance() => create();
  static $pb.PbList<AdminSilenceOpsAlertResponse> createRepeated() =>
      $pb.PbList<AdminSilenceOpsAlertResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminSilenceOpsAlertResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminSilenceOpsAlertResponse>(create);
  static AdminSilenceOpsAlertResponse? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.String get silencedUntil => $_getSZ(1);
  @$pb.TagNumber(2)
  set silencedUntil($core.String value) => $_setString(1, value);
  @$pb.TagNumber(2)
  $core.bool hasSilencedUntil() => $_has(1);
  @$pb.TagNumber(2)
  void clearSilencedUntil() => $_clearField(2);

  @$pb.TagNumber(3)
  $core.int get rowsAffected => $_getIZ(2);
  @$pb.TagNumber(3)
  set rowsAffected($core.int value) => $_setSignedInt32(2, value);
  @$pb.TagNumber(3)
...
class AdminUnsilenceOpsAlertRequest extends $pb.GeneratedMessage {
  factory AdminUnsilenceOpsAlertRequest({
    $core.String? dedupKey,
  }) {
    final result = create();
    if (dedupKey != null) result.dedupKey = dedupKey;
  ...
  AdminUnsilenceOpsAlertRequest._();

  factory AdminUnsilenceOpsAlertRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminUnsilenceOpsAlertRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminUnsilenceOpsAlertRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'dedupKey')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUnsilenceOpsAlertRequest clone() =>
      AdminUnsilenceOpsAlertRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUnsilenceOpsAlertRequest copyWith(
          void Function(AdminUnsilenceOpsAlertRequest) updates) =>
      super.copyWith(
              (message) => updates(message as AdminUnsilenceOpsAlertRequest))
          as AdminUnsilenceOpsAlertRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminUnsilenceOpsAlertRequest create() =>
      AdminUnsilenceOpsAlertRequest._();
  @$core.override
  AdminUnsilenceOpsAlertRequest createEmptyInstance() => create();
  static $pb.PbList<AdminUnsilenceOpsAlertRequest> createRepeated() =>
      $pb.PbList<AdminUnsilenceOpsAlertRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminUnsilenceOpsAlertRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminUnsilenceOpsAlertRequest>(create);
  static AdminUnsilenceOpsAlertRequest? _defaultInstance;
...
class AdminUnsilenceOpsAlertResponse extends $pb.GeneratedMessage {
  factory AdminUnsilenceOpsAlertResponse({
    $core.bool? ok,
    $core.int? rowsAffected,
  }) {
    final result = create();
  ...
  AdminUnsilenceOpsAlertResponse._();

  factory AdminUnsilenceOpsAlertResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminUnsilenceOpsAlertResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminUnsilenceOpsAlertResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'ok')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'rowsAffected', $pb.PbFieldType.O3)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUnsilenceOpsAlertResponse clone() =>
      AdminUnsilenceOpsAlertResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUnsilenceOpsAlertResponse copyWith(
          void Function(AdminUnsilenceOpsAlertResponse) updates) =>
      super.copyWith(
              (message) => updates(message as AdminUnsilenceOpsAlertResponse))
          as AdminUnsilenceOpsAlertResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminUnsilenceOpsAlertResponse create() =>
      AdminUnsilenceOpsAlertResponse._();
  @$core.override
  AdminUnsilenceOpsAlertResponse createEmptyInstance() => create();
  static $pb.PbList<AdminUnsilenceOpsAlertResponse> createRepeated() =>
      $pb.PbList<AdminUnsilenceOpsAlertResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminUnsilenceOpsAlertResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminUnsilenceOpsAlertResponse>(create);
  static AdminUnsilenceOpsAlertResponse? _defaultInstance;
  ...
  @$pb.TagNumber(2)
  $core.int get rowsAffected => $_getIZ(1);
  @$pb.TagNumber(2)
  set rowsAffected($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  $core.bool hasRowsAffected() => $_has(1);
  @$pb.TagNumber(2)
  void clearRowsAffected() => $_clearField(2);
}

class AdminGetOpsAlertRequest extends $pb.GeneratedMessage {
  factory AdminGetOpsAlertRequest({
    $core.String? id,
  }) {
    final result = create();
    if (id != null) result.id = id;
  ...
  AdminGetOpsAlertRequest._();

  factory AdminGetOpsAlertRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminGetOpsAlertRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminGetOpsAlertRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetOpsAlertRequest clone() =>
      AdminGetOpsAlertRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetOpsAlertRequest copyWith(
          void Function(AdminGetOpsAlertRequest) updates) =>
      super.copyWith((message) => updates(message as AdminGetOpsAlertRequest))
          as AdminGetOpsAlertRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminGetOpsAlertRequest create() => AdminGetOpsAlertRequest._();
  @$core.override
  AdminGetOpsAlertRequest createEmptyInstance() => create();
  static $pb.PbList<AdminGetOpsAlertRequest> createRepeated() =>
      $pb.PbList<AdminGetOpsAlertRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminGetOpsAlertRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminGetOpsAlertRequest>(create);
  static AdminGetOpsAlertRequest? _defaultInstance;
...
/// OpsAlertDetail is OpsAlertRow + body_html. Slice 10j keeps the
/// list payload light by stripping body_html from the list shape;
/// detail-page fetches use this richer message.
class OpsAlertDetail extends $pb.GeneratedMessage {
  factory OpsAlertDetail({
    $core.String? id,
    $core.String? dedupKey,
    $core.String? recipient,
    $core.String? subject,
  ...
  factory OpsAlertDetail.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory OpsAlertDetail.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'OpsAlertDetail',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'dedupKey')
    ...
    ..aOS(11, _omitFieldNames ? '' : 'acknowledgedBy')
    ..aOS(12, _omitFieldNames ? '' : 'silencedUntil')
    ..aOS(13, _omitFieldNames ? '' : 'bodyHtml')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OpsAlertDetail clone() => OpsAlertDetail()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  OpsAlertDetail copyWith(void Function(OpsAlertDetail) updates) =>
      super.copyWith((message) => updates(message as OpsAlertDetail))
          as OpsAlertDetail;
  ...
  @$core.pragma('dart2js:noInline')
  static OpsAlertDetail create() => OpsAlertDetail._();
  @$core.override
  OpsAlertDetail createEmptyInstance() => create();
  static $pb.PbList<OpsAlertDetail> createRepeated() =>
      $pb.PbList<OpsAlertDetail>();
  @$core.pragma('dart2js:noInline')
  static OpsAlertDetail getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<OpsAlertDetail>(create);
  static OpsAlertDetail? _defaultInstance;
  ...
  @$pb.TagNumber(13)
  $core.String get bodyHtml => $_getSZ(12);
  @$pb.TagNumber(13)
  set bodyHtml($core.String value) => $_setString(12, value);
  @$pb.TagNumber(13)
  $core.bool hasBodyHtml() => $_has(12);
  @$pb.TagNumber(13)
  void clearBodyHtml() => $_clearField(13);
}

class AdminListSupportedLocalesRequest extends $pb.GeneratedMessage {
  factory AdminListSupportedLocalesRequest() => create();

  AdminListSupportedLocalesRequest._();

  factory AdminListSupportedLocalesRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminListSupportedLocalesRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminListSupportedLocalesRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListSupportedLocalesRequest clone() =>
      AdminListSupportedLocalesRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListSupportedLocalesRequest copyWith(
          void Function(AdminListSupportedLocalesRequest) updates) =>
      super.copyWith(
              (message) => updates(message as AdminListSupportedLocalesRequest))
          as AdminListSupportedLocalesRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminListSupportedLocalesRequest create() =>
      AdminListSupportedLocalesRequest._();
  @$core.override
  AdminListSupportedLocalesRequest createEmptyInstance() => create();
  static $pb.PbList<AdminListSupportedLocalesRequest> createRepeated() =>
      $pb.PbList<AdminListSupportedLocalesRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminListSupportedLocalesRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminListSupportedLocalesRequest>(
          create);
  static AdminListSupportedLocalesRequest? _defaultInstance;
}

/// PlatformLocale mirrors one row of Flutter's CountryLocales.all.
/// The admin dashboard renders these with the country flag derived
/// client-side, then sends `locale` back on i18n upsert RPCs.
/// Named "Platform" prefix to avoid colliding with the
/// SupportedLocale message in multi_country.proto.
class PlatformLocale extends $pb.GeneratedMessage {
  factory PlatformLocale({
    $core.String? locale,
    $core.String? country,
    $core.String? currency,
  ...
  factory PlatformLocale.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PlatformLocale.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PlatformLocale',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PlatformLocale clone() => PlatformLocale()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PlatformLocale copyWith(void Function(PlatformLocale) updates) =>
      super.copyWith((message) => updates(message as PlatformLocale))
          as PlatformLocale;
  ...
  @$core.pragma('dart2js:noInline')
  static PlatformLocale create() => PlatformLocale._();
  @$core.override
  PlatformLocale createEmptyInstance() => create();
  static $pb.PbList<PlatformLocale> createRepeated() =>
      $pb.PbList<PlatformLocale>();
  @$core.pragma('dart2js:noInline')
  static PlatformLocale getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PlatformLocale>(create);
  static PlatformLocale? _defaultInstance;
...
class AdminListSupportedLocalesResponse extends $pb.GeneratedMessage {
  factory AdminListSupportedLocalesResponse({
    $core.Iterable<$core.String>? locales,
    $core.String? defaultLocale,
    $core.Iterable<PlatformLocale>? supported,
  }) {
    final result = create();
  ...
  AdminListSupportedLocalesResponse._();

  factory AdminListSupportedLocalesResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminListSupportedLocalesResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminListSupportedLocalesResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..pPS(1, _omitFieldNames ? '' : 'locales')
    ..aOS(2, _omitFieldNames ? '' : 'defaultLocale')
    ..pc<PlatformLocale>(
        3, _omitFieldNames ? '' : 'supported', $pb.PbFieldType.PM,
        subBuilder: PlatformLocale.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListSupportedLocalesResponse clone() =>
      AdminListSupportedLocalesResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminListSupportedLocalesResponse copyWith(
          void Function(AdminListSupportedLocalesResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminListSupportedLocalesResponse))
          as AdminListSupportedLocalesResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminListSupportedLocalesResponse create() =>
      AdminListSupportedLocalesResponse._();
  @$core.override
  AdminListSupportedLocalesResponse createEmptyInstance() => create();
  static $pb.PbList<AdminListSupportedLocalesResponse> createRepeated() =>
      $pb.PbList<AdminListSupportedLocalesResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminListSupportedLocalesResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminListSupportedLocalesResponse>(
          create);
  static AdminListSupportedLocalesResponse? _defaultInstance;

  /// Flat BCP-47 tag list. Kept for callers that only need names.
  @$pb.TagNumber(1)
  $pb.PbList<$core.String> get locales => $_getList(0);
  ...
  /// Structured rows with country + currency. Source of truth for
  /// the admin locale dropdown so it can show flags and the
  /// currency next to each option.
  @$pb.TagNumber(3)
  $pb.PbList<PlatformLocale> get supported => $_getList(2);
}

class PiggyVaultConfigLocaleStrings extends $pb.GeneratedMessage {
  factory PiggyVaultConfigLocaleStrings({
    $core.String? displayName,
    $core.String? description,
    $core.String? confirmationNotes,
    $core.String? confirmationNotesRenewOn,
  ...
  PiggyVaultConfigLocaleStrings._();

  factory PiggyVaultConfigLocaleStrings.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory PiggyVaultConfigLocaleStrings.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PiggyVaultConfigLocaleStrings',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'displayName')
    ..aOS(2, _omitFieldNames ? '' : 'description')
    ..aOS(3, _omitFieldNames ? '' : 'confirmationNotes')
    ..aOS(4, _omitFieldNames ? '' : 'confirmationNotesRenewOn')
    ..aOS(5, _omitFieldNames ? '' : 'confirmationNotesRenewOff')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PiggyVaultConfigLocaleStrings clone() =>
      PiggyVaultConfigLocaleStrings()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  PiggyVaultConfigLocaleStrings copyWith(
          void Function(PiggyVaultConfigLocaleStrings) updates) =>
      super.copyWith(
              (message) => updates(message as PiggyVaultConfigLocaleStrings))
          as PiggyVaultConfigLocaleStrings;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static PiggyVaultConfigLocaleStrings create() =>
      PiggyVaultConfigLocaleStrings._();
  @$core.override
  PiggyVaultConfigLocaleStrings createEmptyInstance() => create();
  static $pb.PbList<PiggyVaultConfigLocaleStrings> createRepeated() =>
      $pb.PbList<PiggyVaultConfigLocaleStrings>();
  @$core.pragma('dart2js:noInline')
  static PiggyVaultConfigLocaleStrings getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PiggyVaultConfigLocaleStrings>(create);
  static PiggyVaultConfigLocaleStrings? _defaultInstance;
  ...
  @$pb.TagNumber(3)
  $core.String get confirmationNotes => $_getSZ(2);
  @$pb.TagNumber(3)
  set confirmationNotes($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasConfirmationNotes() => $_has(2);
  @$pb.TagNumber(3)
  void clearConfirmationNotes() => $_clearField(3);

  @$pb.TagNumber(4)
  $core.String get confirmationNotesRenewOn => $_getSZ(3);
  @$pb.TagNumber(4)
  set confirmationNotesRenewOn($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasConfirmationNotesRenewOn() => $_has(3);
  @$pb.TagNumber(4)
  void clearConfirmationNotesRenewOn() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.String get confirmationNotesRenewOff => $_getSZ(4);
  @$pb.TagNumber(5)
  set confirmationNotesRenewOff($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasConfirmationNotesRenewOff() => $_has(4);
  @$pb.TagNumber(5)
  void clearConfirmationNotesRenewOff() => $_clearField(5);
}

class AdminGetPiggyVaultConfigI18nRequest extends $pb.GeneratedMessage {
  factory AdminGetPiggyVaultConfigI18nRequest({
    $core.String? lockType,
    $core.String? currency,
  }) {
    final result = create();
  ...
  AdminGetPiggyVaultConfigI18nRequest._();

  factory AdminGetPiggyVaultConfigI18nRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminGetPiggyVaultConfigI18nRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminGetPiggyVaultConfigI18nRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'lockType')
    ..aOS(2, _omitFieldNames ? '' : 'currency')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetPiggyVaultConfigI18nRequest clone() =>
      AdminGetPiggyVaultConfigI18nRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetPiggyVaultConfigI18nRequest copyWith(
          void Function(AdminGetPiggyVaultConfigI18nRequest) updates) =>
      super.copyWith((message) =>
              updates(message as AdminGetPiggyVaultConfigI18nRequest))
          as AdminGetPiggyVaultConfigI18nRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminGetPiggyVaultConfigI18nRequest create() =>
      AdminGetPiggyVaultConfigI18nRequest._();
  @$core.override
  AdminGetPiggyVaultConfigI18nRequest createEmptyInstance() => create();
  static $pb.PbList<AdminGetPiggyVaultConfigI18nRequest> createRepeated() =>
      $pb.PbList<AdminGetPiggyVaultConfigI18nRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminGetPiggyVaultConfigI18nRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminGetPiggyVaultConfigI18nRequest>(create);
  static AdminGetPiggyVaultConfigI18nRequest? _defaultInstance;
...
class AdminGetPiggyVaultConfigI18nResponse extends $pb.GeneratedMessage {
  factory AdminGetPiggyVaultConfigI18nResponse({
    $core.Iterable<$core.MapEntry<$core.String, PiggyVaultConfigLocaleStrings>>?
        bundles,
  }) {
    final result = create();
    if (bundles != null) result.bundles.addEntries(bundles);
    return result;
  }

  AdminGetPiggyVaultConfigI18nResponse._();

  factory AdminGetPiggyVaultConfigI18nResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminGetPiggyVaultConfigI18nResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminGetPiggyVaultConfigI18nResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..m<$core.String, PiggyVaultConfigLocaleStrings>(
        1, _omitFieldNames ? '' : 'bundles',
        entryClassName: 'AdminGetPiggyVaultConfigI18nResponse.BundlesEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OM,
        valueCreator: PiggyVaultConfigLocaleStrings.create,
        valueDefaultOrMaker: PiggyVaultConfigLocaleStrings.getDefault,
        packageName: const $pb.PackageName('accounts'))
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetPiggyVaultConfigI18nResponse clone() =>
      AdminGetPiggyVaultConfigI18nResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminGetPiggyVaultConfigI18nResponse copyWith(
          void Function(AdminGetPiggyVaultConfigI18nResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminGetPiggyVaultConfigI18nResponse))
          as AdminGetPiggyVaultConfigI18nResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminGetPiggyVaultConfigI18nResponse create() =>
      AdminGetPiggyVaultConfigI18nResponse._();
  @$core.override
  AdminGetPiggyVaultConfigI18nResponse createEmptyInstance() => create();
  static $pb.PbList<AdminGetPiggyVaultConfigI18nResponse> createRepeated() =>
      $pb.PbList<AdminGetPiggyVaultConfigI18nResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminGetPiggyVaultConfigI18nResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminGetPiggyVaultConfigI18nResponse>(create);
  static AdminGetPiggyVaultConfigI18nResponse? _defaultInstance;

  /// Map of locale -> localized strings. Missing locales have no
  /// overrides and fall back to the base columns.
  @$pb.TagNumber(1)
  $pb.PbMap<$core.String, PiggyVaultConfigLocaleStrings> get bundles =>
      $_getMap(0);
}

class AdminUpsertPiggyVaultConfigI18nRequest extends $pb.GeneratedMessage {
  factory AdminUpsertPiggyVaultConfigI18nRequest({
    $core.String? lockType,
    $core.String? locale,
    $core.String? currency,
    PiggyVaultConfigLocaleStrings? strings,
  }) {
    final result = create();
    if (lockType != null) result.lockType = lockType;
    if (locale != null) result.locale = locale;
  ...
  AdminUpsertPiggyVaultConfigI18nRequest._();

  factory AdminUpsertPiggyVaultConfigI18nRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminUpsertPiggyVaultConfigI18nRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminUpsertPiggyVaultConfigI18nRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'lockType')
    ..aOS(2, _omitFieldNames ? '' : 'locale')
    ..aOS(3, _omitFieldNames ? '' : 'currency')
    ..aOM<PiggyVaultConfigLocaleStrings>(4, _omitFieldNames ? '' : 'strings',
        subBuilder: PiggyVaultConfigLocaleStrings.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUpsertPiggyVaultConfigI18nRequest clone() =>
      AdminUpsertPiggyVaultConfigI18nRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUpsertPiggyVaultConfigI18nRequest copyWith(
          void Function(AdminUpsertPiggyVaultConfigI18nRequest) updates) =>
      super.copyWith((message) =>
              updates(message as AdminUpsertPiggyVaultConfigI18nRequest))
          as AdminUpsertPiggyVaultConfigI18nRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminUpsertPiggyVaultConfigI18nRequest create() =>
      AdminUpsertPiggyVaultConfigI18nRequest._();
  @$core.override
  AdminUpsertPiggyVaultConfigI18nRequest createEmptyInstance() => create();
  static $pb.PbList<AdminUpsertPiggyVaultConfigI18nRequest> createRepeated() =>
      $pb.PbList<AdminUpsertPiggyVaultConfigI18nRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminUpsertPiggyVaultConfigI18nRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminUpsertPiggyVaultConfigI18nRequest>(create);
  static AdminUpsertPiggyVaultConfigI18nRequest? _defaultInstance;
  ...
  @$pb.TagNumber(4)
  PiggyVaultConfigLocaleStrings get strings => $_getN(3);
  @$pb.TagNumber(4)
  set strings(PiggyVaultConfigLocaleStrings value) => $_setField(4, value);
  @$pb.TagNumber(4)
  $core.bool hasStrings() => $_has(3);
  @$pb.TagNumber(4)
  void clearStrings() => $_clearField(4);
  @$pb.TagNumber(4)
  PiggyVaultConfigLocaleStrings ensureStrings() => $_ensure(3);
}

class AdminUpsertPiggyVaultConfigI18nResponse extends $pb.GeneratedMessage {
  factory AdminUpsertPiggyVaultConfigI18nResponse({
    $core.bool? success,
    $core.String? message,
  }) {
    final result = create();
  ...
  AdminUpsertPiggyVaultConfigI18nResponse._();

  factory AdminUpsertPiggyVaultConfigI18nResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminUpsertPiggyVaultConfigI18nResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminUpsertPiggyVaultConfigI18nResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'success')
    ..aOS(2, _omitFieldNames ? '' : 'message')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUpsertPiggyVaultConfigI18nResponse clone() =>
      AdminUpsertPiggyVaultConfigI18nResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminUpsertPiggyVaultConfigI18nResponse copyWith(
          void Function(AdminUpsertPiggyVaultConfigI18nResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminUpsertPiggyVaultConfigI18nResponse))
          as AdminUpsertPiggyVaultConfigI18nResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminUpsertPiggyVaultConfigI18nResponse create() =>
      AdminUpsertPiggyVaultConfigI18nResponse._();
  @$core.override
  AdminUpsertPiggyVaultConfigI18nResponse createEmptyInstance() => create();
  static $pb.PbList<AdminUpsertPiggyVaultConfigI18nResponse> createRepeated() =>
      $pb.PbList<AdminUpsertPiggyVaultConfigI18nResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminUpsertPiggyVaultConfigI18nResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminUpsertPiggyVaultConfigI18nResponse>(create);
  static AdminUpsertPiggyVaultConfigI18nResponse? _defaultInstance;
...
class FCYAddress extends $pb.GeneratedMessage {
  factory FCYAddress({
    $core.String? state,
    $core.String? city,
    $core.String? street,
    $core.String? zip,
    $core.String? countryOfResidence,
    $core.String? number,
  }) {
    final result = create();
    ...
    if (countryOfResidence != null)
      result.countryOfResidence = countryOfResidence;
  ...
  factory FCYAddress.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FCYAddress.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FCYAddress',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'state')
    ..aOS(2, _omitFieldNames ? '' : 'city')
    ..aOS(3, _omitFieldNames ? '' : 'street')
    ..aOS(4, _omitFieldNames ? '' : 'zip')
    ..aOS(5, _omitFieldNames ? '' : 'countryOfResidence')
    ..aOS(6, _omitFieldNames ? '' : 'number')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FCYAddress clone() => FCYAddress()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FCYAddress copyWith(void Function(FCYAddress) updates) =>
      super.copyWith((message) => updates(message as FCYAddress)) as FCYAddress;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FCYAddress create() => FCYAddress._();
  @$core.override
  FCYAddress createEmptyInstance() => create();
  static $pb.PbList<FCYAddress> createRepeated() => $pb.PbList<FCYAddress>();
  @$core.pragma('dart2js:noInline')
  static FCYAddress getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FCYAddress>(create);
  static FCYAddress? _defaultInstance;
  ...
  @$pb.TagNumber(4)
  set zip($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasZip() => $_has(3);
  @$pb.TagNumber(4)
  void clearZip() => $_clearField(4);

  @$pb.TagNumber(5)
  $core.String get countryOfResidence => $_getSZ(4);
  @$pb.TagNumber(5)
  set countryOfResidence($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasCountryOfResidence() => $_has(4);
  @$pb.TagNumber(5)
  void clearCountryOfResidence() => $_clearField(5);

  @$pb.TagNumber(6)
  $core.String get number => $_getSZ(5);
  @$pb.TagNumber(6)
  set number($core.String value) => $_setString(5, value);
  @$pb.TagNumber(6)
  $core.bool hasNumber() => $_has(5);
  @$pb.TagNumber(6)
  void clearNumber() => $_clearField(6);
}

class FCYIdentityDocument extends $pb.GeneratedMessage {
  factory FCYIdentityDocument({
    $core.String? type,
    $core.String? number,
    $core.String? issuedCountryCode,
    $core.String? issuedBy,
    $core.String? issuedDate,
    $core.String? expirationDate,
  }) {
    final result = create();
    if (type != null) result.type = type;
    if (number != null) result.number = number;
    if (issuedCountryCode != null) result.issuedCountryCode = issuedCountryCode;
  ...
  FCYIdentityDocument._();

  factory FCYIdentityDocument.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory FCYIdentityDocument.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'FCYIdentityDocument',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'type')
    ..aOS(2, _omitFieldNames ? '' : 'number')
    ..aOS(3, _omitFieldNames ? '' : 'issuedCountryCode')
    ..aOS(4, _omitFieldNames ? '' : 'issuedBy')
    ..aOS(5, _omitFieldNames ? '' : 'issuedDate')
    ..aOS(6, _omitFieldNames ? '' : 'expirationDate')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FCYIdentityDocument clone() => FCYIdentityDocument()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  FCYIdentityDocument copyWith(void Function(FCYIdentityDocument) updates) =>
      super.copyWith((message) => updates(message as FCYIdentityDocument))
          as FCYIdentityDocument;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static FCYIdentityDocument create() => FCYIdentityDocument._();
  @$core.override
  FCYIdentityDocument createEmptyInstance() => create();
  static $pb.PbList<FCYIdentityDocument> createRepeated() =>
      $pb.PbList<FCYIdentityDocument>();
  @$core.pragma('dart2js:noInline')
  static FCYIdentityDocument getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<FCYIdentityDocument>(create);
  static FCYIdentityDocument? _defaultInstance;
  ...
  @$pb.TagNumber(3)
  $core.String get issuedCountryCode => $_getSZ(2);
  @$pb.TagNumber(3)
  set issuedCountryCode($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasIssuedCountryCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearIssuedCountryCode() => $_clearField(3);
  ...
  @$pb.TagNumber(5)
  $core.String get issuedDate => $_getSZ(4);
  @$pb.TagNumber(5)
  set issuedDate($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
...
class RequestForeignVirtualAccountRequest extends $pb.GeneratedMessage {
  factory RequestForeignVirtualAccountRequest({
    $core.String? currency,
    $core.Iterable<$core.String>? meansOfId,
    $core.String? utilityBill,
    $core.String? bankStatement,
    $core.String? firstName,
    $core.String? lastName,
    ...
    $core.String? employmentStatus,
    $core.String? sourceOfIncome,
    $core.String? accountDesignation,
    $core.String? incomeBandLower,
    $core.String? incomeBandUpper,
    $core.String? monthlyTransactionCount,
    $core.String? monthlyTransactionVolume,
    $core.String? taxCountry,
    $core.String? taxNumber,
    FCYIdentityDocument? document,
  }) {
    final result = create();
    if (currency != null) result.currency = currency;
    if (meansOfId != null) result.meansOfId.addAll(meansOfId);
    if (utilityBill != null) result.utilityBill = utilityBill;
    if (bankStatement != null) result.bankStatement = bankStatement;
    if (firstName != null) result.firstName = firstName;
    if (lastName != null) result.lastName = lastName;
    ...
    if (employmentStatus != null) result.employmentStatus = employmentStatus;
    if (sourceOfIncome != null) result.sourceOfIncome = sourceOfIncome;
    if (accountDesignation != null)
      result.accountDesignation = accountDesignation;
    if (incomeBandLower != null) result.incomeBandLower = incomeBandLower;
    if (incomeBandUpper != null) result.incomeBandUpper = incomeBandUpper;
    if (monthlyTransactionCount != null)
      result.monthlyTransactionCount = monthlyTransactionCount;
    if (monthlyTransactionVolume != null)
      result.monthlyTransactionVolume = monthlyTransactionVolume;
    if (taxCountry != null) result.taxCountry = taxCountry;
    if (taxNumber != null) result.taxNumber = taxNumber;
    if (document != null) result.document = document;
    return result;
  }

  RequestForeignVirtualAccountRequest._();

  factory RequestForeignVirtualAccountRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RequestForeignVirtualAccountRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RequestForeignVirtualAccountRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'currency')
    ..pPS(2, _omitFieldNames ? '' : 'meansOfId')
    ..aOS(3, _omitFieldNames ? '' : 'utilityBill')
    ..aOS(4, _omitFieldNames ? '' : 'bankStatement')
    ..aOS(5, _omitFieldNames ? '' : 'firstName')
    ..aOS(6, _omitFieldNames ? '' : 'lastName')
    ..aOS(7, _omitFieldNames ? '' : 'otherName')
    ..aOS(8, _omitFieldNames ? '' : 'email')
    ..aOS(9, _omitFieldNames ? '' : 'phone')
    ..aOS(10, _omitFieldNames ? '' : 'birthDate')
    ..aOS(11, _omitFieldNames ? '' : 'nationality')
    ..aOM<FCYAddress>(12, _omitFieldNames ? '' : 'address',
        subBuilder: FCYAddress.create)
    ..aOS(13, _omitFieldNames ? '' : 'occupation')
    ..aOS(14, _omitFieldNames ? '' : 'employmentStatus')
    ..aOS(15, _omitFieldNames ? '' : 'sourceOfIncome')
    ..aOS(16, _omitFieldNames ? '' : 'accountDesignation')
    ..aOS(17, _omitFieldNames ? '' : 'incomeBandLower')
    ..aOS(18, _omitFieldNames ? '' : 'incomeBandUpper')
    ..aOS(19, _omitFieldNames ? '' : 'monthlyTransactionCount')
    ..aOS(20, _omitFieldNames ? '' : 'monthlyTransactionVolume')
    ..aOS(21, _omitFieldNames ? '' : 'taxCountry')
    ..aOS(22, _omitFieldNames ? '' : 'taxNumber')
    ..aOM<FCYIdentityDocument>(23, _omitFieldNames ? '' : 'document',
        subBuilder: FCYIdentityDocument.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RequestForeignVirtualAccountRequest clone() =>
      RequestForeignVirtualAccountRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RequestForeignVirtualAccountRequest copyWith(
          void Function(RequestForeignVirtualAccountRequest) updates) =>
      super.copyWith((message) =>
              updates(message as RequestForeignVirtualAccountRequest))
          as RequestForeignVirtualAccountRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RequestForeignVirtualAccountRequest create() =>
      RequestForeignVirtualAccountRequest._();
  @$core.override
  RequestForeignVirtualAccountRequest createEmptyInstance() => create();
  static $pb.PbList<RequestForeignVirtualAccountRequest> createRepeated() =>
      $pb.PbList<RequestForeignVirtualAccountRequest>();
  @$core.pragma('dart2js:noInline')
  static RequestForeignVirtualAccountRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          RequestForeignVirtualAccountRequest>(create);
  static RequestForeignVirtualAccountRequest? _defaultInstance;
  ...
  /// Document URLs (uploaded to platform storage first).
  @$pb.TagNumber(2)
  $pb.PbList<$core.String> get meansOfId => $_getList(1);

  @$pb.TagNumber(3)
  $core.String get utilityBill => $_getSZ(2);
  @$pb.TagNumber(3)
  set utilityBill($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasUtilityBill() => $_has(2);
  @$pb.TagNumber(3)
  void clearUtilityBill() => $_clearField(3);

  @$pb.TagNumber(4)
  $core.String get bankStatement => $_getSZ(3);
  @$pb.TagNumber(4)
  set bankStatement($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasBankStatement() => $_has(3);
  @$pb.TagNumber(4)
  void clearBankStatement() => $_clearField(4);
  ...
  @$pb.TagNumber(7)
  $core.String get otherName => $_getSZ(6);
  @$pb.TagNumber(7)
  set otherName($core.String value) => $_setString(6, value);
  @$pb.TagNumber(7)
  $core.bool hasOtherName() => $_has(6);
  @$pb.TagNumber(7)
  void clearOtherName() => $_clearField(7);
  ...
  @$pb.TagNumber(11)
  set nationality($core.String value) => $_setString(10, value);
  @$pb.TagNumber(11)
  $core.bool hasNationality() => $_has(10);
  @$pb.TagNumber(11)
  void clearNationality() => $_clearField(11);

  @$pb.TagNumber(12)
  FCYAddress get address => $_getN(11);
  @$pb.TagNumber(12)
  set address(FCYAddress value) => $_setField(12, value);
  @$pb.TagNumber(12)
  $core.bool hasAddress() => $_has(11);
  @$pb.TagNumber(12)
  void clearAddress() => $_clearField(12);
  @$pb.TagNumber(12)
  FCYAddress ensureAddress() => $_ensure(11);

  /// Financial profile.
  @$pb.TagNumber(13)
  $core.String get occupation => $_getSZ(12);
  @$pb.TagNumber(13)
  set occupation($core.String value) => $_setString(12, value);
  @$pb.TagNumber(13)
  $core.bool hasOccupation() => $_has(12);
  @$pb.TagNumber(13)
  void clearOccupation() => $_clearField(13);

  @$pb.TagNumber(14)
  $core.String get employmentStatus => $_getSZ(13);
  @$pb.TagNumber(14)
  set employmentStatus($core.String value) => $_setString(13, value);
  @$pb.TagNumber(14)
  $core.bool hasEmploymentStatus() => $_has(13);
  @$pb.TagNumber(14)
  void clearEmploymentStatus() => $_clearField(14);

  @$pb.TagNumber(15)
  $core.String get sourceOfIncome => $_getSZ(14);
  @$pb.TagNumber(15)
  set sourceOfIncome($core.String value) => $_setString(14, value);
  @$pb.TagNumber(15)
  $core.bool hasSourceOfIncome() => $_has(14);
  @$pb.TagNumber(15)
  void clearSourceOfIncome() => $_clearField(15);

  @$pb.TagNumber(16)
  $core.String get accountDesignation => $_getSZ(15);
  @$pb.TagNumber(16)
  set accountDesignation($core.String value) => $_setString(15, value);
  @$pb.TagNumber(16)
  $core.bool hasAccountDesignation() => $_has(15);
  @$pb.TagNumber(16)
  void clearAccountDesignation() => $_clearField(16);

  @$pb.TagNumber(17)
  $core.String get incomeBandLower => $_getSZ(16);
  @$pb.TagNumber(17)
  set incomeBandLower($core.String value) => $_setString(16, value);
  @$pb.TagNumber(17)
  $core.bool hasIncomeBandLower() => $_has(16);
  @$pb.TagNumber(17)
  void clearIncomeBandLower() => $_clearField(17);

  @$pb.TagNumber(18)
  $core.String get incomeBandUpper => $_getSZ(17);
  @$pb.TagNumber(18)
  set incomeBandUpper($core.String value) => $_setString(17, value);
  @$pb.TagNumber(18)
  $core.bool hasIncomeBandUpper() => $_has(17);
  @$pb.TagNumber(18)
  void clearIncomeBandUpper() => $_clearField(18);

  @$pb.TagNumber(19)
  $core.String get monthlyTransactionCount => $_getSZ(18);
  @$pb.TagNumber(19)
  set monthlyTransactionCount($core.String value) => $_setString(18, value);
  @$pb.TagNumber(19)
  $core.bool hasMonthlyTransactionCount() => $_has(18);
  @$pb.TagNumber(19)
  void clearMonthlyTransactionCount() => $_clearField(19);

  @$pb.TagNumber(20)
  $core.String get monthlyTransactionVolume => $_getSZ(19);
  @$pb.TagNumber(20)
  set monthlyTransactionVolume($core.String value) => $_setString(19, value);
  @$pb.TagNumber(20)
  $core.bool hasMonthlyTransactionVolume() => $_has(19);
  @$pb.TagNumber(20)
  void clearMonthlyTransactionVolume() => $_clearField(20);

  @$pb.TagNumber(21)
  $core.String get taxCountry => $_getSZ(20);
  @$pb.TagNumber(21)
  set taxCountry($core.String value) => $_setString(20, value);
  @$pb.TagNumber(21)
  $core.bool hasTaxCountry() => $_has(20);
  @$pb.TagNumber(21)
  void clearTaxCountry() => $_clearField(21);

  @$pb.TagNumber(22)
  $core.String get taxNumber => $_getSZ(21);
  @$pb.TagNumber(22)
  set taxNumber($core.String value) => $_setString(21, value);
  @$pb.TagNumber(22)
  $core.bool hasTaxNumber() => $_has(21);
  @$pb.TagNumber(22)
  void clearTaxNumber() => $_clearField(22);

  @$pb.TagNumber(23)
  FCYIdentityDocument get document => $_getN(22);
  @$pb.TagNumber(23)
  set document(FCYIdentityDocument value) => $_setField(23, value);
  @$pb.TagNumber(23)
  $core.bool hasDocument() => $_has(22);
  @$pb.TagNumber(23)
  void clearDocument() => $_clearField(23);
  @$pb.TagNumber(23)
  FCYIdentityDocument ensureDocument() => $_ensure(22);
}

class RequestForeignVirtualAccountResponse extends $pb.GeneratedMessage {
  factory RequestForeignVirtualAccountResponse({
    $core.bool? success,
    $core.String? message,
  ...
  RequestForeignVirtualAccountResponse._();

  factory RequestForeignVirtualAccountResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory RequestForeignVirtualAccountResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'RequestForeignVirtualAccountResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOB(1, _omitFieldNames ? '' : 'success')
    ..aOS(2, _omitFieldNames ? '' : 'message')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RequestForeignVirtualAccountResponse clone() =>
      RequestForeignVirtualAccountResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  RequestForeignVirtualAccountResponse copyWith(
          void Function(RequestForeignVirtualAccountResponse) updates) =>
      super.copyWith((message) =>
              updates(message as RequestForeignVirtualAccountResponse))
          as RequestForeignVirtualAccountResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static RequestForeignVirtualAccountResponse create() =>
      RequestForeignVirtualAccountResponse._();
  @$core.override
  RequestForeignVirtualAccountResponse createEmptyInstance() => create();
  static $pb.PbList<RequestForeignVirtualAccountResponse> createRepeated() =>
      $pb.PbList<RequestForeignVirtualAccountResponse>();
  @$core.pragma('dart2js:noInline')
  static RequestForeignVirtualAccountResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          RequestForeignVirtualAccountResponse>(create);
  static RequestForeignVirtualAccountResponse? _defaultInstance;
...
class GetForeignVirtualAccountStatusRequest extends $pb.GeneratedMessage {
  factory GetForeignVirtualAccountStatusRequest({
    $core.String? currency,
  }) {
    final result = create();
    if (currency != null) result.currency = currency;
  ...
  GetForeignVirtualAccountStatusRequest._();

  factory GetForeignVirtualAccountStatusRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetForeignVirtualAccountStatusRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetForeignVirtualAccountStatusRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'currency')
    ..hasRequiredFields = false;
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetForeignVirtualAccountStatusRequest clone() =>
      GetForeignVirtualAccountStatusRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetForeignVirtualAccountStatusRequest copyWith(
          void Function(GetForeignVirtualAccountStatusRequest) updates) =>
      super.copyWith((message) =>
              updates(message as GetForeignVirtualAccountStatusRequest))
          as GetForeignVirtualAccountStatusRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetForeignVirtualAccountStatusRequest create() =>
      GetForeignVirtualAccountStatusRequest._();
  @$core.override
  GetForeignVirtualAccountStatusRequest createEmptyInstance() => create();
  static $pb.PbList<GetForeignVirtualAccountStatusRequest> createRepeated() =>
      $pb.PbList<GetForeignVirtualAccountStatusRequest>();
  @$core.pragma('dart2js:noInline')
  static GetForeignVirtualAccountStatusRequest getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          GetForeignVirtualAccountStatusRequest>(create);
  static GetForeignVirtualAccountStatusRequest? _defaultInstance;
...
class GetForeignVirtualAccountStatusResponse extends $pb.GeneratedMessage {
  factory GetForeignVirtualAccountStatusResponse({
    $core.String? status,
    $core.String? accountId,
    $core.String? currency,
    $core.String? accountNumber,
    ...
    $core.String? bankCode,
    $core.String? accountName,
    $core.String? routingDetailsJson,
    $core.String? message,
  }) {
    final result = create();
    if (status != null) result.status = status;
    ...
    if (bankCode != null) result.bankCode = bankCode;
    if (accountName != null) result.accountName = accountName;
    if (routingDetailsJson != null)
      result.routingDetailsJson = routingDetailsJson;
    if (message != null) result.message = message;
    return result;
  }

  GetForeignVirtualAccountStatusResponse._();

  factory GetForeignVirtualAccountStatusResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetForeignVirtualAccountStatusResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetForeignVirtualAccountStatusResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'accounts'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'status')
    ..aOS(2, _omitFieldNames ? '' : 'accountId')
    ...
    ..aOS(8, _omitFieldNames ? '' : 'routingDetailsJson')
    ..aOS(9, _omitFieldNames ? '' : 'message')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetForeignVirtualAccountStatusResponse clone() =>
      GetForeignVirtualAccountStatusResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetForeignVirtualAccountStatusResponse copyWith(
          void Function(GetForeignVirtualAccountStatusResponse) updates) =>
      super.copyWith((message) =>
              updates(message as GetForeignVirtualAccountStatusResponse))
          as GetForeignVirtualAccountStatusResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetForeignVirtualAccountStatusResponse create() =>
      GetForeignVirtualAccountStatusResponse._();
  @$core.override
  GetForeignVirtualAccountStatusResponse createEmptyInstance() => create();
  static $pb.PbList<GetForeignVirtualAccountStatusResponse> createRepeated() =>
      $pb.PbList<GetForeignVirtualAccountStatusResponse>();
  @$core.pragma('dart2js:noInline')
  static GetForeignVirtualAccountStatusResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          GetForeignVirtualAccountStatusResponse>(create);
  static GetForeignVirtualAccountStatusResponse? _defaultInstance;
  ...
  /// Currency-specific routing details from the provider (IBAN, sort code,
  /// SWIFT, routing number …) as a JSON object string.
  @$pb.TagNumber(8)
  $core.String get routingDetailsJson => $_getSZ(7);
  @$pb.TagNumber(8)
  set routingDetailsJson($core.String value) => $_setString(7, value);
  @$pb.TagNumber(8)
  $core.bool hasRoutingDetailsJson() => $_has(7);
  @$pb.TagNumber(8)
  void clearRoutingDetailsJson() => $_clearField(8);

...
const ListCrowdfundsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sort_by', '3': 6, '4': 1, '5': 9, '10': 'sortBy'},
    const {'1': 'visibility', '3': 7, '4': 1, '5': 14, '6': '.pb.CrowdfundVisibility', '10': 'visibility'},
  ],
};

/// Descriptor for `ListCrowdfundsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listCrowdfundsRequestDescriptor = $convert.base64Decode('');
...
const WithdrawFromCrowdfundResponse$json = const {
  ...
  '2': const [
    const {'1': 'crowdfund_id', '3': 1, '4': 1, '5': 9, '10': 'crowdfundId'},
    const {'1': 'amount_withdrawn', '3': 2, '4': 1, '5': 4, '10': 'amountWithdrawn'},
    const {'1': 'remaining_balance', '3': 3, '4': 1, '5': 4, '10': 'remainingBalance'},
    const {'1': 'destination_account_id', '3': 4, '4': 1, '5': 9, '10': 'destinationAccountId'},
...
final $typed_data.Uint8List getMyCrowdfundsRequestDescriptor = $convert.base64Decode('ChZHZXRNeUNyb3dkZnVuZHNSZXF1ZXN0EhIKBHBhZ2UYASABKAVSBHBhZ2USGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIWCgZzdGF0dXMYAyABKAlSBnN0YXR1cw==');
@$core.Deprecated('Use getMyCrowdfundsResponseDescriptor instead')
const GetMyCrowdfundsResponse$json = const {
...
final $typed_data.Uint8List getMyCrowdfundsResponseDescriptor = $convert.base64Decode('ChdHZXRNeUNyb3dkZnVuZHNSZXNwb25zZRI0Cgpjcm93ZGZ1bmRzGAEgAygLMhQucGIuQ3Jvd2RmdW5kTWVzc2FnZVIKY3Jvd2RmdW5kcxI7CgpwYWdpbmF0aW9uGAIgASgLMhsucGIuQ3Jvd2RmdW5kUGFnaW5hdGlvbkluZm9SCnBhZ2luYXRpb24=');
@$core.Deprecated('Use getCampaignWalletBalanceRequestDescriptor instead')
const GetCampaignWalletBalanceRequest$json = const {
...
final $typed_data.Uint8List getCampaignWalletBalanceRequestDescriptor = $convert.base64Decode('Ch9HZXRDYW1wYWlnbldhbGxldEJhbGFuY2VSZXF1ZXN0EiEKDGNyb3dkZnVuZF9pZBgBIAEoCVILY3Jvd2RmdW5kSWQ=');
@$core.Deprecated('Use getCampaignWalletBalanceResponseDescriptor instead')
const GetCampaignWalletBalanceResponse$json = const {
  '1': 'GetCampaignWalletBalanceResponse',
  '2': const [
    const {'1': 'crowdfund_id', '3': 1, '4': 1, '5': 9, '10': 'crowdfundId'},
    const {'1': 'campaign_wallet_id', '3': 2, '4': 1, '5': 9, '10': 'campaignWalletId'},
    const {'1': 'balance', '3': 3, '4': 1, '5': 4, '10': 'balance'},
    const {'1': 'available_balance', '3': 4, '4': 1, '5': 4, '10': 'availableBalance'},
    const {'1': 'currency', '3': 5, '4': 1, '5': 9, '10': 'currency'},
  ],
};

/// Descriptor for `GetCampaignWalletBalanceResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCampaignWalletBalanceResponseDescriptor = $convert.base64Decode('');
...
const GetCrowdfundLeaderboardRequest$json = const {
  ...
  '2': const [
    const {'1': 'sort_by', '3': 1, '4': 1, '5': 14, '6': '.pb.LeaderboardSortBy', '10': 'sortBy'},
...
final $typed_data.Uint8List getCrowdfundLeaderboardRequestDescriptor = $convert.base64Decode('Ch5HZXRDcm93ZGZ1bmRMZWFkZXJib2FyZFJlcXVlc3QSLgoHc29ydF9ieRgBIAEoDjIVLnBiLkxlYWRlcmJvYXJkU29ydEJ5UgZzb3J0QnkSGgoIY2F0ZWdvcnkYAiABKAlSCGNhdGVnb3J5EhQKBWxpbWl0GAMgASgFUgVsaW1pdBIWCgZvZmZzZXQYBCABKAVSBm9mZnNldA==');
...
const GetCrowdfundLeaderboardResponse$json = const {
  ...
  '2': const [
    const {'1': 'entries', '3': 1, '4': 3, '5': 11, '6': '.pb.LeaderboardCrowdfundEntry', '10': 'entries'},
...
final $typed_data.Uint8List getCrowdfundLeaderboardResponseDescriptor = $convert.base64Decode('Ch9HZXRDcm93ZGZ1bmRMZWFkZXJib2FyZFJlc3BvbnNlEjcKB2VudHJpZXMYASADKAsyHS5wYi5MZWFkZXJib2FyZENyb3dkZnVuZEVudHJ5UgdlbnRyaWVzEh8KC3RvdGFsX2NvdW50GAIgASgFUgp0b3RhbENvdW50');
...
const LeaderboardCrowdfundEntry$json = const {
  ...
  '2': const [
    const {'1': 'rank', '3': 1, '4': 1, '5': 5, '10': 'rank'},
    const {'1': 'crowdfund', '3': 2, '4': 1, '5': 11, '6': '.pb.CrowdfundMessage', '10': 'crowdfund'},
  ],
};

/// Descriptor for `LeaderboardCrowdfundEntry`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List leaderboardCrowdfundEntryDescriptor = $convert.base64Decode('ChlMZWFkZXJib2FyZENyb3dkZnVuZEVudHJ5EhIKBHJhbmsYASABKAVSBHJhbmsSMgoJY3Jvd2RmdW5kGAIgASgLMhQucGIuQ3Jvd2RmdW5kTWVzc2FnZVIJY3Jvd2RmdW5k');

...
const CrowdfundStatus$json = {
  ...
  '2': [
    ...
    {'1': 'CROWDFUND_STATUS_CANCELLING', '2': 5},
    {'1': 'CROWDFUND_STATUS_EXPIRED', '2': 6},
  ],
};
...
final $typed_data.Uint8List crowdfundStatusDescriptor = $convert.base64Decode(
    ...
    'VMTEVEEAQSHwobQ1JPV0RGVU5EX1NUQVRVU19DQU5DRUxMSU5HEAUSHAoYQ1JPV0RGVU5EX1NU'
    'QVRVU19FWFBJUkVEEAY=');
...
const CrowdfundMessage$json = {
  ...
  '2': [
    ...
    {'1': 'cancel_reason', '3': 22, '4': 1, '5': 9, '10': 'cancelReason'},
    {
    ...
    {'1': 'refunds_pending', '3': 26, '4': 1, '5': 5, '10': 'refundsPending'},
    {
      '1': 'refunds_completed',
      '3': 27,
      '4': 1,
    ...
    {'1': 'refunds_failed', '3': 28, '4': 1, '5': 5, '10': 'refundsFailed'},
    {'1': 'total_refunded', '3': 29, '4': 1, '5': 4, '10': 'totalRefunded'},
  ],
};
...
final $typed_data.Uint8List crowdfundMessageDescriptor = $convert.base64Decode(
    ...
    '5kRG9uYXRpb25NZXNzYWdlUg9yZWNlbnREb25hdGlvbnMSIwoNY2FuY2VsX3JlYXNvbhgWIAEo'
    'CVIMY2FuY2VsUmVhc29uEi4KE2NhbmNlbF9pbml0aWF0ZWRfYnkYFyABKAlSEWNhbmNlbEluaX'
    'RpYXRlZEJ5EjcKGGNhbmNlbF9pbml0aWF0b3JfdXNlcl9pZBgYIAEoCVIVY2FuY2VsSW5pdGlh'
    'dG9yVXNlcklkEj0KDGNhbmNlbGxlZF9hdBgZIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3'
    'RhbXBSC2NhbmNlbGxlZEF0EicKD3JlZnVuZHNfcGVuZGluZxgaIAEoBVIOcmVmdW5kc1BlbmRp'
    'bmcSKwoRcmVmdW5kc19jb21wbGV0ZWQYGyABKAVSEHJlZnVuZHNDb21wbGV0ZWQSJQoOcmVmdW'
    '5kc19mYWlsZWQYHCABKAVSDXJlZnVuZHNGYWlsZWQSJQoOdG90YWxfcmVmdW5kZWQYHSABKARS'
    'DXRvdGFsUmVmdW5kZWQ=');
...
const UpdateCrowdfundRequest$json = {
  ...
  '2': [
    ...
    {'1': 'target_amount', '3': 10, '4': 1, '5': 4, '10': 'targetAmount'},
  ],
};
...
final $typed_data.Uint8List updateCrowdfundRequestDescriptor = $convert.base64Decode(
    ...
    'RhGAggASgJUghtZXRhZGF0YRIaCghjYXRlZ29yeRgJIAEoCVIIY2F0ZWdvcnkSIwoNdGFyZ2V0'
    'X2Ftb3VudBgKIAEoBFIMdGFyZ2V0QW1vdW50');
...
final $typed_data.Uint8List makeDonationRequestDescriptor = $convert.base64Decode(
    ...
    'gJUg9zb3VyY2VBY2NvdW50SWQSJwoPdHJhbnNhY3Rpb25fcGluGAYgASgJUg50cmFuc2FjdGlv'
    'blBpbhIlCg50cmFuc2FjdGlvbl9pZBgHIAEoCVINdHJhbnNhY3Rpb25JZA==');
...
final $typed_data.Uint8List withdrawFromCrowdfundRequestDescriptor = $convert.base64Decode(
    ...
    'c3RpbmF0aW9uQWNjb3VudFR5cGUSJQoOdHJhbnNhY3Rpb25faWQYBiABKAlSDXRyYW5zYWN0aW'
    '9uSWQ=');
...
const WithdrawFromCrowdfundResponse$json = {
  ...
  '2': [
    ...
    {'1': 'fee_amount', '3': 7, '4': 1, '5': 4, '10': 'feeAmount'},
    {'1': 'net_amount', '3': 8, '4': 1, '5': 4, '10': 'netAmount'},
    {'1': 'fee_type', '3': 9, '4': 1, '5': 9, '10': 'feeType'},
    {'1': 'fee_basis_points', '3': 10, '4': 1, '5': 5, '10': 'feeBasisPoints'},
    {'1': 'fee_fixed_kobo', '3': 11, '4': 1, '5': 4, '10': 'feeFixedKobo'},
  ],
};
...
final $typed_data.Uint8List withdrawFromCrowdfundResponseDescriptor = $convert.base64Decode(
    ...
    'ABKAlSB21lc3NhZ2USHQoKZmVlX2Ftb3VudBgHIAEoBFIJZmVlQW1vdW50Eh0KCm5ldF9hbW91'
    'bnQYCCABKARSCW5ldEFtb3VudBIZCghmZWVfdHlwZRgJIAEoCVIHZmVlVHlwZRIoChBmZWVfYm'
    'FzaXNfcG9pbnRzGAogASgFUg5mZWVCYXNpc1BvaW50cxIkCg5mZWVfZml4ZWRfa29ibxgLIAEo'
    'BFIMZmVlRml4ZWRLb2Jv');
...
final $typed_data.Uint8List getCrowdfundWithdrawalFeeQuoteRequestDescriptor =
    $convert.base64Decode(
        ...
        'gBIAEoCVILY3Jvd2RmdW5kSWQSFgoGYW1vdW50GAIgASgEUgZhbW91bnQ=');
...
const GetCrowdfundWithdrawalFeeQuoteResponse$json = {
  ...
  '2': [
    {'1': 'gross_amount', '3': 1, '4': 1, '5': 4, '10': 'grossAmount'},
    {'1': 'fee_amount', '3': 2, '4': 1, '5': 4, '10': 'feeAmount'},
    {'1': 'net_amount', '3': 3, '4': 1, '5': 4, '10': 'netAmount'},
    ...
    {'1': 'fee_fixed_kobo', '3': 8, '4': 1, '5': 4, '10': 'feeFixedKobo'},
  ],
};
...
final $typed_data.Uint8List getCrowdfundWithdrawalFeeQuoteResponseDescriptor =
    $convert.base64Decode(
        ...
        'QYASABKARSC2dyb3NzQW1vdW50Eh0KCmZlZV9hbW91bnQYAiABKARSCWZlZUFtb3VudBIdCgpu'
        'ZXRfYW1vdW50GAMgASgEUgluZXRBbW91bnQSGgoIY3VycmVuY3kYBCABKAlSCGN1cnJlbmN5Eh'
        ...
        'hlZF9rb2JvGAggASgEUgxmZWVGaXhlZEtvYm8=');
...
final $typed_data.Uint8List listCrowdfundCustomCategoriesResponseDescriptor =
    $convert.base64Decode(
        'CiVMaXN0Q3Jvd2RmdW5kQ3VzdG9tQ2F0ZWdvcmllc1Jlc3BvbnNlEjsKCmNhdGVnb3JpZXMYAS'
        'ADKAsyGy5wYi5Dcm93ZGZ1bmRDdXN0b21DYXRlZ29yeVIKY2F0ZWdvcmllcw==');
...
final $typed_data.Uint8List addCrowdfundCustomCategoryResponseDescriptor =
    $convert.base64Decode(
        'CiJBZGRDcm93ZGZ1bmRDdXN0b21DYXRlZ29yeVJlc3BvbnNlEjcKCGNhdGVnb3J5GAEgASgLMh'
        'sucGIuQ3Jvd2RmdW5kQ3VzdG9tQ2F0ZWdvcnlSCGNhdGVnb3J5EhgKB2NyZWF0ZWQYAiABKAhS'
        'B2NyZWF0ZWQ=');
...
final $typed_data.Uint8List cancelCrowdfundRequestDescriptor = $convert.base64Decode(
    ...
    'cmFuc2FjdGlvblBpbhIlCg50cmFuc2FjdGlvbl9pZBgEIAEoCVINdHJhbnNhY3Rpb25JZA==');
...
final $typed_data.Uint8List cancelCrowdfundResponseDescriptor = $convert.base64Decode(
    'ChdDYW5jZWxDcm93ZGZ1bmRSZXNwb25zZRIyCgljcm93ZGZ1bmQYASABKAsyFC5wYi5Dcm93ZG'
    'Z1bmRNZXNzYWdlUgljcm93ZGZ1bmQSLwoTdG90YWxfY29udHJpYnV0aW9ucxgCIAEoBVISdG90'
    'YWxDb250cmlidXRpb25zEiUKDnJlZnVuZHNfcXVldWVkGAMgASgFUg1yZWZ1bmRzUXVldWVkEi'
    '4KE3RvdGFsX3JlZnVuZF9hbW91bnQYBCABKARSEXRvdGFsUmVmdW5kQW1vdW50EhgKB21lc3Nh'
    'Z2UYBSABKAlSB21lc3NhZ2U=');

@$core.Deprecated('Use crowdfundRefundRecordDescriptor instead')
const CrowdfundRefundRecord$json = {
...
final $typed_data.Uint8List crowdfundRefundRecordDescriptor = $convert.base64Decode(
    'ChVDcm93ZGZ1bmRSZWZ1bmRSZWNvcmQSDgoCaWQYASABKAlSAmlkEicKD2NvbnRyaWJ1dGlvbl'
    '9pZBgCIAEoCVIOY29udHJpYnV0aW9uSWQSIQoMY3Jvd2RmdW5kX2lkGAMgASgJUgtjcm93ZGZ1'
    'bmRJZBIuChNjb250cmlidXRvcl91c2VyX2lkGAQgASgEUhFjb250cmlidXRvclVzZXJJZBI4Ch'
    'hjb250cmlidXRvcl9kaXNwbGF5X25hbWUYBSABKAlSFmNvbnRyaWJ1dG9yRGlzcGxheU5hbWUS'
    'NAoWZGVzdGluYXRpb25fYWNjb3VudF9pZBgGIAEoCVIUZGVzdGluYXRpb25BY2NvdW50SWQSFg'
    'oGYW1vdW50GAcgASgEUgZhbW91bnQSGgoIY3VycmVuY3kYCCABKAlSCGN1cnJlbmN5EhYKBnN0'
    'YXR1cxgJIAEoCVIGc3RhdHVzEiEKDGluaXRpYXRlZF9ieRgKIAEoCVILaW5pdGlhdGVkQnkSFg'
    'oGcmVhc29uGAsgASgJUgZyZWFzb24SIwoNYXR0ZW1wdF9jb3VudBgMIAEoBVIMYXR0ZW1wdENv'
    'dW50Eh0KCmxhc3RfZXJyb3IYDSABKAlSCWxhc3RFcnJvchIdCgpjcmVhdGVkX2F0GA4gASgJUg'
    'ljcmVhdGVkQXQSHQoKdXBkYXRlZF9hdBgPIAEoCVIJdXBkYXRlZEF0');
...
final $typed_data.Uint8List listCrowdfundRefundsResponseDescriptor = $convert.base64Decode(
    'ChxMaXN0Q3Jvd2RmdW5kUmVmdW5kc1Jlc3BvbnNlEjMKB3JlZnVuZHMYASADKAsyGS5wYi5Dcm'
    '93ZGZ1bmRSZWZ1bmRSZWNvcmRSB3JlZnVuZHMSFAoFdG90YWwYAiABKAVSBXRvdGFsEhIKBHBh'
    'Z2UYAyABKAVSBHBhZ2USGwoJcGFnZV9zaXplGAQgASgFUghwYWdlU2l6ZRIZCghoYXNfbW9yZR'

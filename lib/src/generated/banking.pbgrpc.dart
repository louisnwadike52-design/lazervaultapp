...
class BankingServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.SyncAllAccountTransactionsResponse>
      syncAllAccountTransactions(
    $0.SyncAllAccountTransactionsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$syncAllAccountTransactions, request,
        options: options);
  }
  ...
  static final _$syncAllAccountTransactions = $grpc.ClientMethod<
          $0.SyncAllAccountTransactionsRequest,
          $0.SyncAllAccountTransactionsResponse>(
      '/banking.BankingService/SyncAllAccountTransactions',
      ($0.SyncAllAccountTransactionsRequest value) => value.writeToBuffer(),
      $0.SyncAllAccountTransactionsResponse.fromBuffer);
...
abstract class BankingServiceBase extends $grpc.Service {
  ...
  BankingServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.SyncAllAccountTransactionsRequest,
            $0.SyncAllAccountTransactionsResponse>(
        'SyncAllAccountTransactions',
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.SyncAllAccountTransactionsRequest.fromBuffer(value),
        ($0.SyncAllAccountTransactionsResponse value) =>
            value.writeToBuffer()));
  ...
  $async.Future<$0.SyncAllAccountTransactionsResponse>
      syncAllAccountTransactions_Pre($grpc.ServiceCall $call,
          $async.Future<$0.SyncAllAccountTransactionsRequest> $request) async {
    return syncAllAccountTransactions($call, await $request);
  }

  $async.Future<$0.SyncAllAccountTransactionsResponse>
      syncAllAccountTransactions(
          $grpc.ServiceCall call, $0.SyncAllAccountTransactionsRequest request);

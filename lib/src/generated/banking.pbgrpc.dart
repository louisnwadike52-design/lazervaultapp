...
class BankingServiceClient extends $grpc.Client {
  ...
  /// ===== CONNECT FINANCIAL DATA (Mono Bank Data: statement, insights, income, creditworthiness) =====
  ...
  /// ===== MONO PROVE — 3-TIER KYC (biometric ownership of BVN/NIN) =====
  ...
  $grpc.ResponseFuture<$0.SyncExternalTransactionsResponse>
      syncExternalTransactions(
    $0.SyncExternalTransactionsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$syncExternalTransactions, request,
        options: options);
  }

  /// Get account with its synced transactions
  $grpc.ResponseFuture<$0.GetAccountWithTransactionsResponse>
      getAccountWithTransactions(
    $0.GetAccountWithTransactionsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getAccountWithTransactions, request,
        options: options);
  }

  /// Aggregated analytics over synced external-bank transactions for the
  /// AI budgeting / statistics screen. Filterable to ONE linked bank
  /// (linked_account_id) or ALL linked banks (empty). Returns current +
  /// previous window totals, category breakdowns and a daily expense series
  /// so the client can merge with wallet analytics for combined views.
  $grpc.ResponseFuture<$0.GetExternalBankAnalyticsResponse>
      getExternalBankAnalytics(
    $0.GetExternalBankAnalyticsRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.RefreshAccountTransactionsResponse>
    ...
    $0.RefreshAccountTransactionsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$refreshAccountTransactions, request,
        options: options);
  }
  ...
  /// Refresh a single Mono-linked account's transactions + balance on
  /// demand. Service-to-service only (no gateway route): financial-products-
  /// service calls this for accounts that back an active external_inflow
  /// autosave rule, so inflow detection is TARGETED instead of banking
  /// sweeping every linked account. Refreshing emits external.inflow.detected
  /// for any new credit, same as the webhook/sweep paths.
  $grpc.ResponseFuture<$0.RefreshLinkedAccountResponse> refreshLinkedAccount(
    $0.RefreshLinkedAccountRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$refreshLinkedAccount, request, options: options);
  }
  ...
  /// Admin: list all deposits with filters (used by admin-gateway).
  /// Returns paginated direct_debits rows for the admin dashboard so ops
  /// can track collections per payment method (Apple Pay, card, etc.).
  ...
  /// (only for a first-time link) + the per-deposit fee for the chosen rail,
  /// each broken down into the Mono cost and the LazerVault margin. Powers the
  /// single fee-disclosure modal shown before Mono Connect / DirectPay.
  $grpc.ResponseFuture<$0.DepositFeeQuoteResponse> getDepositFeeQuote(
    $0.DepositFeeQuoteRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getDepositFeeQuote, request, options: options);
  }
  ...
  $grpc.ResponseFuture<$0.MoveTransferResponse> initiateMoveTransfer(
    $0.InitiateMoveTransferRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.MoveTransferResponse> getMoveTransferStatus(
    $0.GetMoveTransferStatusRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.MoveTransfersResponse> getMoveTransfers(
    $0.GetMoveTransfersRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.CalculateMoveFeeResponse> calculateMoveFee(
    $0.CalculateMoveFeeRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// ===== CREDIT SCORE =====
  $grpc.ResponseFuture<$0.CreditScoreResponse> getCreditScore(
    $0.GetCreditScoreRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getCreditScore, request, options: options);
  }

  $grpc.ResponseFuture<$0.CreditScoreHistoryResponse> getCreditScoreHistory(
    $0.GetCreditScoreHistoryRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getCreditScoreHistory, request, options: options);
  }

  $grpc.ResponseFuture<$0.CreditScoreResponse> refreshCreditScore(
    $0.RefreshCreditScoreRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$refreshCreditScore, request, options: options);
  }

  $grpc.ResponseFuture<$0.MultiSourceCreditScoresResponse>
      getMultiSourceCreditScores(
    $0.GetMultiSourceCreditScoresRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getMultiSourceCreditScores, request,
        options: options);
  }
  ...
  static final _$getAccountStatement = $grpc.ClientMethod<
      ...
      $0.AccountStatementResponse.fromBuffer);
  static final _$getStatementInsights = $grpc.ClientMethod<
      ...
      $0.ConnectDataResponse.fromBuffer);
  ...
  static final _$initiateProveKYC = $grpc.ClientMethod<
      ...
      $0.InitiateProveKYCResponse.fromBuffer);
  static final _$completeProveKYC = $grpc.ClientMethod<
      ...
      $0.CompleteProveKYCResponse.fromBuffer);
  static final _$getProveKYCStatus = $grpc.ClientMethod<
      ...
      $0.GetProveKYCStatusResponse.fromBuffer);
  ...
  static final _$syncExternalTransactions = $grpc.ClientMethod<
          $0.SyncExternalTransactionsRequest,
          $0.SyncExternalTransactionsResponse>(
      '/banking.BankingService/SyncExternalTransactions',
      ($0.SyncExternalTransactionsRequest value) => value.writeToBuffer(),
      $0.SyncExternalTransactionsResponse.fromBuffer);
  static final _$getAccountWithTransactions = $grpc.ClientMethod<
          $0.GetAccountWithTransactionsRequest,
          $0.GetAccountWithTransactionsResponse>(
      '/banking.BankingService/GetAccountWithTransactions',
      ($0.GetAccountWithTransactionsRequest value) => value.writeToBuffer(),
      $0.GetAccountWithTransactionsResponse.fromBuffer);
  static final _$getExternalBankAnalytics = $grpc.ClientMethod<
      ...
      $0.GetExternalBankAnalyticsResponse.fromBuffer);
  static final _$refreshAccountTransactions = $grpc.ClientMethod<
      ...
      $0.RefreshAccountTransactionsResponse.fromBuffer);
  ...
  static final _$refreshLinkedAccount = $grpc.ClientMethod<
          $0.RefreshLinkedAccountRequest, $0.RefreshLinkedAccountResponse>(
      '/banking.BankingService/RefreshLinkedAccount',
      ($0.RefreshLinkedAccountRequest value) => value.writeToBuffer(),
      $0.RefreshLinkedAccountResponse.fromBuffer);
  ...
  static final _$getDepositFeeQuote =
      $grpc.ClientMethod<$0.DepositFeeQuoteRequest, $0.DepositFeeQuoteResponse>(
          '/banking.BankingService/GetDepositFeeQuote',
          ($0.DepositFeeQuoteRequest value) => value.writeToBuffer(),
          $0.DepositFeeQuoteResponse.fromBuffer);
  ...
  static final _$initiateMoveTransfer = $grpc.ClientMethod<
          $0.InitiateMoveTransferRequest, $0.MoveTransferResponse>(
      '/banking.BankingService/InitiateMoveTransfer',
      ($0.InitiateMoveTransferRequest value) => value.writeToBuffer(),
      $0.MoveTransferResponse.fromBuffer);
  static final _$getMoveTransferStatus = $grpc.ClientMethod<
          $0.GetMoveTransferStatusRequest, $0.MoveTransferResponse>(
      '/banking.BankingService/GetMoveTransferStatus',
      ($0.GetMoveTransferStatusRequest value) => value.writeToBuffer(),
      $0.MoveTransferResponse.fromBuffer);
  static final _$getMoveTransfers =
      $grpc.ClientMethod<$0.GetMoveTransfersRequest, $0.MoveTransfersResponse>(
          '/banking.BankingService/GetMoveTransfers',
          ($0.GetMoveTransfersRequest value) => value.writeToBuffer(),
          $0.MoveTransfersResponse.fromBuffer);
  static final _$calculateMoveFee = $grpc.ClientMethod<
          $0.CalculateMoveFeeRequest, $0.CalculateMoveFeeResponse>(
      '/banking.BankingService/CalculateMoveFee',
      ($0.CalculateMoveFeeRequest value) => value.writeToBuffer(),
      $0.CalculateMoveFeeResponse.fromBuffer);
  static final _$getCreditScore =
      $grpc.ClientMethod<$0.GetCreditScoreRequest, $0.CreditScoreResponse>(
          '/banking.BankingService/GetCreditScore',
          ($0.GetCreditScoreRequest value) => value.writeToBuffer(),
          $0.CreditScoreResponse.fromBuffer);
  static final _$getCreditScoreHistory = $grpc.ClientMethod<
          $0.GetCreditScoreHistoryRequest, $0.CreditScoreHistoryResponse>(
      '/banking.BankingService/GetCreditScoreHistory',
      ($0.GetCreditScoreHistoryRequest value) => value.writeToBuffer(),
      $0.CreditScoreHistoryResponse.fromBuffer);
  static final _$refreshCreditScore =
      $grpc.ClientMethod<$0.RefreshCreditScoreRequest, $0.CreditScoreResponse>(
          '/banking.BankingService/RefreshCreditScore',
          ($0.RefreshCreditScoreRequest value) => value.writeToBuffer(),
          $0.CreditScoreResponse.fromBuffer);
  static final _$getMultiSourceCreditScores = $grpc.ClientMethod<
          $0.GetMultiSourceCreditScoresRequest,
          $0.MultiSourceCreditScoresResponse>(
...
abstract class BankingServiceBase extends $grpc.Service {
  ...
  BankingServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.SyncExternalTransactionsRequest,
            $0.SyncExternalTransactionsResponse>(
        'SyncExternalTransactions',
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.SyncExternalTransactionsRequest.fromBuffer(value),
        ($0.SyncExternalTransactionsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetAccountWithTransactionsRequest,
            $0.GetAccountWithTransactionsResponse>(
        'GetAccountWithTransactions',
    ...
    $addMethod($grpc.ServiceMethod<$0.RefreshAccountTransactionsRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.RefreshAccountTransactionsRequest.fromBuffer(value),
        ($0.RefreshAccountTransactionsResponse value) =>
            value.writeToBuffer()));
    $addMethod(
    ...
    $addMethod($grpc.ServiceMethod<$0.RefreshLinkedAccountRequest,
            $0.RefreshLinkedAccountResponse>(
        'RefreshLinkedAccount',
        refreshLinkedAccount_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.RefreshLinkedAccountRequest.fromBuffer(value),
        ($0.RefreshLinkedAccountResponse value) => value.writeToBuffer()));
    $addMethod(
    ...
    $addMethod($grpc.ServiceMethod<$0.DepositFeeQuoteRequest,
            $0.DepositFeeQuoteResponse>(
        'GetDepositFeeQuote',
        getDepositFeeQuote_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.DepositFeeQuoteRequest.fromBuffer(value),
        ($0.DepositFeeQuoteResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.InitiateMoveTransferRequest,
            $0.MoveTransferResponse>(
        'InitiateMoveTransfer',
        initiateMoveTransfer_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.InitiateMoveTransferRequest.fromBuffer(value),
        ($0.MoveTransferResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMoveTransferStatusRequest,
            $0.MoveTransferResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.GetMoveTransferStatusRequest.fromBuffer(value),
        ($0.MoveTransferResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMoveTransfersRequest,
            $0.MoveTransfersResponse>(
        'GetMoveTransfers',
        getMoveTransfers_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetMoveTransfersRequest.fromBuffer(value),
        ($0.MoveTransfersResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.CalculateMoveFeeRequest,
            $0.CalculateMoveFeeResponse>(
        'CalculateMoveFee',
        calculateMoveFee_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.CalculateMoveFeeRequest.fromBuffer(value),
        ($0.CalculateMoveFeeResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.GetCreditScoreRequest, $0.CreditScoreResponse>(
            'GetCreditScore',
            getCreditScore_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.GetCreditScoreRequest.fromBuffer(value),
            ($0.CreditScoreResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetCreditScoreHistoryRequest,
            $0.CreditScoreHistoryResponse>(
        'GetCreditScoreHistory',
        getCreditScoreHistory_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetCreditScoreHistoryRequest.fromBuffer(value),
        ($0.CreditScoreHistoryResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RefreshCreditScoreRequest,
            $0.CreditScoreResponse>(
        'RefreshCreditScore',
        refreshCreditScore_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.RefreshCreditScoreRequest.fromBuffer(value),
        ($0.CreditScoreResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMultiSourceCreditScoresRequest,
            $0.MultiSourceCreditScoresResponse>(
        'GetMultiSourceCreditScores',
  ...
  $async.Future<$0.SyncExternalTransactionsResponse>
      syncExternalTransactions_Pre($grpc.ServiceCall $call,
          $async.Future<$0.SyncExternalTransactionsRequest> $request) async {
    return syncExternalTransactions($call, await $request);
  }

  $async.Future<$0.SyncExternalTransactionsResponse> syncExternalTransactions(
      $grpc.ServiceCall call, $0.SyncExternalTransactionsRequest request);

  $async.Future<$0.GetAccountWithTransactionsResponse>
      getAccountWithTransactions_Pre($grpc.ServiceCall $call,
          $async.Future<$0.GetAccountWithTransactionsRequest> $request) async {
  ...
  $async.Future<$0.RefreshLinkedAccountResponse> refreshLinkedAccount_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.RefreshLinkedAccountRequest> $request) async {
    return refreshLinkedAccount($call, await $request);
  }

  $async.Future<$0.RefreshLinkedAccountResponse> refreshLinkedAccount(
      $grpc.ServiceCall call, $0.RefreshLinkedAccountRequest request);
  ...
  $async.Future<$0.DepositFeeQuoteResponse> getDepositFeeQuote_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.DepositFeeQuoteRequest> $request) async {
    return getDepositFeeQuote($call, await $request);
  }

  $async.Future<$0.DepositFeeQuoteResponse> getDepositFeeQuote(
      $grpc.ServiceCall call, $0.DepositFeeQuoteRequest request);
  ...
  $async.Future<$0.MoveTransferResponse> initiateMoveTransfer_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.InitiateMoveTransferRequest> $request) async {
    return initiateMoveTransfer($call, await $request);
  }

  $async.Future<$0.MoveTransferResponse> initiateMoveTransfer(
      $grpc.ServiceCall call, $0.InitiateMoveTransferRequest request);

  $async.Future<$0.MoveTransferResponse> getMoveTransferStatus_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetMoveTransferStatusRequest> $request) async {
    return getMoveTransferStatus($call, await $request);
  }

  $async.Future<$0.MoveTransferResponse> getMoveTransferStatus(
      $grpc.ServiceCall call, $0.GetMoveTransferStatusRequest request);

  $async.Future<$0.MoveTransfersResponse> getMoveTransfers_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetMoveTransfersRequest> $request) async {
    return getMoveTransfers($call, await $request);
  }

  $async.Future<$0.MoveTransfersResponse> getMoveTransfers(
      $grpc.ServiceCall call, $0.GetMoveTransfersRequest request);

  $async.Future<$0.CalculateMoveFeeResponse> calculateMoveFee_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.CalculateMoveFeeRequest> $request) async {
    return calculateMoveFee($call, await $request);
  }

  $async.Future<$0.CalculateMoveFeeResponse> calculateMoveFee(
      $grpc.ServiceCall call, $0.CalculateMoveFeeRequest request);

  $async.Future<$0.CreditScoreResponse> getCreditScore_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetCreditScoreRequest> $request) async {
    return getCreditScore($call, await $request);
  }

  $async.Future<$0.CreditScoreResponse> getCreditScore(
      $grpc.ServiceCall call, $0.GetCreditScoreRequest request);

  $async.Future<$0.CreditScoreHistoryResponse> getCreditScoreHistory_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.GetCreditScoreHistoryRequest> $request) async {
    return getCreditScoreHistory($call, await $request);
  }

  $async.Future<$0.CreditScoreHistoryResponse> getCreditScoreHistory(
      $grpc.ServiceCall call, $0.GetCreditScoreHistoryRequest request);

  $async.Future<$0.CreditScoreResponse> refreshCreditScore_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.RefreshCreditScoreRequest> $request) async {
    return refreshCreditScore($call, await $request);
  }

  $async.Future<$0.CreditScoreResponse> refreshCreditScore(
      $grpc.ServiceCall call, $0.RefreshCreditScoreRequest request);

  $async.Future<$0.MultiSourceCreditScoresResponse>
      getMultiSourceCreditScores_Pre($grpc.ServiceCall $call,
          $async.Future<$0.GetMultiSourceCreditScoresRequest> $request) async {

...
const SplitBill$json = {
  ...
  '2': [
    ...
    {'1': 'paid_amount', '3': 14, '4': 1, '5': 1, '10': 'paidAmount'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.split_bill.SplitBillParticipant',
      '10': 'participants'
    },
    {
      '1': 'created_at',
    ...
    {'1': 'receiver_type', '3': 18, '4': 1, '5': 9, '10': 'receiverType'},
    {'1': 'receiver_name', '3': 19, '4': 1, '5': 9, '10': 'receiverName'},
    {
      '1': 'receiver_account_masked',
      '3': 20,
      '4': 1,
      '5': 9,
      '10': 'receiverAccountMasked'
    },
    {
      '1': 'settlement_status',
      '3': 21,
...
final $typed_data.Uint8List splitBillDescriptor = $convert.base64Decode(
    ...
    'IAEoCVIIY3VycmVuY3kSIAoLZGVzY3JpcHRpb24YCCABKAlSC2Rlc2NyaXB0aW9uEjoKDHNwbG'
    'l0X21ldGhvZBgJIAEoDjIXLnNwbGl0X2JpbGwuU3BsaXRNZXRob2RSC3NwbGl0TWV0aG9kEjMK'
    'BnN0YXR1cxgKIAEoDjIbLnNwbGl0X2JpbGwuU3BsaXRCaWxsU3RhdHVzUgZzdGF0dXMSHAoJcm'
    'VmZXJlbmNlGAsgASgJUglyZWZlcmVuY2USLQoSdG90YWxfcGFydGljaXBhbnRzGAwgASgFUhF0'
    'b3RhbFBhcnRpY2lwYW50cxIdCgpwYWlkX2NvdW50GA0gASgFUglwYWlkQ291bnQSHwoLcGFpZF'
    '9hbW91bnQYDiABKAFSCnBhaWRBbW91bnQSRAoMcGFydGljaXBhbnRzGA8gAygLMiAuc3BsaXRf'
    'YmlsbC5TcGxpdEJpbGxQYXJ0aWNpcGFudFIMcGFydGljaXBhbnRzEjkKCmNyZWF0ZWRfYXQYEC'
    'ABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgljcmVhdGVkQXQSOQoKdXBkYXRlZF9h'
    'dBgRIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCXVwZGF0ZWRBdBIjCg1yZWNlaX'
...
const SplitBillParticipant$json = {
  ...
  '2': [
    ...
    {'1': 'percentage', '3': 7, '4': 1, '5': 1, '10': 'percentage'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.split_bill.SplitBillParticipantStatus',
      '10': 'status'
    },
    {
    ...
    {'1': 'is_creator', '3': 11, '4': 1, '5': 8, '10': 'isCreator'},
  ],
};
...
final $typed_data.Uint8List splitBillParticipantDescriptor = $convert.base64Decode(
    ...
    'Ftb3VudBgGIAEoAVIGYW1vdW50Eh4KCnBlcmNlbnRhZ2UYByABKAFSCnBlcmNlbnRhZ2USPgoG'
    'c3RhdHVzGAggASgOMiYuc3BsaXRfYmlsbC5TcGxpdEJpbGxQYXJ0aWNpcGFudFN0YXR1c1IGc3'
    'RhdHVzEjMKFXRyYW5zYWN0aW9uX3JlZmVyZW5jZRgJIAEoCVIUdHJhbnNhY3Rpb25SZWZlcmVu'
    'Y2USMwoHcGFpZF9hdBgKIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSBnBhaWRBdB'
    'IdCgppc19jcmVhdG9yGAsgASgIUglpc0NyZWF0b3I=');
...
/// Descriptor for `ReceiverInput`. Decode as a `google.protobuf.DescriptorProto`.
...
const CreateSplitBillRequest$json = {
  ...
  '2': [
    ...
    {'1': 'creator_share', '3': 5, '4': 1, '5': 1, '10': 'creatorShare'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.split_bill.SplitBillParticipantInput',
      '10': 'participants'
    },
    {
      '1': 'receiver',
      ...
      '4': 1,
      '5': 11,
      '6': '.split_bill.ReceiverInput',
      '10': 'receiver'
    },
    {
      '1': 'include_self_as_copayer',
      '3': 8,
      '4': 1,
      '5': 8,
...
final $typed_data.Uint8List createSplitBillRequestDescriptor = $convert.base64Decode(
    ...
    'ZXNjcmlwdGlvbhI6CgxzcGxpdF9tZXRob2QYBCABKA4yFy5zcGxpdF9iaWxsLlNwbGl0TWV0aG'
    '9kUgtzcGxpdE1ldGhvZBIjCg1jcmVhdG9yX3NoYXJlGAUgASgBUgxjcmVhdG9yU2hhcmUSSQoM'
...
final $typed_data.Uint8List createSplitBillResponseDescriptor = $convert.base64Decode(
    ...
    '1lc3NhZ2UYAiABKAlSB21lc3NhZ2USNAoKc3BsaXRfYmlsbBgDIAEoCzIVLnNwbGl0X2JpbGwu'
    'U3BsaXRCaWxsUglzcGxpdEJpbGw=');
...
final $typed_data.Uint8List getSplitBillResponseDescriptor = $convert.base64Decode(
    ...
    'NhZ2UYAiABKAlSB21lc3NhZ2USNAoKc3BsaXRfYmlsbBgDIAEoCzIVLnNwbGl0X2JpbGwuU3Bs'
    'aXRCaWxsUglzcGxpdEJpbGw=');
...
final $typed_data.Uint8List getMySplitBillsRequestDescriptor = $convert.base64Decode(
    ...
    'ABKAVSBWxpbWl0EjMKBnN0YXR1cxgDIAEoDjIbLnNwbGl0X2JpbGwuU3BsaXRCaWxsU3RhdHVz'
    'UgZzdGF0dXM=');
...
final $typed_data.Uint8List getSplitBillsResponseDescriptor = $convert.base64Decode(
    'ChVHZXRTcGxpdEJpbGxzUmVzcG9uc2USNgoLc3BsaXRfYmlsbHMYASADKAsyFS5zcGxpdF9iaW'
    'xsLlNwbGl0QmlsbFIKc3BsaXRCaWxscxIUCgV0b3RhbBgCIAEoBVIFdG90YWwSEgoEcGFnZRgD'
...
const PaySplitBillShareResponse$json = {
  ...
  '2': [
    ...
    {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.split_bill.SplitBillTransaction',
      '10': 'transaction'
    },
    {
      '1': 'split_bill',
...
final $typed_data.Uint8List paySplitBillShareResponseDescriptor = $convert.base64Decode(
    ...
    'oHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZRJCCgt0cmFuc2FjdGlvbhgDIAEoCzIgLnNwbGl0X2Jp'
    'bGwuU3BsaXRCaWxsVHJhbnNhY3Rpb25SC3RyYW5zYWN0aW9uEjQKCnNwbGl0X2JpbGwYBCABKA'
    'syFS5zcGxpdF9iaWxsLlNwbGl0QmlsbFIJc3BsaXRCaWxs');
...
final $typed_data.Uint8List cancelSplitBillRequestDescriptor =
...
final $typed_data.Uint8List cancelSplitBillResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List declineSplitBillShareRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List declineSplitBillShareResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List sendSplitBillReminderResponseDescriptor =
    $convert.base64Decode(

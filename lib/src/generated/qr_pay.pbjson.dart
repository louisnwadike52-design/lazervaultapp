...
const GetMyGeneratedQRCodesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'include_all', '3': 4, '4': 1, '5': 8, '10': 'includeAll'},
  ],
};

/// Descriptor for `GetMyGeneratedQRCodesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMyGeneratedQRCodesRequestDescriptor = $convert.base64Decode('ChxHZXRNeUdlbmVyYXRlZFFSQ29kZXNSZXF1ZXN0EhQKBWxpbWl0GAEgASgFUgVsaW1pdBIWCgZvZmZzZXQYAiABKAVSBm9mZnNldBI1Cg1zdGF0dXNfZmlsdGVyGAMgASgOMhAucXJfcGF5LlFSU3RhdHVzUgxzdGF0dXNGaWx0ZXISHwoLaW5jbHVkZV9hbGwYBCABKAhSCmluY2x1ZGVBbGw=');

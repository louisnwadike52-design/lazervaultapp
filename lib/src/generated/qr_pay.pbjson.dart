...
const QRCode$json = {
  ...
  '2': [
    ...
    {'1': 'usage_mode', '3': 14, '4': 1, '5': 9, '10': 'usageMode'},
    {'1': 'no_expiry', '3': 15, '4': 1, '5': 8, '10': 'noExpiry'},
  ],
};
...
final $typed_data.Uint8List qRCodeDescriptor = $convert.base64Decode(
    ...
    'LnByb3RvYnVmLlRpbWVzdGFtcFIGcGFpZEF0Eh0KCnVzYWdlX21vZGUYDiABKAlSCXVzYWdlTW'
    '9kZRIbCglub19leHBpcnkYDyABKAhSCG5vRXhwaXJ5');
...
const GenerateQRRequest$json = {
  ...
  '2': [
    ...
    {'1': 'usage_mode', '3': 6, '4': 1, '5': 9, '10': 'usageMode'},
  ],
};
...
final $typed_data.Uint8List generateQRRequestDescriptor = $convert.base64Decode(
    ...
    'gFIAEoBVIPdmFsaWRpdHlNaW51dGVzEh0KCnVzYWdlX21vZGUYBiABKAlSCXVzYWdlTW9kZQ==');
...
final $typed_data.Uint8List getQRDetailsRequestDescriptor =
...
const GetMyGeneratedQRCodesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'include_all', '3': 4, '4': 1, '5': 8, '10': 'includeAll'},
  ],
};
...
final $typed_data.Uint8List getMyGeneratedQRCodesRequestDescriptor = $convert.base64Decode(
    ...
    'U3RhdHVzUgxzdGF0dXNGaWx0ZXISHwoLaW5jbHVkZV9hbGwYBCABKAhSCmluY2x1ZGVBbGw=');
...
final $typed_data.Uint8List getMyGeneratedQRCodesResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getMyQRPaymentsRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List cancelQRRequestDescriptor = $convert
    .base64Decode('Cg9DYW5jZWxRUlJlcXVlc3QSEwoFcXJfaWQYASABKAlSBHFySWQ=');
...
final $typed_data.Uint8List getQRTransactionReceiptRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getQRTransactionReceiptResponseDescriptor =
    $convert.base64Decode(
        'Ch9HZXRRUlRyYW5zYWN0aW9uUmVjZWlwdFJlc3BvbnNlEjcKC3RyYW5zYWN0aW9uGAEgASgLMh'
        'UucXJfcGF5LlFSVHJhbnNhY3Rpb25SC3RyYW5zYWN0aW9u');

@$core.Deprecated('Use updateQRExpiryRequestDescriptor instead')
const UpdateQRExpiryRequest$json = {
  '1': 'UpdateQRExpiryRequest',
  '2': [
    {'1': 'qr_id', '3': 1, '4': 1, '5': 9, '10': 'qrId'},
    {'1': 'validity_minutes', '3': 2, '4': 1, '5': 5, '10': 'validityMinutes'},
  ],
};

/// Descriptor for `UpdateQRExpiryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateQRExpiryRequestDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVRUkV4cGlyeVJlcXVlc3QSEwoFcXJfaWQYASABKAlSBHFySWQSKQoQdmFsaWRpdH'
    'lfbWludXRlcxgCIAEoBVIPdmFsaWRpdHlNaW51dGVz');

@$core.Deprecated('Use updateQRExpiryResponseDescriptor instead')
const UpdateQRExpiryResponse$json = {
  '1': 'UpdateQRExpiryResponse',
  '2': [
    {
      '1': 'qr_code',
      '3': 1,
...
/// Descriptor for `UpdateQRExpiryResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateQRExpiryResponseDescriptor =
    $convert.base64Decode(
        'ChZVcGRhdGVRUkV4cGlyeVJlc3BvbnNlEicKB3FyX2NvZGUYASABKAsyDi5xcl9wYXkuUVJDb2'
        'RlUgZxckNvZGUSGAoHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZQ==');

@$core.Deprecated('Use getQRPayersRequestDescriptor instead')
const GetQRPayersRequest$json = {
  '1': 'GetQRPayersRequest',
  '2': [
    {'1': 'qr_id', '3': 1, '4': 1, '5': 9, '10': 'qrId'},
...
/// Descriptor for `GetQRPayersRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getQRPayersRequestDescriptor = $convert.base64Decode(
    'ChJHZXRRUlBheWVyc1JlcXVlc3QSEwoFcXJfaWQYASABKAlSBHFySWQSFAoFbGltaXQYAiABKA'
    'VSBWxpbWl0EhYKBm9mZnNldBgDIAEoBVIGb2Zmc2V0');

@$core.Deprecated('Use getQRPayersResponseDescriptor instead')
const GetQRPayersResponse$json = {
  '1': 'GetQRPayersResponse',
  '2': [
    {
      '1': 'transactions',
      '3': 1,
    ...
    {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
    {'1': 'total_collected', '3': 3, '4': 1, '5': 1, '10': 'totalCollected'},
  ],
};

/// Descriptor for `GetQRPayersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getQRPayersResponseDescriptor = $convert.base64Decode(
    'ChNHZXRRUlBheWVyc1Jlc3BvbnNlEjkKDHRyYW5zYWN0aW9ucxgBIAMoCzIVLnFyX3BheS5RUl'
    'RyYW5zYWN0aW9uUgx0cmFuc2FjdGlvbnMSFAoFdG90YWwYAiABKAVSBXRvdGFsEicKD3RvdGFs'
    'X2NvbGxlY3RlZBgDIAEoAVIOdG90YWxDb2xsZWN0ZWQ=');

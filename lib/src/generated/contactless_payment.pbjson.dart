...
final $typed_data.Uint8List createPaymentSessionResponseDescriptor =
...
final $typed_data.Uint8List getPaymentSessionRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getPaymentSessionResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List processContactlessPaymentRequestDescriptor =
    $convert.base64Decode(
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.contactless.ContactlessTransaction',
      '10': 'transaction'
    },
...
final $typed_data.Uint8List cancelPaymentSessionRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List cancelPaymentSessionResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getMyPaymentSessionsRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getMyPaymentSessionsResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getMyContactlessPaymentsRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List getMyContactlessPaymentsResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List checkSessionStatusRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List checkSessionStatusResponseDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List acknowledgeSessionReadRequestDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List acknowledgeSessionReadResponseDescriptor =
    $convert.base64Decode(

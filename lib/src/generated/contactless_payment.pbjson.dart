...
const CreatePaymentSessionResponse$json = const {
  ...
  '2': const [
    const {'1': 'session', '3': 1, '4': 1, '5': 11, '6': '.contactless.PaymentSession', '10': 'session'},
...
final $typed_data.Uint8List createPaymentSessionResponseDescriptor = $convert.base64Decode('ChxDcmVhdGVQYXltZW50U2Vzc2lvblJlc3BvbnNlEjUKB3Nlc3Npb24YASABKAsyGy5jb250YWN0bGVzcy5QYXltZW50U2Vzc2lvblIHc2Vzc2lvbhIfCgtuZmNfcGF5bG9hZBgCIAEoCVIKbmZjUGF5bG9hZBIYCgdtZXNzYWdlGAMgASgJUgdtZXNzYWdl');
...
final $typed_data.Uint8List getPaymentSessionResponseDescriptor = $convert.base64Decode('ChlHZXRQYXltZW50U2Vzc2lvblJlc3BvbnNlEjUKB3Nlc3Npb24YASABKAsyGy5jb250YWN0bGVzcy5QYXltZW50U2Vzc2lvblIHc2Vzc2lvbg==');
...
const ProcessContactlessPaymentResponse$json = const {
  ...
  '2': const [
    const {'1': 'transaction', '3': 1, '4': 1, '5': 11, '6': '.contactless.ContactlessTransaction', '10': 'transaction'},
...
final $typed_data.Uint8List processContactlessPaymentResponseDescriptor = $convert.base64Decode('CiFQcm9jZXNzQ29udGFjdGxlc3NQYXltZW50UmVzcG9uc2USRQoLdHJhbnNhY3Rpb24YASABKAsyIy5jb250YWN0bGVzcy5Db250YWN0bGVzc1RyYW5zYWN0aW9uUgt0cmFuc2FjdGlvbhIfCgtuZXdfYmFsYW5jZRgCIAEoAVIKbmV3QmFsYW5jZRIYCgdtZXNzYWdlGAMgASgJUgdtZXNzYWdl');
...
const GetMyPaymentSessionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'sessions', '3': 1, '4': 3, '5': 11, '6': '.contactless.PaymentSession', '10': 'sessions'},
...
final $typed_data.Uint8List getMyPaymentSessionsResponseDescriptor = $convert.base64Decode('ChxHZXRNeVBheW1lbnRTZXNzaW9uc1Jlc3BvbnNlEjcKCHNlc3Npb25zGAEgAygLMhsuY29udGFjdGxlc3MuUGF5bWVudFNlc3Npb25SCHNlc3Npb25zEhQKBXRvdGFsGAIgASgFUgV0b3RhbA==');
...
const GetMyContactlessPaymentsResponse$json = const {
  ...
  '2': const [
    const {'1': 'transactions', '3': 1, '4': 3, '5': 11, '6': '.contactless.ContactlessTransaction', '10': 'transactions'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
  ],
};

/// Descriptor for `GetMyContactlessPaymentsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMyContactlessPaymentsResponseDescriptor = $convert.base64Decode('CiBHZXRNeUNvbnRhY3RsZXNzUGF5bWVudHNSZXNwb25zZRJHCgx0cmFuc2FjdGlvbnMYASADKAsyIy5jb250YWN0bGVzcy5Db250YWN0bGVzc1RyYW5zYWN0aW9uUgx0cmFuc2FjdGlvbnMSFAoFdG90YWwYAiABKAVSBXRvdGFs');
...
final $typed_data.Uint8List acknowledgeSessionReadResponseDescriptor = $convert.base64Decode('Ch5BY2tub3dsZWRnZVNlc3Npb25SZWFkUmVzcG9uc2USNQoHc2Vzc2lvbhgBIAEoCzIbLmNvbnRhY3RsZXNzLlBheW1lbnRTZXNzaW9uUgdzZXNzaW9uEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2U=');

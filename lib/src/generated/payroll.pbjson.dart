...
const ExpenseCategory$json = {
  '1': 'ExpenseCategory',
  '2': [
    {'1': 'EXPENSE_CATEGORY_OFFICE', '2': 0},
    {'1': 'EXPENSE_CATEGORY_TRAVEL', '2': 1},
    {'1': 'EXPENSE_CATEGORY_MEALS', '2': 2},
    {'1': 'EXPENSE_CATEGORY_MARKETING', '2': 3},
    {'1': 'EXPENSE_CATEGORY_UTILITIES', '2': 4},
    {'1': 'EXPENSE_CATEGORY_PAYROLL', '2': 5},
    {'1': 'EXPENSE_CATEGORY_PROFESSIONAL', '2': 6},
    {'1': 'EXPENSE_CATEGORY_SOFTWARE', '2': 7},
    {'1': 'EXPENSE_CATEGORY_INVENTORY', '2': 8},
    {'1': 'EXPENSE_CATEGORY_TAXES', '2': 9},
    {'1': 'EXPENSE_CATEGORY_OTHER', '2': 10},
  ],
};
...
final $typed_data.Uint8List expenseCategoryDescriptor = $convert.base64Decode(
    'Cg9FeHBlbnNlQ2F0ZWdvcnkSGwoXRVhQRU5TRV9DQVRFR09SWV9PRkZJQ0UQABIbChdFWFBFTl'
    'NFX0NBVEVHT1JZX1RSQVZFTBABEhoKFkVYUEVOU0VfQ0FURUdPUllfTUVBTFMQAhIeChpFWFBF'
    'TlNFX0NBVEVHT1JZX01BUktFVElORxADEh4KGkVYUEVOU0VfQ0FURUdPUllfVVRJTElUSUVTEA'
    'QSHAoYRVhQRU5TRV9DQVRFR09SWV9QQVlST0xMEAUSIQodRVhQRU5TRV9DQVRFR09SWV9QUk9G'
    'RVNTSU9OQUwQBhIdChlFWFBFTlNFX0NBVEVHT1JZX1NPRlRXQVJFEAcSHgoaRVhQRU5TRV9DQV'
    'RFR09SWV9JTlZFTlRPUlkQCBIaChZFWFBFTlNFX0NBVEVHT1JZX1RBWEVTEAkSGgoWRVhQRU5T'
    'RV9DQVRFR09SWV9PVEhFUhAK');

@$core.Deprecated('Use expenseStatusDescriptor instead')
const ExpenseStatus$json = {
  '1': 'ExpenseStatus',
  '2': [
    {'1': 'EXPENSE_STATUS_PENDING', '2': 0},
    {'1': 'EXPENSE_STATUS_APPROVED', '2': 1},
    {'1': 'EXPENSE_STATUS_REIMBURSED', '2': 2},
    {'1': 'EXPENSE_STATUS_REJECTED', '2': 3},
  ],
};

/// Descriptor for `ExpenseStatus`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List expenseStatusDescriptor = $convert.base64Decode(
    'Cg1FeHBlbnNlU3RhdHVzEhoKFkVYUEVOU0VfU1RBVFVTX1BFTkRJTkcQABIbChdFWFBFTlNFX1'
    'NUQVRVU19BUFBST1ZFRBABEh0KGUVYUEVOU0VfU1RBVFVTX1JFSU1CVVJTRUQQAhIbChdFWFBF'
    'TlNFX1NUQVRVU19SRUpFQ1RFRBAD');

@$core.Deprecated('Use expensePaymentMethodDescriptor instead')
const ExpensePaymentMethod$json = {
  '1': 'ExpensePaymentMethod',
  '2': [
    {'1': 'EXPENSE_PAYMENT_METHOD_CASH', '2': 0},
    {'1': 'EXPENSE_PAYMENT_METHOD_CARD', '2': 1},
    {'1': 'EXPENSE_PAYMENT_METHOD_BANK_TRANSFER', '2': 2},
    {'1': 'EXPENSE_PAYMENT_METHOD_CHEQUE', '2': 3},
    {'1': 'EXPENSE_PAYMENT_METHOD_OTHER', '2': 4},
  ],
};

/// Descriptor for `ExpensePaymentMethod`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List expensePaymentMethodDescriptor = $convert.base64Decode(
    'ChRFeHBlbnNlUGF5bWVudE1ldGhvZBIfChtFWFBFTlNFX1BBWU1FTlRfTUVUSE9EX0NBU0gQAB'
    'IfChtFWFBFTlNFX1BBWU1FTlRfTUVUSE9EX0NBUkQQARIoCiRFWFBFTlNFX1BBWU1FTlRfTUVU'
    'SE9EX0JBTktfVFJBTlNGRVIQAhIhCh1FWFBFTlNFX1BBWU1FTlRfTUVUSE9EX0NIRVFVRRADEi'
    'AKHEVYUEVOU0VfUEFZTUVOVF9NRVRIT0RfT1RIRVIQBA==');
...
const Employee$json = {
  ...
  '2': [
    ...
    {'1': 'payout_type', '3': 20, '4': 1, '5': 9, '10': 'payoutType'},
    {
      '1': 'bank_account_name',
      '3': 21,
      '4': 1,
...
final $typed_data.Uint8List employeeDescriptor = $convert.base64Decode(
    ...
    'cFIJdXBkYXRlZEF0Eh8KC3BheW91dF90eXBlGBQgASgJUgpwYXlvdXRUeXBlEioKEWJhbmtfYW'
    'Njb3VudF9uYW1lGBUgASgJUg9iYW5rQWNjb3VudE5hbWU=');
...
const InventoryCategorySummary$json = {
...
final $typed_data.Uint8List inventoryCategorySummaryDescriptor = $convert.base64Decode(
    'ChhJbnZlbnRvcnlDYXRlZ29yeVN1bW1hcnkSGgoIY2F0ZWdvcnkYASABKAlSCGNhdGVnb3J5Eh'
    '0KCml0ZW1fY291bnQYAiABKAVSCWl0ZW1Db3VudBIfCgt0b3RhbF92YWx1ZRgDIAEoA1IKdG90'
    'YWxWYWx1ZRImCg9sb3dfc3RvY2tfY291bnQYBCABKAVSDWxvd1N0b2NrQ291bnQ=');
...
const AddEmployeeRequest$json = {
  ...
  '2': [
    ...
    {'1': 'payout_type', '3': 15, '4': 1, '5': 9, '10': 'payoutType'},
    {
      '1': 'bank_account_name',
      '3': 16,
      '4': 1,
...
final $typed_data.Uint8List addEmployeeRequestDescriptor = $convert.base64Decode(
    ...
    'dGFydERhdGUSFwoHdXNlcl9pZBgOIAEoCVIGdXNlcklkEh8KC3BheW91dF90eXBlGA8gASgJUg'
    'pwYXlvdXRUeXBlEioKEWJhbmtfYWNjb3VudF9uYW1lGBAgASgJUg9iYW5rQWNjb3VudE5hbWU=');
...
const UpdateEmployeeRequest$json = {
  ...
  '2': [
    ...
    {'1': 'payout_type', '3': 16, '4': 1, '5': 9, '10': 'payoutType'},
    {
      '1': 'bank_account_name',
      '3': 17,
      '4': 1,
...
final $typed_data.Uint8List updateEmployeeRequestDescriptor = $convert.base64Decode(
    ...
    'VzEhcKB3VzZXJfaWQYDyABKAlSBnVzZXJJZBIfCgtwYXlvdXRfdHlwZRgQIAEoCVIKcGF5b3V0'
    'VHlwZRIqChFiYW5rX2FjY291bnRfbmFtZRgRIAEoCVIPYmFua0FjY291bnROYW1l');
...
final $typed_data.Uint8List listPaySlipsRequestDescriptor = $convert.base64Decode(
    ...
    'BhZ2UYAiABKAVSBHBhZ2USFAoFbGltaXQYAyABKAVSBWxpbWl0Eh8KC2VtcGxveWVlX2lkGAQg'
    'ASgJUgplbXBsb3llZUlk');
...
final $typed_data.Uint8List getInventorySummaryResponseDescriptor = $convert.base64Decode(
    ...
    'ZlbnRvcnlfdmFsdWUYBSABKANSE3RvdGFsSW52ZW50b3J5VmFsdWUSPAoKY2F0ZWdvcmllcxgG'
    'IAMoCzIcLnBiLkludmVudG9yeUNhdGVnb3J5U3VtbWFyeVIKY2F0ZWdvcmllcw==');
...
const Expense$json = {
  ...
  '2': [
    ...
    {'1': 'supplier_id', '3': 21, '4': 1, '5': 9, '10': 'supplierId'},
  ],
};
...
final $typed_data.Uint8List expenseDescriptor = $convert.base64Decode(
    'CgdFeHBlbnNlEg4KAmlkGAEgASgJUgJpZBIfCgtidXNpbmVzc19pZBgCIAEoCVIKYnVzaW5lc3'
    'NJZBIgCgtkZXNjcmlwdGlvbhgDIAEoCVILZGVzY3JpcHRpb24SFgoGYW1vdW50GAQgASgDUgZh'
    'bW91bnQSGgoIY3VycmVuY3kYBSABKAlSCGN1cnJlbmN5Ei8KCGNhdGVnb3J5GAYgASgOMhMucG'
    'IuRXhwZW5zZUNhdGVnb3J5UghjYXRlZ29yeRIpCgZzdGF0dXMYByABKA4yES5wYi5FeHBlbnNl'
    'U3RhdHVzUgZzdGF0dXMSPwoOcGF5bWVudF9tZXRob2QYCCABKA4yGC5wYi5FeHBlbnNlUGF5bW'
    'VudE1ldGhvZFINcGF5bWVudE1ldGhvZBI9CgxleHBlbnNlX2RhdGUYCSABKAsyGi5nb29nbGUu'
    'cHJvdG9idWYuVGltZXN0YW1wUgtleHBlbnNlRGF0ZRIWCgZ2ZW5kb3IYCiABKAlSBnZlbmRvch'
    'IcCglyZWZlcmVuY2UYCyABKAlSCXJlZmVyZW5jZRIfCgtyZWNlaXB0X3VybBgMIAEoCVIKcmVj'
    'ZWlwdFVybBISCgR0YWdzGA0gAygJUgR0YWdzEhQKBW5vdGVzGA4gASgJUgVub3RlcxIdCgpjcm'
    'VhdGVkX2J5GA8gASgJUgljcmVhdGVkQnkSHwoLYXBwcm92ZWRfYnkYECABKAlSCmFwcHJvdmVk'
    'QnkSOwoLYXBwcm92ZWRfYXQYESABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgphcH'
    'Byb3ZlZEF0Ej8KDXJlaW1idXJzZWRfYXQYEiABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0'
    'YW1wUgxyZWltYnVyc2VkQXQSOQoKY3JlYXRlZF9hdBgTIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi'
    '5UaW1lc3RhbXBSCWNyZWF0ZWRBdBI5Cgp1cGRhdGVkX2F0GBQgASgLMhouZ29vZ2xlLnByb3Rv'
    'YnVmLlRpbWVzdGFtcFIJdXBkYXRlZEF0Eh8KC3N1cHBsaWVyX2lkGBUgASgJUgpzdXBwbGllck'
    'lk');

@$core.Deprecated('Use expenseSummaryDescriptor instead')
const ExpenseSummary$json = {
  '1': 'ExpenseSummary',
  '2': [
    {'1': 'total_expenses', '3': 1, '4': 1, '5': 3, '10': 'totalExpenses'},
    {'1': 'total_pending', '3': 2, '4': 1, '5': 3, '10': 'totalPending'},
    {'1': 'total_approved', '3': 3, '4': 1, '5': 3, '10': 'totalApproved'},
    {'1': 'total_reimbursed', '3': 4, '4': 1, '5': 3, '10': 'totalReimbursed'},
    {'1': 'total_rejected', '3': 5, '4': 1, '5': 3, '10': 'totalRejected'},
    {'1': 'expense_count', '3': 6, '4': 1, '5': 5, '10': 'expenseCount'},
    {'1': 'pending_count', '3': 7, '4': 1, '5': 5, '10': 'pendingCount'},
    {'1': 'approved_count', '3': 8, '4': 1, '5': 5, '10': 'approvedCount'},
    {'1': 'reimbursed_count', '3': 9, '4': 1, '5': 5, '10': 'reimbursedCount'},
    {'1': 'rejected_count', '3': 10, '4': 1, '5': 5, '10': 'rejectedCount'},
...
final $typed_data.Uint8List expenseSummaryDescriptor = $convert.base64Decode(
    'Cg5FeHBlbnNlU3VtbWFyeRIlCg50b3RhbF9leHBlbnNlcxgBIAEoA1INdG90YWxFeHBlbnNlcx'
    'IjCg10b3RhbF9wZW5kaW5nGAIgASgDUgx0b3RhbFBlbmRpbmcSJQoOdG90YWxfYXBwcm92ZWQY'
    'AyABKANSDXRvdGFsQXBwcm92ZWQSKQoQdG90YWxfcmVpbWJ1cnNlZBgEIAEoA1IPdG90YWxSZW'
    'ltYnVyc2VkEiUKDnRvdGFsX3JlamVjdGVkGAUgASgDUg10b3RhbFJlamVjdGVkEiMKDWV4cGVu'
    'c2VfY291bnQYBiABKAVSDGV4cGVuc2VDb3VudBIjCg1wZW5kaW5nX2NvdW50GAcgASgFUgxwZW'
    '5kaW5nQ291bnQSJQoOYXBwcm92ZWRfY291bnQYCCABKAVSDWFwcHJvdmVkQ291bnQSKQoQcmVp'
    'bWJ1cnNlZF9jb3VudBgJIAEoBVIPcmVpbWJ1cnNlZENvdW50EiUKDnJlamVjdGVkX2NvdW50GA'
    'ogASgFUg1yZWplY3RlZENvdW50EhoKCGN1cnJlbmN5GAsgASgJUghjdXJyZW5jeRI5CgtieV9j'
    'YXRlZ29yeRgMIAMoCzIYLnBiLkV4cGVuc2VDYXRlZ29yeVRvdGFsUgpieUNhdGVnb3J5EjIKCG'
    'J5X21vbnRoGA0gAygLMhcucGIuRXhwZW5zZU1vbnRobHlUb3RhbFIHYnlNb250aA==');

@$core.Deprecated('Use expenseCategoryTotalDescriptor instead')
const ExpenseCategoryTotal$json = {
  ...
  '2': [
    ...
    {'1': 'expense_count', '3': 3, '4': 1, '5': 5, '10': 'expenseCount'},
  ],
};

/// Descriptor for `ExpenseCategoryTotal`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List expenseCategoryTotalDescriptor = $convert.base64Decode(
    'ChRFeHBlbnNlQ2F0ZWdvcnlUb3RhbBIvCghjYXRlZ29yeRgBIAEoDjITLnBiLkV4cGVuc2VDYX'
    'RlZ29yeVIIY2F0ZWdvcnkSIQoMdG90YWxfYW1vdW50GAIgASgDUgt0b3RhbEFtb3VudBIjCg1l'
    'eHBlbnNlX2NvdW50GAMgASgFUgxleHBlbnNlQ291bnQ=');

@$core.Deprecated('Use expenseMonthlyTotalDescriptor instead')
const ExpenseMonthlyTotal$json = {
...
final $typed_data.Uint8List expenseMonthlyTotalDescriptor = $convert.base64Decode(
    'ChNFeHBlbnNlTW9udGhseVRvdGFsEhYKBnBlcmlvZBgBIAEoCVIGcGVyaW9kEiEKDHRvdGFsX2'
    'Ftb3VudBgCIAEoA1ILdG90YWxBbW91bnQSIwoNZXhwZW5zZV9jb3VudBgDIAEoBVIMZXhwZW5z'
    'ZUNvdW50');
...
const CreateExpenseRequest$json = {
  ...
  '2': [
    ...
    {'1': 'expense_date', '3': 6, '4': 1, '5': 9, '10': 'expenseDate'},
    ...
    {'1': 'notes', '3': 11, '4': 1, '5': 9, '10': 'notes'},
    {'1': 'supplier_id', '3': 12, '4': 1, '5': 9, '10': 'supplierId'},
  ],
};
...
final $typed_data.Uint8List createExpenseRequestDescriptor = $convert.base64Decode(
    'ChRDcmVhdGVFeHBlbnNlUmVxdWVzdBIgCgtkZXNjcmlwdGlvbhgBIAEoCVILZGVzY3JpcHRpb2'
    '4SFgoGYW1vdW50GAIgASgDUgZhbW91bnQSGgoIY3VycmVuY3kYAyABKAlSCGN1cnJlbmN5Ei8K'
    'CGNhdGVnb3J5GAQgASgOMhMucGIuRXhwZW5zZUNhdGVnb3J5UghjYXRlZ29yeRI/Cg5wYXltZW'
    '50X21ldGhvZBgFIAEoDjIYLnBiLkV4cGVuc2VQYXltZW50TWV0aG9kUg1wYXltZW50TWV0aG9k'
    'EiEKDGV4cGVuc2VfZGF0ZRgGIAEoCVILZXhwZW5zZURhdGUSFgoGdmVuZG9yGAcgASgJUgZ2ZW'
    '5kb3ISHAoJcmVmZXJlbmNlGAggASgJUglyZWZlcmVuY2USHwoLcmVjZWlwdF91cmwYCSABKAlS'
    'CnJlY2VpcHRVcmwSEgoEdGFncxgKIAMoCVIEdGFncxIUCgVub3RlcxgLIAEoCVIFbm90ZXMSHw'
    'oLc3VwcGxpZXJfaWQYDCABKAlSCnN1cHBsaWVySWQ=');
...
final $typed_data.Uint8List createExpenseResponseDescriptor = $convert.base64Decode(
    'ChVDcmVhdGVFeHBlbnNlUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZX'
    'NzYWdlGAIgASgJUgdtZXNzYWdlEiUKB2V4cGVuc2UYAyABKAsyCy5wYi5FeHBlbnNlUgdleHBl'
    'bnNl');
...
const UpdateExpenseRequest$json = {
  ...
  '2': [
    ...
    {'1': 'expense_date', '3': 8, '4': 1, '5': 9, '10': 'expenseDate'},
    {'1': 'vendor', '3': 9, '4': 1, '5': 9, '10': 'vendor'},
    {'1': 'reference', '3': 10, '4': 1, '5': 9, '10': 'reference'},
    {'1': 'receipt_url', '3': 11, '4': 1, '5': 9, '10': 'receiptUrl'},
    {'1': 'tags', '3': 12, '4': 3, '5': 9, '10': 'tags'},
    {'1': 'notes', '3': 13, '4': 1, '5': 9, '10': 'notes'},
    {'1': 'supplier_id', '3': 14, '4': 1, '5': 9, '10': 'supplierId'},
  ],
};
...
final $typed_data.Uint8List updateExpenseRequestDescriptor = $convert.base64Decode(
    'ChRVcGRhdGVFeHBlbnNlUmVxdWVzdBIdCgpleHBlbnNlX2lkGAEgASgJUglleHBlbnNlSWQSIA'
    'oLZGVzY3JpcHRpb24YAiABKAlSC2Rlc2NyaXB0aW9uEhYKBmFtb3VudBgDIAEoA1IGYW1vdW50'
    'EhoKCGN1cnJlbmN5GAQgASgJUghjdXJyZW5jeRIvCghjYXRlZ29yeRgFIAEoDjITLnBiLkV4cG'
    'Vuc2VDYXRlZ29yeVIIY2F0ZWdvcnkSPwoOcGF5bWVudF9tZXRob2QYBiABKA4yGC5wYi5FeHBl'
    'bnNlUGF5bWVudE1ldGhvZFINcGF5bWVudE1ldGhvZBIpCgZzdGF0dXMYByABKA4yES5wYi5FeH'
    'BlbnNlU3RhdHVzUgZzdGF0dXMSIQoMZXhwZW5zZV9kYXRlGAggASgJUgtleHBlbnNlRGF0ZRIW'
    'CgZ2ZW5kb3IYCSABKAlSBnZlbmRvchIcCglyZWZlcmVuY2UYCiABKAlSCXJlZmVyZW5jZRIfCg'
    'tyZWNlaXB0X3VybBgLIAEoCVIKcmVjZWlwdFVybBISCgR0YWdzGAwgAygJUgR0YWdzEhQKBW5v'
    'dGVzGA0gASgJUgVub3RlcxIfCgtzdXBwbGllcl9pZBgOIAEoCVIKc3VwcGxpZXJJZA==');
...
final $typed_data.Uint8List updateExpenseResponseDescriptor = $convert.base64Decode(
    'ChVVcGRhdGVFeHBlbnNlUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZX'
    'NzYWdlGAIgASgJUgdtZXNzYWdlEiUKB2V4cGVuc2UYAyABKAsyCy5wYi5FeHBlbnNlUgdleHBl'
    'bnNl');
...
final $typed_data.Uint8List getExpenseRequestDescriptor = $convert.base64Decode(
    'ChFHZXRFeHBlbnNlUmVxdWVzdBIdCgpleHBlbnNlX2lkGAEgASgJUglleHBlbnNlSWQ=');
...
final $typed_data.Uint8List getExpenseResponseDescriptor = $convert.base64Decode(
    'ChJHZXRFeHBlbnNlUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZXNzYW'
    'dlGAIgASgJUgdtZXNzYWdlEiUKB2V4cGVuc2UYAyABKAsyCy5wYi5FeHBlbnNlUgdleHBlbnNl');
...
const ListExpensesRequest$json = {
  ...
  '2': [
    ...
    {'1': 'min_amount', '3': 9, '4': 1, '5': 3, '10': 'minAmount'},
    {'1': 'max_amount', '3': 10, '4': 1, '5': 3, '10': 'maxAmount'},
    {'1': 'has_category', '3': 11, '4': 1, '5': 8, '10': 'hasCategory'},
    {'1': 'has_status', '3': 12, '4': 1, '5': 8, '10': 'hasStatus'},
  ],
};
...
final $typed_data.Uint8List listExpensesRequestDescriptor = $convert.base64Decode(
    'ChNMaXN0RXhwZW5zZXNSZXF1ZXN0EhIKBHBhZ2UYASABKAVSBHBhZ2USFAoFbGltaXQYAiABKA'
    'VSBWxpbWl0EhYKBnNlYXJjaBgDIAEoCVIGc2VhcmNoEi8KCGNhdGVnb3J5GAQgASgOMhMucGIu'
    'RXhwZW5zZUNhdGVnb3J5UghjYXRlZ29yeRIpCgZzdGF0dXMYBSABKA4yES5wYi5FeHBlbnNlU3'
    'RhdHVzUgZzdGF0dXMSHQoKc3RhcnRfZGF0ZRgGIAEoCVIJc3RhcnREYXRlEhkKCGVuZF9kYXRl'
    'GAcgASgJUgdlbmREYXRlEhAKA3RhZxgIIAEoCVIDdGFnEh0KCm1pbl9hbW91bnQYCSABKANSCW'
    '1pbkFtb3VudBIdCgptYXhfYW1vdW50GAogASgDUgltYXhBbW91bnQSIQoMaGFzX2NhdGVnb3J5'
    'GAsgASgIUgtoYXNDYXRlZ29yeRIdCgpoYXNfc3RhdHVzGAwgASgIUgloYXNTdGF0dXM=');
...
final $typed_data.Uint8List listExpensesResponseDescriptor = $convert.base64Decode(
    'ChRMaXN0RXhwZW5zZXNSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3'
    'NhZ2UYAiABKAlSB21lc3NhZ2USJwoIZXhwZW5zZXMYAyADKAsyCy5wYi5FeHBlbnNlUghleHBl'
    'bnNlcxI5CgpwYWdpbmF0aW9uGAQgASgLMhkucGIuUGF5cm9sbFBhZ2luYXRpb25JbmZvUgpwYW'
    'dpbmF0aW9u');

@$core.Deprecated('Use getExpenseSummaryRequestDescriptor instead')
const GetExpenseSummaryRequest$json = {
...
final $typed_data.Uint8List getExpenseSummaryRequestDescriptor =
    $convert.base64Decode(
        'ChhHZXRFeHBlbnNlU3VtbWFyeVJlcXVlc3QSHQoKc3RhcnRfZGF0ZRgBIAEoCVIJc3RhcnREYX'
        'RlEhkKCGVuZF9kYXRlGAIgASgJUgdlbmREYXRl');

@$core.Deprecated('Use getExpenseSummaryResponseDescriptor instead')
const GetExpenseSummaryResponse$json = {
...
final $typed_data.Uint8List getExpenseSummaryResponseDescriptor = $convert.base64Decode(
    'ChlHZXRFeHBlbnNlU3VtbWFyeVJlc3BvbnNlEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3MSGA'
    'oHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZRIsCgdzdW1tYXJ5GAMgASgLMhIucGIuRXhwZW5zZVN1'
    'bW1hcnlSB3N1bW1hcnk=');

@$core.Deprecated('Use approveExpenseRequestDescriptor instead')
const ApproveExpenseRequest$json = {
  '1': 'ApproveExpenseRequest',
  '2': [
    {'1': 'expense_id', '3': 1, '4': 1, '5': 9, '10': 'expenseId'},
    {'1': 'approval_notes', '3': 2, '4': 1, '5': 9, '10': 'approvalNotes'},
  ],
};

/// Descriptor for `ApproveExpenseRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List approveExpenseRequestDescriptor = $convert.base64Decode(
    'ChVBcHByb3ZlRXhwZW5zZVJlcXVlc3QSHQoKZXhwZW5zZV9pZBgBIAEoCVIJZXhwZW5zZUlkEi'
    'UKDmFwcHJvdmFsX25vdGVzGAIgASgJUg1hcHByb3ZhbE5vdGVz');

@$core.Deprecated('Use approveExpenseResponseDescriptor instead')
const ApproveExpenseResponse$json = {
...
final $typed_data.Uint8List approveExpenseResponseDescriptor = $convert.base64Decode(
    'ChZBcHByb3ZlRXhwZW5zZVJlc3BvbnNlEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3MSGAoHbW'
    'Vzc2FnZRgCIAEoCVIHbWVzc2FnZRIlCgdleHBlbnNlGAMgASgLMgsucGIuRXhwZW5zZVIHZXhw'
    'ZW5zZQ==');

@$core.Deprecated('Use markExpenseReimbursedRequestDescriptor instead')
const MarkExpenseReimbursedRequest$json = {
  '1': 'MarkExpenseReimbursedRequest',
  '2': [
    {'1': 'expense_id', '3': 1, '4': 1, '5': 9, '10': 'expenseId'},
    {
      '1': 'reimbursement_reference',
      '3': 2,
      '4': 1,
      '5': 9,
      '10': 'reimbursementReference'
    },
  ],
};

/// Descriptor for `MarkExpenseReimbursedRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List markExpenseReimbursedRequestDescriptor =
    $convert.base64Decode(
        'ChxNYXJrRXhwZW5zZVJlaW1idXJzZWRSZXF1ZXN0Eh0KCmV4cGVuc2VfaWQYASABKAlSCWV4cG'
        'Vuc2VJZBI3ChdyZWltYnVyc2VtZW50X3JlZmVyZW5jZRgCIAEoCVIWcmVpbWJ1cnNlbWVudFJl'
        'ZmVyZW5jZQ==');

@$core.Deprecated('Use markExpenseReimbursedResponseDescriptor instead')
const MarkExpenseReimbursedResponse$json = {
...
final $typed_data.Uint8List markExpenseReimbursedResponseDescriptor =
    $convert.base64Decode(
        'Ch1NYXJrRXhwZW5zZVJlaW1idXJzZWRSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZX'
        'NzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USJQoHZXhwZW5zZRgDIAEoCzILLnBiLkV4cGVu'
        'c2VSB2V4cGVuc2U=');

@$core.Deprecated('Use saleDescriptor instead')
const Sale$json = {
  '1': 'Sale',
  '2': [
    {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    ...
    {'1': 'inventory_item_id', '3': 5, '4': 1, '5': 9, '10': 'inventoryItemId'},
    {'1': 'item_name', '3': 6, '4': 1, '5': 9, '10': 'itemName'},
    {'1': 'description', '3': 7, '4': 1, '5': 9, '10': 'description'},
    {'1': 'quantity', '3': 8, '4': 1, '5': 5, '10': 'quantity'},
    {'1': 'unit_price', '3': 9, '4': 1, '5': 3, '10': 'unitPrice'},
    {'1': 'amount', '3': 10, '4': 1, '5': 3, '10': 'amount'},
    {'1': 'currency', '3': 11, '4': 1, '5': 9, '10': 'currency'},
...
/// Descriptor for `Sale`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List saleDescriptor = $convert.base64Decode(
    'CgRTYWxlEg4KAmlkGAEgASgJUgJpZBIfCgtidXNpbmVzc19pZBgCIAEoCVIKYnVzaW5lc3NJZB'
    'IfCgtjdXN0b21lcl9pZBgDIAEoCVIKY3VzdG9tZXJJZBIjCg1jdXN0b21lcl9uYW1lGAQgASgJ'
    'UgxjdXN0b21lck5hbWUSKgoRaW52ZW50b3J5X2l0ZW1faWQYBSABKAlSD2ludmVudG9yeUl0ZW'
    '1JZBIbCglpdGVtX25hbWUYBiABKAlSCGl0ZW1OYW1lEiAKC2Rlc2NyaXB0aW9uGAcgASgJUgtk'
    'ZXNjcmlwdGlvbhIaCghxdWFudGl0eRgIIAEoBVIIcXVhbnRpdHkSHQoKdW5pdF9wcmljZRgJIA'
    'EoA1IJdW5pdFByaWNlEhYKBmFtb3VudBgKIAEoA1IGYW1vdW50EhoKCGN1cnJlbmN5GAsgASgJ'
    'UghjdXJyZW5jeRIlCg5wYXltZW50X21ldGhvZBgMIAEoCVINcGF5bWVudE1ldGhvZBIWCgZzdG'
    'F0dXMYDSABKAlSBnN0YXR1cxIcCglyZWZlcmVuY2UYDiABKAlSCXJlZmVyZW5jZRIdCgpjcmVh'
    'dGVkX2F0GA8gASgJUgljcmVhdGVkQXQ=');

@$core.Deprecated('Use recordSaleRequestDescriptor instead')
const RecordSaleRequest$json = {
  '1': 'RecordSaleRequest',
  '2': [
    {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '10': 'customerId'},
...
/// Descriptor for `RecordSaleRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List recordSaleRequestDescriptor = $convert.base64Decode(
    'ChFSZWNvcmRTYWxlUmVxdWVzdBIfCgtjdXN0b21lcl9pZBgBIAEoCVIKY3VzdG9tZXJJZBIqCh'
    'FpbnZlbnRvcnlfaXRlbV9pZBgCIAEoCVIPaW52ZW50b3J5SXRlbUlkEiAKC2Rlc2NyaXB0aW9u'
    'GAMgASgJUgtkZXNjcmlwdGlvbhIaCghxdWFudGl0eRgEIAEoBVIIcXVhbnRpdHkSHQoKdW5pdF'
    '9wcmljZRgFIAEoA1IJdW5pdFByaWNlEhYKBmFtb3VudBgGIAEoA1IGYW1vdW50EhoKCGN1cnJl'
    'bmN5GAcgASgJUghjdXJyZW5jeRIlCg5wYXltZW50X21ldGhvZBgIIAEoCVINcGF5bWVudE1ldG'
    'hvZBISCgRwYWlkGAkgASgIUgRwYWlkEicKD2lkZW1wb3RlbmN5X2tleRgKIAEoCVIOaWRlbXBv'
    'dGVuY3lLZXk=');

@$core.Deprecated('Use recordSaleResponseDescriptor instead')
const RecordSaleResponse$json = {
  '1': 'RecordSaleResponse',
  '2': [
    {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    {'1': 'sale', '3': 3, '4': 1, '5': 11, '6': '.pb.Sale', '10': 'sale'},
  ],
};

/// Descriptor for `RecordSaleResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List recordSaleResponseDescriptor = $convert.base64Decode(
    'ChJSZWNvcmRTYWxlUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZXNzYW'
    'dlGAIgASgJUgdtZXNzYWdlEhwKBHNhbGUYAyABKAsyCC5wYi5TYWxlUgRzYWxl');

@$core.Deprecated('Use listSalesRequestDescriptor instead')
const ListSalesRequest$json = {
  '1': 'ListSalesRequest',
  '2': [
    {'1': 'page', '3': 1, '4': 1, '5': 5, '10': 'page'},
    {'1': 'limit', '3': 2, '4': 1, '5': 5, '10': 'limit'},
...
/// Descriptor for `ListSalesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listSalesRequestDescriptor = $convert.base64Decode(
    'ChBMaXN0U2FsZXNSZXF1ZXN0EhIKBHBhZ2UYASABKAVSBHBhZ2USFAoFbGltaXQYAiABKAVSBW'
    'xpbWl0EhYKBnN0YXR1cxgDIAEoCVIGc3RhdHVz');

@$core.Deprecated('Use listSalesResponseDescriptor instead')
const ListSalesResponse$json = {
  '1': 'ListSalesResponse',
  '2': [
    {'1': 'sales', '3': 1, '4': 3, '5': 11, '6': '.pb.Sale', '10': 'sales'},
    {
      '1': 'pagination',
      '3': 2,
      '4': 1,
...
/// Descriptor for `ListSalesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listSalesResponseDescriptor = $convert.base64Decode(
    'ChFMaXN0U2FsZXNSZXNwb25zZRIeCgVzYWxlcxgBIAMoCzIILnBiLlNhbGVSBXNhbGVzEjkKCn'
    'BhZ2luYXRpb24YAiABKAsyGS5wYi5QYXlyb2xsUGFnaW5hdGlvbkluZm9SCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List getSaleRequestDescriptor = $convert
    .base64Decode('Cg5HZXRTYWxlUmVxdWVzdBIXCgdzYWxlX2lkGAEgASgJUgZzYWxlSWQ=');
...
const GetSaleResponse$json = {
  ...
  '2': [
    {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    {'1': 'sale', '3': 2, '4': 1, '5': 11, '6': '.pb.Sale', '10': 'sale'},
  ],
};
...
final $typed_data.Uint8List getSaleResponseDescriptor = $convert.base64Decode(
    'Cg9HZXRTYWxlUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIcCgRzYWxlGAIgAS'
    'gLMggucGIuU2FsZVIEc2FsZQ==');

@$core.Deprecated('Use getSalesSummaryRequestDescriptor instead')
const GetSalesSummaryRequest$json = {
  '1': 'GetSalesSummaryRequest',
  '2': [
    {'1': 'start_date', '3': 1, '4': 1, '5': 9, '10': 'startDate'},
    {'1': 'end_date', '3': 2, '4': 1, '5': 9, '10': 'endDate'},
  ],
...
/// Descriptor for `GetSalesSummaryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSalesSummaryRequestDescriptor =
    $convert.base64Decode(
        'ChZHZXRTYWxlc1N1bW1hcnlSZXF1ZXN0Eh0KCnN0YXJ0X2RhdGUYASABKAlSCXN0YXJ0RGF0ZR'
        'IZCghlbmRfZGF0ZRgCIAEoCVIHZW5kRGF0ZQ==');

@$core.Deprecated('Use getSalesSummaryResponseDescriptor instead')
const GetSalesSummaryResponse$json = {
  '1': 'GetSalesSummaryResponse',
  '2': [
    {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    {'1': 'total_revenue', '3': 2, '4': 1, '5': 3, '10': 'totalRevenue'},
    {
      '1': 'total_receivables',
      '3': 3,
      '4': 1,
    ...
    {'1': 'sale_count', '3': 4, '4': 1, '5': 5, '10': 'saleCount'},
    {'1': 'currency', '3': 5, '4': 1, '5': 9, '10': 'currency'},
  ],
};

/// Descriptor for `GetSalesSummaryResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSalesSummaryResponseDescriptor = $convert.base64Decode(
    'ChdHZXRTYWxlc1N1bW1hcnlSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEiMKDX'
    'RvdGFsX3JldmVudWUYAiABKANSDHRvdGFsUmV2ZW51ZRIrChF0b3RhbF9yZWNlaXZhYmxlcxgD'
    'IAEoA1IQdG90YWxSZWNlaXZhYmxlcxIdCgpzYWxlX2NvdW50GAQgASgFUglzYWxlQ291bnQSGg'

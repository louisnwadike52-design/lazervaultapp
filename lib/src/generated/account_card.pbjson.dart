...
const AccountCard$json = const {
  ...
  '2': const [
    ...
    const {'1': 'card_pin', '3': 27, '4': 1, '5': 9, '10': 'cardPin'},
    const {'1': 'shipping_address', '3': 28, '4': 1, '5': 9, '10': 'shippingAddress'},
    const {'1': 'shipping_status', '3': 29, '4': 1, '5': 9, '10': 'shippingStatus'},
    const {'1': 'tracking_number', '3': 30, '4': 1, '5': 9, '10': 'trackingNumber'},
  ],
};

/// Descriptor for `AccountCard`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List accountCardDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List createVirtualCardResponseDescriptor = $convert.base64Decode('ChlDcmVhdGVWaXJ0dWFsQ2FyZFJlc3BvbnNlEikKBGNhcmQYASABKAsyFS5hY2NvdW50cy5BY2NvdW50Q2FyZFIEY2FyZA==');
...
final $typed_data.Uint8List createDisposableCardResponseDescriptor = $convert.base64Decode('ChxDcmVhdGVEaXNwb3NhYmxlQ2FyZFJlc3BvbnNlEikKBGNhcmQYASABKAsyFS5hY2NvdW50cy5BY2NvdW50Q2FyZFIEY2FyZA==');
...
const GetUserCardsResponse$json = const {
  ...
  '2': const [
    const {'1': 'cards', '3': 1, '4': 3, '5': 11, '6': '.accounts.AccountCard', '10': 'cards'},
    const {'1': 'statistics', '3': 2, '4': 1, '5': 11, '6': '.accounts.CardStatistics', '10': 'statistics'},
  ],
};

/// Descriptor for `GetUserCardsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getUserCardsResponseDescriptor = $convert.base64Decode('ChRHZXRVc2VyQ2FyZHNSZXNwb25zZRIrCgVjYXJkcxgBIAMoCzIVLmFjY291bnRzLkFjY291bnRDYXJkUgVjYXJkcxI4CgpzdGF0aXN0aWNzGAIgASgLMhguYWNjb3VudHMuQ2FyZFN0YXRpc3RpY3NSCnN0YXRpc3RpY3M=');
...
const GetCardDetailsResponse$json = const {
  ...
  '2': const [
    const {'1': 'card', '3': 1, '4': 1, '5': 11, '6': '.accounts.AccountCard', '10': 'card'},
    const {'1': 'recent_transactions', '3': 2, '4': 3, '5': 11, '6': '.accounts.CardTransaction', '10': 'recentTransactions'},
  ],
};

/// Descriptor for `GetCardDetailsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getCardDetailsResponseDescriptor = $convert.base64Decode('ChZHZXRDYXJkRGV0YWlsc1Jlc3BvbnNlEikKBGNhcmQYASABKAsyFS5hY2NvdW50cy5BY2NvdW50Q2FyZFIEY2FyZBJKChNyZWNlbnRfdHJhbnNhY3Rpb25zGAIgAygLMhkuYWNjb3VudHMuQ2FyZFRyYW5zYWN0aW9uUhJyZWNlbnRUcmFuc2FjdGlvbnM=');
...
final $typed_data.Uint8List freezeCardResponseDescriptor = $convert.base64Decode('ChJGcmVlemVDYXJkUmVzcG9uc2USKQoEY2FyZBgBIAEoCzIVLmFjY291bnRzLkFjY291bnRDYXJkUgRjYXJk');
...
final $typed_data.Uint8List unfreezeCardResponseDescriptor = $convert.base64Decode('ChRVbmZyZWV6ZUNhcmRSZXNwb25zZRIpCgRjYXJkGAEgASgLMhUuYWNjb3VudHMuQWNjb3VudENhcmRSBGNhcmQ=');
...
final $typed_data.Uint8List updateCardNicknameResponseDescriptor = $convert.base64Decode('ChpVcGRhdGVDYXJkTmlja25hbWVSZXNwb25zZRIpCgRjYXJkGAEgASgLMhUuYWNjb3VudHMuQWNjb3VudENhcmRSBGNhcmQ=');
...
final $typed_data.Uint8List updateCardSpendingLimitResponseDescriptor = $convert.base64Decode('Ch9VcGRhdGVDYXJkU3BlbmRpbmdMaW1pdFJlc3BvbnNlEikKBGNhcmQYASABKAsyFS5hY2NvdW50cy5BY2NvdW50Q2FyZFIEY2FyZA==');
...
const GetCardTransactionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'transactions', '3': 1, '4': 3, '5': 11, '6': '.accounts.CardTransaction', '10': 'transactions'},
...
final $typed_data.Uint8List getCardTransactionsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List setDefaultCardResponseDescriptor = $convert.base64Decode('ChZTZXREZWZhdWx0Q2FyZFJlc3BvbnNlEikKBGNhcmQYASABKAsyFS5hY2NvdW50cy5BY2NvdW50Q2FyZFIEY2FyZA==');
@$core.Deprecated('Use requestPhysicalCardRequestDescriptor instead')
const RequestPhysicalCardRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'currency', '3': 3, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'billing_address', '3': 4, '4': 1, '5': 9, '10': 'billingAddress'},
    const {'1': 'shipping_address', '3': 5, '4': 1, '5': 9, '10': 'shippingAddress'},
  ],
};

/// Descriptor for `RequestPhysicalCardRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List requestPhysicalCardRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use requestPhysicalCardResponseDescriptor instead')
const RequestPhysicalCardResponse$json = const {
...
final $typed_data.Uint8List requestPhysicalCardResponseDescriptor = $convert.base64Decode('ChtSZXF1ZXN0UGh5c2ljYWxDYXJkUmVzcG9uc2USKQoEY2FyZBgBIAEoCzIVLmFjY291bnRzLkFjY291bnRDYXJkUgRjYXJk');
@$core.Deprecated('Use setCardPINRequestDescriptor instead')
const SetCardPINRequest$json = const {
  '1': 'SetCardPINRequest',
  '2': const [
    const {'1': 'card_uuid', '3': 1, '4': 1, '5': 9, '10': 'cardUuid'},
...
final $typed_data.Uint8List setCardPINRequestDescriptor = $convert.base64Decode('ChFTZXRDYXJkUElOUmVxdWVzdBIbCgljYXJkX3V1aWQYASABKAlSCGNhcmRVdWlkEhAKA3BpbhgCIAEoCVIDcGlu');
@$core.Deprecated('Use setCardPINResponseDescriptor instead')
const SetCardPINResponse$json = const {
...
final $typed_data.Uint8List setCardPINResponseDescriptor = $convert.base64Decode('ChJTZXRDYXJkUElOUmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdl');
@$core.Deprecated('Use revealCardPINRequestDescriptor instead')
const RevealCardPINRequest$json = const {
...
final $typed_data.Uint8List revealCardPINRequestDescriptor = $convert.base64Decode('ChRSZXZlYWxDYXJkUElOUmVxdWVzdBIbCgljYXJkX3V1aWQYASABKAlSCGNhcmRVdWlk');
@$core.Deprecated('Use revealCardPINResponseDescriptor instead')
const RevealCardPINResponse$json = const {
  '1': 'RevealCardPINResponse',
  '2': const [
    const {'1': 'card_pin', '3': 1, '4': 1, '5': 9, '10': 'cardPin'},
  ],
};

/// Descriptor for `RevealCardPINResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List revealCardPINResponseDescriptor = $convert.base64Decode('ChVSZXZlYWxDYXJkUElOUmVzcG9uc2USGQoIY2FyZF9waW4YASABKAlSB2NhcmRQaW4=');
@$core.Deprecated('Use revealFullCardDetailsRequestDescriptor instead')
const RevealFullCardDetailsRequest$json = const {
...
final $typed_data.Uint8List revealFullCardDetailsRequestDescriptor = $convert.base64Decode('ChxSZXZlYWxGdWxsQ2FyZERldGFpbHNSZXF1ZXN0EhsKCWNhcmRfdXVpZBgBIAEoCVIIY2FyZFV1aWQ=');
@$core.Deprecated('Use revealFullCardDetailsResponseDescriptor instead')
const RevealFullCardDetailsResponse$json = const {
...
final $typed_data.Uint8List revealFullCardDetailsResponseDescriptor = $convert.base64Decode('Ch1SZXZlYWxGdWxsQ2FyZERldGFpbHNSZXNwb25zZRIpCgRjYXJkGAEgASgLMhUuYWNjb3VudHMuQWNjb3VudENhcmRSBGNhcmQ=');
@$core.Deprecated('Use fundCardRequestDescriptor instead')
const FundCardRequest$json = const {
  '1': 'FundCardRequest',
  '2': const [
    const {'1': 'card_uuid', '3': 1, '4': 1, '5': 9, '10': 'cardUuid'},
...
final $typed_data.Uint8List fundCardRequestDescriptor = $convert.base64Decode('Cg9GdW5kQ2FyZFJlcXVlc3QSGwoJY2FyZF91dWlkGAEgASgJUghjYXJkVXVpZBIWCgZhbW91bnQYAiABKAFSBmFtb3VudA==');
@$core.Deprecated('Use fundCardResponseDescriptor instead')
const FundCardResponse$json = const {
  '1': 'FundCardResponse',
  '2': const [
    const {'1': 'card', '3': 1, '4': 1, '5': 11, '6': '.accounts.AccountCard', '10': 'card'},
  ],
...
final $typed_data.Uint8List fundCardResponseDescriptor = $convert.base64Decode('ChBGdW5kQ2FyZFJlc3BvbnNlEikKBGNhcmQYASABKAsyFS5hY2NvdW50cy5BY2NvdW50Q2FyZFIEY2FyZA==');
@$core.Deprecated('Use withdrawFromCardRequestDescriptor instead')
const WithdrawFromCardRequest$json = const {
...
final $typed_data.Uint8List withdrawFromCardRequestDescriptor = $convert.base64Decode('ChdXaXRoZHJhd0Zyb21DYXJkUmVxdWVzdBIbCgljYXJkX3V1aWQYASABKAlSCGNhcmRVdWlkEhYKBmFtb3VudBgCIAEoAVIGYW1vdW50');
@$core.Deprecated('Use withdrawFromCardResponseDescriptor instead')
const WithdrawFromCardResponse$json = const {
...
final $typed_data.Uint8List withdrawFromCardResponseDescriptor = $convert.base64Decode('ChhXaXRoZHJhd0Zyb21DYXJkUmVzcG9uc2USKQoEY2FyZBgBIAEoCzIVLmFjY291bnRzLkFjY291bnRDYXJkUgRjYXJk');

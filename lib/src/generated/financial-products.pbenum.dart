...
class AutoSaveTriggerType extends $pb.ProtobufEnum {
  ...
  static final $core.List<AutoSaveTriggerType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 3);
  static AutoSaveTriggerType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const AutoSaveTriggerType._(super.value, super.name);
}
...
class AutoSaveScheduleFrequency extends $pb.ProtobufEnum {
  ...
  static final $core.List<AutoSaveScheduleFrequency?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 4);
  static AutoSaveScheduleFrequency? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const AutoSaveScheduleFrequency._(super.value, super.name);
}
...
class AutoSaveRuleStatus extends $pb.ProtobufEnum {
  static const AutoSaveRuleStatus AUTO_SAVE_STATUS_UNKNOWN =
      AutoSaveRuleStatus._(0, _omitEnumNames ? '' : 'AUTO_SAVE_STATUS_UNKNOWN');
  static const AutoSaveRuleStatus AUTO_SAVE_STATUS_ACTIVE =
      AutoSaveRuleStatus._(1, _omitEnumNames ? '' : 'AUTO_SAVE_STATUS_ACTIVE');
  static const AutoSaveRuleStatus AUTO_SAVE_STATUS_PAUSED =
      AutoSaveRuleStatus._(2, _omitEnumNames ? '' : 'AUTO_SAVE_STATUS_PAUSED');
  static const AutoSaveRuleStatus AUTO_SAVE_STATUS_COMPLETED =
      AutoSaveRuleStatus._(
          3, _omitEnumNames ? '' : 'AUTO_SAVE_STATUS_COMPLETED');
  static const AutoSaveRuleStatus AUTO_SAVE_STATUS_CANCELLED =
      AutoSaveRuleStatus._(
          4, _omitEnumNames ? '' : 'AUTO_SAVE_STATUS_CANCELLED');
  ...
  static final $core.List<AutoSaveRuleStatus?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 4);
  static AutoSaveRuleStatus? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const AutoSaveRuleStatus._(super.value, super.name);
}
...
class AutoSaveAmountType extends $pb.ProtobufEnum {
  static const AutoSaveAmountType AUTO_SAVE_AMOUNT_UNKNOWN =
      AutoSaveAmountType._(0, _omitEnumNames ? '' : 'AUTO_SAVE_AMOUNT_UNKNOWN');
  static const AutoSaveAmountType AUTO_SAVE_AMOUNT_FIXED =
      AutoSaveAmountType._(1, _omitEnumNames ? '' : 'AUTO_SAVE_AMOUNT_FIXED');
  static const AutoSaveAmountType AUTO_SAVE_AMOUNT_PERCENTAGE =
      AutoSaveAmountType._(
          2, _omitEnumNames ? '' : 'AUTO_SAVE_AMOUNT_PERCENTAGE');
  ...
  static final $core.List<AutoSaveAmountType?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static AutoSaveAmountType? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const AutoSaveAmountType._(super.value, super.name);
}

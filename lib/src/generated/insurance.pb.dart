...
class InsuranceProductFormField extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<InsuranceProductFormItemField>(
        12, _omitFieldNames ? '' : 'itemFields', $pb.PbFieldType.PM,
        subBuilder: InsuranceProductFormItemField.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(12)
  $pb.PbList<InsuranceProductFormItemField> get itemFields => $_getList(11);
}

/// One sub-field of a structured-array item (see
/// InsuranceProductFormField.item_fields).
class InsuranceProductFormItemField extends $pb.GeneratedMessage {
  ...
  InsuranceProductFormItemField._();

  factory InsuranceProductFormItemField.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory InsuranceProductFormItemField.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'InsuranceProductFormItemField',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'name')
    ..aOS(2, _omitFieldNames ? '' : 'label')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  InsuranceProductFormItemField clone() =>
      InsuranceProductFormItemField()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  InsuranceProductFormItemField copyWith(
          void Function(InsuranceProductFormItemField) updates) =>
      super.copyWith(
              (message) => updates(message as InsuranceProductFormItemField))
          as InsuranceProductFormItemField;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static InsuranceProductFormItemField create() =>
      InsuranceProductFormItemField._();
  @$core.override
  InsuranceProductFormItemField createEmptyInstance() => create();
  static $pb.PbList<InsuranceProductFormItemField> createRepeated() =>
      $pb.PbList<InsuranceProductFormItemField>();
  @$core.pragma('dart2js:noInline')
  static InsuranceProductFormItemField getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InsuranceProductFormItemField>(create);
...
class GetInsuranceCategoriesResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOB(2, _omitFieldNames ? '' : 'success')
    ..aOS(3, _omitFieldNames ? '' : 'msg')
    ..aOS(4, _omitFieldNames ? '' : 'termsLink')
    ..hasRequiredFields = false;
  ...
  /// Admin-set hosted terms & conditions URL surfaced to Flutter so
  /// the in-app webview bottom sheet on the Review step can load it.
  ...
  @$pb.TagNumber(4)
  set termsLink($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  $core.bool hasTermsLink() => $_has(3);
  @$pb.TagNumber(4)
  void clearTermsLink() => $_clearField(4);
}

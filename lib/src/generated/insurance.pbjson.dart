...
const InsuranceProductFormField$json = {
  ...
  '2': [
    ...
    {'1': 'depends_on', '3': 11, '4': 1, '5': 9, '10': 'dependsOn'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.pb.InsuranceProductFormItemField',
      '10': 'itemFields'
    },
  ],
};
...
final $typed_data.Uint8List insuranceProductFormFieldDescriptor = $convert.base64Decode(
    ...
    'lSC2Rlc2NyaXB0aW9uEh0KCnV0aWxpdHlfaWQYCiABKAlSCXV0aWxpdHlJZBIdCgpkZXBlbmRz'
    'X29uGAsgASgJUglkZXBlbmRzT24SQgoLaXRlbV9maWVsZHMYDCADKAsyIS5wYi5JbnN1cmFuY2'
    'VQcm9kdWN0Rm9ybUl0ZW1GaWVsZFIKaXRlbUZpZWxkcw==');

@$core.Deprecated('Use insuranceProductFormItemFieldDescriptor instead')
const InsuranceProductFormItemField$json = {
...
final $typed_data.Uint8List insuranceProductFormItemFieldDescriptor = $convert.base64Decode(
    'Ch1JbnN1cmFuY2VQcm9kdWN0Rm9ybUl0ZW1GaWVsZBISCgRuYW1lGAEgASgJUgRuYW1lEhQKBW'
    'xhYmVsGAIgASgJUgVsYWJlbBISCgR0eXBlGAMgASgJUgR0eXBlEhoKCHJlcXVpcmVkGAQgASgI'
    'UghyZXF1aXJlZBIYCgdvcHRpb25zGAUgAygJUgdvcHRpb25zEiAKC3BsYWNlaG9sZGVyGAYgAS'
    'gJUgtwbGFjZWhvbGRlcg==');
...
const GetInsuranceCategoriesResponse$json = {
  ...
  '2': [
    ...
    {'1': 'success', '3': 2, '4': 1, '5': 8, '10': 'success'},
    {'1': 'msg', '3': 3, '4': 1, '5': 9, '10': 'msg'},
    {'1': 'terms_link', '3': 4, '4': 1, '5': 9, '10': 'termsLink'},
  ],
};
...
final $typed_data.Uint8List getInsuranceCategoriesResponseDescriptor =
    $convert.base64Decode(
        ...
        'c3MSEAoDbXNnGAMgASgJUgNtc2cSHQoKdGVybXNfbGluaxgEIAEoCVIJdGVybXNMaW5r');

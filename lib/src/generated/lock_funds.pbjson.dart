...
final $typed_data.Uint8List piggyVaultConfigDescriptor = $convert.base64Decode(
    ...
    'ZXNjcmlwdGlvbhImCg9pc19maXhlZF9hbW91bnQYFCABKAhSDWlzRml4ZWRBbW91bnQSIQoMZm'
    'l4ZWRfYW1vdW50GBUgASgBUgtmaXhlZEFtb3VudBIpChBkdXJhdGlvbl9vcHRpb25zGBYgASgJ'
    'Ug9kdXJhdGlvbk9wdGlvbnMSMAoUcXVpY2tfYW1vdW50X29wdGlvbnMYFyABKAlSEnF1aWNrQW'
    '1vdW50T3B0aW9ucxItChJjb25maXJtYXRpb25fbm90ZXMYGCABKAlSEWNvbmZpcm1hdGlvbk5v'
    'dGVzEj0KG2NvbmZpcm1hdGlvbl9ub3Rlc19yZW5ld19vbhgZIAEoCVIYY29uZmlybWF0aW9uTm'
    '90ZXNSZW5ld09uEj8KHGNvbmZpcm1hdGlvbl9ub3Rlc19yZW5ld19vZmYYGiABKAlSGWNvbmZp'
    'cm1hdGlvbk5vdGVzUmVuZXdPZmY=');
...
final $typed_data.Uint8List createLockFundRequestDescriptor = $convert.base64Decode(
    ...
    'BpbhJFCh9pbnRlcmVzdF9kZXN0aW5hdGlvbl9hY2NvdW50X2lkGAsgASgJUhxpbnRlcmVzdERl'
    'c3RpbmF0aW9uQWNjb3VudElkEicKD2lkZW1wb3RlbmN5X2tleRgMIAEoCVIOaWRlbXBvdGVuY3'
    'lLZXkSGwoJY29uZmlnX2lkGA0gASgJUghjb25maWdJZA==');
...
final $typed_data.Uint8List topUpLockFundRequestDescriptor = $convert.base64Decode(
    ...
    'c2FjdGlvblBpbhIqChFzb3VyY2VfYWNjb3VudF9pZBgEIAEoCVIPc291cmNlQWNjb3VudElkEi'
    'cKD2lkZW1wb3RlbmN5X2tleRgFIAEoCVIOaWRlbXBvdGVuY3lLZXk=');
...
const CalculateInterestRequest$json = {
  ...
  '2': [
    ...
    {'1': 'config_id', '3': 4, '4': 1, '5': 9, '10': 'configId'},
  ],
};
...
final $typed_data.Uint8List calculateInterestRequestDescriptor = $convert.base64Decode(
    ...
    'ZGF5cxgDIAEoBVIQbG9ja0R1cmF0aW9uRGF5cxIbCgljb25maWdfaWQYBCABKAlSCGNvbmZpZ0'
    'lk');
...
final $typed_data.Uint8List renewLockFundRequestDescriptor = $convert.base64Decode(
    ...
    'QSKgoRbmV3X2R1cmF0aW9uX2RheXMYAiABKAVSD25ld0R1cmF0aW9uRGF5cxInCg9pZGVtcG90'
    'ZW5jeV9rZXkYAyABKAlSDmlkZW1wb3RlbmN5S2V5');
...
final $typed_data.Uint8List getPiggyVaultConfigsRequestDescriptor =
    $convert.base64Decode(
        ...
        'N5EhYKBmxvY2FsZRgCIAEoCVIGbG9jYWxl');

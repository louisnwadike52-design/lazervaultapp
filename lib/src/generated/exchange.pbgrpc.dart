...
class ExchangeServiceClient extends $grpc.Client {
  ...
  /// Bridge funds between two platform wallets via FX. Used when one
  /// REVENUE-currency wallet is underfunded and a sibling has surplus
  /// in another currency. Human-in-the-loop: caller (admin-gateway)
  /// must present a valid HMAC approval_token minted by the
  /// accounts-service alert email.
  $grpc.ResponseFuture<$0.AdminConvertPlatformWalletsResponse>
      adminConvertPlatformWallets(
    $0.AdminConvertPlatformWalletsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$adminConvertPlatformWallets, request,
        options: options);
  }

  /// Preview the rate + computed source-amount without executing.
  /// The dashboard calls this on the bridge approval screen.
  $grpc.ResponseFuture<$0.AdminBridgePreviewResponse> adminBridgePreview(
    $0.AdminBridgePreviewRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$adminBridgePreview, request, options: options);
  }
  ...
  static final _$adminConvertPlatformWallets = $grpc.ClientMethod<
          $0.AdminConvertPlatformWalletsRequest,
          $0.AdminConvertPlatformWalletsResponse>(
      '/exchange.ExchangeService/AdminConvertPlatformWallets',
      ($0.AdminConvertPlatformWalletsRequest value) => value.writeToBuffer(),
      $0.AdminConvertPlatformWalletsResponse.fromBuffer);
  static final _$adminBridgePreview = $grpc.ClientMethod<
          $0.AdminBridgePreviewRequest, $0.AdminBridgePreviewResponse>(
      '/exchange.ExchangeService/AdminBridgePreview',
      ($0.AdminBridgePreviewRequest value) => value.writeToBuffer(),
      $0.AdminBridgePreviewResponse.fromBuffer);
}
...
abstract class ExchangeServiceBase extends $grpc.Service {
  ...
  ExchangeServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.AdminConvertPlatformWalletsRequest,
            $0.AdminConvertPlatformWalletsResponse>(
        'AdminConvertPlatformWallets',
        adminConvertPlatformWallets_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.AdminConvertPlatformWalletsRequest.fromBuffer(value),
        ($0.AdminConvertPlatformWalletsResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.AdminBridgePreviewRequest,
            $0.AdminBridgePreviewResponse>(
        'AdminBridgePreview',
        adminBridgePreview_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.AdminBridgePreviewRequest.fromBuffer(value),
        ($0.AdminBridgePreviewResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.AdminConvertPlatformWalletsResponse>
      adminConvertPlatformWallets_Pre($grpc.ServiceCall $call,
          $async.Future<$0.AdminConvertPlatformWalletsRequest> $request) async {
    return adminConvertPlatformWallets($call, await $request);
  }

  $async.Future<$0.AdminConvertPlatformWalletsResponse>
      adminConvertPlatformWallets($grpc.ServiceCall call,
          $0.AdminConvertPlatformWalletsRequest request);

  $async.Future<$0.AdminBridgePreviewResponse> adminBridgePreview_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.AdminBridgePreviewRequest> $request) async {
    return adminBridgePreview($call, await $request);
  }

  $async.Future<$0.AdminBridgePreviewResponse> adminBridgePreview(
      $grpc.ServiceCall call, $0.AdminBridgePreviewRequest request);
}

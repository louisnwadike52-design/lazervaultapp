...
class ExchangeServiceClient extends $grpc.Client {
  ...
  static final _$getExchangeLimits = $grpc.ClientMethod<$0.GetExchangeLimitsRequest, $0.GetExchangeLimitsResponse>(
      '/exchange.ExchangeService/GetExchangeLimits',
      ($0.GetExchangeLimitsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetExchangeLimitsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetExchangeLimitsResponse> getExchangeLimits($0.GetExchangeLimitsRequest request, {$grpc.CallOptions? options}) {
...
abstract class ExchangeServiceBase extends $grpc.Service {
  ...
  ExchangeServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetExchangeLimitsRequest, $0.GetExchangeLimitsResponse>(
        'GetExchangeLimits',
        getExchangeLimits_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetExchangeLimitsRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetExchangeLimitsResponse> getExchangeLimits_Pre($grpc.ServiceCall call, $async.Future<$0.GetExchangeLimitsRequest> request) async {
  ...
  $async.Future<$0.GetExchangeLimitsResponse> getExchangeLimits($grpc.ServiceCall call, $0.GetExchangeLimitsRequest request);

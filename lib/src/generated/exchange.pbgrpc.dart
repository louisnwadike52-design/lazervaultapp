...
class ExchangeServiceClient extends $grpc.Client {
  ...
  static final _$adminConvertPlatformWallets = $grpc.ClientMethod<
          $16.AdminConvertPlatformWalletsRequest,
          $16.AdminConvertPlatformWalletsResponse>(
      '/exchange.ExchangeService/AdminConvertPlatformWallets',
      ($16.AdminConvertPlatformWalletsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $16.AdminConvertPlatformWalletsResponse.fromBuffer(value));
  static final _$adminBridgePreview = $grpc.ClientMethod<
          $16.AdminBridgePreviewRequest, $16.AdminBridgePreviewResponse>(
      '/exchange.ExchangeService/AdminBridgePreview',
      ($16.AdminBridgePreviewRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $16.AdminBridgePreviewResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$16.AdminConvertPlatformWalletsResponse>
      adminConvertPlatformWallets(
          $16.AdminConvertPlatformWalletsRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$adminConvertPlatformWallets, request,
        options: options);
  }

  $grpc.ResponseFuture<$16.AdminBridgePreviewResponse> adminBridgePreview(
      $16.AdminBridgePreviewRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ExchangeServiceBase extends $grpc.Service {
  ...
  ExchangeServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$16.AdminConvertPlatformWalletsRequest,
            $16.AdminConvertPlatformWalletsResponse>(
        'AdminConvertPlatformWallets',
        ...
        false,
        ($core.List<$core.int> value) =>
            $16.AdminConvertPlatformWalletsRequest.fromBuffer(value),
        ($16.AdminConvertPlatformWalletsResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$16.AdminBridgePreviewRequest,
            $16.AdminBridgePreviewResponse>(
        'AdminBridgePreview',
        adminBridgePreview_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $16.AdminBridgePreviewRequest.fromBuffer(value),
        ($16.AdminBridgePreviewResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$16.AdminConvertPlatformWalletsResponse>
      adminConvertPlatformWallets_Pre($grpc.ServiceCall call,
          $async.Future<$16.AdminConvertPlatformWalletsRequest> request) async {
    return adminConvertPlatformWallets(call, await request);
  }

  $async.Future<$16.AdminBridgePreviewResponse> adminBridgePreview_Pre(
      $grpc.ServiceCall call,
      $async.Future<$16.AdminBridgePreviewRequest> request) async {
  ...
  $async.Future<$16.AdminConvertPlatformWalletsResponse>
      adminConvertPlatformWallets($grpc.ServiceCall call,
          $16.AdminConvertPlatformWalletsRequest request);
  $async.Future<$16.AdminBridgePreviewResponse> adminBridgePreview(
      $grpc.ServiceCall call, $16.AdminBridgePreviewRequest request);
}

...
const TagPayTransaction$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 11, '4': 1, '5': 14, '6': '.tag_pay.TagPayTransactionStatus', '10': 'status'},
    const {'1': 'type', '3': 12, '4': 1, '5': 14, '6': '.tag_pay.TagPayTransactionType', '10': 'type'},
...
final $typed_data.Uint8List tagPayTransactionDescriptor = $convert.base64Decode('');
...
const MoneyRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'currency', '3': 9, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'description', '3': 10, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'status', '3': 11, '4': 1, '5': 14, '6': '.tag_pay.MoneyRequestStatus', '10': 'status'},
...
final $typed_data.Uint8List moneyRequestDescriptor = $convert.base64Decode('');
...
const UserTag$json = const {
  ...
  '2': const [
    ...
    const {'1': 'currency', '3': 9, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'description', '3': 10, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'status', '3': 11, '4': 1, '5': 14, '6': '.tag_pay.TagStatus', '10': 'status'},
    const {'1': 'created_at', '3': 12, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createdAt'},
...
final $typed_data.Uint8List userTagDescriptor = $convert.base64Decode('');
...
const CreateTagPayResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tag_pay', '3': 3, '4': 1, '5': 11, '6': '.tag_pay.TagPay', '10': 'tagPay'},
  ],
};

/// Descriptor for `CreateTagPayResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createTagPayResponseDescriptor = $convert.base64Decode('ChRDcmVhdGVUYWdQYXlSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USKAoHdGFnX3BheRgDIAEoCzIPLnRhZ19wYXkuVGFnUGF5UgZ0YWdQYXk=');
...
final $typed_data.Uint8List getTagPayResponseDescriptor = $convert.base64Decode('ChFHZXRUYWdQYXlSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USKAoHdGFnX3BheRgDIAEoCzIPLnRhZ19wYXkuVGFnUGF5UgZ0YWdQYXk=');
...
const SearchTagPayResponse$json = const {
  ...
  '2': const [
    const {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.tag_pay.TagPay', '10': 'results'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
  ],
};

/// Descriptor for `SearchTagPayResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchTagPayResponseDescriptor = $convert.base64Decode('ChRTZWFyY2hUYWdQYXlSZXNwb25zZRIpCgdyZXN1bHRzGAEgAygLMg8udGFnX3BheS5UYWdQYXlSB3Jlc3VsdHMSFAoFdG90YWwYAiABKAVSBXRvdGFs');
...
const SendMoneyTagPayResponse$json = const {
  ...
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'transaction', '3': 3, '4': 1, '5': 11, '6': '.tag_pay.TagPayTransaction', '10': 'transaction'},
  ],
};

/// Descriptor for `SendMoneyTagPayResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sendMoneyTagPayResponseDescriptor = $convert.base64Decode('ChdTZW5kTW9uZXlUYWdQYXlSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USPAoLdHJhbnNhY3Rpb24YAyABKAsyGi50YWdfcGF5LlRhZ1BheVRyYW5zYWN0aW9uUgt0cmFuc2FjdGlvbg==');
...
const RequestMoneyTagPayResponse$json = const {
  ...
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'money_request', '3': 3, '4': 1, '5': 11, '6': '.tag_pay.MoneyRequest', '10': 'moneyRequest'},
  ],
};

/// Descriptor for `RequestMoneyTagPayResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List requestMoneyTagPayResponseDescriptor = $convert.base64Decode('ChpSZXF1ZXN0TW9uZXlUYWdQYXlSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USOgoNbW9uZXlfcmVxdWVzdBgDIAEoCzIVLnRhZ19wYXkuTW9uZXlSZXF1ZXN0Ugxtb25leVJlcXVlc3Q=');
...
const GetTagPayTransactionsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'limit', '3': 2, '4': 1, '5': 5, '10': 'limit'},
    const {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.tag_pay.TagPayTransactionType', '10': 'type'},
  ],
};

/// Descriptor for `GetTagPayTransactionsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getTagPayTransactionsRequestDescriptor = $convert.base64Decode('ChxHZXRUYWdQYXlUcmFuc2FjdGlvbnNSZXF1ZXN0EhIKBHBhZ2UYASABKAVSBHBhZ2USFAoFbGltaXQYAiABKAVSBWxpbWl0EjIKBHR5cGUYAyABKA4yHi50YWdfcGF5LlRhZ1BheVRyYW5zYWN0aW9uVHlwZVIEdHlwZQ==');
...
const GetTagPayTransactionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'transactions', '3': 1, '4': 3, '5': 11, '6': '.tag_pay.TagPayTransaction', '10': 'transactions'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
...
final $typed_data.Uint8List getTagPayTransactionsResponseDescriptor = $convert.base64Decode('Ch1HZXRUYWdQYXlUcmFuc2FjdGlvbnNSZXNwb25zZRI+Cgx0cmFuc2FjdGlvbnMYASADKAsyGi50YWdfcGF5LlRhZ1BheVRyYW5zYWN0aW9uUgx0cmFuc2FjdGlvbnMSFAoFdG90YWwYAiABKAVSBXRvdGFsEhIKBHBhZ2UYAyABKAVSBHBhZ2USHwoLdG90YWxfcGFnZXMYBCABKAVSCnRvdGFsUGFnZXM=');
...
final $typed_data.Uint8List acceptMoneyRequestResponseDescriptor = $convert.base64Decode('ChpBY2NlcHRNb25leVJlcXVlc3RSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USPAoLdHJhbnNhY3Rpb24YAyABKAsyGi50YWdfcGF5LlRhZ1BheVRyYW5zYWN0aW9uUgt0cmFuc2FjdGlvbg==');
...
const GetPendingMoneyRequestsResponse$json = const {
  ...
  '2': const [
    const {'1': 'requests', '3': 1, '4': 3, '5': 11, '6': '.tag_pay.MoneyRequest', '10': 'requests'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'total_pages', '3': 4, '4': 1, '5': 5, '10': 'totalPages'},
  ],
...
final $typed_data.Uint8List getPendingMoneyRequestsResponseDescriptor = $convert.base64Decode('Ch9HZXRQZW5kaW5nTW9uZXlSZXF1ZXN0c1Jlc3BvbnNlEjEKCHJlcXVlc3RzGAEgAygLMhUudGFnX3BheS5Nb25leVJlcXVlc3RSCHJlcXVlc3RzEhQKBXRvdGFsGAIgASgFUgV0b3RhbBISCgRwYWdlGAMgASgFUgRwYWdlEh8KC3RvdGFsX3BhZ2VzGAQgASgFUgp0b3RhbFBhZ2Vz');
...
const CreateTagResponse$json = const {
  ...
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'tag', '3': 3, '4': 1, '5': 11, '6': '.tag_pay.UserTag', '10': 'tag'},
  ],
};

/// Descriptor for `CreateTagResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createTagResponseDescriptor = $convert.base64Decode('ChFDcmVhdGVUYWdSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USIgoDdGFnGAMgASgLMhAudGFnX3BheS5Vc2VyVGFnUgN0YWc=');
...
const GetMyTagsRequest$json = const {
  ...
  '2': const [
    const {'1': 'page', '3': 1, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'limit', '3': 2, '4': 1, '5': 5, '10': 'limit'},
    const {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.tag_pay.TagStatus', '10': 'status'},
  ],
};

/// Descriptor for `GetMyTagsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMyTagsRequestDescriptor = $convert.base64Decode('ChBHZXRNeVRhZ3NSZXF1ZXN0EhIKBHBhZ2UYASABKAVSBHBhZ2USFAoFbGltaXQYAiABKAVSBWxpbWl0EioKBnN0YXR1cxgDIAEoDjISLnRhZ19wYXkuVGFnU3RhdHVzUgZzdGF0dXM=');
@$core.Deprecated('Use getMyTagsResponseDescriptor instead')
const GetMyTagsResponse$json = const {
  '1': 'GetMyTagsResponse',
  '2': const [
    const {'1': 'tags', '3': 1, '4': 3, '5': 11, '6': '.tag_pay.UserTag', '10': 'tags'},
    const {'1': 'total', '3': 2, '4': 1, '5': 5, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'total_pages', '3': 4, '4': 1, '5': 5, '10': 'totalPages'},
  ],
...
final $typed_data.Uint8List getMyTagsResponseDescriptor = $convert.base64Decode('ChFHZXRNeVRhZ3NSZXNwb25zZRIkCgR0YWdzGAEgAygLMhAudGFnX3BheS5Vc2VyVGFnUgR0YWdzEhQKBXRvdGFsGAIgASgFUgV0b3RhbBISCgRwYWdlGAMgASgFUgRwYWdlEh8KC3RvdGFsX3BhZ2VzGAQgASgFUgp0b3RhbFBhZ2Vz');
...
final $typed_data.Uint8List payTagResponseDescriptor = $convert.base64Decode('Cg5QYXlUYWdSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USPAoLdHJhbnNhY3Rpb24YAyABKAsyGi50YWdfcGF5LlRhZ1BheVRyYW5zYWN0aW9uUgt0cmFuc2FjdGlvbg==');
...
const SearchUsersForTagResponse$json = const {
  ...
  '2': const [
    const {'1': 'users', '3': 1, '4': 3, '5': 11, '6': '.tag_pay.UserSearchResult', '10': 'users'},
  ],
};

/// Descriptor for `SearchUsersForTagResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchUsersForTagResponseDescriptor = $convert.base64Decode('ChlTZWFyY2hVc2Vyc0ZvclRhZ1Jlc3BvbnNlEi8KBXVzZXJzGAEgAygLMhkudGFnX3BheS5Vc2VyU2VhcmNoUmVzdWx0UgV1c2Vycw==');
...
const BatchCreateTagsResponse$json = const {
  ...
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'tags', '3': 3, '4': 3, '5': 11, '6': '.tag_pay.UserTag', '10': 'tags'},
...
final $typed_data.Uint8List batchCreateTagsResponseDescriptor = $convert.base64Decode('ChdCYXRjaENyZWF0ZVRhZ3NSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USJAoEdGFncxgDIAMoCzIQLnRhZ19wYXkuVXNlclRhZ1IEdGFncxIhCgxmYWlsZWRfdXNlcnMYBCADKAlSC2ZhaWxlZFVzZXJz');

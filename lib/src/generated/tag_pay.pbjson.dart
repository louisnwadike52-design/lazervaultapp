...
const MoneyRequestStatus$json = {
  ...
  '2': [
    ...
    {'1': 'MONEY_REQUEST_STATUS_PAYING', '2': 5},
  ],
};
...
final $typed_data.Uint8List moneyRequestStatusDescriptor = $convert.base64Decode(
    ...
    'lfUkVRVUVTVF9TVEFUVVNfQ0FOQ0VMTEVEEAQSHwobTU9ORVlfUkVRVUVTVF9TVEFUVVNfUEFZ'
    'SU5HEAU=');
...
const TagPayTransaction$json = {
  ...
  '2': [
    ...
    {'1': 'description', '3': 10, '4': 1, '5': 9, '10': 'description'},
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.tag_pay.TagPayTransactionStatus',
      '10': 'status'
    },
    {
      '1': 'type',
      ...
      '4': 1,
      '5': 14,
      '6': '.tag_pay.TagPayTransactionType',
      '10': 'type'
    },

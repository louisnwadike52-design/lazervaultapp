...
const StartVoiceSessionRequest$json = {
  ...
  '2': [
    ...
    {'1': 'user_country', '3': 5, '4': 1, '5': 9, '10': 'userCountry'},
  ],
};
...
final $typed_data.Uint8List startVoiceSessionRequestDescriptor = $convert.base64Decode(
    ...
    'IAEoCVIPdm9pY2VQcmVmZXJlbmNlEhYKBmxvY2FsZRgEIAEoCVIGbG9jYWxlEiEKDHVzZXJfY2'
    '91bnRyeRgFIAEoCVILdXNlckNvdW50cnk=');
...
final $typed_data.Uint8List processVoiceNoteResponseDescriptor = $convert.base64Decode(
    ...
    'NzaW5nIHRpbWUgaW4gbWlsbGlzZWNvbmRzLlIQcHJvY2Vzc2luZ1RpbWVNczpfkkFcCloqG1By'
    'b2Nlc3MgVm9pY2UgTm90ZSBSZXNwb25zZTI7Q29udGFpbnMgdGhlIEFJJ3MgcmVzcG9uc2UgYm'
    'FzZWQgb24gdGhlIHZvaWNlIG5vdGUgY29udGVudC4=');

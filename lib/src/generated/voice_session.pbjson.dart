...
const StartVoiceSessionRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'voice_preference', '3': 3, '4': 1, '5': 9, '10': 'voicePreference'},
    const {'1': 'locale', '3': 4, '4': 1, '5': 9, '10': 'locale'},
    const {'1': 'user_country', '3': 5, '4': 1, '5': 9, '10': 'userCountry'},
  ],
};

/// Descriptor for `StartVoiceSessionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List startVoiceSessionRequestDescriptor = $convert.base64Decode('ChhTdGFydFZvaWNlU2Vzc2lvblJlcXVlc3QSIQoMc2VydmljZV9uYW1lGAEgASgJUgtzZXJ2aWNlTmFtZRIaCghsYW5ndWFnZRgCIAEoCVIIbGFuZ3VhZ2USKQoQdm9pY2VfcHJlZmVyZW5jZRgDIAEoCVIPdm9pY2VQcmVmZXJlbmNlEhYKBmxvY2FsZRgEIAEoCVIGbG9jYWxlEiEKDHVzZXJfY291bnRyeRgFIAEoCVILdXNlckNvdW50cnk=');
...
final $typed_data.Uint8List processVoiceNoteResponseDescriptor = $convert.base64Decode('');

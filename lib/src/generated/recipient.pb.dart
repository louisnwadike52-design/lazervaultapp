...
import 'google/protobuf/wrappers.pb.dart' as $38;
...
class UpdateRecipientRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateRecipientRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pb'), createEmptyInstance: create)
    ...
    ..aOM<$38.StringValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name', subBuilder: $38.StringValue.create)
    ..aOM<$38.BoolValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isFavorite', subBuilder: $38.BoolValue.create)
    ..aOM<$38.StringValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountNumber', subBuilder: $38.StringValue.create)
  ...
  factory UpdateRecipientRequest({
    ...
    $38.StringValue? name,
    $38.BoolValue? isFavorite,
    $38.StringValue? accountNumber,
  ...
  @$pb.TagNumber(2)
  $38.StringValue get name => $_getN(1);
  @$pb.TagNumber(2)
  set name($38.StringValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasName() => $_has(1);
  @$pb.TagNumber(2)
  void clearName() => clearField(2);
  @$pb.TagNumber(2)
  $38.StringValue ensureName() => $_ensure(1);

  @$pb.TagNumber(3)
  $38.BoolValue get isFavorite => $_getN(2);
  @$pb.TagNumber(3)
  set isFavorite($38.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasIsFavorite() => $_has(2);
  @$pb.TagNumber(3)
  void clearIsFavorite() => clearField(3);
  @$pb.TagNumber(3)
  $38.BoolValue ensureIsFavorite() => $_ensure(2);

  @$pb.TagNumber(4)
  $38.StringValue get accountNumber => $_getN(3);
  @$pb.TagNumber(4)
  set accountNumber($38.StringValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAccountNumber() => $_has(3);
  @$pb.TagNumber(4)
  void clearAccountNumber() => clearField(4);
  @$pb.TagNumber(4)
  $38.StringValue ensureAccountNumber() => $_ensure(3);

  @$pb.TagNumber(5)
  $38.StringValue get sortCode => $_getN(4);
  @$pb.TagNumber(5)
  set sortCode($38.StringValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasSortCode() => $_has(4);
  @$pb.TagNumber(5)
  void clearSortCode() => clearField(5);
  @$pb.TagNumber(5)
  $38.StringValue ensureSortCode() => $_ensure(4);

  @$pb.TagNumber(6)
  $38.StringValue get bankName => $_getN(5);
  @$pb.TagNumber(6)
  set bankName($38.StringValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasBankName() => $_has(5);
  @$pb.TagNumber(6)
  void clearBankName() => clearField(6);
  @$pb.TagNumber(6)
  $38.StringValue ensureBankName() => $_ensure(5);

  @$pb.TagNumber(7)
  $38.StringValue get countryCode => $_getN(6);
  @$pb.TagNumber(7)
  set countryCode($38.StringValue v) { setField(7, v); }
  @$pb.TagNumber(7)

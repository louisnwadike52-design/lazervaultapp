...
class SmsCampaign extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmsCampaign', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'bulksms'), createEmptyInstance: create)
    ...
    ..aOM<$49.Timestamp>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduledAt', subBuilder: $49.Timestamp.create)
    ..aOM<$49.Timestamp>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completedAt', subBuilder: $49.Timestamp.create)
  ...
  @$pb.TagNumber(17)
  $49.Timestamp get scheduledAt => $_getN(16);
  @$pb.TagNumber(17)
  set scheduledAt($49.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasScheduledAt() => $_has(16);
  @$pb.TagNumber(17)
  void clearScheduledAt() => clearField(17);
  @$pb.TagNumber(17)
  $49.Timestamp ensureScheduledAt() => $_ensure(16);

  @$pb.TagNumber(18)
  $49.Timestamp get completedAt => $_getN(17);
  @$pb.TagNumber(18)
  set completedAt($49.Timestamp v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasCompletedAt() => $_has(17);
  @$pb.TagNumber(18)
  void clearCompletedAt() => clearField(18);
  @$pb.TagNumber(18)
  $49.Timestamp ensureCompletedAt() => $_ensure(17);
...
class SmsDeliveryReport extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmsDeliveryReport', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'bulksms'), createEmptyInstance: create)
    ...
    ..aOM<$49.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sentAt', subBuilder: $49.Timestamp.create)
    ..aOM<$49.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deliveredAt', subBuilder: $49.Timestamp.create)
  ...
  @$pb.TagNumber(7)
  $49.Timestamp get sentAt => $_getN(6);
  @$pb.TagNumber(7)
  set sentAt($49.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasSentAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearSentAt() => clearField(7);
  @$pb.TagNumber(7)
  $49.Timestamp ensureSentAt() => $_ensure(6);

  @$pb.TagNumber(8)
  $49.Timestamp get deliveredAt => $_getN(7);
  @$pb.TagNumber(8)
  set deliveredAt($49.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasDeliveredAt() => $_has(7);
  @$pb.TagNumber(8)
  void clearDeliveredAt() => clearField(8);
  @$pb.TagNumber(8)
  $49.Timestamp ensureDeliveredAt() => $_ensure(7);
...
class SmsBalance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmsBalance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'bulksms'), createEmptyInstance: create)
    ...
    ..aOM<$49.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastPurchaseAt', subBuilder: $49.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $49.Timestamp get lastPurchaseAt => $_getN(2);
  @$pb.TagNumber(3)
  set lastPurchaseAt($49.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasLastPurchaseAt() => $_has(2);
  @$pb.TagNumber(3)
  void clearLastPurchaseAt() => clearField(3);
  @$pb.TagNumber(3)
  $49.Timestamp ensureLastPurchaseAt() => $_ensure(2);
}
...
class SenderId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SenderId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'bulksms'), createEmptyInstance: create)
    ...
    ..aOM<$49.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestedAt', subBuilder: $49.Timestamp.create)
    ..aOM<$49.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedAt', subBuilder: $49.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $49.Timestamp get requestedAt => $_getN(5);
  @$pb.TagNumber(6)
  set requestedAt($49.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRequestedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearRequestedAt() => clearField(6);
  @$pb.TagNumber(6)
  $49.Timestamp ensureRequestedAt() => $_ensure(5);

  @$pb.TagNumber(7)
  $49.Timestamp get approvedAt => $_getN(6);
  @$pb.TagNumber(7)
  set approvedAt($49.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasApprovedAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearApprovedAt() => clearField(7);
  @$pb.TagNumber(7)
  $49.Timestamp ensureApprovedAt() => $_ensure(6);
...
class ScheduleSmsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScheduleSmsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'bulksms'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageTemplate')
    ..pc<SmsRecipient>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recipients', $pb.PbFieldType.PM, subBuilder: SmsRecipient.create)
    ..aOM<$49.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduledAt', subBuilder: $49.Timestamp.create)
  ...
  @$pb.TagNumber(5)
  $49.Timestamp get scheduledAt => $_getN(4);
  @$pb.TagNumber(5)
  set scheduledAt($49.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasScheduledAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearScheduledAt() => clearField(5);
  @$pb.TagNumber(5)
  $49.Timestamp ensureScheduledAt() => $_ensure(4);

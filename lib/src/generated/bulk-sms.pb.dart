...
class SmsRecipientGroup extends $pb.GeneratedMessage {
  ...
  factory SmsRecipientGroup({
    ...
    $core.Iterable<SmsRecipient>? members,
  ...
  @$pb.TagNumber(5)
  $core.List<SmsRecipient> get members => $_getList(4);
...
class CreateRecipientGroupRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $core.List<SmsRecipient> get members => $_getList(1);
}
...
class ListRecipientGroupsResponse extends $pb.GeneratedMessage {
  ...
  factory ListRecipientGroupsResponse({
    $core.Iterable<SmsRecipientGroup>? groups,
  }) {
    final _result = create();
    if (groups != null) {
  ...
  @$pb.TagNumber(1)
  $core.List<SmsRecipientGroup> get groups => $_getList(0);
}
...
class UpdateRecipientGroupRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  $core.List<SmsRecipient> get members => $_getList(2);
}
...
class RecipientGroupResponse extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(1)
  SmsRecipientGroup ensureGroup() => $_ensure(0);
}
...
class ApproveSenderIdRequest extends $pb.GeneratedMessage {
  ...
  factory ApproveSenderIdRequest({
    $core.String? senderIdRecordId,
  }) {
    final _result = create();
    if (senderIdRecordId != null) {
      _result.senderIdRecordId = senderIdRecordId;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(1)
  void clearSenderIdRecordId() => clearField(1);
}

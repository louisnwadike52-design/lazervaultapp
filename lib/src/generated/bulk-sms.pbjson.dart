...
@$core.Deprecated('Use smsRecipientGroupDescriptor instead')
const SmsRecipientGroup$json = const {
  '1': 'SmsRecipientGroup',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'user_id', '3': 2, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'name', '3': 3, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'member_count', '3': 4, '4': 1, '5': 5, '10': 'memberCount'},
    const {'1': 'members', '3': 5, '4': 3, '5': 11, '6': '.bulksms.SmsRecipient', '10': 'members'},
    const {'1': 'created_at', '3': 6, '4': 1, '5': 9, '10': 'createdAt'},
    const {'1': 'updated_at', '3': 7, '4': 1, '5': 9, '10': 'updatedAt'},
  ],
};

/// Descriptor for `SmsRecipientGroup`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List smsRecipientGroupDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use createRecipientGroupRequestDescriptor instead')
const CreateRecipientGroupRequest$json = const {
  '1': 'CreateRecipientGroupRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'members', '3': 2, '4': 3, '5': 11, '6': '.bulksms.SmsRecipient', '10': 'members'},
  ],
};

/// Descriptor for `CreateRecipientGroupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createRecipientGroupRequestDescriptor = $convert.base64Decode('ChtDcmVhdGVSZWNpcGllbnRHcm91cFJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIvCgdtZW1iZXJzGAIgAygLMhUuYnVsa3Ntcy5TbXNSZWNpcGllbnRSB21lbWJlcnM=');
@$core.Deprecated('Use listRecipientGroupsRequestDescriptor instead')
const ListRecipientGroupsRequest$json = const {
  '1': 'ListRecipientGroupsRequest',
};

/// Descriptor for `ListRecipientGroupsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listRecipientGroupsRequestDescriptor = $convert.base64Decode('ChpMaXN0UmVjaXBpZW50R3JvdXBzUmVxdWVzdA==');
@$core.Deprecated('Use listRecipientGroupsResponseDescriptor instead')
const ListRecipientGroupsResponse$json = const {
  '1': 'ListRecipientGroupsResponse',
  '2': const [
    const {'1': 'groups', '3': 1, '4': 3, '5': 11, '6': '.bulksms.SmsRecipientGroup', '10': 'groups'},
  ],
};

/// Descriptor for `ListRecipientGroupsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listRecipientGroupsResponseDescriptor = $convert.base64Decode('ChtMaXN0UmVjaXBpZW50R3JvdXBzUmVzcG9uc2USMgoGZ3JvdXBzGAEgAygLMhouYnVsa3Ntcy5TbXNSZWNpcGllbnRHcm91cFIGZ3JvdXBz');
@$core.Deprecated('Use getRecipientGroupRequestDescriptor instead')
const GetRecipientGroupRequest$json = const {
  '1': 'GetRecipientGroupRequest',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 9, '10': 'groupId'},
  ],
};

/// Descriptor for `GetRecipientGroupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getRecipientGroupRequestDescriptor = $convert.base64Decode('ChhHZXRSZWNpcGllbnRHcm91cFJlcXVlc3QSGQoIZ3JvdXBfaWQYASABKAlSB2dyb3VwSWQ=');
@$core.Deprecated('Use updateRecipientGroupRequestDescriptor instead')
const UpdateRecipientGroupRequest$json = const {
  '1': 'UpdateRecipientGroupRequest',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 9, '10': 'groupId'},
    const {'1': 'name', '3': 2, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'members', '3': 3, '4': 3, '5': 11, '6': '.bulksms.SmsRecipient', '10': 'members'},
  ],
};

/// Descriptor for `UpdateRecipientGroupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateRecipientGroupRequestDescriptor = $convert.base64Decode('ChtVcGRhdGVSZWNpcGllbnRHcm91cFJlcXVlc3QSGQoIZ3JvdXBfaWQYASABKAlSB2dyb3VwSWQSEgoEbmFtZRgCIAEoCVIEbmFtZRIvCgdtZW1iZXJzGAMgAygLMhUuYnVsa3Ntcy5TbXNSZWNpcGllbnRSB21lbWJlcnM=');
@$core.Deprecated('Use deleteRecipientGroupRequestDescriptor instead')
const DeleteRecipientGroupRequest$json = const {
  '1': 'DeleteRecipientGroupRequest',
  '2': const [
    const {'1': 'group_id', '3': 1, '4': 1, '5': 9, '10': 'groupId'},
  ],
};

/// Descriptor for `DeleteRecipientGroupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteRecipientGroupRequestDescriptor = $convert.base64Decode('ChtEZWxldGVSZWNpcGllbnRHcm91cFJlcXVlc3QSGQoIZ3JvdXBfaWQYASABKAlSB2dyb3VwSWQ=');
@$core.Deprecated('Use deleteRecipientGroupResponseDescriptor instead')
const DeleteRecipientGroupResponse$json = const {
  '1': 'DeleteRecipientGroupResponse',
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
  ],
...
/// Descriptor for `DeleteRecipientGroupResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deleteRecipientGroupResponseDescriptor = $convert.base64Decode('ChxEZWxldGVSZWNpcGllbnRHcm91cFJlc3BvbnNlEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3MSGAoHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZQ==');
@$core.Deprecated('Use recipientGroupResponseDescriptor instead')
const RecipientGroupResponse$json = const {
  '1': 'RecipientGroupResponse',
  '2': const [
    const {'1': 'group', '3': 1, '4': 1, '5': 11, '6': '.bulksms.SmsRecipientGroup', '10': 'group'},
  ],
};

/// Descriptor for `RecipientGroupResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List recipientGroupResponseDescriptor = $convert.base64Decode('ChZSZWNpcGllbnRHcm91cFJlc3BvbnNlEjAKBWdyb3VwGAEgASgLMhouYnVsa3Ntcy5TbXNSZWNpcGllbnRHcm91cFIFZ3JvdXA=');
@$core.Deprecated('Use listPendingSenderIdsRequestDescriptor instead')
const ListPendingSenderIdsRequest$json = const {
  '1': 'ListPendingSenderIdsRequest',
};

/// Descriptor for `ListPendingSenderIdsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listPendingSenderIdsRequestDescriptor = $convert.base64Decode('ChtMaXN0UGVuZGluZ1NlbmRlcklkc1JlcXVlc3Q=');
@$core.Deprecated('Use approveSenderIdRequestDescriptor instead')
const ApproveSenderIdRequest$json = const {
  '1': 'ApproveSenderIdRequest',
  '2': const [
    const {'1': 'sender_id_record_id', '3': 1, '4': 1, '5': 9, '10': 'senderIdRecordId'},
  ],
};

/// Descriptor for `ApproveSenderIdRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List approveSenderIdRequestDescriptor = $convert.base64Decode('ChZBcHByb3ZlU2VuZGVySWRSZXF1ZXN0Ei0KE3NlbmRlcl9pZF9yZWNvcmRfaWQYASABKAlSEHNlbmRlcklkUmVjb3JkSWQ=');
@$core.Deprecated('Use rejectSenderIdRequestDescriptor instead')
const RejectSenderIdRequest$json = const {
  '1': 'RejectSenderIdRequest',
  '2': const [
    const {'1': 'sender_id_record_id', '3': 1, '4': 1, '5': 9, '10': 'senderIdRecordId'},
...
/// Descriptor for `RejectSenderIdRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rejectSenderIdRequestDescriptor = $convert.base64Decode('ChVSZWplY3RTZW5kZXJJZFJlcXVlc3QSLQoTc2VuZGVyX2lkX3JlY29yZF9pZBgBIAEoCVIQc2VuZGVySWRSZWNvcmRJZBIWCgZyZWFzb24YAiABKAlSBnJlYXNvbg==');

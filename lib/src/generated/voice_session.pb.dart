...
class StartVoiceSessionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(5, _omitFieldNames ? '' : 'userCountry')
  ...
  /// Service name to route the voice session to the correct agent
  @$pb.TagNumber(1)
  ...
  /// Dashboard BCP-47 locale (e.g. "en-NG") for voice-agent TTS routing
  @$pb.TagNumber(4)
  ...
  /// ISO country code from dashboard (e.g. "NG") — forwarded to LiveKit metadata
  @$pb.TagNumber(5)
  $core.String get userCountry => $_getSZ(4);
  @$pb.TagNumber(5)
  set userCountry($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasUserCountry() => $_has(4);
  @$pb.TagNumber(5)
  void clearUserCountry() => $_clearField(5);
}

...
class WhatsAppServiceClient extends $grpc.Client {
  static final _$getLinkStatus = $grpc.ClientMethod<
          $0.GetLinkStatusRequest, $0.GetLinkStatusResponse>(
  ...
  static final _$initiateLinking = $grpc.ClientMethod<
          $0.InitiateLinkingRequest, $0.InitiateLinkingResponse>(
  ...
  static final _$verifyLinking = $grpc.ClientMethod<
          $0.VerifyLinkingRequest, $0.VerifyLinkingResponse>(
  ...
  static final _$unlinkAccount = $grpc.ClientMethod<
          $0.UnlinkAccountRequest, $0.UnlinkAccountResponse>(
  ...
  static final _$verifyWebhook = $grpc.ClientMethod<
          $0.VerifyWebhookRequest, $0.VerifyWebhookResponse>(
...
abstract class WhatsAppServiceBase extends $grpc.Service {
  ...
  WhatsAppServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.VerifyLinkingRequest,
            $0.VerifyLinkingResponse>(
        'VerifyLinking',
        verifyLinking_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.UnlinkAccountRequest,
            $0.UnlinkAccountResponse>(
        'UnlinkAccount',
        unlinkAccount_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.WebhookRequest,
            $0.WebhookResponse>(
        'HandleWebhook',
        handleWebhook_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.WebhookRequest.fromBuffer(value),
        ($0.WebhookResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.VerifyWebhookRequest,
            $0.VerifyWebhookResponse>(
        'VerifyWebhook',
        verifyWebhook_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$0.GetSessionRequest,
            $0.GetSessionResponse>(
        'GetSession',
        getSession_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetSessionRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.GetAuditLogsRequest,
            $0.GetAuditLogsResponse>(
        'GetAuditLogs',
        getAuditLogs_Pre,
        false,
        false,
  ...
  $async.Future<$0.WebhookResponse> handleWebhook_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.WebhookRequest> request) async {
  ...
  $async.Future<$0.GetSessionResponse> getSession_Pre(
      $grpc.ServiceCall call,

...
class GiftCardsServiceClient extends $grpc.Client {
  ...
  static final _$redeemGiftCard =
      $grpc.ClientMethod<$0.RedeemGiftCardRequest, $0.RedeemGiftCardResponse>(
          '/giftcards.GiftCardsService/RedeemGiftCard',
          ($0.RedeemGiftCardRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.RedeemGiftCardResponse.fromBuffer(value));
  ...
  static final _$getGiftCardBalance = $grpc.ClientMethod<
          $0.GetGiftCardBalanceRequest, $0.GetGiftCardBalanceResponse>(
      '/giftcards.GiftCardsService/GetGiftCardBalance',
      ($0.GetGiftCardBalanceRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.GetGiftCardBalanceResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.RedeemGiftCardResponse> redeemGiftCard(
      $0.RedeemGiftCardRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.GetGiftCardBalanceResponse> getGiftCardBalance(
      $0.GetGiftCardBalanceRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class GiftCardsServiceBase extends $grpc.Service {
  ...
  GiftCardsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.RedeemGiftCardRequest,
            $0.RedeemGiftCardResponse>(
        'RedeemGiftCard',
        redeemGiftCard_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.RedeemGiftCardRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.GetGiftCardBalanceRequest,
            $0.GetGiftCardBalanceResponse>(
        'GetGiftCardBalance',
        getGiftCardBalance_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetGiftCardBalanceRequest.fromBuffer(value),
  ...
  $async.Future<$0.RedeemGiftCardResponse> redeemGiftCard_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.RedeemGiftCardRequest> request) async {
  ...
  $async.Future<$0.GetGiftCardBalanceResponse> getGiftCardBalance_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetGiftCardBalanceRequest> request) async {
  ...
  $async.Future<$0.RedeemGiftCardResponse> redeemGiftCard(
      $grpc.ServiceCall call, $0.RedeemGiftCardRequest request);
  ...
  $async.Future<$0.GetGiftCardBalanceResponse> getGiftCardBalance(
      $grpc.ServiceCall call, $0.GetGiftCardBalanceRequest request);

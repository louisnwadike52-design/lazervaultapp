...
const SellGiftCardRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'balance_attested', '3': 26, '4': 1, '5': 8, '10': 'balanceAttested'},
    const {'1': 'cards', '3': 27, '4': 3, '5': 11, '6': '.giftcards.SellCardItem', '10': 'cards'},
  ],
};

/// Descriptor for `SellGiftCardRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sellGiftCardRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use sellCardItemDescriptor instead')
const SellCardItem$json = const {
  '1': 'SellCardItem',
  '2': const [
    const {'1': 'denomination', '3': 1, '4': 1, '5': 1, '10': 'denomination'},
    const {'1': 'card_code', '3': 2, '4': 1, '5': 9, '10': 'cardCode'},
    const {'1': 'card_number', '3': 3, '4': 1, '5': 9, '10': 'cardNumber'},
    const {'1': 'card_pin', '3': 4, '4': 1, '5': 9, '10': 'cardPin'},
    const {'1': 'image_urls', '3': 5, '4': 3, '5': 9, '10': 'imageUrls'},
  ],
};

/// Descriptor for `SellCardItem`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sellCardItemDescriptor = $convert.base64Decode('CgxTZWxsQ2FyZEl0ZW0SIgoMZGVub21pbmF0aW9uGAEgASgBUgxkZW5vbWluYXRpb24SGwoJY2FyZF9jb2RlGAIgASgJUghjYXJkQ29kZRIfCgtjYXJkX251bWJlchgDIAEoCVIKY2FyZE51bWJlchIZCghjYXJkX3BpbhgEIAEoCVIHY2FyZFBpbhIdCgppbWFnZV91cmxzGAUgAygJUglpbWFnZVVybHM=');
...
const FloatTopUp$json = const {
  ...
  '2': const [
    ...
    const {'1': 'note', '3': 8, '4': 1, '5': 9, '10': 'note'},
    const {'1': 'created_by', '3': 9, '4': 1, '5': 9, '10': 'createdBy'},
...
final $typed_data.Uint8List floatTopUpDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminFloatTopUpRequestDescriptor instead')
const AdminFloatTopUpRequest$json = const {
...
final $typed_data.Uint8List adminFloatTopUpRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminFloatTopUpResponseDescriptor instead')
const AdminFloatTopUpResponse$json = const {
  '1': 'AdminFloatTopUpResponse',
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'status', '3': 2, '4': 1, '5': 9, '10': 'status'},
    const {'1': 'message', '3': 3, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'topup', '3': 4, '4': 1, '5': 11, '6': '.giftcards.FloatTopUp', '10': 'topup'},
  ],
};

/// Descriptor for `AdminFloatTopUpResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminFloatTopUpResponseDescriptor = $convert.base64Decode('ChdBZG1pbkZsb2F0VG9wVXBSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhYKBnN0YXR1cxgCIAEoCVIGc3RhdHVzEhgKB21lc3NhZ2UYAyABKAlSB21lc3NhZ2USKwoFdG9wdXAYBCABKAsyFS5naWZ0Y2FyZHMuRmxvYXRUb3BVcFIFdG9wdXA=');
@$core.Deprecated('Use adminListFloatTopUpsRequestDescriptor instead')
const AdminListFloatTopUpsRequest$json = const {
...
final $typed_data.Uint8List adminListFloatTopUpsRequestDescriptor = $convert.base64Decode('ChtBZG1pbkxpc3RGbG9hdFRvcFVwc1JlcXVlc3QSGgoIcHJvdmlkZXIYASABKAlSCHByb3ZpZGVyEhIKBHBhZ2UYAiABKAVSBHBhZ2USFAoFbGltaXQYAyABKAVSBWxpbWl0');
@$core.Deprecated('Use adminListFloatTopUpsResponseDescriptor instead')
const AdminListFloatTopUpsResponse$json = const {
  '1': 'AdminListFloatTopUpsResponse',
  '2': const [
    const {'1': 'topups', '3': 1, '4': 3, '5': 11, '6': '.giftcards.FloatTopUp', '10': 'topups'},
    const {'1': 'total', '3': 2, '4': 1, '5': 3, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'limit', '3': 4, '4': 1, '5': 5, '10': 'limit'},
  ],
...
final $typed_data.Uint8List adminListFloatTopUpsResponseDescriptor = $convert.base64Decode('ChxBZG1pbkxpc3RGbG9hdFRvcFVwc1Jlc3BvbnNlEi0KBnRvcHVwcxgBIAMoCzIVLmdpZnRjYXJkcy5GbG9hdFRvcFVwUgZ0b3B1cHMSFAoFdG90YWwYAiABKANSBXRvdGFsEhIKBHBhZ2UYAyABKAVSBHBhZ2USFAoFbGltaXQYBCABKAVSBWxpbWl0');
@$core.Deprecated('Use adminGetFloatStatusRequestDescriptor instead')
const AdminGetFloatStatusRequest$json = const {
...
final $typed_data.Uint8List adminGetFloatStatusRequestDescriptor = $convert.base64Decode('ChpBZG1pbkdldEZsb2F0U3RhdHVzUmVxdWVzdBIaCghwcm92aWRlchgBIAEoCVIIcHJvdmlkZXI=');
@$core.Deprecated('Use adminGetFloatStatusResponseDescriptor instead')
const AdminGetFloatStatusResponse$json = const {
  '1': 'AdminGetFloatStatusResponse',
  '2': const [
    const {'1': 'provider', '3': 1, '4': 1, '5': 9, '10': 'provider'},
    const {'1': 'balance', '3': 2, '4': 1, '5': 1, '10': 'balance'},
    const {'1': 'wallet_currency', '3': 3, '4': 1, '5': 9, '10': 'walletCurrency'},
    const {'1': 'low_threshold', '3': 4, '4': 1, '5': 1, '10': 'lowThreshold'},
    const {'1': 'critical_threshold', '3': 5, '4': 1, '5': 1, '10': 'criticalThreshold'},
    const {'1': 'preferred_balance', '3': 6, '4': 1, '5': 1, '10': 'preferredBalance'},
    const {'1': 'is_low', '3': 7, '4': 1, '5': 8, '10': 'isLow'},
    const {'1': 'is_critical', '3': 8, '4': 1, '5': 8, '10': 'isCritical'},
    const {'1': 'suggested_topup', '3': 9, '4': 1, '5': 1, '10': 'suggestedTopup'},
    const {'1': 'last_checked_at', '3': 10, '4': 1, '5': 9, '10': 'lastCheckedAt'},
  ],
};

/// Descriptor for `AdminGetFloatStatusResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminGetFloatStatusResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use outboxEventDescriptor instead')
const OutboxEvent$json = const {
  '1': 'OutboxEvent',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'aggregate_type', '3': 2, '4': 1, '5': 9, '10': 'aggregateType'},
    ...
    const {'1': 'retry_count', '3': 6, '4': 1, '5': 5, '10': 'retryCount'},
    const {'1': 'max_retries', '3': 7, '4': 1, '5': 5, '10': 'maxRetries'},
    const {'1': 'last_error', '3': 8, '4': 1, '5': 9, '10': 'lastError'},
    const {'1': 'processed_at', '3': 9, '4': 1, '5': 9, '10': 'processedAt'},
    const {'1': 'created_at', '3': 10, '4': 1, '5': 9, '10': 'createdAt'},
  ],
};

/// Descriptor for `OutboxEvent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List outboxEventDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminListOutboxRequestDescriptor instead')
const AdminListOutboxRequest$json = const {
...
final $typed_data.Uint8List adminListOutboxRequestDescriptor = $convert.base64Decode('ChZBZG1pbkxpc3RPdXRib3hSZXF1ZXN0EhYKBnN0YXR1cxgBIAEoCVIGc3RhdHVzEhIKBHBhZ2UYAiABKAVSBHBhZ2USFAoFbGltaXQYAyABKAVSBWxpbWl0');
@$core.Deprecated('Use adminListOutboxResponseDescriptor instead')
const AdminListOutboxResponse$json = const {
  '1': 'AdminListOutboxResponse',
  '2': const [
    const {'1': 'events', '3': 1, '4': 3, '5': 11, '6': '.giftcards.OutboxEvent', '10': 'events'},
    const {'1': 'total', '3': 2, '4': 1, '5': 3, '10': 'total'},
    const {'1': 'page', '3': 3, '4': 1, '5': 5, '10': 'page'},
    const {'1': 'limit', '3': 4, '4': 1, '5': 5, '10': 'limit'},
  ],
...
final $typed_data.Uint8List adminListOutboxResponseDescriptor = $convert.base64Decode('ChdBZG1pbkxpc3RPdXRib3hSZXNwb25zZRIuCgZldmVudHMYASADKAsyFi5naWZ0Y2FyZHMuT3V0Ym94RXZlbnRSBmV2ZW50cxIUCgV0b3RhbBgCIAEoA1IFdG90YWwSEgoEcGFnZRgDIAEoBVIEcGFnZRIUCgVsaW1pdBgEIAEoBVIFbGltaXQ=');

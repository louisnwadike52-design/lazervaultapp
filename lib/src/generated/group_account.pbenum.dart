...
class GroupMemberRole extends $pb.ProtobufEnum {
  ...
  static const GroupMemberRole GROUP_MEMBER_ROLE_MODERATOR = GroupMemberRole._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GROUP_MEMBER_ROLE_MODERATOR');
...
class GroupMemberStatus extends $pb.ProtobufEnum {
  ...
  static const GroupMemberStatus GROUP_MEMBER_STATUS_PENDING = GroupMemberStatus._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GROUP_MEMBER_STATUS_PENDING');
...
class PaymentStatus extends $pb.ProtobufEnum {
  ...
  static const PaymentStatus PAYMENT_STATUS_AWAITING_VERIFICATION = PaymentStatus._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYMENT_STATUS_AWAITING_VERIFICATION');
  static const PaymentStatus PAYMENT_STATUS_REFUNDING = PaymentStatus._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYMENT_STATUS_REFUNDING');
  static const PaymentStatus PAYMENT_STATUS_MANUAL_REVIEW = PaymentStatus._(8, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYMENT_STATUS_MANUAL_REVIEW');
...
class PayoutStatus extends $pb.ProtobufEnum {
  ...
  static const PayoutStatus PAYOUT_STATUS_PROCESSING = PayoutStatus._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYOUT_STATUS_PROCESSING');
  static const PayoutStatus PAYOUT_STATUS_FAILED = PayoutStatus._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYOUT_STATUS_FAILED');
  static const PayoutStatus PAYOUT_STATUS_MANUAL_REVIEW = PayoutStatus._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYOUT_STATUS_MANUAL_REVIEW');
...
class GroupVisibility extends $pb.ProtobufEnum {
  static const GroupVisibility GROUP_VISIBILITY_UNSPECIFIED = GroupVisibility._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GROUP_VISIBILITY_UNSPECIFIED');
  static const GroupVisibility GROUP_VISIBILITY_PRIVATE = GroupVisibility._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GROUP_VISIBILITY_PRIVATE');
  static const GroupVisibility GROUP_VISIBILITY_PUBLIC = GroupVisibility._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GROUP_VISIBILITY_PUBLIC');
...
class ScheduledPayoutStatus extends $pb.ProtobufEnum {
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_UNSPECIFIED = ScheduledPayoutStatus._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_UNSPECIFIED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_PENDING_RECEIVER = ScheduledPayoutStatus._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_PENDING_RECEIVER');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_READY = ScheduledPayoutStatus._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_READY');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_SCHEDULED = ScheduledPayoutStatus._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_SCHEDULED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_IN_FLIGHT = ScheduledPayoutStatus._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_IN_FLIGHT');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_SETTLED = ScheduledPayoutStatus._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_SETTLED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_FAILED = ScheduledPayoutStatus._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_FAILED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_EXHAUSTED = ScheduledPayoutStatus._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_EXHAUSTED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_CANCELED = ScheduledPayoutStatus._(8, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEDULED_PAYOUT_STATUS_CANCELED');
  ...
  static final $core.Map<$core.int, ScheduledPayoutStatus> _byValue = $pb.ProtobufEnum.initByValue(values);
  static ScheduledPayoutStatus? valueOf($core.int value) => _byValue[value];

  const ScheduledPayoutStatus._($core.int v, $core.String n) : super(v, n);
}

class PayoutMode extends $pb.ProtobufEnum {
  static const PayoutMode PAYOUT_MODE_UNSPECIFIED = PayoutMode._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYOUT_MODE_UNSPECIFIED');
  static const PayoutMode PAYOUT_MODE_AUTO = PayoutMode._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYOUT_MODE_AUTO');
  static const PayoutMode PAYOUT_MODE_MANUAL = PayoutMode._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAYOUT_MODE_MANUAL');
  ...
  static final $core.Map<$core.int, PayoutMode> _byValue = $pb.ProtobufEnum.initByValue(values);
  static PayoutMode? valueOf($core.int value) => _byValue[value];

  const PayoutMode._($core.int v, $core.String n) : super(v, n);
}

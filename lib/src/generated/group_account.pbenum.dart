...
class GroupMemberRole extends $pb.ProtobufEnum {
  ...
  static const GroupMemberRole GROUP_MEMBER_ROLE_MODERATOR =
      GroupMemberRole._(4, _omitEnumNames ? '' : 'GROUP_MEMBER_ROLE_MODERATOR');
...
class GroupMemberStatus extends $pb.ProtobufEnum {
  ...
  /// Synthesized for shadow rows that represent a pending group
  /// invitation. The user is not yet a real group_members row — the
  /// server materializes a transient GroupMember from the live
  /// GroupInvitation so the canonical member-list response carries
  /// the "Invite Sent" state. Clients render an Invite Sent badge
  /// and gate role/remove actions off until the invite is accepted.
  static const GroupMemberStatus GROUP_MEMBER_STATUS_PENDING =
      GroupMemberStatus._(
...
class PaymentStatus extends $pb.ProtobufEnum {
  ...
  static const PaymentStatus PAYMENT_STATUS_AWAITING_VERIFICATION =
      PaymentStatus._(
          6, _omitEnumNames ? '' : 'PAYMENT_STATUS_AWAITING_VERIFICATION');

  /// Phase 3 failed AFTER a successful debit. The rollback processor is
  /// issuing the compensating credit. Money WILL be returned.
  static const PaymentStatus PAYMENT_STATUS_REFUNDING =
      PaymentStatus._(7, _omitEnumNames ? '' : 'PAYMENT_STATUS_REFUNDING');
  ...
  static const PaymentStatus PAYMENT_STATUS_MANUAL_REVIEW =
      PaymentStatus._(8, _omitEnumNames ? '' : 'PAYMENT_STATUS_MANUAL_REVIEW');
...
class PayoutStatus extends $pb.ProtobufEnum {
  ...
  static const PayoutStatus PAYOUT_STATUS_PROCESSING =
      PayoutStatus._(4, _omitEnumNames ? '' : 'PAYOUT_STATUS_PROCESSING');
  static const PayoutStatus PAYOUT_STATUS_FAILED =
      PayoutStatus._(5, _omitEnumNames ? '' : 'PAYOUT_STATUS_FAILED');
  static const PayoutStatus PAYOUT_STATUS_MANUAL_REVIEW =
      PayoutStatus._(6, _omitEnumNames ? '' : 'PAYOUT_STATUS_MANUAL_REVIEW');
...
class GroupVisibility extends $pb.ProtobufEnum {
  ...
  static const GroupVisibility GROUP_VISIBILITY_PRIVATE =
      GroupVisibility._(1, _omitEnumNames ? '' : 'GROUP_VISIBILITY_PRIVATE');
  static const GroupVisibility GROUP_VISIBILITY_PUBLIC =
      GroupVisibility._(2, _omitEnumNames ? '' : 'GROUP_VISIBILITY_PUBLIC');
...
class ScheduledPayoutStatus extends $pb.ProtobufEnum {
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_UNSPECIFIED =
      ScheduledPayoutStatus._(
          0, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_UNSPECIFIED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_PENDING_RECEIVER =
      ScheduledPayoutStatus._(
          1, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_PENDING_RECEIVER');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_READY =
      ScheduledPayoutStatus._(
          2, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_READY');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_SCHEDULED =
      ScheduledPayoutStatus._(
          3, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_SCHEDULED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_IN_FLIGHT =
      ScheduledPayoutStatus._(
          4, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_IN_FLIGHT');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_SETTLED =
      ScheduledPayoutStatus._(
          5, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_SETTLED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_FAILED =
      ScheduledPayoutStatus._(
          6, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_FAILED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_EXHAUSTED =
      ScheduledPayoutStatus._(
          7, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_EXHAUSTED');
  static const ScheduledPayoutStatus SCHEDULED_PAYOUT_STATUS_CANCELED =
      ScheduledPayoutStatus._(
          8, _omitEnumNames ? '' : 'SCHEDULED_PAYOUT_STATUS_CANCELED');

  static const $core.List<ScheduledPayoutStatus> values =
  ...
  static final $core.List<ScheduledPayoutStatus?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 8);
  static ScheduledPayoutStatus? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class PayoutMode extends $pb.ProtobufEnum {
  static const PayoutMode PAYOUT_MODE_UNSPECIFIED =
      PayoutMode._(0, _omitEnumNames ? '' : 'PAYOUT_MODE_UNSPECIFIED');
  static const PayoutMode PAYOUT_MODE_AUTO =
      PayoutMode._(1, _omitEnumNames ? '' : 'PAYOUT_MODE_AUTO');
  static const PayoutMode PAYOUT_MODE_MANUAL =
      PayoutMode._(2, _omitEnumNames ? '' : 'PAYOUT_MODE_MANUAL');
  ...
  static final $core.List<PayoutMode?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static PayoutMode? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

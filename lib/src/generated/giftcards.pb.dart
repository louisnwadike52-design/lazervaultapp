...
class TransferGiftCardRequest extends $pb.GeneratedMessage {
  ...
  factory TransferGiftCardRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TransferGiftCardRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransferGiftCardRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'giftcards'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'giftCardId')
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransferGiftCardRequest clone() =>
      TransferGiftCardRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransferGiftCardRequest copyWith(
          void Function(TransferGiftCardRequest) updates) =>
      super.copyWith((message) => updates(message as TransferGiftCardRequest))
          as TransferGiftCardRequest;
  ...
  static $pb.PbList<TransferGiftCardRequest> createRepeated() =>
      $pb.PbList<TransferGiftCardRequest>();
  @$core.pragma('dart2js:noInline')
  static TransferGiftCardRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransferGiftCardRequest>(create);
...
class TransferGiftCardResponse extends $pb.GeneratedMessage {
  ...
  factory TransferGiftCardResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TransferGiftCardResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransferGiftCardResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'giftcards'),
      createEmptyInstance: create)
    ..aOM<GiftCard>(1, _omitFieldNames ? '' : 'giftCard',
        subBuilder: GiftCard.create)
    ..aOS(2, _omitFieldNames ? '' : 'message')
    ..aOM<GiftCard>(3, _omitFieldNames ? '' : 'recipientGiftCard',
        subBuilder: GiftCard.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransferGiftCardResponse clone() =>
      TransferGiftCardResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransferGiftCardResponse copyWith(
          void Function(TransferGiftCardResponse) updates) =>
      super.copyWith((message) => updates(message as TransferGiftCardResponse))
          as TransferGiftCardResponse;
  ...
  static $pb.PbList<TransferGiftCardResponse> createRepeated() =>
      $pb.PbList<TransferGiftCardResponse>();
  @$core.pragma('dart2js:noInline')
  static TransferGiftCardResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransferGiftCardResponse>(create);
...
class GiftCardSale extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pPS(20, _omitFieldNames ? '' : 'imageUrls')
    ..aOS(21, _omitFieldNames ? '' : 'ocrBrand')
    ..aOS(22, _omitFieldNames ? '' : 'ocrCardNumber')
    ..aOS(23, _omitFieldNames ? '' : 'ocrPin')
    ..a<$core.double>(
        24, _omitFieldNames ? '' : 'ocrDenomination', $pb.PbFieldType.OD)
    ..aOS(25, _omitFieldNames ? '' : 'ocrCurrency')
    ..aOS(26, _omitFieldNames ? '' : 'adminReviewerId')
    ..aOS(27, _omitFieldNames ? '' : 'rejectionReason')
    ..aOS(28, _omitFieldNames ? '' : 'adminNotes')
    ..aOS(29, _omitFieldNames ? '' : 'cardPin')
    ..a<$core.double>(
        30, _omitFieldNames ? '' : 'exitRatePercent', $pb.PbFieldType.OD)
    ..a<$core.double>(
        31, _omitFieldNames ? '' : 'baseMarginPercent', $pb.PbFieldType.OD)
    ..a<$core.double>(
        32, _omitFieldNames ? '' : 'riskBufferPercent', $pb.PbFieldType.OD)
    ..a<$core.double>(
        33, _omitFieldNames ? '' : 'commissionAmount', $pb.PbFieldType.OD)
    ..a<$core.int>(34, _omitFieldNames ? '' : 'riskScore', $pb.PbFieldType.O3)
    ..aOS(35, _omitFieldNames ? '' : 'riskLevel')
    ..pPS(36, _omitFieldNames ? '' : 'riskFlags')
    ..aOS(37, _omitFieldNames ? '' : 'riskAction')
    ..aOS(38, _omitFieldNames ? '' : 'cardCountry')
    ..aOS(39, _omitFieldNames ? '' : 'cardFormat')
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(20)
  $pb.PbList<$core.String> get imageUrls => $_getList(19);

  @$pb.TagNumber(21)
  $core.String get ocrBrand => $_getSZ(20);
  @$pb.TagNumber(21)
  set ocrBrand($core.String value) => $_setString(20, value);
  @$pb.TagNumber(21)
  $core.bool hasOcrBrand() => $_has(20);
  @$pb.TagNumber(21)
  void clearOcrBrand() => $_clearField(21);

  @$pb.TagNumber(22)
  $core.String get ocrCardNumber => $_getSZ(21);
  @$pb.TagNumber(22)
  set ocrCardNumber($core.String value) => $_setString(21, value);
  @$pb.TagNumber(22)
  $core.bool hasOcrCardNumber() => $_has(21);
  @$pb.TagNumber(22)
  void clearOcrCardNumber() => $_clearField(22);

  @$pb.TagNumber(23)
  $core.String get ocrPin => $_getSZ(22);
  @$pb.TagNumber(23)
  set ocrPin($core.String value) => $_setString(22, value);
  @$pb.TagNumber(23)
  $core.bool hasOcrPin() => $_has(22);
  @$pb.TagNumber(23)
  void clearOcrPin() => $_clearField(23);

  @$pb.TagNumber(24)
  $core.double get ocrDenomination => $_getN(23);
  @$pb.TagNumber(24)
  set ocrDenomination($core.double value) => $_setDouble(23, value);
  @$pb.TagNumber(24)
  $core.bool hasOcrDenomination() => $_has(23);
  @$pb.TagNumber(24)
  void clearOcrDenomination() => $_clearField(24);

  @$pb.TagNumber(25)
  $core.String get ocrCurrency => $_getSZ(24);
  @$pb.TagNumber(25)
  set ocrCurrency($core.String value) => $_setString(24, value);
  @$pb.TagNumber(25)
  $core.bool hasOcrCurrency() => $_has(24);
  @$pb.TagNumber(25)
  void clearOcrCurrency() => $_clearField(25);

  /// Admin review fields
  @$pb.TagNumber(26)
  $core.String get adminReviewerId => $_getSZ(25);
  @$pb.TagNumber(26)
  set adminReviewerId($core.String value) => $_setString(25, value);
  @$pb.TagNumber(26)
  $core.bool hasAdminReviewerId() => $_has(25);
  @$pb.TagNumber(26)
  void clearAdminReviewerId() => $_clearField(26);

  @$pb.TagNumber(27)
  $core.String get rejectionReason => $_getSZ(26);
  @$pb.TagNumber(27)
  set rejectionReason($core.String value) => $_setString(26, value);
  @$pb.TagNumber(27)
  $core.bool hasRejectionReason() => $_has(26);
  @$pb.TagNumber(27)
  void clearRejectionReason() => $_clearField(27);

  @$pb.TagNumber(28)
  $core.String get adminNotes => $_getSZ(27);
  @$pb.TagNumber(28)
  set adminNotes($core.String value) => $_setString(27, value);
  @$pb.TagNumber(28)
  $core.bool hasAdminNotes() => $_has(27);
  @$pb.TagNumber(28)
  void clearAdminNotes() => $_clearField(28);

  @$pb.TagNumber(29)
  $core.String get cardPin => $_getSZ(28);
  @$pb.TagNumber(29)
  set cardPin($core.String value) => $_setString(28, value);
  @$pb.TagNumber(29)
  $core.bool hasCardPin() => $_has(28);
  @$pb.TagNumber(29)
  void clearCardPin() => $_clearField(29);

  /// Dynamic pricing breakdown
  @$pb.TagNumber(30)
  $core.double get exitRatePercent => $_getN(29);
  @$pb.TagNumber(30)
  set exitRatePercent($core.double value) => $_setDouble(29, value);
  @$pb.TagNumber(30)
  $core.bool hasExitRatePercent() => $_has(29);
  @$pb.TagNumber(30)
  void clearExitRatePercent() => $_clearField(30);

  @$pb.TagNumber(31)
  $core.double get baseMarginPercent => $_getN(30);
  @$pb.TagNumber(31)
  set baseMarginPercent($core.double value) => $_setDouble(30, value);
  @$pb.TagNumber(31)
  $core.bool hasBaseMarginPercent() => $_has(30);
  @$pb.TagNumber(31)
  void clearBaseMarginPercent() => $_clearField(31);

  @$pb.TagNumber(32)
  $core.double get riskBufferPercent => $_getN(31);
  @$pb.TagNumber(32)
  set riskBufferPercent($core.double value) => $_setDouble(31, value);
  @$pb.TagNumber(32)
  $core.bool hasRiskBufferPercent() => $_has(31);
  @$pb.TagNumber(32)
  void clearRiskBufferPercent() => $_clearField(32);

  @$pb.TagNumber(33)
  $core.double get commissionAmount => $_getN(32);
  @$pb.TagNumber(33)
  set commissionAmount($core.double value) => $_setDouble(32, value);
  @$pb.TagNumber(33)
  $core.bool hasCommissionAmount() => $_has(32);
  @$pb.TagNumber(33)
  void clearCommissionAmount() => $_clearField(33);

  /// Risk scoring
  @$pb.TagNumber(34)
  $core.int get riskScore => $_getIZ(33);
  @$pb.TagNumber(34)
  set riskScore($core.int value) => $_setSignedInt32(33, value);
  @$pb.TagNumber(34)
  $core.bool hasRiskScore() => $_has(33);
  @$pb.TagNumber(34)
  void clearRiskScore() => $_clearField(34);

  @$pb.TagNumber(35)
  $core.String get riskLevel => $_getSZ(34);
  @$pb.TagNumber(35)
  set riskLevel($core.String value) => $_setString(34, value);
  @$pb.TagNumber(35)
  $core.bool hasRiskLevel() => $_has(34);
  @$pb.TagNumber(35)
  void clearRiskLevel() => $_clearField(35);

  @$pb.TagNumber(36)
  $pb.PbList<$core.String> get riskFlags => $_getList(35);

  @$pb.TagNumber(37)
  $core.String get riskAction => $_getSZ(36);
  @$pb.TagNumber(37)
  set riskAction($core.String value) => $_setString(36, value);
  @$pb.TagNumber(37)
  $core.bool hasRiskAction() => $_has(36);
  @$pb.TagNumber(37)
  void clearRiskAction() => $_clearField(37);

  /// Card details
  @$pb.TagNumber(38)
  $core.String get cardCountry => $_getSZ(37);
  @$pb.TagNumber(38)
  set cardCountry($core.String value) => $_setString(37, value);
  @$pb.TagNumber(38)
  $core.bool hasCardCountry() => $_has(37);
  @$pb.TagNumber(38)
  void clearCardCountry() => $_clearField(38);

  @$pb.TagNumber(39)
  $core.String get cardFormat => $_getSZ(38);
  @$pb.TagNumber(39)
  set cardFormat($core.String value) => $_setString(38, value);
  @$pb.TagNumber(39)
  $core.bool hasCardFormat() => $_has(38);
  @$pb.TagNumber(39)
  void clearCardFormat() => $_clearField(39);
}

...
const ExchangeType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'PLATFORM_BRIDGE', '2': 3},
  ],
};

/// Descriptor for `ExchangeType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List exchangeTypeDescriptor = $convert.base64Decode('CgxFeGNoYW5nZVR5cGUSHQoZRVhDSEFOR0VfVFlQRV9VTlNQRUNJRklFRBAAEg4KCkNPTlZFUlNJT04QARIRCg1JTlRFUk5BVElPTkFMEAISEwoPUExBVEZPUk1fQlJJREdFEAM=');
...
const ReceiverDetails$json = const {
  ...
  '2': const [
    ...
    const {'1': 'beneficiary_type', '3': 12, '4': 1, '5': 9, '10': 'beneficiaryType'},
  ],
};

/// Descriptor for `ReceiverDetails`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List receiverDetailsDescriptor = $convert.base64Decode('');
...
const AdminConvertPlatformWalletsRequest$json = const {
  '1': 'AdminConvertPlatformWalletsRequest',
  '2': const [
    const {'1': 'from_wallet_code', '3': 1, '4': 1, '5': 9, '10': 'fromWalletCode'},
    const {'1': 'from_currency', '3': 2, '4': 1, '5': 9, '10': 'fromCurrency'},
    const {'1': 'to_wallet_code', '3': 3, '4': 1, '5': 9, '10': 'toWalletCode'},
    const {'1': 'to_currency', '3': 4, '4': 1, '5': 9, '10': 'toCurrency'},
    const {'1': 'amount_in_destination_currency', '3': 5, '4': 1, '5': 1, '10': 'amountInDestinationCurrency'},
    const {'1': 'admin_user_id', '3': 6, '4': 1, '5': 9, '10': 'adminUserId'},
    const {'1': 'approval_token', '3': 7, '4': 1, '5': 9, '10': 'approvalToken'},
...
final $typed_data.Uint8List adminConvertPlatformWalletsRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use adminConvertPlatformWalletsResponseDescriptor instead')
const AdminConvertPlatformWalletsResponse$json = const {
  '1': 'AdminConvertPlatformWalletsResponse',
  '2': const [
    const {'1': 'transaction', '3': 1, '4': 1, '5': 11, '6': '.exchange.ExchangeTransaction', '10': 'transaction'},
    const {'1': 'fx_rate_used', '3': 2, '4': 1, '5': 1, '10': 'fxRateUsed'},
...
final $typed_data.Uint8List adminConvertPlatformWalletsResponseDescriptor = $convert.base64Decode('CiNBZG1pbkNvbnZlcnRQbGF0Zm9ybVdhbGxldHNSZXNwb25zZRI/Cgt0cmFuc2FjdGlvbhgBIAEoCzIdLmV4Y2hhbmdlLkV4Y2hhbmdlVHJhbnNhY3Rpb25SC3RyYW5zYWN0aW9uEiAKDGZ4X3JhdGVfdXNlZBgCIAEoAVIKZnhSYXRlVXNlZBIfCgtmcm9tX2Ftb3VudBgDIAEoAVIKZnJvbUFtb3VudA==');
@$core.Deprecated('Use adminBridgePreviewRequestDescriptor instead')
const AdminBridgePreviewRequest$json = const {
  '1': 'AdminBridgePreviewRequest',
  '2': const [
    const {'1': 'from_currency', '3': 1, '4': 1, '5': 9, '10': 'fromCurrency'},
    const {'1': 'to_currency', '3': 2, '4': 1, '5': 9, '10': 'toCurrency'},
    const {'1': 'amount_in_destination_currency', '3': 3, '4': 1, '5': 1, '10': 'amountInDestinationCurrency'},
  ],
};

/// Descriptor for `AdminBridgePreviewRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminBridgePreviewRequestDescriptor = $convert.base64Decode('ChlBZG1pbkJyaWRnZVByZXZpZXdSZXF1ZXN0EiMKDWZyb21fY3VycmVuY3kYASABKAlSDGZyb21DdXJyZW5jeRIfCgt0b19jdXJyZW5jeRgCIAEoCVIKdG9DdXJyZW5jeRJDCh5hbW91bnRfaW5fZGVzdGluYXRpb25fY3VycmVuY3kYAyABKAFSG2Ftb3VudEluRGVzdGluYXRpb25DdXJyZW5jeQ==');
@$core.Deprecated('Use adminBridgePreviewResponseDescriptor instead')
const AdminBridgePreviewResponse$json = const {
  '1': 'AdminBridgePreviewResponse',
  '2': const [
    const {'1': 'fx_rate', '3': 1, '4': 1, '5': 1, '10': 'fxRate'},
    const {'1': 'from_amount', '3': 2, '4': 1, '5': 1, '10': 'fromAmount'},
    const {'1': 'margin_amount', '3': 3, '4': 1, '5': 1, '10': 'marginAmount'},
    const {'1': 'rate_id', '3': 4, '4': 1, '5': 9, '10': 'rateId'},
  ],
};

/// Descriptor for `AdminBridgePreviewResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminBridgePreviewResponseDescriptor = $convert.base64Decode('ChpBZG1pbkJyaWRnZVByZXZpZXdSZXNwb25zZRIXCgdmeF9yYXRlGAEgASgBUgZmeFJhdGUSHwoLZnJvbV9hbW91bnQYAiABKAFSCmZyb21BbW91bnQSIwoNbWFyZ2luX2Ftb3VudBgDIAEoAVIMbWFyZ2luQW1vdW50EhcKB3JhdGVfaWQYBCABKAlSBnJhdGVJZA==');

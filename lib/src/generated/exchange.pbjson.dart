...
final $typed_data.Uint8List exchangeTypeDescriptor = $convert.base64Decode(
    ...
    'NJT04QARIRCg1JTlRFUk5BVElPTkFMEAISEwoPUExBVEZPUk1fQlJJREdFEAM=');
...
const ReceiverDetails$json = {
  ...
  '2': [
    ...
    {'1': 'beneficiary_type', '3': 12, '4': 1, '5': 9, '10': 'beneficiaryType'},
  ],
};
...
final $typed_data.Uint8List receiverDetailsDescriptor = $convert.base64Decode(
    ...
    'cxgLIAEoCVIHYWRkcmVzcxIpChBiZW5lZmljaWFyeV90eXBlGAwgASgJUg9iZW5lZmljaWFyeV'
    'R5cGU=');
...
final $typed_data.Uint8List initiateInternationalTransferRequestDescriptor = $convert.base64Decode(
    ...
    'VycmVuY3knLlIKYW1vdW50RnJvbRJkChByZWNlaXZlcl9kZXRhaWxzGAQgASgLMhkuZXhjaGFu'
    'Z2UuUmVjZWl2ZXJEZXRhaWxzQh6SQRsyGURldGFpbHMgb2YgdGhlIHJlY2lwaWVudC5SD3JlY2'
    'VpdmVyRGV0YWlscxJdChJ2ZXJpZmljYXRpb25fdG9rZW4YBSABKAlCLpJBKzIpUElOIHZlcmlm'
    'aWNhdGlvbiB0b2tlbiBmcm9tIGF1dGgtc2VydmljZS5SEXZlcmlmaWNhdGlvblRva2VuEl0KD2'
    'lkZW1wb3RlbmN5X2tleRgGIAEoCUI0kkExMi9DbGllbnQtZ2VuZXJhdGVkIFVVSUQgZm9yIGR1'
    'cGxpY2F0ZSBwcmV2ZW50aW9uLlIOaWRlbXBvdGVuY3lLZXkSTwoHcmF0ZV9pZBgHIAEoCUI2kk'
...
const ExchangeTransaction$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.exchange.ExchangeType',
      '10': 'exchangeType'
    },
    {'1': 'failure_reason', '3': 16, '4': 1, '5': 9, '10': 'failureReason'},
    {'1': 'provider_fee', '3': 17, '4': 1, '5': 1, '10': 'providerFee'},
    {'1': 'service_fee', '3': 18, '4': 1, '5': 1, '10': 'serviceFee'},
  ],
};
...
final $typed_data.Uint8List exchangeTransactionDescriptor = $convert.base64Decode(
    ...
    'eGNoYW5nZV9yYXRlGAcgASgBUgxleGNoYW5nZVJhdGUSEgoEZmVlcxgIIAEoAVIEZmVlcxJECh'
    'ByZWNlaXZlcl9kZXRhaWxzGAkgASgLMhkuZXhjaGFuZ2UuUmVjZWl2ZXJEZXRhaWxzUg9yZWNl'
    'aXZlckRldGFpbHMSMAoGc3RhdHVzGAogASgOMhguZXhjaGFuZ2UuRXhjaGFuZ2VTdGF0dXNSBn'
    'N0YXR1cxI5CgpjcmVhdGVkX2F0GAsgASgLMhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcFIJ'
    'Y3JlYXRlZEF0EjkKCnVwZGF0ZWRfYXQYDCABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW'
    '1wUgl1cGRhdGVkQXQSHAoJcmVmZXJlbmNlGA0gASgJUglyZWZlcmVuY2USLQoScHJvdmlkZXJf'
    'cmVmZXJlbmNlGA4gASgJUhFwcm92aWRlclJlZmVyZW5jZRI7Cg1leGNoYW5nZV90eXBlGA8gAS'
    'gOMhYuZXhjaGFuZ2UuRXhjaGFuZ2VUeXBlUgxleGNoYW5nZVR5cGUSJQoOZmFpbHVyZV9yZWFz'
    'b24YECABKAlSDWZhaWx1cmVSZWFzb24SIQoMcHJvdmlkZXJfZmVlGBEgASgBUgtwcm92aWRlck'
    'ZlZRIfCgtzZXJ2aWNlX2ZlZRgSIAEoAVIKc2VydmljZUZlZQ==');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.exchange.ExchangeTransaction',
      '10': 'transaction'
    },
  ],
  '7': {},
...
final $typed_data.Uint8List initiateInternationalTransferResponseDescriptor =
    $convert.base64Decode(
        'CiVJbml0aWF0ZUludGVybmF0aW9uYWxUcmFuc2ZlclJlc3BvbnNlEj8KC3RyYW5zYWN0aW9uGA'
        'EgASgLMh0uZXhjaGFuZ2UuRXhjaGFuZ2VUcmFuc2FjdGlvblILdHJhbnNhY3Rpb246XJJBWQpX'
        'KihJbml0aWF0ZSBJbnRlcm5hdGlvbmFsIFRyYW5zZmVyIFJlc3BvbnNlMitDb250YWlucyBkZX'
        'RhaWxzIG9mIHRoZSBpbml0aWF0ZWQgdHJhbnNmZXIu');
...
final $typed_data.Uint8List getRecentExchangesResponseDescriptor = $convert.base64Decode(
    'ChpHZXRSZWNlbnRFeGNoYW5nZXNSZXNwb25zZRJBCgx0cmFuc2FjdGlvbnMYASADKAsyHS5leG'
    'NoYW5nZS5FeGNoYW5nZVRyYW5zYWN0aW9uUgx0cmFuc2FjdGlvbnMSJgoPbmV4dF9wYWdlX3Rv'
    'a2VuGAIgASgJUg1uZXh0UGFnZVRva2VuOkuSQUgKRiodR2V0IFJlY2VudCBFeGNoYW5nZXMgUm'
    'VzcG9uc2UyJUxpc3Qgb2YgcmVjZW50IGV4Y2hhbmdlIHRyYW5zYWN0aW9ucy4=');
...
final $typed_data.Uint8List convertCurrencyResponseDescriptor = $convert.base64Decode(
    'ChdDb252ZXJ0Q3VycmVuY3lSZXNwb25zZRI/Cgt0cmFuc2FjdGlvbhgBIAEoCzIdLmV4Y2hhbm'
    'dlLkV4Y2hhbmdlVHJhbnNhY3Rpb25SC3RyYW5zYWN0aW9uOkiSQUUKQyoZQ29udmVydCBDdXJy'
    'ZW5jeSBSZXNwb25zZTImUmVzdWx0IG9mIHdhbGxldC10by13YWxsZXQgY29udmVyc2lvbi4=');
...
final $typed_data.Uint8List getTransactionStatusResponseDescriptor = $convert.base64Decode(
    'ChxHZXRUcmFuc2FjdGlvblN0YXR1c1Jlc3BvbnNlEj8KC3RyYW5zYWN0aW9uGAEgASgLMh0uZX'
    'hjaGFuZ2UuRXhjaGFuZ2VUcmFuc2FjdGlvblILdHJhbnNhY3Rpb246UpJBTwpNKh9HZXQgVHJh'
    'bnNhY3Rpb24gU3RhdHVzIFJlc3BvbnNlMipDdXJyZW50IHN0YXR1cyBvZiBhbiBleGNoYW5nZS'
    'B0cmFuc2FjdGlvbi4=');
...
final $typed_data.Uint8List getSupportedCurrenciesResponseDescriptor =
    $convert.base64Decode(
        'Ch5HZXRTdXBwb3J0ZWRDdXJyZW5jaWVzUmVzcG9uc2USOwoKY3VycmVuY2llcxgBIAMoCzIbLm'
        'V4Y2hhbmdlLlN1cHBvcnRlZEN1cnJlbmN5UgpjdXJyZW5jaWVzOlCSQU0KSyohR2V0IFN1cHBv'
        'cnRlZCBDdXJyZW5jaWVzIFJlc3BvbnNlMiZMaXN0IG9mIHN1cHBvcnRlZCBleGNoYW5nZSBjdX'
        'JyZW5jaWVzLg==');

@$core.Deprecated('Use adminConvertPlatformWalletsRequestDescriptor instead')
const AdminConvertPlatformWalletsRequest$json = {
  '1': 'AdminConvertPlatformWalletsRequest',
  '2': [
    {'1': 'from_wallet_code', '3': 1, '4': 1, '5': 9, '10': 'fromWalletCode'},
    {'1': 'from_currency', '3': 2, '4': 1, '5': 9, '10': 'fromCurrency'},
    {'1': 'to_wallet_code', '3': 3, '4': 1, '5': 9, '10': 'toWalletCode'},
    {'1': 'to_currency', '3': 4, '4': 1, '5': 9, '10': 'toCurrency'},
    {
      '1': 'amount_in_destination_currency',
      '3': 5,
      '4': 1,
      '5': 1,
      '10': 'amountInDestinationCurrency'
    },
    {'1': 'admin_user_id', '3': 6, '4': 1, '5': 9, '10': 'adminUserId'},
    {'1': 'approval_token', '3': 7, '4': 1, '5': 9, '10': 'approvalToken'},
    {'1': 'idempotency_key', '3': 8, '4': 1, '5': 9, '10': 'idempotencyKey'},
  ],
};

/// Descriptor for `AdminConvertPlatformWalletsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminConvertPlatformWalletsRequestDescriptor = $convert.base64Decode(
    'CiJBZG1pbkNvbnZlcnRQbGF0Zm9ybVdhbGxldHNSZXF1ZXN0EigKEGZyb21fd2FsbGV0X2NvZG'
    'UYASABKAlSDmZyb21XYWxsZXRDb2RlEiMKDWZyb21fY3VycmVuY3kYAiABKAlSDGZyb21DdXJy'
    'ZW5jeRIkCg50b193YWxsZXRfY29kZRgDIAEoCVIMdG9XYWxsZXRDb2RlEh8KC3RvX2N1cnJlbm'
    'N5GAQgASgJUgp0b0N1cnJlbmN5EkMKHmFtb3VudF9pbl9kZXN0aW5hdGlvbl9jdXJyZW5jeRgF'
    'IAEoAVIbYW1vdW50SW5EZXN0aW5hdGlvbkN1cnJlbmN5EiIKDWFkbWluX3VzZXJfaWQYBiABKA'
    'lSC2FkbWluVXNlcklkEiUKDmFwcHJvdmFsX3Rva2VuGAcgASgJUg1hcHByb3ZhbFRva2VuEicK'
    'D2lkZW1wb3RlbmN5X2tleRgIIAEoCVIOaWRlbXBvdGVuY3lLZXk=');

@$core.Deprecated('Use adminConvertPlatformWalletsResponseDescriptor instead')
const AdminConvertPlatformWalletsResponse$json = {
  '1': 'AdminConvertPlatformWalletsResponse',
  '2': [
    {
      '1': 'transaction',
      '3': 1,
    ...
    {'1': 'fx_rate_used', '3': 2, '4': 1, '5': 1, '10': 'fxRateUsed'},
    {'1': 'from_amount', '3': 3, '4': 1, '5': 1, '10': 'fromAmount'},
  ],
};

/// Descriptor for `AdminConvertPlatformWalletsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminConvertPlatformWalletsResponseDescriptor =
    $convert.base64Decode(
        'CiNBZG1pbkNvbnZlcnRQbGF0Zm9ybVdhbGxldHNSZXNwb25zZRI/Cgt0cmFuc2FjdGlvbhgBIA'
        'EoCzIdLmV4Y2hhbmdlLkV4Y2hhbmdlVHJhbnNhY3Rpb25SC3RyYW5zYWN0aW9uEiAKDGZ4X3Jh'
        'dGVfdXNlZBgCIAEoAVIKZnhSYXRlVXNlZBIfCgtmcm9tX2Ftb3VudBgDIAEoAVIKZnJvbUFtb3'
        'VudA==');

@$core.Deprecated('Use adminBridgePreviewRequestDescriptor instead')
const AdminBridgePreviewRequest$json = {
  '1': 'AdminBridgePreviewRequest',
  '2': [
    {'1': 'from_currency', '3': 1, '4': 1, '5': 9, '10': 'fromCurrency'},
    {'1': 'to_currency', '3': 2, '4': 1, '5': 9, '10': 'toCurrency'},
    {
...
/// Descriptor for `AdminBridgePreviewRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminBridgePreviewRequestDescriptor = $convert.base64Decode(
    'ChlBZG1pbkJyaWRnZVByZXZpZXdSZXF1ZXN0EiMKDWZyb21fY3VycmVuY3kYASABKAlSDGZyb2'
    '1DdXJyZW5jeRIfCgt0b19jdXJyZW5jeRgCIAEoCVIKdG9DdXJyZW5jeRJDCh5hbW91bnRfaW5f'
    'ZGVzdGluYXRpb25fY3VycmVuY3kYAyABKAFSG2Ftb3VudEluRGVzdGluYXRpb25DdXJyZW5jeQ'
    '==');

@$core.Deprecated('Use adminBridgePreviewResponseDescriptor instead')
const AdminBridgePreviewResponse$json = {
  '1': 'AdminBridgePreviewResponse',
  '2': [
    {'1': 'fx_rate', '3': 1, '4': 1, '5': 1, '10': 'fxRate'},
    {'1': 'from_amount', '3': 2, '4': 1, '5': 1, '10': 'fromAmount'},
    {'1': 'margin_amount', '3': 3, '4': 1, '5': 1, '10': 'marginAmount'},
    {'1': 'rate_id', '3': 4, '4': 1, '5': 9, '10': 'rateId'},
  ],
};

/// Descriptor for `AdminBridgePreviewResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List adminBridgePreviewResponseDescriptor =
    $convert.base64Decode(

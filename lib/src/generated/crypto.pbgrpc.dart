...
class CryptoServiceClient extends $grpc.Client {
  ...
  static final _$getSupportedAssets = $grpc.ClientMethod<$0.GetSupportedAssetsRequest, $0.GetSupportedAssetsResponse>(
      '/pb.CryptoService/GetSupportedAssets',
      ($0.GetSupportedAssetsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetSupportedAssetsResponse.fromBuffer(value));
  static final _$getCryptoFiatRate = $grpc.ClientMethod<$0.GetCryptoFiatRateRequest, $0.GetCryptoFiatRateResponse>(
      '/pb.CryptoService/GetCryptoFiatRate',
      ($0.GetCryptoFiatRateRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetCryptoFiatRateResponse.fromBuffer(value));
  ...
  static final _$toggleFavorite = $grpc.ClientMethod<$0.ToggleFavoriteRequest, $0.ToggleFavoriteResponse>(
      '/pb.CryptoService/ToggleFavorite',
      ($0.ToggleFavoriteRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ToggleFavoriteResponse.fromBuffer(value));
  static final _$getCryptoNews = $grpc.ClientMethod<$0.GetCryptoNewsRequest, $0.GetCryptoNewsResponse>(
      '/pb.CryptoService/GetCryptoNews',
      ($0.GetCryptoNewsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetCryptoNewsResponse.fromBuffer(value));
  static final _$getOHLCV = $grpc.ClientMethod<$0.GetOHLCVRequest, $0.GetOHLCVResponse>(
      '/pb.CryptoService/GetOHLCV',
      ($0.GetOHLCVRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetOHLCVResponse.fromBuffer(value));
  static final _$getOrderBook = $grpc.ClientMethod<$0.GetOrderBookRequest, $0.GetOrderBookResponse>(
      '/pb.CryptoService/GetOrderBook',
      ($0.GetOrderBookRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetOrderBookResponse.fromBuffer(value));
  static final _$getRecentTrades = $grpc.ClientMethod<$0.GetRecentTradesRequest, $0.GetRecentTradesResponse>(
      '/pb.CryptoService/GetRecentTrades',
      ($0.GetRecentTradesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetRecentTradesResponse.fromBuffer(value));
  static final _$getFearGreedIndex = $grpc.ClientMethod<$0.GetFearGreedIndexRequest, $0.GetFearGreedIndexResponse>(
      '/pb.CryptoService/GetFearGreedIndex',
      ($0.GetFearGreedIndexRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetFearGreedIndexResponse.fromBuffer(value));
  ...
  static final _$getPlatformCryptoPortfolio = $grpc.ClientMethod<$0.GetPlatformCryptoPortfolioRequest, $0.GetPlatformCryptoPortfolioResponse>(
      '/pb.CryptoService/GetPlatformCryptoPortfolio',
      ($0.GetPlatformCryptoPortfolioRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetPlatformCryptoPortfolioResponse.fromBuffer(value));
  static final _$getPlatformCryptoTransactions = $grpc.ClientMethod<$0.GetPlatformCryptoTransactionsRequest, $0.GetPlatformCryptoTransactionsResponse>(
      '/pb.CryptoService/GetPlatformCryptoTransactions',
      ($0.GetPlatformCryptoTransactionsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetPlatformCryptoTransactionsResponse.fromBuffer(value));
  static final _$getFeeTiers = $grpc.ClientMethod<$0.GetFeeTiersRequest, $0.GetFeeTiersResponse>(
      '/pb.CryptoService/GetFeeTiers',
      ($0.GetFeeTiersRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetFeeTiersResponse.fromBuffer(value));
  static final _$createFeeTier = $grpc.ClientMethod<$0.CreateFeeTierRequest, $0.CreateFeeTierResponse>(
      '/pb.CryptoService/CreateFeeTier',
      ($0.CreateFeeTierRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.CreateFeeTierResponse.fromBuffer(value));
  static final _$updateFeeTier = $grpc.ClientMethod<$0.UpdateFeeTierRequest, $0.UpdateFeeTierResponse>(
      '/pb.CryptoService/UpdateFeeTier',
      ($0.UpdateFeeTierRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UpdateFeeTierResponse.fromBuffer(value));
  static final _$deleteFeeTier = $grpc.ClientMethod<$0.DeleteFeeTierRequest, $0.DeleteFeeTierResponse>(
      '/pb.CryptoService/DeleteFeeTier',
      ($0.DeleteFeeTierRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.DeleteFeeTierResponse.fromBuffer(value));
  static final _$runReconciliation = $grpc.ClientMethod<$0.RunReconciliationRequest, $0.ReconciliationResult>(
      '/pb.CryptoService/RunReconciliation',
      ($0.RunReconciliationRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.ReconciliationResult.fromBuffer(value));
  static final _$getReconciliationLogs = $grpc.ClientMethod<$0.GetReconciliationLogsRequest, $0.GetReconciliationLogsResponse>(
      '/pb.CryptoService/GetReconciliationLogs',
      ($0.GetReconciliationLogsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetReconciliationLogsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetSupportedAssetsResponse> getSupportedAssets($0.GetSupportedAssetsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSupportedAssets, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetCryptoFiatRateResponse> getCryptoFiatRate($0.GetCryptoFiatRateRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.ToggleFavoriteResponse> toggleFavorite($0.ToggleFavoriteRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$toggleFavorite, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetCryptoNewsResponse> getCryptoNews($0.GetCryptoNewsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getCryptoNews, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetOHLCVResponse> getOHLCV($0.GetOHLCVRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getOHLCV, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetOrderBookResponse> getOrderBook($0.GetOrderBookRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getOrderBook, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetRecentTradesResponse> getRecentTrades($0.GetRecentTradesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getRecentTrades, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetFearGreedIndexResponse> getFearGreedIndex($0.GetFearGreedIndexRequest request, {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.GetPlatformCryptoPortfolioResponse> getPlatformCryptoPortfolio($0.GetPlatformCryptoPortfolioRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getPlatformCryptoPortfolio, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetPlatformCryptoTransactionsResponse> getPlatformCryptoTransactions($0.GetPlatformCryptoTransactionsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getPlatformCryptoTransactions, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetFeeTiersResponse> getFeeTiers($0.GetFeeTiersRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getFeeTiers, request, options: options);
  }

  $grpc.ResponseFuture<$0.CreateFeeTierResponse> createFeeTier($0.CreateFeeTierRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createFeeTier, request, options: options);
  }

  $grpc.ResponseFuture<$0.UpdateFeeTierResponse> updateFeeTier($0.UpdateFeeTierRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateFeeTier, request, options: options);
  }

  $grpc.ResponseFuture<$0.DeleteFeeTierResponse> deleteFeeTier($0.DeleteFeeTierRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteFeeTier, request, options: options);
  }

  $grpc.ResponseFuture<$0.ReconciliationResult> runReconciliation($0.RunReconciliationRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$runReconciliation, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetReconciliationLogsResponse> getReconciliationLogs($0.GetReconciliationLogsRequest request, {$grpc.CallOptions? options}) {
...
abstract class CryptoServiceBase extends $grpc.Service {
  ...
  CryptoServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetSupportedAssetsRequest, $0.GetSupportedAssetsResponse>(
        'GetSupportedAssets',
        getSupportedAssets_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetSupportedAssetsRequest.fromBuffer(value),
        ($0.GetSupportedAssetsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetCryptoFiatRateRequest, $0.GetCryptoFiatRateResponse>(
        'GetCryptoFiatRate',
        getCryptoFiatRate_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetCryptoFiatRateRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.ToggleFavoriteRequest, $0.ToggleFavoriteResponse>(
        'ToggleFavorite',
        toggleFavorite_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.ToggleFavoriteRequest.fromBuffer(value),
        ($0.ToggleFavoriteResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetCryptoNewsRequest, $0.GetCryptoNewsResponse>(
        'GetCryptoNews',
        getCryptoNews_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetCryptoNewsRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.GetOrderBookRequest, $0.GetOrderBookResponse>(
        'GetOrderBook',
        getOrderBook_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetOrderBookRequest.fromBuffer(value),
        ($0.GetOrderBookResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetRecentTradesRequest, $0.GetRecentTradesResponse>(
        'GetRecentTrades',
        getRecentTrades_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetRecentTradesRequest.fromBuffer(value),
        ($0.GetRecentTradesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetFearGreedIndexRequest, $0.GetFearGreedIndexResponse>(
        'GetFearGreedIndex',
        getFearGreedIndex_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetFearGreedIndexRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.GetPlatformCryptoPortfolioRequest, $0.GetPlatformCryptoPortfolioResponse>(
        'GetPlatformCryptoPortfolio',
        getPlatformCryptoPortfolio_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetPlatformCryptoPortfolioRequest.fromBuffer(value),
        ($0.GetPlatformCryptoPortfolioResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetPlatformCryptoTransactionsRequest, $0.GetPlatformCryptoTransactionsResponse>(
        'GetPlatformCryptoTransactions',
        getPlatformCryptoTransactions_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetPlatformCryptoTransactionsRequest.fromBuffer(value),
        ($0.GetPlatformCryptoTransactionsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetFeeTiersRequest, $0.GetFeeTiersResponse>(
        'GetFeeTiers',
        getFeeTiers_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetFeeTiersRequest.fromBuffer(value),
        ($0.GetFeeTiersResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.CreateFeeTierRequest, $0.CreateFeeTierResponse>(
        'CreateFeeTier',
        createFeeTier_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.CreateFeeTierRequest.fromBuffer(value),
        ($0.CreateFeeTierResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpdateFeeTierRequest, $0.UpdateFeeTierResponse>(
        'UpdateFeeTier',
        updateFeeTier_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.UpdateFeeTierRequest.fromBuffer(value),
        ($0.UpdateFeeTierResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.DeleteFeeTierRequest, $0.DeleteFeeTierResponse>(
        'DeleteFeeTier',
        deleteFeeTier_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.DeleteFeeTierRequest.fromBuffer(value),
        ($0.DeleteFeeTierResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RunReconciliationRequest, $0.ReconciliationResult>(
        'RunReconciliation',
    ...
    $addMethod($grpc.ServiceMethod<$0.GetReconciliationLogsRequest, $0.GetReconciliationLogsResponse>(
        'GetReconciliationLogs',
        getReconciliationLogs_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetReconciliationLogsRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetSupportedAssetsResponse> getSupportedAssets_Pre($grpc.ServiceCall call, $async.Future<$0.GetSupportedAssetsRequest> request) async {
    return getSupportedAssets(call, await request);
  }

  $async.Future<$0.GetCryptoFiatRateResponse> getCryptoFiatRate_Pre($grpc.ServiceCall call, $async.Future<$0.GetCryptoFiatRateRequest> request) async {
  ...
  $async.Future<$0.ToggleFavoriteResponse> toggleFavorite_Pre($grpc.ServiceCall call, $async.Future<$0.ToggleFavoriteRequest> request) async {
    return toggleFavorite(call, await request);
  }

  $async.Future<$0.GetCryptoNewsResponse> getCryptoNews_Pre($grpc.ServiceCall call, $async.Future<$0.GetCryptoNewsRequest> request) async {
    return getCryptoNews(call, await request);
  }

  $async.Future<$0.GetOHLCVResponse> getOHLCV_Pre($grpc.ServiceCall call, $async.Future<$0.GetOHLCVRequest> request) async {
    return getOHLCV(call, await request);
  }

  $async.Future<$0.GetOrderBookResponse> getOrderBook_Pre($grpc.ServiceCall call, $async.Future<$0.GetOrderBookRequest> request) async {
    return getOrderBook(call, await request);
  }

  $async.Future<$0.GetRecentTradesResponse> getRecentTrades_Pre($grpc.ServiceCall call, $async.Future<$0.GetRecentTradesRequest> request) async {
    return getRecentTrades(call, await request);
  }

  $async.Future<$0.GetFearGreedIndexResponse> getFearGreedIndex_Pre($grpc.ServiceCall call, $async.Future<$0.GetFearGreedIndexRequest> request) async {
  ...
  $async.Future<$0.GetPlatformCryptoPortfolioResponse> getPlatformCryptoPortfolio_Pre($grpc.ServiceCall call, $async.Future<$0.GetPlatformCryptoPortfolioRequest> request) async {
    return getPlatformCryptoPortfolio(call, await request);
  }

  $async.Future<$0.GetPlatformCryptoTransactionsResponse> getPlatformCryptoTransactions_Pre($grpc.ServiceCall call, $async.Future<$0.GetPlatformCryptoTransactionsRequest> request) async {
    return getPlatformCryptoTransactions(call, await request);
  }

  $async.Future<$0.GetFeeTiersResponse> getFeeTiers_Pre($grpc.ServiceCall call, $async.Future<$0.GetFeeTiersRequest> request) async {
    return getFeeTiers(call, await request);
  }

  $async.Future<$0.CreateFeeTierResponse> createFeeTier_Pre($grpc.ServiceCall call, $async.Future<$0.CreateFeeTierRequest> request) async {
    return createFeeTier(call, await request);
  }

  $async.Future<$0.UpdateFeeTierResponse> updateFeeTier_Pre($grpc.ServiceCall call, $async.Future<$0.UpdateFeeTierRequest> request) async {
    return updateFeeTier(call, await request);
  }

  $async.Future<$0.DeleteFeeTierResponse> deleteFeeTier_Pre($grpc.ServiceCall call, $async.Future<$0.DeleteFeeTierRequest> request) async {
    return deleteFeeTier(call, await request);
  }

  $async.Future<$0.ReconciliationResult> runReconciliation_Pre($grpc.ServiceCall call, $async.Future<$0.RunReconciliationRequest> request) async {
    return runReconciliation(call, await request);
  }

  $async.Future<$0.GetReconciliationLogsResponse> getReconciliationLogs_Pre($grpc.ServiceCall call, $async.Future<$0.GetReconciliationLogsRequest> request) async {
  ...
  $async.Future<$0.GetSupportedAssetsResponse> getSupportedAssets($grpc.ServiceCall call, $0.GetSupportedAssetsRequest request);
  $async.Future<$0.GetCryptoFiatRateResponse> getCryptoFiatRate($grpc.ServiceCall call, $0.GetCryptoFiatRateRequest request);
  ...
  $async.Future<$0.ToggleFavoriteResponse> toggleFavorite($grpc.ServiceCall call, $0.ToggleFavoriteRequest request);
  $async.Future<$0.GetCryptoNewsResponse> getCryptoNews($grpc.ServiceCall call, $0.GetCryptoNewsRequest request);
  $async.Future<$0.GetOHLCVResponse> getOHLCV($grpc.ServiceCall call, $0.GetOHLCVRequest request);
  $async.Future<$0.GetOrderBookResponse> getOrderBook($grpc.ServiceCall call, $0.GetOrderBookRequest request);
  $async.Future<$0.GetRecentTradesResponse> getRecentTrades($grpc.ServiceCall call, $0.GetRecentTradesRequest request);
  $async.Future<$0.GetFearGreedIndexResponse> getFearGreedIndex($grpc.ServiceCall call, $0.GetFearGreedIndexRequest request);
  ...
  $async.Future<$0.GetPlatformCryptoPortfolioResponse> getPlatformCryptoPortfolio($grpc.ServiceCall call, $0.GetPlatformCryptoPortfolioRequest request);
  $async.Future<$0.GetPlatformCryptoTransactionsResponse> getPlatformCryptoTransactions($grpc.ServiceCall call, $0.GetPlatformCryptoTransactionsRequest request);
  $async.Future<$0.GetFeeTiersResponse> getFeeTiers($grpc.ServiceCall call, $0.GetFeeTiersRequest request);
  $async.Future<$0.CreateFeeTierResponse> createFeeTier($grpc.ServiceCall call, $0.CreateFeeTierRequest request);
  $async.Future<$0.UpdateFeeTierResponse> updateFeeTier($grpc.ServiceCall call, $0.UpdateFeeTierRequest request);
  $async.Future<$0.DeleteFeeTierResponse> deleteFeeTier($grpc.ServiceCall call, $0.DeleteFeeTierRequest request);
  $async.Future<$0.ReconciliationResult> runReconciliation($grpc.ServiceCall call, $0.RunReconciliationRequest request);
  $async.Future<$0.GetReconciliationLogsResponse> getReconciliationLogs($grpc.ServiceCall call, $0.GetReconciliationLogsRequest request);
}

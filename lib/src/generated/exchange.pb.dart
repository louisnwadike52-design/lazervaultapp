...
class ReceiverDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(12, _omitFieldNames ? '' : 'beneficiaryType')
    ..hasRequiredFields = false;
  ...
  /// "individual" or "business". Drives UK Confirmation-of-Payee alignment
  /// (name-pattern matching by recipient account type). Carried into the
  /// Flutterwave meta.beneficiary_type field — v3 ignores unknown meta
  /// keys; v4 will consume it natively once we migrate.
  @$pb.TagNumber(12)
  $core.String get beneficiaryType => $_getSZ(11);
  @$pb.TagNumber(12)
  set beneficiaryType($core.String value) => $_setString(11, value);
  @$pb.TagNumber(12)
  $core.bool hasBeneficiaryType() => $_has(11);
  @$pb.TagNumber(12)
  void clearBeneficiaryType() => $_clearField(12);
}
...
class ExchangeTransaction extends $pb.GeneratedMessage {
  factory ExchangeTransaction({
    ...
    if (providerFee != null) result.providerFee = providerFee;
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$core.double>(
        17, _omitFieldNames ? '' : 'providerFee', $pb.PbFieldType.OD)
    ..a<$core.double>(
        18, _omitFieldNames ? '' : 'serviceFee', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;
  ...
  /// Fee breakdown (major units of from_currency). `fees` (8) stays the
  /// composite total for backward compatibility.
  @$pb.TagNumber(17)
  $core.double get providerFee => $_getN(16);
  @$pb.TagNumber(17)
  set providerFee($core.double value) => $_setDouble(16, value);
  @$pb.TagNumber(17)
  $core.bool hasProviderFee() => $_has(16);
  @$pb.TagNumber(17)
  void clearProviderFee() => $_clearField(17);

  @$pb.TagNumber(18)
  $core.double get serviceFee => $_getN(17);
  @$pb.TagNumber(18)
  set serviceFee($core.double value) => $_setDouble(17, value);
  @$pb.TagNumber(18)
  $core.bool hasServiceFee() => $_has(17);
  @$pb.TagNumber(18)
  void clearServiceFee() => $_clearField(18);
}
...
class AdminConvertPlatformWalletsRequest extends $pb.GeneratedMessage {
  factory AdminConvertPlatformWalletsRequest({
    ...
    final result = create();
    if (fromWalletCode != null) result.fromWalletCode = fromWalletCode;
    if (fromCurrency != null) result.fromCurrency = fromCurrency;
    if (toWalletCode != null) result.toWalletCode = toWalletCode;
    if (toCurrency != null) result.toCurrency = toCurrency;
    if (amountInDestinationCurrency != null)
      result.amountInDestinationCurrency = amountInDestinationCurrency;
  ...
  AdminConvertPlatformWalletsRequest._();

  factory AdminConvertPlatformWalletsRequest.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminConvertPlatformWalletsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminConvertPlatformWalletsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'exchange'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'fromWalletCode')
    ..aOS(2, _omitFieldNames ? '' : 'fromCurrency')
    ..aOS(3, _omitFieldNames ? '' : 'toWalletCode')
    ..aOS(4, _omitFieldNames ? '' : 'toCurrency')
    ..a<$core.double>(5, _omitFieldNames ? '' : 'amountInDestinationCurrency',
        $pb.PbFieldType.OD)
    ..aOS(6, _omitFieldNames ? '' : 'adminUserId')
    ..aOS(7, _omitFieldNames ? '' : 'approvalToken')
    ..aOS(8, _omitFieldNames ? '' : 'idempotencyKey')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminConvertPlatformWalletsRequest clone() =>
      AdminConvertPlatformWalletsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminConvertPlatformWalletsRequest copyWith(
          void Function(AdminConvertPlatformWalletsRequest) updates) =>
      super.copyWith((message) =>
              updates(message as AdminConvertPlatformWalletsRequest))
          as AdminConvertPlatformWalletsRequest;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminConvertPlatformWalletsRequest create() =>
      AdminConvertPlatformWalletsRequest._();
  @$core.override
  AdminConvertPlatformWalletsRequest createEmptyInstance() => create();
  static $pb.PbList<AdminConvertPlatformWalletsRequest> createRepeated() =>
      $pb.PbList<AdminConvertPlatformWalletsRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminConvertPlatformWalletsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminConvertPlatformWalletsRequest>(
          create);
  ...
  @$pb.TagNumber(1)
  set fromWalletCode($core.String value) => $_setString(0, value);
  @$pb.TagNumber(1)
  $core.bool hasFromWalletCode() => $_has(0);
  @$pb.TagNumber(1)
  void clearFromWalletCode() => $_clearField(1);
  ...
  @$pb.TagNumber(3)
  set toWalletCode($core.String value) => $_setString(2, value);
  @$pb.TagNumber(3)
  $core.bool hasToWalletCode() => $_has(2);
  @$pb.TagNumber(3)
  void clearToWalletCode() => $_clearField(3);
  ...
  /// We owe N units in destination currency; bridge that much.
  @$pb.TagNumber(5)
  $core.double get amountInDestinationCurrency => $_getN(4);
  @$pb.TagNumber(5)
  set amountInDestinationCurrency($core.double value) => $_setDouble(4, value);
  @$pb.TagNumber(5)
  $core.bool hasAmountInDestinationCurrency() => $_has(4);
  @$pb.TagNumber(5)
  void clearAmountInDestinationCurrency() => $_clearField(5);
  ...
  @$pb.TagNumber(7)
  set approvalToken($core.String value) => $_setString(6, value);
  @$pb.TagNumber(7)
  $core.bool hasApprovalToken() => $_has(6);
  @$pb.TagNumber(7)
  void clearApprovalToken() => $_clearField(7);
...
class AdminConvertPlatformWalletsResponse extends $pb.GeneratedMessage {
  factory AdminConvertPlatformWalletsResponse({
    ...
    final result = create();
    if (transaction != null) result.transaction = transaction;
    if (fxRateUsed != null) result.fxRateUsed = fxRateUsed;
    if (fromAmount != null) result.fromAmount = fromAmount;
    return result;
  }

  AdminConvertPlatformWalletsResponse._();

  factory AdminConvertPlatformWalletsResponse.fromBuffer(
          $core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminConvertPlatformWalletsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminConvertPlatformWalletsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'exchange'),
      createEmptyInstance: create)
    ..aOM<ExchangeTransaction>(1, _omitFieldNames ? '' : 'transaction',
        subBuilder: ExchangeTransaction.create)
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'fxRateUsed', $pb.PbFieldType.OD)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'fromAmount', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminConvertPlatformWalletsResponse clone() =>
      AdminConvertPlatformWalletsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminConvertPlatformWalletsResponse copyWith(
          void Function(AdminConvertPlatformWalletsResponse) updates) =>
      super.copyWith((message) =>
              updates(message as AdminConvertPlatformWalletsResponse))
          as AdminConvertPlatformWalletsResponse;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static AdminConvertPlatformWalletsResponse create() =>
      AdminConvertPlatformWalletsResponse._();
  @$core.override
  AdminConvertPlatformWalletsResponse createEmptyInstance() => create();
  static $pb.PbList<AdminConvertPlatformWalletsResponse> createRepeated() =>
      $pb.PbList<AdminConvertPlatformWalletsResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminConvertPlatformWalletsResponse getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<
          AdminConvertPlatformWalletsResponse>(create);
  ...
  @$pb.TagNumber(2)
  set fxRateUsed($core.double value) => $_setDouble(1, value);
  @$pb.TagNumber(2)
  $core.bool hasFxRateUsed() => $_has(1);
  @$pb.TagNumber(2)
  void clearFxRateUsed() => $_clearField(2);

  /// amount actually debited from the source wallet (in source currency).
  @$pb.TagNumber(3)
...
class AdminBridgePreviewRequest extends $pb.GeneratedMessage {
  ...
  AdminBridgePreviewRequest._();

  factory AdminBridgePreviewRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminBridgePreviewRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminBridgePreviewRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'exchange'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'fromCurrency')
    ..aOS(2, _omitFieldNames ? '' : 'toCurrency')
    ..a<$core.double>(3, _omitFieldNames ? '' : 'amountInDestinationCurrency',
        $pb.PbFieldType.OD)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminBridgePreviewRequest clone() =>
      AdminBridgePreviewRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminBridgePreviewRequest copyWith(
          void Function(AdminBridgePreviewRequest) updates) =>
      super.copyWith((message) => updates(message as AdminBridgePreviewRequest))
          as AdminBridgePreviewRequest;
  ...
  static $pb.PbList<AdminBridgePreviewRequest> createRepeated() =>
      $pb.PbList<AdminBridgePreviewRequest>();
  @$core.pragma('dart2js:noInline')
  static AdminBridgePreviewRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminBridgePreviewRequest>(create);
  ...
  @$pb.TagNumber(3)
  set amountInDestinationCurrency($core.double value) => $_setDouble(2, value);
  @$pb.TagNumber(3)
  $core.bool hasAmountInDestinationCurrency() => $_has(2);
  @$pb.TagNumber(3)
  void clearAmountInDestinationCurrency() => $_clearField(3);
}
...
class AdminBridgePreviewResponse extends $pb.GeneratedMessage {
  factory AdminBridgePreviewResponse({
    ...
    if (fromAmount != null) result.fromAmount = fromAmount;
    if (marginAmount != null) result.marginAmount = marginAmount;
    if (rateId != null) result.rateId = rateId;
    return result;
  }

  AdminBridgePreviewResponse._();

  factory AdminBridgePreviewResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory AdminBridgePreviewResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'AdminBridgePreviewResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'exchange'),
      createEmptyInstance: create)
    ..a<$core.double>(1, _omitFieldNames ? '' : 'fxRate', $pb.PbFieldType.OD)
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'fromAmount', $pb.PbFieldType.OD)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'marginAmount', $pb.PbFieldType.OD)
    ..aOS(4, _omitFieldNames ? '' : 'rateId')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminBridgePreviewResponse clone() =>
      AdminBridgePreviewResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  AdminBridgePreviewResponse copyWith(
          void Function(AdminBridgePreviewResponse) updates) =>
      super.copyWith(
              (message) => updates(message as AdminBridgePreviewResponse))
          as AdminBridgePreviewResponse;
  ...
  static $pb.PbList<AdminBridgePreviewResponse> createRepeated() =>
      $pb.PbList<AdminBridgePreviewResponse>();
  @$core.pragma('dart2js:noInline')
  static AdminBridgePreviewResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<AdminBridgePreviewResponse>(create);
  static AdminBridgePreviewResponse? _defaultInstance;

  @$pb.TagNumber(1)
  $core.double get fxRate => $_getN(0);
  @$pb.TagNumber(1)
  set fxRate($core.double value) => $_setDouble(0, value);
  @$pb.TagNumber(1)
  $core.bool hasFxRate() => $_has(0);
  @$pb.TagNumber(1)
  void clearFxRate() => $_clearField(1);

  @$pb.TagNumber(2)
  $core.double get fromAmount => $_getN(1);
  @$pb.TagNumber(2)
  set fromAmount($core.double value) => $_setDouble(1, value);
  @$pb.TagNumber(2)
  $core.bool hasFromAmount() => $_has(1);
  @$pb.TagNumber(2)
  void clearFromAmount() => $_clearField(2);

  @$pb.TagNumber(3)
  $core.double get marginAmount => $_getN(2);
  @$pb.TagNumber(3)
  set marginAmount($core.double value) => $_setDouble(2, value);
  @$pb.TagNumber(3)
  $core.bool hasMarginAmount() => $_has(2);
  @$pb.TagNumber(3)
  void clearMarginAmount() => $_clearField(3);

  @$pb.TagNumber(4)
  $core.String get rateId => $_getSZ(3);
  @$pb.TagNumber(4)
  set rateId($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)

...
class GroupAccountServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.RemoveContributionShadowResponse>
    ...
    $0.RemoveContributionShadowRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  /// Cycle history. Each cycle of a contribution (ROSCA rotation or
  /// a one-time fresh-start) is frozen at close into
  /// contribution_cycles + contribution_cycle_members. These RPCs
  /// surface that frozen state to the Flutter cycle-history screen,
  /// the cycle-details bottom sheet, and the admin dashboard cycles
  /// tab. RestartContribution lets an admin close the current cycle
  /// of a one-time contribution and start a fresh one with the same
  /// members + settings (canonical "fresh start" path).
  $grpc.ResponseFuture<$0.ListContributionCyclesResponse>
      listContributionCycles(
    $0.ListContributionCyclesRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.SendContributionMessageResponse>
    ...
    $0.SendContributionMessageRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  $grpc.ResponseFuture<$0.ListContributionMessagesResponse>
    ...
    $0.ListContributionMessagesRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$removeContributionShadow = $grpc.ClientMethod<
      ...
      $0.RemoveContributionShadowResponse.fromBuffer);
  ...
  static final _$listContributionCycles = $grpc.ClientMethod<
      ...
      $0.ListContributionCyclesResponse.fromBuffer);
  static final _$getContributionCycleDetails = $grpc.ClientMethod<
      ...
      $0.GetContributionCycleDetailsResponse.fromBuffer);
  static final _$restartContribution = $grpc.ClientMethod<
      ...
      $0.RestartContributionResponse.fromBuffer);

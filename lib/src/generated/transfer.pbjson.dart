...
const InitiateTransferRequest$json = {
  ...
  '2': [
    ...
    {'1': 'scheduled_at', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'scheduledAt'},
...
final $typed_data.Uint8List initiateTransferRequestDescriptor = $convert.base64Decode(
    ...
    'Y2F0ZWdvcnkSHAoJcmVmZXJlbmNlGAQgASgJUglyZWZlcmVuY2USPQoMc2NoZWR1bGVkX2F0GA'
    'UgASgLMhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcFILc2NoZWR1bGVkQXQSJAoNdG9fYWNj'
    'b3VudF9pZBgKIAEoBFINdG9fYWNjb3VudF9pZBIiCgxyZWNpcGllbnRfaWQYCyABKARSDHJlY2'
    'lwaWVudF9pZDogkkEdChvSAQ9mcm9tX2FjY291bnRfaWTSAQZhbW91bnQ=');
...
const PaginationInfo$json = {
  ...
  '2': [
    ...
    {'1': 'total_items', '3': 4, '4': 1, '5': 3, '10': 'totalItems'},
  ],
};
...
final $typed_data.Uint8List paginationInfoDescriptor = $convert.base64Decode(
    ...
    'BhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHwoLdG90YWxfcGFnZXMYAyABKAVSCnRvdGFsUGFn'
    'ZXMSHwoLdG90YWxfaXRlbXMYBCABKANSCnRvdGFsSXRlbXM=');
...
const GetTransactionsRequest$json = {
  ...
  '2': [
    ...
    {'1': 'transfer_type', '3': 5, '4': 1, '5': 14, '6': '.pb.TransferType', '10': 'transferType'},
    {'1': 'category', '3': 6, '4': 1, '5': 9, '10': 'category'},
    {'1': 'page_number', '3': 10, '4': 1, '5': 5, '10': 'pageNumber'},
...
final $typed_data.Uint8List getTransactionsRequestDescriptor = $convert.base64Decode(
    'ChZHZXRUcmFuc2FjdGlvbnNSZXF1ZXN0Eh0KCmFjY291bnRfaWQYASABKARSCWFjY291bnRJZB'
    'IXCgdjYXJkX2lkGAIgASgJUgZjYXJkSWQSOQoKc3RhcnRfZGF0ZRgDIAEoCzIaLmdvb2dsZS5w'
    'cm90b2J1Zi5UaW1lc3RhbXBSCXN0YXJ0RGF0ZRI1CghlbmRfZGF0ZRgEIAEoCzIaLmdvb2dsZS'
    '5wcm90b2J1Zi5UaW1lc3RhbXBSB2VuZERhdGUSNQoNdHJhbnNmZXJfdHlwZRgFIAEoDjIQLnBi'
    'LlRyYW5zZmVyVHlwZVIMdHJhbnNmZXJUeXBlEhoKCGNhdGVnb3J5GAYgASgJUghjYXRlZ29yeR'
    'IfCgtwYWdlX251bWJlchgKIAEoBVIKcGFnZU51bWJlchIbCglwYWdlX3NpemUYCyABKAVSCHBh'
    'Z2VTaXplOgWSQQIKAA==');
...
const GetTransactionsResponse$json = {
  ...
  '2': [
    {'1': 'transactions', '3': 1, '4': 3, '5': 11, '6': '.pb.TransferTransaction', '10': 'transactions'},
...
final $typed_data.Uint8List getTransactionsResponseDescriptor = $convert.base64Decode(
    'ChdHZXRUcmFuc2FjdGlvbnNSZXNwb25zZRI7Cgx0cmFuc2FjdGlvbnMYASADKAsyFy5wYi5Ucm'
    'Fuc2ZlclRyYW5zYWN0aW9uUgx0cmFuc2FjdGlvbnMSMgoKcGFnaW5hdGlvbhgCIAEoCzISLnBi'
...
const GetTransferDetailsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'scheduled_at', '3': 14, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'scheduled_at'},
...
final $typed_data.Uint8List getTransferDetailsResponseDescriptor = $convert.base64Decode(
    ...
    'cFIKY3JlYXRlZF9hdBI+CgxzY2hlZHVsZWRfYXQYDiABKAsyGi5nb29nbGUucHJvdG9idWYuVG'
    'ltZXN0YW1wUgxzY2hlZHVsZWRfYXQSPgoMY29tcGxldGVkX2F0GA8gASgLMhouZ29vZ2xlLnBy'
    'b3RvYnVmLlRpbWVzdGFtcFIMY29tcGxldGVkX2F0EjgKCWZhaWxlZF9hdBgQIAEoCzIaLmdvb2'
    'dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCWZhaWxlZF9hdBImCg5mYWlsdXJlX3JlYXNvbhgRIAEo'
    'CVIOZmFpbHVyZV9yZWFzb24=');

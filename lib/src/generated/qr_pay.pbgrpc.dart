...
/// QRPayService - QR code-based payment service
...
class QRPayServiceClient extends $grpc.Client {
  ...
  /// Creator edits/clears the optional expiry after creation (0 = none). A
  /// still-valid new window also revives an EXPIRED code.
  $grpc.ResponseFuture<$0.UpdateQRExpiryResponse> updateQRExpiry(
    $0.UpdateQRExpiryRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$updateQRExpiry, request, options: options);
  }

  /// Creator lists everyone who paid one QR code (reusable codes accumulate
  /// many), newest first, with the completed total.
  $grpc.ResponseFuture<$0.GetQRPayersResponse> getQRPayers(
    $0.GetQRPayersRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getQRPayers, request, options: options);
  }
  ...
  static final _$updateQRExpiry =
      $grpc.ClientMethod<$0.UpdateQRExpiryRequest, $0.UpdateQRExpiryResponse>(
          '/qr_pay.QRPayService/UpdateQRExpiry',
          ($0.UpdateQRExpiryRequest value) => value.writeToBuffer(),
          $0.UpdateQRExpiryResponse.fromBuffer);
  static final _$getQRPayers =
      $grpc.ClientMethod<$0.GetQRPayersRequest, $0.GetQRPayersResponse>(
          '/qr_pay.QRPayService/GetQRPayers',
          ($0.GetQRPayersRequest value) => value.writeToBuffer(),
          $0.GetQRPayersResponse.fromBuffer);
...
abstract class QRPayServiceBase extends $grpc.Service {
  ...
  QRPayServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.UpdateQRExpiryRequest,
            $0.UpdateQRExpiryResponse>(
        'UpdateQRExpiry',
        updateQRExpiry_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.UpdateQRExpiryRequest.fromBuffer(value),
        ($0.UpdateQRExpiryResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.GetQRPayersRequest, $0.GetQRPayersResponse>(
            'GetQRPayers',
            getQRPayers_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.GetQRPayersRequest.fromBuffer(value),
            ($0.GetQRPayersResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$0.UpdateQRExpiryResponse> updateQRExpiry_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.UpdateQRExpiryRequest> $request) async {
    return updateQRExpiry($call, await $request);
  }

  $async.Future<$0.UpdateQRExpiryResponse> updateQRExpiry(
      $grpc.ServiceCall call, $0.UpdateQRExpiryRequest request);

  $async.Future<$0.GetQRPayersResponse> getQRPayers_Pre($grpc.ServiceCall $call,
      $async.Future<$0.GetQRPayersRequest> $request) async {
    return getQRPayers($call, await $request);
  }

  $async.Future<$0.GetQRPayersResponse> getQRPayers(
      $grpc.ServiceCall call, $0.GetQRPayersRequest request);

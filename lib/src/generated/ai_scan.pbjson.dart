...
const ScanStatus$json = const {
  ...
  '2': const [
    ...
    const {'1': 'SCAN_STATUS_PENDING', '2': 1},
    const {'1': 'SCAN_STATUS_PROCESSING', '2': 2},
    const {'1': 'SCAN_STATUS_COMPLETED', '2': 3},
    const {'1': 'SCAN_STATUS_FAILED', '2': 4},
  ],
};

/// Descriptor for `ScanStatus`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List scanStatusDescriptor = $convert.base64Decode('CgpTY2FuU3RhdHVzEhsKF1NDQU5fU1RBVFVTX1VOU1BFQ0lGSUVEEAASFwoTU0NBTl9TVEFUVVNfUEVORElORxABEhoKFlNDQU5fU1RBVFVTX1BST0NFU1NJTkcQAhIZChVTQ0FOX1NUQVRVU19DT01QTEVURUQQAxIWChJTQ0FOX1NUQVRVU19GQUlMRUQQBA==');
...
const StartScanSessionRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'scan_type', '3': 2, '4': 1, '5': 14, '6': '.pb.ScanType', '10': 'scanType'},
  ],
};

/// Descriptor for `StartScanSessionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List startScanSessionRequestDescriptor = $convert.base64Decode('ChdTdGFydFNjYW5TZXNzaW9uUmVxdWVzdBIXCgd1c2VyX2lkGAEgASgJUgZ1c2VySWQSKQoJc2Nhbl90eXBlGAIgASgOMgwucGIuU2NhblR5cGVSCHNjYW5UeXBl');
...
const StartScanSessionResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'scan_type', '3': 2, '4': 1, '5': 14, '6': '.pb.ScanType', '10': 'scanType'},
    const {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.pb.ScanStatus', '10': 'status'},
...
final $typed_data.Uint8List startScanSessionResponseDescriptor = $convert.base64Decode('ChhTdGFydFNjYW5TZXNzaW9uUmVzcG9uc2USHQoKc2Vzc2lvbl9pZBgBIAEoCVIJc2Vzc2lvbklkEikKCXNjYW5fdHlwZRgCIAEoDjIMLnBiLlNjYW5UeXBlUghzY2FuVHlwZRImCgZzdGF0dXMYAyABKA4yDi5wYi5TY2FuU3RhdHVzUgZzdGF0dXMSHQoKY3JlYXRlZF9hdBgEIAEoA1IJY3JlYXRlZEF0');
...
const ProcessImageRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'scan_type', '3': 3, '4': 1, '5': 14, '6': '.pb.ScanType', '10': 'scanType'},
  ],
};

/// Descriptor for `ProcessImageRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List processImageRequestDescriptor = $convert.base64Decode('ChNQcm9jZXNzSW1hZ2VSZXF1ZXN0Eh0KCnNlc3Npb25faWQYASABKAlSCXNlc3Npb25JZBIdCgppbWFnZV9kYXRhGAIgASgMUglpbWFnZURhdGESKQoJc2Nhbl90eXBlGAMgASgOMgwucGIuU2NhblR5cGVSCHNjYW5UeXBl');
...
const ExtractedData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'additional_fields', '3': 10, '4': 3, '5': 11, '6': '.pb.ExtractedData.AdditionalFieldsEntry', '10': 'additionalFields'},
...
final $typed_data.Uint8List extractedDataDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use processImageResponseDescriptor instead')
const ProcessImageResponse$json = const {
  '1': 'ProcessImageResponse',
  '2': const [
    const {'1': 'session_id', '3': 1, '4': 1, '5': 9, '10': 'sessionId'},
    const {'1': 'extracted_data', '3': 2, '4': 1, '5': 11, '6': '.pb.ExtractedData', '10': 'extractedData'},
...
final $typed_data.Uint8List processImageResponseDescriptor = $convert.base64Decode('');
...
const SendChatMessageRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'context_data', '3': 3, '4': 1, '5': 11, '6': '.pb.ExtractedData', '10': 'contextData'},
  ],
};

/// Descriptor for `SendChatMessageRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sendChatMessageRequestDescriptor = $convert.base64Decode('ChZTZW5kQ2hhdE1lc3NhZ2VSZXF1ZXN0Eh0KCnNlc3Npb25faWQYASABKAlSCXNlc3Npb25JZBIhCgx1c2VyX21lc3NhZ2UYAiABKAlSC3VzZXJNZXNzYWdlEjQKDGNvbnRleHRfZGF0YRgDIAEoCzIRLnBiLkV4dHJhY3RlZERhdGFSC2NvbnRleHREYXRh');
...
final $typed_data.Uint8List generatePaymentInstructionRequestDescriptor = $convert.base64Decode('CiFHZW5lcmF0ZVBheW1lbnRJbnN0cnVjdGlvblJlcXVlc3QSHQoKc2Vzc2lvbl9pZBgBIAEoCVIJc2Vzc2lvbklkEjgKDmV4dHJhY3RlZF9kYXRhGAIgASgLMhEucGIuRXh0cmFjdGVkRGF0YVINZXh0cmFjdGVkRGF0YRIpCglzY2FuX3R5cGUYAyABKA4yDC5wYi5TY2FuVHlwZVIIc2NhblR5cGU=');
...
const PaymentInstruction$json = const {
  ...
  '2': const [
    ...
    const {'1': 'description', '3': 6, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'metadata', '3': 7, '4': 3, '5': 11, '6': '.pb.PaymentInstruction.MetadataEntry', '10': 'metadata'},
  ],
...
final $typed_data.Uint8List paymentInstructionDescriptor = $convert.base64Decode('');
...
const GeneratePaymentInstructionResponse$json = const {
  ...
  '2': const [
    const {'1': 'instruction', '3': 1, '4': 1, '5': 11, '6': '.pb.PaymentInstruction', '10': 'instruction'},
...
final $typed_data.Uint8List generatePaymentInstructionResponseDescriptor = $convert.base64Decode('CiJHZW5lcmF0ZVBheW1lbnRJbnN0cnVjdGlvblJlc3BvbnNlEjgKC2luc3RydWN0aW9uGAEgASgLMhYucGIuUGF5bWVudEluc3RydWN0aW9uUgtpbnN0cnVjdGlvbhIYCgdzdWNjZXNzGAIgASgIUgdzdWNjZXNzEiMKDWVycm9yX21lc3NhZ2UYAyABKAlSDGVycm9yTWVzc2FnZQ==');
...
const ScanProcessPaymentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'instruction', '3': 3, '4': 1, '5': 11, '6': '.pb.PaymentInstruction', '10': 'instruction'},
  ],
};

/// Descriptor for `ScanProcessPaymentRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List scanProcessPaymentRequestDescriptor = $convert.base64Decode('ChlTY2FuUHJvY2Vzc1BheW1lbnRSZXF1ZXN0EhcKB3VzZXJfaWQYASABKAlSBnVzZXJJZBIdCgpzZXNzaW9uX2lkGAIgASgJUglzZXNzaW9uSWQSOAoLaW5zdHJ1Y3Rpb24YAyABKAsyFi5wYi5QYXltZW50SW5zdHJ1Y3Rpb25SC2luc3RydWN0aW9u');
...
const ScanSessionHistory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.pb.ScanStatus', '10': 'status'},
    const {'1': 'created_at', '3': 4, '4': 1, '5': 3, '10': 'createdAt'},
    const {'1': 'extracted_data', '3': 5, '4': 1, '5': 11, '6': '.pb.ExtractedData', '10': 'extractedData'},
...
final $typed_data.Uint8List scanSessionHistoryDescriptor = $convert.base64Decode('');
...
const GetScanHistoryResponse$json = const {
  ...
  '2': const [
    const {'1': 'sessions', '3': 1, '4': 3, '5': 11, '6': '.pb.ScanSessionHistory', '10': 'sessions'},
...
final $typed_data.Uint8List getScanHistoryResponseDescriptor = $convert.base64Decode('ChZHZXRTY2FuSGlzdG9yeVJlc3BvbnNlEjIKCHNlc3Npb25zGAEgAygLMhYucGIuU2NhblNlc3Npb25IaXN0b3J5UghzZXNzaW9ucxIfCgt0b3RhbF9jb3VudBgCIAEoBVIKdG90YWxDb3VudBISCgRwYWdlGAMgASgFUgRwYWdlEhsKCXBhZ2Vfc2l6ZRgEIAEoBVIIcGFnZVNpemU=');

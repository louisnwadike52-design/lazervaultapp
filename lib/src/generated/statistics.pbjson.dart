...
const BudgetEnforcementMode$json = const {
  '1': 'BudgetEnforcementMode',
  '2': const [
    const {'1': 'BUDGET_ENFORCEMENT_MODE_UNSPECIFIED', '2': 0},
    const {'1': 'BUDGET_ENFORCEMENT_MODE_FLEXIBLE', '2': 1},
    const {'1': 'BUDGET_ENFORCEMENT_MODE_STRICT', '2': 2},
  ],
};

/// Descriptor for `BudgetEnforcementMode`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List budgetEnforcementModeDescriptor = $convert.base64Decode('ChVCdWRnZXRFbmZvcmNlbWVudE1vZGUSJwojQlVER0VUX0VORk9SQ0VNRU5UX01PREVfVU5TUEVDSUZJRUQQABIkCiBCVURHRVRfRU5GT1JDRU1FTlRfTU9ERV9GTEVYSUJMRRABEiIKHkJVREdFVF9FTkZPUkNFTUVOVF9NT0RFX1NUUklDVBAC');
...
final $typed_data.Uint8List expenseMessageDescriptor = $convert.base64Decode('');
...
const BudgetMessage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enforcement_mode', '3': 16, '4': 1, '5': 14, '6': '.pb.BudgetEnforcementMode', '10': 'enforcementMode'},
    const {'1': 'created_at', '3': 17, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createdAt'},
    const {'1': 'updated_at', '3': 18, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'updatedAt'},
  ],
};
...
final $typed_data.Uint8List budgetMessageDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List budgetAlertMessageDescriptor = $convert.base64Decode('');
...
const CreateBudgetRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enforcement_mode', '3': 10, '4': 1, '5': 14, '6': '.pb.BudgetEnforcementMode', '10': 'enforcementMode'},
  ],
};

/// Descriptor for `CreateBudgetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createBudgetRequestDescriptor = $convert.base64Decode('');
...
const UpdateBudgetRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enforcement_mode', '3': 9, '4': 1, '5': 14, '6': '.pb.BudgetEnforcementMode', '10': 'enforcementMode'},
  ],
};

/// Descriptor for `UpdateBudgetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateBudgetRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List incomeSourceDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List investmentDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List financialGoalDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List savingsGoalDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List recurringBillDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List trackedIncomeTransactionDescriptor = $convert.base64Decode('');
...
const TrackedExpenditureTransaction$json = const {
  ...
  '2': const [
    ...
    const {'1': 'category', '3': 8, '4': 1, '5': 9, '10': 'category'},
    const {'1': 'recipient_id', '3': 9, '4': 1, '5': 9, '10': 'recipientId'},
...
final $typed_data.Uint8List trackedExpenditureTransactionDescriptor = $convert.base64Decode('');
...
const ValidateCategoryBudgetRequest$json = const {
  '1': 'ValidateCategoryBudgetRequest',
  '2': const [
    const {'1': 'user_id', '3': 1, '4': 1, '5': 9, '10': 'userId'},
    const {'1': 'budget_category', '3': 2, '4': 1, '5': 5, '10': 'budgetCategory'},
...
final $typed_data.Uint8List validateCategoryBudgetRequestDescriptor = $convert.base64Decode('Ch1WYWxpZGF0ZUNhdGVnb3J5QnVkZ2V0UmVxdWVzdBIXCgd1c2VyX2lkGAEgASgJUgZ1c2VySWQSJwoPYnVkZ2V0X2NhdGVnb3J5GAIgASgFUg5idWRnZXRDYXRlZ29yeRIhCgxhbW91bnRfbWlub3IYAyABKANSC2Ftb3VudE1pbm9yEhoKCGN1cnJlbmN5GAQgASgJUghjdXJyZW5jeQ==');
@$core.Deprecated('Use validateCategoryBudgetResponseDescriptor instead')
const ValidateCategoryBudgetResponse$json = const {
  '1': 'ValidateCategoryBudgetResponse',
  '2': const [
    const {'1': 'allowed', '3': 1, '4': 1, '5': 8, '10': 'allowed'},
    const {'1': 'reason', '3': 2, '4': 1, '5': 9, '10': 'reason'},
    const {'1': 'current_spent', '3': 3, '4': 1, '5': 1, '10': 'currentSpent'},
    const {'1': 'budget_limit', '3': 4, '4': 1, '5': 1, '10': 'budgetLimit'},
    const {'1': 'percentage_used', '3': 5, '4': 1, '5': 1, '10': 'percentageUsed'},
    const {'1': 'remaining', '3': 6, '4': 1, '5': 1, '10': 'remaining'},
    const {'1': 'matching_budgets', '3': 7, '4': 3, '5': 11, '6': '.pb.BudgetInfo', '10': 'matchingBudgets'},
  ],
};

/// Descriptor for `ValidateCategoryBudgetResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List validateCategoryBudgetResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use budgetInfoDescriptor instead')
const BudgetInfo$json = const {
  '1': 'BudgetInfo',
  '2': const [
    const {'1': 'budget_id', '3': 1, '4': 1, '5': 9, '10': 'budgetId'},
    const {'1': 'budget_name', '3': 2, '4': 1, '5': 9, '10': 'budgetName'},
    const {'1': 'amount', '3': 3, '4': 1, '5': 1, '10': 'amount'},
    const {'1': 'spent', '3': 4, '4': 1, '5': 1, '10': 'spent'},
    const {'1': 'percentage', '3': 5, '4': 1, '5': 1, '10': 'percentage'},
    const {'1': 'days_remaining', '3': 6, '4': 1, '5': 5, '10': 'daysRemaining'},
    const {'1': 'start_date', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'startDate'},
    const {'1': 'end_date', '3': 8, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'endDate'},
    const {'1': 'currency', '3': 9, '4': 1, '5': 9, '10': 'currency'},
  ],
};

/// Descriptor for `BudgetInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List budgetInfoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use getServiceCategoriesRequestDescriptor instead')
const GetServiceCategoriesRequest$json = const {
...
final $typed_data.Uint8List getServiceCategoriesRequestDescriptor = $convert.base64Decode('ChtHZXRTZXJ2aWNlQ2F0ZWdvcmllc1JlcXVlc3QSIQoMc2VydmljZV9uYW1lGAEgASgJUgtzZXJ2aWNlTmFtZRIfCgthY3RpdmVfb25seRgCIAEoCFIKYWN0aXZlT25seQ==');
@$core.Deprecated('Use getServiceCategoriesResponseDescriptor instead')
const GetServiceCategoriesResponse$json = const {
  '1': 'GetServiceCategoriesResponse',
  '2': const [
    const {'1': 'categories', '3': 1, '4': 3, '5': 11, '6': '.pb.ServiceCategoryItem', '10': 'categories'},
    const {'1': 'success', '3': 2, '4': 1, '5': 8, '10': 'success'},
  ],
};

/// Descriptor for `GetServiceCategoriesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getServiceCategoriesResponseDescriptor = $convert.base64Decode('ChxHZXRTZXJ2aWNlQ2F0ZWdvcmllc1Jlc3BvbnNlEjcKCmNhdGVnb3JpZXMYASADKAsyFy5wYi5TZXJ2aWNlQ2F0ZWdvcnlJdGVtUgpjYXRlZ29yaWVzEhgKB3N1Y2Nlc3MYAiABKAhSB3N1Y2Nlc3M=');
@$core.Deprecated('Use serviceCategoryItemDescriptor instead')
const ServiceCategoryItem$json = const {
  '1': 'ServiceCategoryItem',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'service_name', '3': 2, '4': 1, '5': 9, '10': 'serviceName'},
    const {'1': 'sub_category_name', '3': 3, '4': 1, '5': 9, '10': 'subCategoryName'},
    const {'1': 'budget_category', '3': 4, '4': 1, '5': 5, '10': 'budgetCategory'},
    const {'1': 'display_name', '3': 5, '4': 1, '5': 9, '10': 'displayName'},
    const {'1': 'icon', '3': 6, '4': 1, '5': 9, '10': 'icon'},
    const {'1': 'color', '3': 7, '4': 1, '5': 9, '10': 'color'},
    const {'1': 'is_active', '3': 8, '4': 1, '5': 8, '10': 'isActive'},
    const {'1': 'is_custom', '3': 9, '4': 1, '5': 8, '10': 'isCustom'},
  ],
};

/// Descriptor for `ServiceCategoryItem`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List serviceCategoryItemDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use createCustomCategoryRequestDescriptor instead')
const CreateCustomCategoryRequest$json = const {
  '1': 'CreateCustomCategoryRequest',
  '2': const [
    const {'1': 'service_name', '3': 1, '4': 1, '5': 9, '10': 'serviceName'},
    const {'1': 'display_name', '3': 2, '4': 1, '5': 9, '10': 'displayName'},
    const {'1': 'budget_category', '3': 3, '4': 1, '5': 5, '10': 'budgetCategory'},
...
final $typed_data.Uint8List createCustomCategoryRequestDescriptor = $convert.base64Decode('ChtDcmVhdGVDdXN0b21DYXRlZ29yeVJlcXVlc3QSIQoMc2VydmljZV9uYW1lGAEgASgJUgtzZXJ2aWNlTmFtZRIhCgxkaXNwbGF5X25hbWUYAiABKAlSC2Rpc3BsYXlOYW1lEicKD2J1ZGdldF9jYXRlZ29yeRgDIAEoBVIOYnVkZ2V0Q2F0ZWdvcnkSEgoEaWNvbhgEIAEoCVIEaWNvbhIUCgVjb2xvchgFIAEoCVIFY29sb3I=');
@$core.Deprecated('Use createCustomCategoryResponseDescriptor instead')
const CreateCustomCategoryResponse$json = const {
  '1': 'CreateCustomCategoryResponse',
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'category', '3': 3, '4': 1, '5': 11, '6': '.pb.ServiceCategoryItem', '10': 'category'},
  ],
};

/// Descriptor for `CreateCustomCategoryResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createCustomCategoryResponseDescriptor = $convert.base64Decode('ChxDcmVhdGVDdXN0b21DYXRlZ29yeVJlc3BvbnNlEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3MSGAoHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZRIzCghjYXRlZ29yeRgDIAEoCzIXLnBiLlNlcnZpY2VDYXRlZ29yeUl0ZW1SCGNhdGVnb3J5');
@$core.Deprecated('Use deleteCustomCategoryRequestDescriptor instead')
const DeleteCustomCategoryRequest$json = const {
...
final $typed_data.Uint8List deleteCustomCategoryRequestDescriptor = $convert.base64Decode('ChtEZWxldGVDdXN0b21DYXRlZ29yeVJlcXVlc3QSHwoLY2F0ZWdvcnlfaWQYASABKAlSCmNhdGVnb3J5SWQ=');
@$core.Deprecated('Use deleteCustomCategoryResponseDescriptor instead')
const DeleteCustomCategoryResponse$json = const {
...
final $typed_data.Uint8List deleteCustomCategoryResponseDescriptor = $convert.base64Decode('ChxEZWxldGVDdXN0b21DYXRlZ29yeVJlc3BvbnNlEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3MSGAoHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZQ==');

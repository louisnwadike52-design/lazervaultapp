...
final $typed_data.Uint8List invoiceDescriptor = $convert.base64Decode(
    ...
    'dExvZ29VcmwSLAoSY3JlYXRvcl9maXJzdF9uYW1lGBwgASgJUhBjcmVhdG9yRmlyc3ROYW1lEi'
    'oKEWNyZWF0b3JfbGFzdF9uYW1lGB0gASgJUg9jcmVhdG9yTGFzdE5hbWUSKQoQY3JlYXRvcl91'
...
const InvoiceParty$json = {
  ...
  '2': [
    ...
    {'1': 'address_line1', '3': 5, '4': 1, '5': 9, '10': 'addressLine1'},
    {'1': 'address_line2', '3': 6, '4': 1, '5': 9, '10': 'addressLine2'},
    {'1': 'city', '3': 7, '4': 1, '5': 9, '10': 'city'},
    {'1': 'state', '3': 8, '4': 1, '5': 9, '10': 'state'},
    {'1': 'postcode', '3': 9, '4': 1, '5': 9, '10': 'postcode'},
    {'1': 'country', '3': 10, '4': 1, '5': 9, '10': 'country'},
    {'1': 'logo_url', '3': 11, '4': 1, '5': 9, '10': 'logoUrl'},
  ],
};

/// Descriptor for `InvoiceParty`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List invoicePartyDescriptor = $convert.base64Decode(
    'CgxJbnZvaWNlUGFydHkSIwoNYnVzaW5lc3NfbmFtZRgBIAEoCVIMYnVzaW5lc3NOYW1lEiEKDG'
    'NvbnRhY3RfbmFtZRgCIAEoCVILY29udGFjdE5hbWUSFAoFZW1haWwYAyABKAlSBWVtYWlsEhQK'
    'BXBob25lGAQgASgJUgVwaG9uZRIjCg1hZGRyZXNzX2xpbmUxGAUgASgJUgxhZGRyZXNzTGluZT'
    'ESIwoNYWRkcmVzc19saW5lMhgGIAEoCVIMYWRkcmVzc0xpbmUyEhIKBGNpdHkYByABKAlSBGNp'
    'dHkSFAoFc3RhdGUYCCABKAlSBXN0YXRlEhoKCHBvc3Rjb2RlGAkgASgJUghwb3N0Y29kZRIYCg'
    'djb3VudHJ5GAogASgJUgdjb3VudHJ5EhkKCGxvZ29fdXJsGAsgASgJUgdsb2dvVXJs');
...
@$core.Deprecated('Use getInvoiceServiceFeeRequestDescriptor instead')
const GetInvoiceServiceFeeRequest$json = {
  '1': 'GetInvoiceServiceFeeRequest',
  '2': [
    {'1': 'account_id', '3': 1, '4': 1, '5': 9, '10': 'accountId'},
  ],
};

/// Descriptor for `GetInvoiceServiceFeeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getInvoiceServiceFeeRequestDescriptor =
    $convert.base64Decode(
        'ChtHZXRJbnZvaWNlU2VydmljZUZlZVJlcXVlc3QSHQoKYWNjb3VudF9pZBgBIAEoCVIJYWNjb3'
        'VudElk');

@$core.Deprecated('Use getInvoiceServiceFeeResponseDescriptor instead')
const GetInvoiceServiceFeeResponse$json = {
  '1': 'GetInvoiceServiceFeeResponse',
  '2': [
    {'1': 'fee_amount', '3': 1, '4': 1, '5': 1, '10': 'feeAmount'},
    {'1': 'currency', '3': 2, '4': 1, '5': 9, '10': 'currency'},
    {'1': 'enabled', '3': 3, '4': 1, '5': 8, '10': 'enabled'},
  ],
};

/// Descriptor for `GetInvoiceServiceFeeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getInvoiceServiceFeeResponseDescriptor =
    $convert.base64Decode(

...
const Invoice$json = const {
  ...
  '2': const [
    ...
    const {'1': 'payer_email', '3': 25, '4': 1, '5': 9, '10': 'payerEmail'},
    const {'1': 'payer_logo_url', '3': 26, '4': 1, '5': 9, '10': 'payerLogoUrl'},
    const {'1': 'recipient_logo_url', '3': 27, '4': 1, '5': 9, '10': 'recipientLogoUrl'},
    const {'1': 'creator_first_name', '3': 28, '4': 1, '5': 9, '10': 'creatorFirstName'},
    const {'1': 'creator_last_name', '3': 29, '4': 1, '5': 9, '10': 'creatorLastName'},
    const {'1': 'creator_username', '3': 30, '4': 1, '5': 9, '10': 'creatorUsername'},
  ],
};

/// Descriptor for `Invoice`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List invoiceDescriptor = $convert.base64Decode('');
...
const CreateInvoiceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'payer_email', '3': 13, '4': 1, '5': 9, '10': 'payerEmail'},
    const {'1': 'currency', '3': 14, '4': 1, '5': 9, '10': 'currency'},
    const {'1': 'payer_logo_url', '3': 15, '4': 1, '5': 9, '10': 'payerLogoUrl'},
    const {'1': 'recipient_logo_url', '3': 16, '4': 1, '5': 9, '10': 'recipientLogoUrl'},
    const {'1': 'service_fee_ref', '3': 17, '4': 1, '5': 9, '10': 'serviceFeeRef'},
  ],
};

/// Descriptor for `CreateInvoiceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createInvoiceRequestDescriptor = $convert.base64Decode('');
...
const PaginationInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'has_previous', '3': 6, '4': 1, '5': 8, '10': 'hasPrevious'},
  ],
};

/// Descriptor for `PaginationInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List paginationInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getInvoicesRequestDescriptor = $convert.base64Decode('');
...
const GetInvoicesResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pagination', '3': 5, '4': 1, '5': 11, '6': '.invoice.PaginationInfo', '10': 'pagination'},
  ],
};

/// Descriptor for `GetInvoicesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getInvoicesResponseDescriptor = $convert.base64Decode('');
...
const SendInvoiceToEmailRequest$json = const {
...
final $typed_data.Uint8List sendInvoiceToEmailRequestDescriptor = $convert.base64Decode('ChlTZW5kSW52b2ljZVRvRW1haWxSZXF1ZXN0Eh0KCmludm9pY2VfaWQYASABKAlSCWludm9pY2VJZBIUCgVlbWFpbBgCIAEoCVIFZW1haWwSFgoGbG9jYWxlGAMgASgJUgZsb2NhbGU=');
@$core.Deprecated('Use sendInvoiceToEmailResponseDescriptor instead')
const SendInvoiceToEmailResponse$json = const {
...
final $typed_data.Uint8List sendInvoiceToEmailResponseDescriptor = $convert.base64Decode('ChpTZW5kSW52b2ljZVRvRW1haWxSZXNwb25zZRISCgRzZW50GAEgASgIUgRzZW50EhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2U=');
...
final $typed_data.Uint8List getInvoicesTaggedToUserRequestDescriptor = $convert.base64Decode('Ch5HZXRJbnZvaWNlc1RhZ2dlZFRvVXNlclJlcXVlc3QSFgoGc3RhdHVzGAEgASgJUgZzdGF0dXMSFAoFbGltaXQYAiABKAVSBWxpbWl0EhYKBm9mZnNldBgDIAEoBVIGb2Zmc2V0EhoKCGN1cnJlbmN5GAQgASgJUghjdXJyZW5jeRISCgRwYWdlGAUgASgFUgRwYWdlEhsKCXBhZ2Vfc2l6ZRgGIAEoBVIIcGFnZVNpemU=');
...
final $typed_data.Uint8List getInvoicesTaggedToUserResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getSentInvoicesRequestDescriptor = $convert.base64Decode('ChZHZXRTZW50SW52b2ljZXNSZXF1ZXN0EhYKBnN0YXR1cxgBIAEoCVIGc3RhdHVzEhQKBWxpbWl0GAIgASgFUgVsaW1pdBIWCgZvZmZzZXQYAyABKAVSBm9mZnNldBISCgRwYWdlGAQgASgFUgRwYWdlEhsKCXBhZ2Vfc2l6ZRgFIAEoBVIIcGFnZVNpemU=');
...
final $typed_data.Uint8List getSentInvoicesResponseDescriptor = $convert.base64Decode('');
...
const UploadInvoiceImageRequest$json = const {
...
final $typed_data.Uint8List uploadInvoiceImageRequestDescriptor = $convert.base64Decode('ChlVcGxvYWRJbnZvaWNlSW1hZ2VSZXF1ZXN0Eh0KCmltYWdlX2RhdGEYASABKAxSCWltYWdlRGF0YRIbCglmaWxlX25hbWUYAiABKAlSCGZpbGVOYW1lEiEKDGNvbnRlbnRfdHlwZRgDIAEoCVILY29udGVudFR5cGU=');
@$core.Deprecated('Use uploadInvoiceImageResponseDescriptor instead')
const UploadInvoiceImageResponse$json = const {
...
final $typed_data.Uint8List uploadInvoiceImageResponseDescriptor = $convert.base64Decode('ChpVcGxvYWRJbnZvaWNlSW1hZ2VSZXNwb25zZRIbCglpbWFnZV91cmwYASABKAlSCGltYWdlVXJs');
@$core.Deprecated('Use payInvoiceServiceFeeRequestDescriptor instead')
const PayInvoiceServiceFeeRequest$json = const {
...
final $typed_data.Uint8List payInvoiceServiceFeeRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use payInvoiceServiceFeeResponseDescriptor instead')
const PayInvoiceServiceFeeResponse$json = const {
  '1': 'PayInvoiceServiceFeeResponse',
  '2': const [
    const {'1': 'service_fee_ref', '3': 1, '4': 1, '5': 9, '10': 'serviceFeeRef'},
    const {'1': 'new_balance', '3': 2, '4': 1, '5': 1, '10': 'newBalance'},
    const {'1': 'fee_amount', '3': 3, '4': 1, '5': 1, '10': 'feeAmount'},
    const {'1': 'message', '3': 4, '4': 1, '5': 9, '10': 'message'},
  ],
};

/// Descriptor for `PayInvoiceServiceFeeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List payInvoiceServiceFeeResponseDescriptor = $convert.base64Decode('ChxQYXlJbnZvaWNlU2VydmljZUZlZVJlc3BvbnNlEiYKD3NlcnZpY2VfZmVlX3JlZhgBIAEoCVINc2VydmljZUZlZVJlZhIfCgtuZXdfYmFsYW5jZRgCIAEoAVIKbmV3QmFsYW5jZRIdCgpmZWVfYW1vdW50GAMgASgBUglmZWVBbW91bnQSGAoHbWVzc2FnZRgEIAEoCVIHbWVzc2FnZQ==');

...
class FinancialProductsServiceClient extends $grpc.Client {
  ...
  static final _$getMyCoverCustomers = $grpc.ClientMethod<$0.GetMyCoverCustomersRequest, $0.GetMyCoverCustomersResponse>(
      '/financialproducts.FinancialProductsService/GetMyCoverCustomers',
      ($0.GetMyCoverCustomersRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetMyCoverCustomersResponse.fromBuffer(value));
  static final _$getMyCoverCustomerById = $grpc.ClientMethod<$0.GetMyCoverCustomerByIdRequest, $0.GetMyCoverCustomerByIdResponse>(
      ...
      ($core.List<$core.int> value) => $0.GetMyCoverCustomerByIdResponse.fromBuffer(value));
  static final _$getMyCoverCustomerPolicies = $grpc.ClientMethod<$0.GetMyCoverCustomerPoliciesRequest, $0.GetMyCoverCustomerPoliciesResponse>(
      ...
      ($core.List<$core.int> value) => $0.GetMyCoverCustomerPoliciesResponse.fromBuffer(value));
  static final _$getMyCoverCustomerPurchases = $grpc.ClientMethod<$0.GetMyCoverCustomerPurchasesRequest, $0.GetMyCoverCustomerPurchasesResponse>(
      ...
      ($core.List<$core.int> value) => $0.GetMyCoverCustomerPurchasesResponse.fromBuffer(value));
  static final _$getMyCoverPurchases = $grpc.ClientMethod<$0.GetMyCoverPurchasesRequest, $0.GetMyCoverPurchasesResponse>(
      '/financialproducts.FinancialProductsService/GetMyCoverPurchases',
      ($0.GetMyCoverPurchasesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetMyCoverPurchasesResponse.fromBuffer(value));
  static final _$getMyCoverPurchaseById = $grpc.ClientMethod<$0.GetMyCoverPurchaseByIdRequest, $0.GetMyCoverPurchaseByIdResponse>(
      ...
      ($core.List<$core.int> value) => $0.GetMyCoverPurchaseByIdResponse.fromBuffer(value));
  static final _$getMyCoverClaims = $grpc.ClientMethod<$0.GetMyCoverClaimsRequest, $0.GetMyCoverClaimsResponse>(
      '/financialproducts.FinancialProductsService/GetMyCoverClaims',
      ($0.GetMyCoverClaimsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetMyCoverClaimsResponse.fromBuffer(value));
  static final _$getMyCoverClaimById = $grpc.ClientMethod<$0.GetMyCoverClaimByIdRequest, $0.GetMyCoverClaimByIdResponse>(
      '/financialproducts.FinancialProductsService/GetMyCoverClaimById',
      ($0.GetMyCoverClaimByIdRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetMyCoverClaimByIdResponse.fromBuffer(value));
  static final _$fileCreditLifeClaim = $grpc.ClientMethod<$0.FileCreditLifeClaimRequest, $0.FileCreditLifeClaimResponse>(
      '/financialproducts.FinancialProductsService/FileCreditLifeClaim',
      ($0.FileCreditLifeClaimRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.FileCreditLifeClaimResponse.fromBuffer(value));
  static final _$getInsuranceStates = $grpc.ClientMethod<$0.GetInsuranceStatesRequest, $0.GetInsuranceStatesResponse>(
      '/financialproducts.FinancialProductsService/GetInsuranceStates',
      ($0.GetInsuranceStatesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetInsuranceStatesResponse.fromBuffer(value));
  static final _$getInsuranceVehicleMakes = $grpc.ClientMethod<$0.GetInsuranceVehicleMakesRequest, $0.GetInsuranceVehicleMakesResponse>(
      ...
      ($core.List<$core.int> value) => $0.GetInsuranceVehicleMakesResponse.fromBuffer(value));
  static final _$getMyCoverNotificationPreferences = $grpc.ClientMethod<$0.GetMyCoverNotificationPreferencesRequest, $0.GetMyCoverNotificationPreferencesResponse>(
      '/financialproducts.FinancialProductsService/GetMyCoverNotificationPreferences',
      ($0.GetMyCoverNotificationPreferencesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.GetMyCoverNotificationPreferencesResponse.fromBuffer(value));
  static final _$updateMyCoverNotificationPreferences = $grpc.ClientMethod<$0.UpdateMyCoverNotificationPreferencesRequest, $0.UpdateMyCoverNotificationPreferencesResponse>(
      '/financialproducts.FinancialProductsService/UpdateMyCoverNotificationPreferences',
      ($0.UpdateMyCoverNotificationPreferencesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.UpdateMyCoverNotificationPreferencesResponse.fromBuffer(value));
  static final _$getMyCoverWalletBalance = $grpc.ClientMethod<$0.GetMyCoverWalletBalanceRequest, $0.GetMyCoverWalletBalanceResponse>(
      ...
      ($core.List<$core.int> value) => $0.GetMyCoverWalletBalanceResponse.fromBuffer(value));
  static final _$requestInsuranceRefund = $grpc.ClientMethod<$0.RequestInsuranceRefundRequest, $0.RequestInsuranceRefundResponse>(
      ...
      ($core.List<$core.int> value) => $0.RequestInsuranceRefundResponse.fromBuffer(value));
  static final _$getInsuranceRefundStatus = $grpc.ClientMethod<$0.GetInsuranceRefundStatusRequest, $0.GetInsuranceRefundStatusResponse>(
      ...
      ($core.List<$core.int> value) => $0.GetInsuranceRefundStatusResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetMyCoverCustomersResponse> getMyCoverCustomers($0.GetMyCoverCustomersRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverCustomers, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverCustomerByIdResponse> getMyCoverCustomerById($0.GetMyCoverCustomerByIdRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverCustomerById, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverCustomerPoliciesResponse> getMyCoverCustomerPolicies($0.GetMyCoverCustomerPoliciesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverCustomerPolicies, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverCustomerPurchasesResponse> getMyCoverCustomerPurchases($0.GetMyCoverCustomerPurchasesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverCustomerPurchases, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverPurchasesResponse> getMyCoverPurchases($0.GetMyCoverPurchasesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverPurchases, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverPurchaseByIdResponse> getMyCoverPurchaseById($0.GetMyCoverPurchaseByIdRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverPurchaseById, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverClaimsResponse> getMyCoverClaims($0.GetMyCoverClaimsRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverClaims, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverClaimByIdResponse> getMyCoverClaimById($0.GetMyCoverClaimByIdRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverClaimById, request, options: options);
  }

  $grpc.ResponseFuture<$0.FileCreditLifeClaimResponse> fileCreditLifeClaim($0.FileCreditLifeClaimRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$fileCreditLifeClaim, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetInsuranceStatesResponse> getInsuranceStates($0.GetInsuranceStatesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getInsuranceStates, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetInsuranceVehicleMakesResponse> getInsuranceVehicleMakes($0.GetInsuranceVehicleMakesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getInsuranceVehicleMakes, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverNotificationPreferencesResponse> getMyCoverNotificationPreferences($0.GetMyCoverNotificationPreferencesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverNotificationPreferences, request, options: options);
  }

  $grpc.ResponseFuture<$0.UpdateMyCoverNotificationPreferencesResponse> updateMyCoverNotificationPreferences($0.UpdateMyCoverNotificationPreferencesRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateMyCoverNotificationPreferences, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetMyCoverWalletBalanceResponse> getMyCoverWalletBalance($0.GetMyCoverWalletBalanceRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getMyCoverWalletBalance, request, options: options);
  }

  $grpc.ResponseFuture<$0.RequestInsuranceRefundResponse> requestInsuranceRefund($0.RequestInsuranceRefundRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$requestInsuranceRefund, request, options: options);
  }

  $grpc.ResponseFuture<$0.GetInsuranceRefundStatusResponse> getInsuranceRefundStatus($0.GetInsuranceRefundStatusRequest request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getInsuranceRefundStatus, request, options: options);
  }
...
abstract class FinancialProductsServiceBase extends $grpc.Service {
  ...
  FinancialProductsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverCustomersRequest, $0.GetMyCoverCustomersResponse>(
        'GetMyCoverCustomers',
        getMyCoverCustomers_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverCustomersRequest.fromBuffer(value),
        ($0.GetMyCoverCustomersResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverCustomerByIdRequest, $0.GetMyCoverCustomerByIdResponse>(
        'GetMyCoverCustomerById',
        getMyCoverCustomerById_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverCustomerByIdRequest.fromBuffer(value),
        ($0.GetMyCoverCustomerByIdResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverCustomerPoliciesRequest, $0.GetMyCoverCustomerPoliciesResponse>(
        'GetMyCoverCustomerPolicies',
        getMyCoverCustomerPolicies_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverCustomerPoliciesRequest.fromBuffer(value),
        ($0.GetMyCoverCustomerPoliciesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverCustomerPurchasesRequest, $0.GetMyCoverCustomerPurchasesResponse>(
        'GetMyCoverCustomerPurchases',
        getMyCoverCustomerPurchases_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverCustomerPurchasesRequest.fromBuffer(value),
        ($0.GetMyCoverCustomerPurchasesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverPurchasesRequest, $0.GetMyCoverPurchasesResponse>(
        'GetMyCoverPurchases',
        getMyCoverPurchases_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverPurchasesRequest.fromBuffer(value),
        ($0.GetMyCoverPurchasesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverPurchaseByIdRequest, $0.GetMyCoverPurchaseByIdResponse>(
        'GetMyCoverPurchaseById',
        getMyCoverPurchaseById_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverPurchaseByIdRequest.fromBuffer(value),
        ($0.GetMyCoverPurchaseByIdResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverClaimsRequest, $0.GetMyCoverClaimsResponse>(
        'GetMyCoverClaims',
        getMyCoverClaims_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverClaimsRequest.fromBuffer(value),
        ($0.GetMyCoverClaimsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverClaimByIdRequest, $0.GetMyCoverClaimByIdResponse>(
        'GetMyCoverClaimById',
        getMyCoverClaimById_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverClaimByIdRequest.fromBuffer(value),
        ($0.GetMyCoverClaimByIdResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.FileCreditLifeClaimRequest, $0.FileCreditLifeClaimResponse>(
        'FileCreditLifeClaim',
        fileCreditLifeClaim_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.FileCreditLifeClaimRequest.fromBuffer(value),
        ($0.FileCreditLifeClaimResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetInsuranceStatesRequest, $0.GetInsuranceStatesResponse>(
        'GetInsuranceStates',
        getInsuranceStates_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetInsuranceStatesRequest.fromBuffer(value),
        ($0.GetInsuranceStatesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetInsuranceVehicleMakesRequest, $0.GetInsuranceVehicleMakesResponse>(
        'GetInsuranceVehicleMakes',
        getInsuranceVehicleMakes_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetInsuranceVehicleMakesRequest.fromBuffer(value),
        ($0.GetInsuranceVehicleMakesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverNotificationPreferencesRequest, $0.GetMyCoverNotificationPreferencesResponse>(
        'GetMyCoverNotificationPreferences',
        getMyCoverNotificationPreferences_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverNotificationPreferencesRequest.fromBuffer(value),
        ($0.GetMyCoverNotificationPreferencesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpdateMyCoverNotificationPreferencesRequest, $0.UpdateMyCoverNotificationPreferencesResponse>(
        'UpdateMyCoverNotificationPreferences',
        updateMyCoverNotificationPreferences_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.UpdateMyCoverNotificationPreferencesRequest.fromBuffer(value),
        ($0.UpdateMyCoverNotificationPreferencesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetMyCoverWalletBalanceRequest, $0.GetMyCoverWalletBalanceResponse>(
        'GetMyCoverWalletBalance',
        getMyCoverWalletBalance_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetMyCoverWalletBalanceRequest.fromBuffer(value),
        ($0.GetMyCoverWalletBalanceResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.RequestInsuranceRefundRequest, $0.RequestInsuranceRefundResponse>(
        'RequestInsuranceRefund',
        requestInsuranceRefund_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.RequestInsuranceRefundRequest.fromBuffer(value),
        ($0.RequestInsuranceRefundResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetInsuranceRefundStatusRequest, $0.GetInsuranceRefundStatusResponse>(
        'GetInsuranceRefundStatus',
        getInsuranceRefundStatus_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $0.GetInsuranceRefundStatusRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetMyCoverCustomersResponse> getMyCoverCustomers_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverCustomersRequest> request) async {
    return getMyCoverCustomers(call, await request);
  }

  $async.Future<$0.GetMyCoverCustomerByIdResponse> getMyCoverCustomerById_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverCustomerByIdRequest> request) async {
    return getMyCoverCustomerById(call, await request);
  }

  $async.Future<$0.GetMyCoverCustomerPoliciesResponse> getMyCoverCustomerPolicies_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverCustomerPoliciesRequest> request) async {
    return getMyCoverCustomerPolicies(call, await request);
  }

  $async.Future<$0.GetMyCoverCustomerPurchasesResponse> getMyCoverCustomerPurchases_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverCustomerPurchasesRequest> request) async {
    return getMyCoverCustomerPurchases(call, await request);
  }

  $async.Future<$0.GetMyCoverPurchasesResponse> getMyCoverPurchases_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverPurchasesRequest> request) async {
    return getMyCoverPurchases(call, await request);
  }

  $async.Future<$0.GetMyCoverPurchaseByIdResponse> getMyCoverPurchaseById_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverPurchaseByIdRequest> request) async {
    return getMyCoverPurchaseById(call, await request);
  }

  $async.Future<$0.GetMyCoverClaimsResponse> getMyCoverClaims_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverClaimsRequest> request) async {
    return getMyCoverClaims(call, await request);
  }

  $async.Future<$0.GetMyCoverClaimByIdResponse> getMyCoverClaimById_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverClaimByIdRequest> request) async {
    return getMyCoverClaimById(call, await request);
  }

  $async.Future<$0.FileCreditLifeClaimResponse> fileCreditLifeClaim_Pre($grpc.ServiceCall call, $async.Future<$0.FileCreditLifeClaimRequest> request) async {
    return fileCreditLifeClaim(call, await request);
  }

  $async.Future<$0.GetInsuranceStatesResponse> getInsuranceStates_Pre($grpc.ServiceCall call, $async.Future<$0.GetInsuranceStatesRequest> request) async {
    return getInsuranceStates(call, await request);
  }

  $async.Future<$0.GetInsuranceVehicleMakesResponse> getInsuranceVehicleMakes_Pre($grpc.ServiceCall call, $async.Future<$0.GetInsuranceVehicleMakesRequest> request) async {
    return getInsuranceVehicleMakes(call, await request);
  }

  $async.Future<$0.GetMyCoverNotificationPreferencesResponse> getMyCoverNotificationPreferences_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverNotificationPreferencesRequest> request) async {
    return getMyCoverNotificationPreferences(call, await request);
  }

  $async.Future<$0.UpdateMyCoverNotificationPreferencesResponse> updateMyCoverNotificationPreferences_Pre($grpc.ServiceCall call, $async.Future<$0.UpdateMyCoverNotificationPreferencesRequest> request) async {
    return updateMyCoverNotificationPreferences(call, await request);
  }

  $async.Future<$0.GetMyCoverWalletBalanceResponse> getMyCoverWalletBalance_Pre($grpc.ServiceCall call, $async.Future<$0.GetMyCoverWalletBalanceRequest> request) async {
    return getMyCoverWalletBalance(call, await request);
  }

  $async.Future<$0.RequestInsuranceRefundResponse> requestInsuranceRefund_Pre($grpc.ServiceCall call, $async.Future<$0.RequestInsuranceRefundRequest> request) async {
    return requestInsuranceRefund(call, await request);
  }

  $async.Future<$0.GetInsuranceRefundStatusResponse> getInsuranceRefundStatus_Pre($grpc.ServiceCall call, $async.Future<$0.GetInsuranceRefundStatusRequest> request) async {
  ...
  $async.Future<$0.GetMyCoverCustomersResponse> getMyCoverCustomers($grpc.ServiceCall call, $0.GetMyCoverCustomersRequest request);
  $async.Future<$0.GetMyCoverCustomerByIdResponse> getMyCoverCustomerById($grpc.ServiceCall call, $0.GetMyCoverCustomerByIdRequest request);
  $async.Future<$0.GetMyCoverCustomerPoliciesResponse> getMyCoverCustomerPolicies($grpc.ServiceCall call, $0.GetMyCoverCustomerPoliciesRequest request);
  $async.Future<$0.GetMyCoverCustomerPurchasesResponse> getMyCoverCustomerPurchases($grpc.ServiceCall call, $0.GetMyCoverCustomerPurchasesRequest request);
  $async.Future<$0.GetMyCoverPurchasesResponse> getMyCoverPurchases($grpc.ServiceCall call, $0.GetMyCoverPurchasesRequest request);
  $async.Future<$0.GetMyCoverPurchaseByIdResponse> getMyCoverPurchaseById($grpc.ServiceCall call, $0.GetMyCoverPurchaseByIdRequest request);
  $async.Future<$0.GetMyCoverClaimsResponse> getMyCoverClaims($grpc.ServiceCall call, $0.GetMyCoverClaimsRequest request);
  $async.Future<$0.GetMyCoverClaimByIdResponse> getMyCoverClaimById($grpc.ServiceCall call, $0.GetMyCoverClaimByIdRequest request);
  $async.Future<$0.FileCreditLifeClaimResponse> fileCreditLifeClaim($grpc.ServiceCall call, $0.FileCreditLifeClaimRequest request);
  $async.Future<$0.GetInsuranceStatesResponse> getInsuranceStates($grpc.ServiceCall call, $0.GetInsuranceStatesRequest request);
  $async.Future<$0.GetInsuranceVehicleMakesResponse> getInsuranceVehicleMakes($grpc.ServiceCall call, $0.GetInsuranceVehicleMakesRequest request);
  $async.Future<$0.GetMyCoverNotificationPreferencesResponse> getMyCoverNotificationPreferences($grpc.ServiceCall call, $0.GetMyCoverNotificationPreferencesRequest request);
  $async.Future<$0.UpdateMyCoverNotificationPreferencesResponse> updateMyCoverNotificationPreferences($grpc.ServiceCall call, $0.UpdateMyCoverNotificationPreferencesRequest request);
  $async.Future<$0.GetMyCoverWalletBalanceResponse> getMyCoverWalletBalance($grpc.ServiceCall call, $0.GetMyCoverWalletBalanceRequest request);
  $async.Future<$0.RequestInsuranceRefundResponse> requestInsuranceRefund($grpc.ServiceCall call, $0.RequestInsuranceRefundRequest request);
  $async.Future<$0.GetInsuranceRefundStatusResponse> getInsuranceRefundStatus($grpc.ServiceCall call, $0.GetInsuranceRefundStatusRequest request);

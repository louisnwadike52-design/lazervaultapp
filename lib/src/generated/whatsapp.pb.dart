...
class InitiateLinkingResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InitiateLinkingResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'whatsapp'), createEmptyInstance: create)
    ...
    ..aOM<$49.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expiresAt', subBuilder: $49.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $49.Timestamp get expiresAt => $_getN(2);
  @$pb.TagNumber(3)
  set expiresAt($49.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasExpiresAt() => $_has(2);
  @$pb.TagNumber(3)
  void clearExpiresAt() => clearField(3);
  @$pb.TagNumber(3)
  $49.Timestamp ensureExpiresAt() => $_ensure(2);
}
...
class WhatsAppSession extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WhatsAppSession', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'whatsapp'), createEmptyInstance: create)
    ...
    ..aOM<$49.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastActivityAt', subBuilder: $49.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $49.Timestamp get lastActivityAt => $_getN(4);
  @$pb.TagNumber(5)
  set lastActivityAt($49.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasLastActivityAt() => $_has(4);
  @$pb.TagNumber(5)
  void clearLastActivityAt() => clearField(5);
  @$pb.TagNumber(5)
  $49.Timestamp ensureLastActivityAt() => $_ensure(4);
}
...
class WhatsAppUser extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WhatsAppUser', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'whatsapp'), createEmptyInstance: create)
    ...
    ..aOM<$49.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linkedAt', subBuilder: $49.Timestamp.create)
    ..aOM<$49.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastActiveAt', subBuilder: $49.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory WhatsAppUser({
    ...
    $49.Timestamp? linkedAt,
    $49.Timestamp? lastActiveAt,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
  ...
  @$pb.TagNumber(6)
  $49.Timestamp get linkedAt => $_getN(5);
  @$pb.TagNumber(6)
  set linkedAt($49.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasLinkedAt() => $_has(5);
  @$pb.TagNumber(6)
  void clearLinkedAt() => clearField(6);
  @$pb.TagNumber(6)
  $49.Timestamp ensureLinkedAt() => $_ensure(5);

  @$pb.TagNumber(7)
  $49.Timestamp get lastActiveAt => $_getN(6);
  @$pb.TagNumber(7)
  set lastActiveAt($49.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasLastActiveAt() => $_has(6);
  @$pb.TagNumber(7)
  void clearLastActiveAt() => clearField(7);
  @$pb.TagNumber(7)
  $49.Timestamp ensureLastActiveAt() => $_ensure(6);
}

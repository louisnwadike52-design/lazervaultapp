...
const SupportTicket$json = const {
  ...
  '2': const [
    ...
    const {'1': 'category', '3': 4, '4': 1, '5': 14, '6': '.pb.TicketCategory', '10': 'category'},
    const {'1': 'subject', '3': 5, '4': 1, '5': 9, '10': 'subject'},
    const {'1': 'description', '3': 6, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'status', '3': 7, '4': 1, '5': 14, '6': '.pb.TicketStatus', '10': 'status'},
    const {'1': 'priority', '3': 8, '4': 1, '5': 14, '6': '.pb.TicketPriority', '10': 'priority'},
    ...
    const {'1': 'replies', '3': 12, '4': 3, '5': 11, '6': '.pb.TicketReply', '10': 'replies'},
  ],
};

/// Descriptor for `SupportTicket`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List supportTicketDescriptor = $convert.base64Decode('');
...
const CreateSupportTicketRequest$json = const {
  ...
  '2': const [
    const {'1': 'category', '3': 1, '4': 1, '5': 14, '6': '.pb.TicketCategory', '10': 'category'},
...
final $typed_data.Uint8List createSupportTicketRequestDescriptor = $convert.base64Decode('ChpDcmVhdGVTdXBwb3J0VGlja2V0UmVxdWVzdBIuCghjYXRlZ29yeRgBIAEoDjISLnBiLlRpY2tldENhdGVnb3J5UghjYXRlZ29yeRIYCgdzdWJqZWN0GAIgASgJUgdzdWJqZWN0EiAKC2Rlc2NyaXB0aW9uGAMgASgJUgtkZXNjcmlwdGlvbg==');
...
const CreateSupportTicketResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ticket', '3': 3, '4': 1, '5': 11, '6': '.pb.SupportTicket', '10': 'ticket'},
  ],
};

/// Descriptor for `CreateSupportTicketResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createSupportTicketResponseDescriptor = $convert.base64Decode('ChtDcmVhdGVTdXBwb3J0VGlja2V0UmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdlEikKBnRpY2tldBgDIAEoCzIRLnBiLlN1cHBvcnRUaWNrZXRSBnRpY2tldA==');
...
const GetSupportTicketsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status_filter', '3': 3, '4': 1, '5': 14, '6': '.pb.TicketStatus', '10': 'statusFilter'},
  ],
};

/// Descriptor for `GetSupportTicketsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getSupportTicketsRequestDescriptor = $convert.base64Decode('ChhHZXRTdXBwb3J0VGlja2V0c1JlcXVlc3QSEgoEcGFnZRgBIAEoBVIEcGFnZRIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXplEjUKDXN0YXR1c19maWx0ZXIYAyABKA4yEC5wYi5UaWNrZXRTdGF0dXNSDHN0YXR1c0ZpbHRlcg==');
...
const GetSupportTicketsResponse$json = const {
  ...
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'tickets', '3': 3, '4': 3, '5': 11, '6': '.pb.SupportTicket', '10': 'tickets'},
...
final $typed_data.Uint8List getSupportTicketsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getSupportTicketResponseDescriptor = $convert.base64Decode('ChhHZXRTdXBwb3J0VGlja2V0UmVzcG9uc2USGAoHc3VjY2VzcxgBIAEoCFIHc3VjY2VzcxIYCgdtZXNzYWdlGAIgASgJUgdtZXNzYWdlEikKBnRpY2tldBgDIAEoCzIRLnBiLlN1cHBvcnRUaWNrZXRSBnRpY2tldA==');
...
const UpdateTicketStatusRequest$json = const {
  ...
  '2': const [
    const {'1': 'ticket_id', '3': 1, '4': 1, '5': 9, '10': 'ticketId'},
    const {'1': 'status', '3': 2, '4': 1, '5': 14, '6': '.pb.TicketStatus', '10': 'status'},
...
final $typed_data.Uint8List updateTicketStatusRequestDescriptor = $convert.base64Decode('ChlVcGRhdGVUaWNrZXRTdGF0dXNSZXF1ZXN0EhsKCXRpY2tldF9pZBgBIAEoCVIIdGlja2V0SWQSKAoGc3RhdHVzGAIgASgOMhAucGIuVGlja2V0U3RhdHVzUgZzdGF0dXMSJwoPcmVzb2x1dGlvbl9ub3RlGAMgASgJUg5yZXNvbHV0aW9uTm90ZQ==');
...
final $typed_data.Uint8List updateTicketStatusResponseDescriptor = $convert.base64Decode('ChpVcGRhdGVUaWNrZXRTdGF0dXNSZXNwb25zZRIYCgdzdWNjZXNzGAEgASgIUgdzdWNjZXNzEhgKB21lc3NhZ2UYAiABKAlSB21lc3NhZ2USKQoGdGlja2V0GAMgASgLMhEucGIuU3VwcG9ydFRpY2tldFIGdGlja2V0');
...
const AddTicketReplyResponse$json = const {
  ...
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'reply', '3': 3, '4': 1, '5': 11, '6': '.pb.TicketReply', '10': 'reply'},
  ],
};

/// Descriptor for `AddTicketReplyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List addTicketReplyResponseDescriptor = $convert.base64Decode('ChZBZGRUaWNrZXRSZXBseVJlc3BvbnNlEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3MSGAoHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZRIlCgVyZXBseRgDIAEoCzIPLnBiLlRpY2tldFJlcGx5UgVyZXBseQ==');
...
const SubmitContactFormResponse$json = const {
  ...
  '2': const [
    const {'1': 'success', '3': 1, '4': 1, '5': 8, '10': 'success'},
    const {'1': 'message', '3': 2, '4': 1, '5': 9, '10': 'message'},
    const {'1': 'contact_message', '3': 3, '4': 1, '5': 11, '6': '.pb.ContactMessage', '10': 'contactMessage'},
  ],
};

/// Descriptor for `SubmitContactFormResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List submitContactFormResponseDescriptor = $convert.base64Decode('ChlTdWJtaXRDb250YWN0Rm9ybVJlc3BvbnNlEhgKB3N1Y2Nlc3MYASABKAhSB3N1Y2Nlc3MSGAoHbWVzc2FnZRgCIAEoCVIHbWVzc2FnZRI7Cg9jb250YWN0X21lc3NhZ2UYAyABKAsyEi5wYi5Db250YWN0TWVzc2FnZVIOY29udGFjdE1lc3NhZ2U=');

...
class ExpenseCategory extends $pb.ProtobufEnum {
  static const ExpenseCategory EXPENSE_CATEGORY_OFFICE =
      ExpenseCategory._(0, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_OFFICE');
  static const ExpenseCategory EXPENSE_CATEGORY_TRAVEL =
      ExpenseCategory._(1, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_TRAVEL');
  static const ExpenseCategory EXPENSE_CATEGORY_MEALS =
      ExpenseCategory._(2, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_MEALS');
  static const ExpenseCategory EXPENSE_CATEGORY_MARKETING =
      ExpenseCategory._(3, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_MARKETING');
  static const ExpenseCategory EXPENSE_CATEGORY_UTILITIES =
      ExpenseCategory._(4, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_UTILITIES');
  static const ExpenseCategory EXPENSE_CATEGORY_PAYROLL =
      ExpenseCategory._(5, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_PAYROLL');
  static const ExpenseCategory EXPENSE_CATEGORY_PROFESSIONAL =
      ExpenseCategory._(
          6, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_PROFESSIONAL');
  static const ExpenseCategory EXPENSE_CATEGORY_SOFTWARE =
      ExpenseCategory._(7, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_SOFTWARE');
  static const ExpenseCategory EXPENSE_CATEGORY_INVENTORY =
      ExpenseCategory._(8, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_INVENTORY');
  static const ExpenseCategory EXPENSE_CATEGORY_TAXES =
      ExpenseCategory._(9, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_TAXES');
  static const ExpenseCategory EXPENSE_CATEGORY_OTHER =
      ExpenseCategory._(10, _omitEnumNames ? '' : 'EXPENSE_CATEGORY_OTHER');
...
class ExpenseStatus extends $pb.ProtobufEnum {
  static const ExpenseStatus EXPENSE_STATUS_PENDING =
      ExpenseStatus._(0, _omitEnumNames ? '' : 'EXPENSE_STATUS_PENDING');
  static const ExpenseStatus EXPENSE_STATUS_APPROVED =
      ExpenseStatus._(1, _omitEnumNames ? '' : 'EXPENSE_STATUS_APPROVED');
  static const ExpenseStatus EXPENSE_STATUS_REIMBURSED =
      ExpenseStatus._(2, _omitEnumNames ? '' : 'EXPENSE_STATUS_REIMBURSED');
  static const ExpenseStatus EXPENSE_STATUS_REJECTED =
      ExpenseStatus._(3, _omitEnumNames ? '' : 'EXPENSE_STATUS_REJECTED');
  ...
  static final $core.List<ExpenseStatus?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 3);
  static ExpenseStatus? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ExpenseStatus._(super.value, super.name);
}

class ExpensePaymentMethod extends $pb.ProtobufEnum {
  static const ExpensePaymentMethod EXPENSE_PAYMENT_METHOD_CASH =
      ExpensePaymentMethod._(
          0, _omitEnumNames ? '' : 'EXPENSE_PAYMENT_METHOD_CASH');
  static const ExpensePaymentMethod EXPENSE_PAYMENT_METHOD_CARD =
      ExpensePaymentMethod._(
          1, _omitEnumNames ? '' : 'EXPENSE_PAYMENT_METHOD_CARD');
  static const ExpensePaymentMethod EXPENSE_PAYMENT_METHOD_BANK_TRANSFER =
      ExpensePaymentMethod._(
          2, _omitEnumNames ? '' : 'EXPENSE_PAYMENT_METHOD_BANK_TRANSFER');
  static const ExpensePaymentMethod EXPENSE_PAYMENT_METHOD_CHEQUE =
      ExpensePaymentMethod._(
          3, _omitEnumNames ? '' : 'EXPENSE_PAYMENT_METHOD_CHEQUE');
  static const ExpensePaymentMethod EXPENSE_PAYMENT_METHOD_OTHER =
      ExpensePaymentMethod._(
          4, _omitEnumNames ? '' : 'EXPENSE_PAYMENT_METHOD_OTHER');
  ...
  static final $core.List<ExpensePaymentMethod?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 4);
  static ExpensePaymentMethod? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];

  const ExpensePaymentMethod._(super.value, super.name);
}

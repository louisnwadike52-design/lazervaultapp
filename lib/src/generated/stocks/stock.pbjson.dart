...
const AlertType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ALERT_TYPE_PRICE_ABOVE', '2': 1},
    const {'1': 'ALERT_TYPE_PRICE_BELOW', '2': 2},
    const {'1': 'ALERT_TYPE_PERCENT_CHANGE', '2': 3},
  ],
};

/// Descriptor for `AlertType`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List alertTypeDescriptor = $convert.base64Decode('CglBbGVydFR5cGUSGgoWQUxFUlRfVFlQRV9VTlNQRUNJRklFRBAAEhoKFkFMRVJUX1RZUEVfUFJJQ0VfQUJPVkUQARIaChZBTEVSVF9UWVBFX1BSSUNFX0JFTE9XEAISHQoZQUxFUlRfVFlQRV9QRVJDRU5UX0NIQU5HRRAD');
...
final $typed_data.Uint8List searchStocksRequestDescriptor = $convert.base64Decode('ChNTZWFyY2hTdG9ja3NSZXF1ZXN0EhQKBXF1ZXJ5GAEgASgJUgVxdWVyeRIUCgVsaW1pdBgCIAEoBVIFbGltaXQSFgoGbWFya2V0GAMgASgJUgZtYXJrZXQ=');
...
const GetMarketStatusResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'trading_session', '3': 2, '4': 1, '5': 9, '10': 'tradingSession'},
    const {'1': 'next_open', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'nextOpen'},
    const {'1': 'next_close', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'nextClose'},
...
final $typed_data.Uint8List getMarketStatusResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use marketNewsMessageDescriptor instead')
const MarketNewsMessage$json = const {
  '1': 'MarketNewsMessage',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'headline', '3': 2, '4': 1, '5': 9, '10': 'headline'},
    const {'1': 'summary', '3': 3, '4': 1, '5': 9, '10': 'summary'},
    const {'1': 'source', '3': 4, '4': 1, '5': 9, '10': 'source'},
    const {'1': 'url', '3': 5, '4': 1, '5': 9, '10': 'url'},
    const {'1': 'symbols', '3': 6, '4': 3, '5': 9, '10': 'symbols'},
...
final $typed_data.Uint8List marketNewsMessageDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getMarketNewsRequestDescriptor = $convert.base64Decode('ChRHZXRNYXJrZXROZXdzUmVxdWVzdBIYCgdzeW1ib2xzGAEgAygJUgdzeW1ib2xzEhIKBHBhZ2UYAiABKAVSBHBhZ2USFAoFbGltaXQYAyABKAVSBWxpbWl0');
@$core.Deprecated('Use getMarketNewsResponseDescriptor instead')
const GetMarketNewsResponse$json = const {
  '1': 'GetMarketNewsResponse',
  '2': const [
    const {'1': 'articles', '3': 1, '4': 3, '5': 11, '6': '.stockspb.MarketNewsMessage', '10': 'articles'},
  ],
};

/// Descriptor for `GetMarketNewsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getMarketNewsResponseDescriptor = $convert.base64Decode('ChVHZXRNYXJrZXROZXdzUmVzcG9uc2USNwoIYXJ0aWNsZXMYASADKAsyGy5zdG9ja3NwYi5NYXJrZXROZXdzTWVzc2FnZVIIYXJ0aWNsZXM=');
@$core.Deprecated('Use priceAlertMessageDescriptor instead')
const PriceAlertMessage$json = const {
  '1': 'PriceAlertMessage',
  '2': const [
    const {'1': 'id', '3': 1, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'symbol', '3': 2, '4': 1, '5': 9, '10': 'symbol'},
    const {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.stockspb.AlertType', '10': 'type'},
    const {'1': 'target_value', '3': 4, '4': 1, '5': 1, '10': 'targetValue'},
    const {'1': 'is_active', '3': 5, '4': 1, '5': 8, '10': 'isActive'},
    const {'1': 'is_triggered', '3': 6, '4': 1, '5': 8, '10': 'isTriggered'},
    const {'1': 'created_at', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createdAt'},
    const {'1': 'triggered_at', '3': 8, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'triggeredAt'},
  ],
};

/// Descriptor for `PriceAlertMessage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List priceAlertMessageDescriptor = $convert.base64Decode('');
...
const CreatePriceAlertRequest$json = const {
  ...
  '2': const [
    const {'1': 'symbol', '3': 1, '4': 1, '5': 9, '10': 'symbol'},
    const {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.stockspb.AlertType', '10': 'type'},
...
final $typed_data.Uint8List createPriceAlertRequestDescriptor = $convert.base64Decode('ChdDcmVhdGVQcmljZUFsZXJ0UmVxdWVzdBIWCgZzeW1ib2wYASABKAlSBnN5bWJvbBInCgR0eXBlGAIgASgOMhMuc3RvY2tzcGIuQWxlcnRUeXBlUgR0eXBlEiEKDHRhcmdldF92YWx1ZRgDIAEoAVILdGFyZ2V0VmFsdWU=');
...
const CreatePriceAlertResponse$json = const {
  ...
  '2': const [
    const {'1': 'alert', '3': 1, '4': 1, '5': 11, '6': '.stockspb.PriceAlertMessage', '10': 'alert'},
  ],
};

/// Descriptor for `CreatePriceAlertResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createPriceAlertResponseDescriptor = $convert.base64Decode('ChhDcmVhdGVQcmljZUFsZXJ0UmVzcG9uc2USMQoFYWxlcnQYASABKAsyGy5zdG9ja3NwYi5QcmljZUFsZXJ0TWVzc2FnZVIFYWxlcnQ=');
...
final $typed_data.Uint8List getPriceAlertsRequestDescriptor = $convert.base64Decode('ChVHZXRQcmljZUFsZXJ0c1JlcXVlc3Q=');
...
const GetPriceAlertsResponse$json = const {
  ...
  '2': const [
    const {'1': 'alerts', '3': 1, '4': 3, '5': 11, '6': '.stockspb.PriceAlertMessage', '10': 'alerts'},
  ],
};

/// Descriptor for `GetPriceAlertsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getPriceAlertsResponseDescriptor = $convert.base64Decode('ChZHZXRQcmljZUFsZXJ0c1Jlc3BvbnNlEjMKBmFsZXJ0cxgBIAMoCzIbLnN0b2Nrc3BiLlByaWNlQWxlcnRNZXNzYWdlUgZhbGVydHM=');
...
const UpdatePriceAlertRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'target_value', '3': 2, '4': 1, '5': 1, '10': 'targetValue'},
...
final $typed_data.Uint8List updatePriceAlertRequestDescriptor = $convert.base64Decode('ChdVcGRhdGVQcmljZUFsZXJ0UmVxdWVzdBIZCghhbGVydF9pZBgBIAEoCVIHYWxlcnRJZBIhCgx0YXJnZXRfdmFsdWUYAiABKAFSC3RhcmdldFZhbHVlEhsKCWlzX2FjdGl2ZRgDIAEoCFIIaXNBY3RpdmU=');
...
final $typed_data.Uint8List updatePriceAlertResponseDescriptor = $convert.base64Decode('ChhVcGRhdGVQcmljZUFsZXJ0UmVzcG9uc2USMQoFYWxlcnQYASABKAsyGy5zdG9ja3NwYi5QcmljZUFsZXJ0TWVzc2FnZVIFYWxlcnQ=');
...
final $typed_data.Uint8List deletePriceAlertResponseDescriptor = $convert.base64Decode('ChhEZWxldGVQcmljZUFsZXJ0UmVzcG9uc2USGAoHbWVzc2FnZRgBIAEoCVIHbWVzc2FnZQ==');

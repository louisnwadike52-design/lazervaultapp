...
class TransferTransaction extends $pb.GeneratedMessage {
  factory TransferTransaction({
    ...
    if (toRecipientId != null) result.toRecipientId = toRecipientId;
  ...
  factory TransferTransaction.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TransferTransaction.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransferTransaction',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'transactionId')
    ..a<$fixnum.Int64>(
        2, _omitFieldNames ? '' : 'fromAccountId', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        3, _omitFieldNames ? '' : 'toAccountId', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(4, _omitFieldNames ? '' : 'toRecipientId')
    ..a<$core.double>(5, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OD)
    ..aOS(6, _omitFieldNames ? '' : 'currency')
    ..e<TransferType>(
        7, _omitFieldNames ? '' : 'transferType', $pb.PbFieldType.OE,
        defaultOrMaker: TransferType.TRANSFER_TYPE_UNSPECIFIED,
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransferTransaction copyWith(void Function(TransferTransaction) updates) =>
      super.copyWith((message) => updates(message as TransferTransaction))
  ...
  static $pb.PbList<TransferTransaction> createRepeated() =>
      $pb.PbList<TransferTransaction>();
  @$core.pragma('dart2js:noInline')
  static TransferTransaction getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransferTransaction>(create);
  ...
  @$pb.TagNumber(2)
  set fromAccountId($fixnum.Int64 value) => $_setInt64(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set toAccountId($fixnum.Int64 value) => $_setInt64(2, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set toRecipientId($core.String value) => $_setString(3, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set transferType(TransferType value) => $_setField(7, value);
  @$pb.TagNumber(7)
...
class InitiateTransferRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(
        1, _omitFieldNames ? '' : 'from_account_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'amount', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOS(3, _omitFieldNames ? '' : 'category')
    ..aOS(4, _omitFieldNames ? '' : 'reference')
    ..aOS(5, _omitFieldNames ? '' : 'scheduledAt')
    ..aOS(6, _omitFieldNames ? '' : 'transaction_id')
    ..aOS(7, _omitFieldNames ? '' : 'verification_token')
    ..a<$fixnum.Int64>(
        10, _omitFieldNames ? '' : 'to_account_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        11, _omitFieldNames ? '' : 'recipient_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  set fromAccountId($fixnum.Int64 value) => $_setInt64(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(5)
  set scheduledAt($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(10)
  $fixnum.Int64 get toAccountId => $_getI64(7);
  @$pb.TagNumber(10)
  set toAccountId($fixnum.Int64 value) => $_setInt64(7, value);
  @$pb.TagNumber(10)
  $core.bool hasToAccountId() => $_has(7);
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set recipientId($fixnum.Int64 value) => $_setInt64(8, value);
  @$pb.TagNumber(11)
...
class InitiateTransferResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(
        1, _omitFieldNames ? '' : 'transferId', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..a<$fixnum.Int64>(4, _omitFieldNames ? '' : 'fee', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        5, _omitFieldNames ? '' : 'totalAmount', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
  ...
  @$pb.TagNumber(1)
  set transferId($fixnum.Int64 value) => $_setInt64(0, value);
  @$pb.TagNumber(1)
...
class MonthlyData extends $pb.GeneratedMessage {
  ...
  factory MonthlyData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory MonthlyData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'MonthlyData',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  MonthlyData copyWith(void Function(MonthlyData) updates) =>
      super.copyWith((message) => updates(message as MonthlyData))
          as MonthlyData;
  ...
  @$core.pragma('dart2js:noInline')
  static MonthlyData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<MonthlyData>(create);
  ...
  @$pb.TagNumber(2)
  set income($core.double value) => $_setDouble(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set expenses($core.double value) => $_setDouble(2, value);
  @$pb.TagNumber(3)
...
class ComparisonData extends $pb.GeneratedMessage {
  factory ComparisonData({
    ...
    final result = create();
    if (currentIncome != null) result.currentIncome = currentIncome;
    if (previousIncome != null) result.previousIncome = previousIncome;
    if (currentExpenses != null) result.currentExpenses = currentExpenses;
    if (previousExpenses != null) result.previousExpenses = previousExpenses;
    if (currentSavings != null) result.currentSavings = currentSavings;
    if (previousSavings != null) result.previousSavings = previousSavings;
    return result;
  }

  ComparisonData._();

  factory ComparisonData.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory ComparisonData.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'ComparisonData',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
    ..a<$core.double>(
        1, _omitFieldNames ? '' : 'currentIncome', $pb.PbFieldType.OD)
    ..a<$core.double>(
        2, _omitFieldNames ? '' : 'previousIncome', $pb.PbFieldType.OD)
    ..a<$core.double>(
        3, _omitFieldNames ? '' : 'currentExpenses', $pb.PbFieldType.OD)
    ..a<$core.double>(
        4, _omitFieldNames ? '' : 'previousExpenses', $pb.PbFieldType.OD)
    ..a<$core.double>(
        5, _omitFieldNames ? '' : 'currentSavings', $pb.PbFieldType.OD)
    ..a<$core.double>(
        6, _omitFieldNames ? '' : 'previousSavings', $pb.PbFieldType.OD)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ComparisonData clone() => ComparisonData()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ComparisonData copyWith(void Function(ComparisonData) updates) =>
      super.copyWith((message) => updates(message as ComparisonData))
          as ComparisonData;
  ...
  static $pb.PbList<ComparisonData> createRepeated() =>
      $pb.PbList<ComparisonData>();
  @$core.pragma('dart2js:noInline')
  static ComparisonData getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<ComparisonData>(create);
  static ComparisonData? _defaultInstance;

  @$pb.TagNumber(1)
  $core.double get currentIncome => $_getN(0);
  @$pb.TagNumber(1)
  set currentIncome($core.double value) => $_setDouble(0, value);
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set previousIncome($core.double value) => $_setDouble(1, value);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set currentExpenses($core.double value) => $_setDouble(2, value);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set previousExpenses($core.double value) => $_setDouble(3, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set currentSavings($core.double value) => $_setDouble(4, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set previousSavings($core.double value) => $_setDouble(5, value);
  @$pb.TagNumber(6)
...
class GetStatisticsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
    ..e<TimePeriod>(1, _omitFieldNames ? '' : 'timePeriod', $pb.PbFieldType.OE,
        defaultOrMaker: TimePeriod.TIME_PERIOD_UNSPECIFIED,
        valueOf: TimePeriod.valueOf,
        enumValues: TimePeriod.values)
    ..aOS(4, _omitFieldNames ? '' : 'currency')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetStatisticsRequest clone() =>
      GetStatisticsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<GetStatisticsRequest> createRepeated() =>
      $pb.PbList<GetStatisticsRequest>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set timePeriod(TimePeriod value) => $_setField(1, value);
  @$pb.TagNumber(1)
...
class GetStatisticsResponse extends $pb.GeneratedMessage {
  factory GetStatisticsResponse({
    ...
    if (incomeBreakdown != null) result.incomeBreakdown.addAll(incomeBreakdown);
    if (monthlyOverview != null) result.monthlyOverview.addAll(monthlyOverview);
    if (comparisonMetrics != null) result.comparisonMetrics = comparisonMetrics;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<TimeSeriesPoint>(
        3, _omitFieldNames ? '' : 'expenseTimeseries', $pb.PbFieldType.PM,
        subBuilder: TimeSeriesPoint.create)
    ..pc<CategorySummary>(
        4, _omitFieldNames ? '' : 'expenseBreakdown', $pb.PbFieldType.PM,
        subBuilder: CategorySummary.create)
    ..pc<CategorySummary>(
        5, _omitFieldNames ? '' : 'incomeBreakdown', $pb.PbFieldType.PM,
        subBuilder: CategorySummary.create)
    ..pc<MonthlyData>(
        6, _omitFieldNames ? '' : 'monthlyOverview', $pb.PbFieldType.PM,
        subBuilder: MonthlyData.create)
    ..aOM<ComparisonData>(7, _omitFieldNames ? '' : 'comparisonMetrics',
        subBuilder: ComparisonData.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetStatisticsResponse clone() =>
      GetStatisticsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  ...
  static $pb.PbList<GetStatisticsResponse> createRepeated() =>
      $pb.PbList<GetStatisticsResponse>();
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set comparisonMetrics(ComparisonData value) => $_setField(7, value);
  @$pb.TagNumber(7)
...
class GetTransferDetailsRequest extends $pb.GeneratedMessage {
  ...
  GetTransferDetailsRequest._();

  factory GetTransferDetailsRequest.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetTransferDetailsRequest.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetTransferDetailsRequest',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(
        1, _omitFieldNames ? '' : 'transfer_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTransferDetailsRequest clone() =>
      GetTransferDetailsRequest()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTransferDetailsRequest copyWith(
          void Function(GetTransferDetailsRequest) updates) =>
      super.copyWith((message) => updates(message as GetTransferDetailsRequest))
          as GetTransferDetailsRequest;
  ...
  static $pb.PbList<GetTransferDetailsRequest> createRepeated() =>
      $pb.PbList<GetTransferDetailsRequest>();
  @$core.pragma('dart2js:noInline')
  static GetTransferDetailsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetTransferDetailsRequest>(create);
...
class GetTransferDetailsResponse extends $pb.GeneratedMessage {
  ...
  GetTransferDetailsResponse._();

  factory GetTransferDetailsResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetTransferDetailsResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'GetTransferDetailsResponse',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
    ..a<$fixnum.Int64>(
        1, _omitFieldNames ? '' : 'transfer_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        2, _omitFieldNames ? '' : 'from_account_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        3, _omitFieldNames ? '' : 'to_account_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        4, _omitFieldNames ? '' : 'from_user_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        5, _omitFieldNames ? '' : 'to_user_id', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..a<$fixnum.Int64>(7, _omitFieldNames ? '' : 'fee', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        8, _omitFieldNames ? '' : 'totalAmount', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ...
    ..aOM<$1.Timestamp>(13, _omitFieldNames ? '' : 'created_at',
        subBuilder: $1.Timestamp.create)
    ..aOS(14, _omitFieldNames ? '' : 'scheduled_at')
    ..aOM<$1.Timestamp>(15, _omitFieldNames ? '' : 'completed_at',
        subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(16, _omitFieldNames ? '' : 'failed_at',
        subBuilder: $1.Timestamp.create)
    ..aOS(17, _omitFieldNames ? '' : 'failure_reason')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTransferDetailsResponse clone() =>
      GetTransferDetailsResponse()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetTransferDetailsResponse copyWith(
          void Function(GetTransferDetailsResponse) updates) =>
      super.copyWith(
              (message) => updates(message as GetTransferDetailsResponse))
          as GetTransferDetailsResponse;
  ...
  static $pb.PbList<GetTransferDetailsResponse> createRepeated() =>
      $pb.PbList<GetTransferDetailsResponse>();
  @$core.pragma('dart2js:noInline')
  static GetTransferDetailsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<GetTransferDetailsResponse>(create);
  ...
  @$pb.TagNumber(4)
  set fromUserId($fixnum.Int64 value) => $_setInt64(3, value);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set toUserId($fixnum.Int64 value) => $_setInt64(4, value);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(16)
  set failedAt($1.Timestamp value) => $_setField(16, value);
  @$pb.TagNumber(16)
...
class TransferPaginationInfo extends $pb.GeneratedMessage {
  ...
  TransferPaginationInfo._();

  factory TransferPaginationInfo.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory TransferPaginationInfo.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransferPaginationInfo',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransferPaginationInfo clone() =>
      TransferPaginationInfo()..mergeFromMessage(this);
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  TransferPaginationInfo copyWith(
          void Function(TransferPaginationInfo) updates) =>
      super.copyWith((message) => updates(message as TransferPaginationInfo))
          as TransferPaginationInfo;
  ...
  static $pb.PbList<TransferPaginationInfo> createRepeated() =>
      $pb.PbList<TransferPaginationInfo>();
  @$core.pragma('dart2js:noInline')
  static TransferPaginationInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransferPaginationInfo>(create);
...
class ListTransfersRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(5, _omitFieldNames ? '' : 'sortOrder')
  ...
  @$pb.TagNumber(5)
  set sortOrder($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
...
class ListTransfersResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'pb'),
      createEmptyInstance: create)
    ..pc<GetTransferDetailsResponse>(
        1, _omitFieldNames ? '' : 'transfers', $pb.PbFieldType.PM,
        subBuilder: GetTransferDetailsResponse.create)
    ..aOM<TransferPaginationInfo>(2, _omitFieldNames ? '' : 'pagination',
        subBuilder: TransferPaginationInfo.create)
    ..hasRequiredFields = false;
  ...
  @$pb.TagNumber(1)
  $pb.PbList<GetTransferDetailsResponse> get transfers => $_getList(0);

  @$pb.TagNumber(2)
  TransferPaginationInfo get pagination => $_getN(1);
  @$pb.TagNumber(2)
  set pagination(TransferPaginationInfo value) => $_setField(2, value);
  @$pb.TagNumber(2)

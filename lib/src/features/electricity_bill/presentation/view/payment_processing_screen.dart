...
class _PaymentProcessingScreenState extends State<PaymentProcessingScreen>
                ...
                return Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildPaymentDetailsCard(provider, validationResult, amount),
  ...
  Widget _buildPaymentDetailsCard(
    ...
    return Container(
      ...
      child: Column(
        children: [
          _buildDetailRow('Provider', provider.providerName, Icons.bolt),
          SizedBox(height: 16.h),
          _buildDetailRow('Customer', validationResult.customerName, Icons.person),
          SizedBox(height: 16.h),
          _buildDetailRow('Meter Number', validationResult.meterNumber, Icons.numbers),
          SizedBox(height: 16.h),
          Row(

...
abstract class SendGeneralChatMessageUseCase {
  Future<Either<Failure, GeneralChatResponse>> call({
    ...
    String language = 'en',
    String locale = 'en-NG',
    // Active region/account so the gateway + downstream services scope reads/writes
    // to the active region (the general path previously relied on header fallback only).
    String accountId = '',
    String currency = '',
    String userCountry = '',

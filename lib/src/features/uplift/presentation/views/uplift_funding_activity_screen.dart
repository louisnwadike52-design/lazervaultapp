...
class UpliftFundingActivityScreen extends StatefulWidget {
  const UpliftFundingActivityScreen(
      {required this.fundId, required this.currency, super.key});
  final String fundId;
  final String currency;

  @override
  State<UpliftFundingActivityScreen> createState() =>
      _UpliftFundingActivityScreenState();
}

class _UpliftFundingActivityScreenState
    extends State<UpliftFundingActivityScreen> {
      ...
      child: ListView.separated(
        ...
        itemBuilder: (_, i) {
          ...
          return _activityTile(
            ...
            error: r.lastError,
            reference: r.creditReference.isNotEmpty
                ? r.creditReference
                : r.debitReference,
          );
        },
        ...
        children: [
          Row(
            children: [
              ...
              Text(upNaira(amount, widget.currency),
                  style: const TextStyle(

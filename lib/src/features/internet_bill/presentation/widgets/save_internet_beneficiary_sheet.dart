...
/// Save / edit an internet ISP account. Mirrors
/// `SaveDataBeneficiarySheet` — minimal single-field (nickname) sheet
...
class SaveInternetBeneficiarySheet extends StatefulWidget {
  ...
  const SaveInternetBeneficiarySheet({
    super.key,
  ...
  static Future<bool?> show(
    ...
    return showModalBottomSheet<bool>(
      ...
      builder: (_) => BlocProvider(
        create: (_) => GetIt.I<InternetBeneficiaryCubit>(),
        child: SaveInternetBeneficiarySheet(
  ...
  @override
  State<SaveInternetBeneficiarySheet> createState() =>
      _SaveInternetBeneficiarySheetState();
}

class _SaveInternetBeneficiarySheetState
    extends State<SaveInternetBeneficiarySheet> {
  ...
  Future<void> _save() async {
    ...
    try {
      final cubit = context.read<InternetBeneficiaryCubit>();
      if (widget.isEditing) {
        await cubit.update(
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<InternetBeneficiaryCubit, InternetBeneficiaryState>(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              isEdit ? 'Edit Internet Contact' : 'Save Internet Contact',
              style: TextStyle(
                fontSize: 20.sp,

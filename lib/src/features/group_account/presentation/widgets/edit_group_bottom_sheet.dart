  ...
  void initState() {
    ...
    _whatsappLinkController = TextEditingController(
      text: stripCanonicalPrefix(
          metadata['whatsapp_group_link']?.toString(), whatsappLinkPrefix),
    );
    _telegramLinkController = TextEditingController(
      text: stripCanonicalPrefix(
          metadata['telegram_group_link']?.toString(), telegramLinkPrefix),
    );
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              _whatsappFocus.hasFocus ? 'invite-code' : '',
                          hintStyle: GoogleFonts.inter(
                            color: Colors.grey[500],
                            fontSize: 14.sp,
                          ),
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText:
                              _telegramFocus.hasFocus ? 'group-handle' : '',
                          hintStyle: GoogleFonts.inter(
                            color: Colors.grey[500],
                            fontSize: 14.sp,
                          ),

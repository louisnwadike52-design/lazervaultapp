...
import 'package:lazervault/src/features/transaction_history/domain/repository/transaction_history_repository.dart' show TransactionHistoryRepository;

/// Implementation of transaction history repository
class TransactionHistoryRepositoryImpl implements TransactionHistoryRepository {
  // In production, this would use actual data sources (API, local database)
  ...
  Future<void> refreshTransactions() async {
    // Simulate refresh by clearing and reinitializing
  ...
  Future<void> cacheTransactions(List<UnifiedTransaction> transactions) async {
    // In production, this would cache to local database (e.g., SQLite, Hive)
    await Future.delayed(const Duration(milliseconds: 200));
  }

  @override
  Future<List<UnifiedTransaction>> getCachedTransactions() async {
    // In production, this would load from local database
    await Future.delayed(const Duration(milliseconds: 200));
    return _mockTransactions;
  }
}

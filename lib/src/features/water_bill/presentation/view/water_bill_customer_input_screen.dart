...
class WaterBillCustomerInputScreen extends StatefulWidget {
  const WaterBillCustomerInputScreen({super.key});

  @override
  State<WaterBillCustomerInputScreen> createState() => _WaterBillCustomerInputScreenState();
}

class _WaterBillCustomerInputScreenState extends State<WaterBillCustomerInputScreen> {
  ...
  void _validateCustomer(WaterProviderEntity provider) {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _isValidating ? null : () => _validateCustomer(provider),

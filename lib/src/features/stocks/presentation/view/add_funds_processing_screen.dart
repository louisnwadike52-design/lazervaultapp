...
import 'add_funds_confirmation_screen.dart';

/// Processing screen for adding funds with animations
class AddFundsProcessingScreen extends StatefulWidget {
  final double amount;
  final String paymentMethod;
  final Map<String, String> paymentDetails;

  const AddFundsProcessingScreen({
    super.key,
...
class _AddFundsProcessingScreenState extends State<AddFundsProcessingScreen>
  ...
  Future<void> _processDeposit() async {
    try {
      ...
      // Error handling
      if (!mounted) return;
      _showErrorDialog('Failed to process deposit. Please try again.');
    }
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Adding \$${widget.amount.toStringAsFixed(2)} to your account',
                style: GoogleFonts.inter(
                  fontSize: 16.sp,

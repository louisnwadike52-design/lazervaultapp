...
class _RecordSaleScreenState extends State<RecordSaleScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final who = _selectedCustomer != null ? ' to ${_selectedCustomer!.name}' : '';
      _snack(
        _paid
            ? (_isInventorySale
                ? 'Sale recorded$who — revenue logged, stock updated'
                : 'Sale recorded$who — revenue logged')
            : 'Sale recorded$who as a receivable',
        _accent,
      );
        ...
        child: Row(
          children: [
            Container(
              ...
              child: Icon(_isInventorySale ? Icons.inventory_2_rounded : Icons.edit_note_rounded,
                ...
                children: [
                  ...
                  Text(
                    _isInventorySale
                        ...
                        : 'From inventory, or a custom one-off item',
                    style: GoogleFonts.inter(color: _muted, fontSize: 11.5.sp),
                  ),
                ],
              ),
              ...
              children: [
                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      // Custom / one-off item escape hatch
                      _pickerRow(
                        icon: Icons.edit_note_rounded,
                        title: 'Custom item (not in inventory)',
                        subtitle: 'Free-text — does not affect stock',
                        selected: !_isInventorySale,
                        onTap: () {
                          setState(() {
                            _selectedItem = null;
                            _quantity = 1;

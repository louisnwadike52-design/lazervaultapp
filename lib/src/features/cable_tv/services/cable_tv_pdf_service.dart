...
class CableTVPdfService {
  ...
  /// Generate a professional receipt PDF for a cable TV payment
  static Future<File> generateReceipt({
    required CableTVPaymentEntity payment,
  }) async {
    await _loadFonts();
    ...
    final receiptNumber =
        'CATV-${payment.reference.length > 12 ? payment.reference.substring(0, 12) : payment.reference}';
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              _buildSubscriptionDetails(payment: payment),
    ...
    final fileName =
        'cable_tv_receipt_${payment.reference.replaceAll(RegExp(r'[^a-zA-Z0-9]'), '_')}.pdf';
  ...
  static pw.Widget _buildSummaryTable({
    ...
    return pw.Column(
      children: [
        ...
        _buildSummaryRow('Type', 'Cable TV Subscription'),
      ],
    );
  }
  ...
  static pw.Widget _buildSubscriptionDetails({
    required CableTVPaymentEntity payment,
  }) {
    return pw.Column(
      crossAxisAlignment: pw.CrossAxisAlignment.start,
  ...
  static Future<void> shareReceipt({
    ...
    try {
      ...
      await SharePlus.instance.share(ShareParams(
        ...
        text:
            'Cable TV Subscription Receipt - NGN $amount to $provider (Smart Card: ${payment.customerNumber})',
        subject: 'LazerVault Cable TV Subscription Receipt',
      ));
    } catch (e) {

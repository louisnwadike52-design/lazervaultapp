...
/// Create or edit a cable TV reminder. Mirrors `CreateDataReminderScreen`.
...
class _CreateCableTVReminderScreenState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<CableTVReminderCubit, CableTVReminderState>(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 24.h),
                  _section('Link to Saved Smart Card (Optional)'),
                  SizedBox(height: 12.h),

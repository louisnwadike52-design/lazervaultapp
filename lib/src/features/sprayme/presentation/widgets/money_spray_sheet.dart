...
class _MoneySpraySheetState extends State<MoneySpraySheet> {
  ...
  String?
      _customAmountError; // inline hint when the typed amount exceeds balance
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              if (_selectedAmount == null &&
                  !_isCustomAmount &&
                  widget.walletBalance < _amounts.first)
                Padding(
                  padding: EdgeInsets.symmetric(horizontal: 16.w),
                    ...
                    onPressed: _selectedAmount != null &&
                        ...
                        ? () {
                            ...
                            final effectiveAmount =
                                _tapCount * _selectedDenomination!;
                            widget.onConfirm(

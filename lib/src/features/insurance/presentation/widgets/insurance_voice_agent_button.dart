...
class InsuranceVoiceAgentButton extends StatefulWidget {
  ...
  State<InsuranceVoiceAgentButton> createState() =>
      _InsuranceVoiceAgentButtonState();
}

class _InsuranceVoiceAgentButtonState extends State<InsuranceVoiceAgentButton>
    ...
    return FloatingActionButton(
      ...
      backgroundColor: _isConnected
          ...
          : (_isConnecting
              ...
              : const Color(0xFF10B981)), // Green color for insurance
      elevation: 6,
      child: _isConnecting
          ? RotationTransition(
...
class InsuranceVoiceAgentControl extends StatefulWidget {
  final String? accessToken;
  final VoidCallback? onConnected;
  final VoidCallback? onDisconnected;
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                IconButton(
                  ...
                  color: _isMuted ? Colors.red : const Color(0xFF10B981),
                ),
                ...
                ElevatedButton.icon(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor:
                        _isConnected ? Colors.red : const Color(0xFF10B981),
            ...
            if (_isConnected) ...[
              const SizedBox(height: 16),
              const Text(
                'Try saying:\n"Show my insurance policies"\n"What\'s my next payment due?"\n"File a claim for my auto insurance"',

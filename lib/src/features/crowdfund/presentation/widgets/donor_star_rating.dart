...
///
/// Two modes:
/// - `compact`: Small inline row of stars + "AI Rating" label (for donor cards)
/// - `expanded`: Larger stars + score + label + breakdown bars (for detail dialogs)
class DonorStarRating extends StatelessWidget {
  final DonorRating rating;
  final bool compact;

  const DonorStarRating({
    super.key,

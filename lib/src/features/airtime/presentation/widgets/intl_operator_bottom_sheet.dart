...
class IntlOperatorBottomSheet extends StatefulWidget {
  ...
  @override
  State<IntlOperatorBottomSheet> createState() =>
      _IntlOperatorBottomSheetState();
}
...
class _IntlOperatorBottomSheetState extends State<IntlOperatorBottomSheet> {
              ...
              child: _filteredOperators.isEmpty
                      ...
                      child: Column(
                        ...
                        children: [
                          Icon(Icons.search_off,
                              size: 40.sp, color: const Color(0xFF4B5563)),
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isDetected =
                            widget.autoDetectedOperator?.id == op.id;
  ...
  String _getFixedAmountsPreview(IntlAirtimeOperator op) {
    ...
    final preview = amounts
        .take(3)
        .map((a) => '${a.toStringAsFixed(0)}${op.destCurrencyCode}')
        .join(', ');
    return amounts.length > 3
        ? '$preview +${amounts.length - 3} more'
        : preview;
  }
}

...
const GroupAccountMessage$json = {
  ...
  '2': [
    ...
    {'1': 'admin_id', '3': 4, '4': 1, '5': 4, '10': 'adminId'},
    {
      '1': 'status',
      '3': 5,
      '4': 1,
      '5': 14,
      '6': '.pb.GroupAccountStatus',
      '10': 'status'
    },
    {
      '1': 'created_at',
...
final $typed_data.Uint8List groupAccountMessageDescriptor = $convert.base64Decode(
    ...
    '1lEiAKC2Rlc2NyaXB0aW9uGAMgASgJUgtkZXNjcmlwdGlvbhIZCghhZG1pbl9pZBgEIAEoBFIH'
...
final $typed_data.Uint8List groupMemberMessageDescriptor = $convert.base64Decode(
    ...
    'dncm91cElkEhcKB3VzZXJfaWQYAyABKARSBnVzZXJJZBIbCgl1c2VyX25hbWUYBCABKAlSCHVz'
...
const ContributionMessage$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.pb.ContributionStatus',
      '10': 'status'
    },
    {'1': 'created_by', '3': 10, '4': 1, '5': 4, '10': 'createdBy'},
    {
      '1': 'created_at',
      '3': 11,
      '4': 1,
    ...
    {'1': 'minimum_balance', '3': 27, '4': 1, '5': 4, '10': 'minimumBalance'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.pb.ContributionPaymentMessage',
      '10': 'payments'
    },
    {
      '1': 'payout_schedule',
    ...
    },
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.pb.ContributionMemberMessage',
      '10': 'members'
    },
  ],
};
...
final $typed_data.Uint8List contributionMessageDescriptor = $convert.base64Decode(
    ...
    'cmVhdGVkX2J5GAogASgEUgljcmVhdGVkQnkSOQoKY3JlYXRlZF9hdBgLIAEoCzIaLmdvb2dsZS'
    ...
    'IMY3VycmVudEN5Y2xlEjgKGGN1cnJlbnRfcGF5b3V0X3JlY2lwaWVudBgVIAEoBFIWY3VycmVu'
...
final $typed_data.Uint8List contributionMemberMessageDescriptor = $convert.base64Decode(
    ...
    'Rpb25faWQYAiABKAlSDmNvbnRyaWJ1dGlvbklkEhcKB3VzZXJfaWQYAyABKARSBnVzZXJJZBIb'
...
final $typed_data.Uint8List contributionPaymentMessageDescriptor = $convert.base64Decode(
    ...
    'ZBIXCgd1c2VyX2lkGAQgASgEUgZ1c2VySWQSGwoJdXNlcl9uYW1lGAUgASgJUgh1c2VyTmFtZR'
...
final $typed_data.Uint8List payoutScheduleMessageDescriptor = $convert.base64Decode(
    ...
    'RSBnVzZXJJZBIbCgl1c2VyX25hbWUYAyABKAlSCHVzZXJOYW1lEhoKCHBvc2l0aW9uGAQgASgF'
...
const PayoutTransactionMessage$json = {
  ...
  '2': [
    ...
    {'1': 'contribution_id', '3': 2, '4': 1, '5': 9, '10': 'contributionId'},
    {'1': 'group_id', '3': 3, '4': 1, '5': 9, '10': 'groupId'},
    {'1': 'recipient_user_id', '3': 4, '4': 1, '5': 4, '10': 'recipientUserId'},
    {
...
final $typed_data.Uint8List payoutTransactionMessageDescriptor = $convert.base64Decode(
    ...
    'KgoRcmVjaXBpZW50X3VzZXJfaWQYBCABKARSD3JlY2lwaWVudFVzZXJJZBIuChNyZWNpcGllbn'
...
const ContributionReceiptMessage$json = {
  ...
  '2': [
    ...
    {'1': 'user_id', '3': 5, '4': 1, '5': 4, '10': 'userId'},
...
final $typed_data.Uint8List contributionReceiptMessageDescriptor = $convert.base64Decode(
    ...
    'aW9uSWQSGQoIZ3JvdXBfaWQYBCABKAlSB2dyb3VwSWQSFwoHdXNlcl9pZBgFIAEoBFIGdXNlck'
...
final $typed_data.Uint8List addMemberRequestDescriptor = $convert.base64Decode(
    ...
    'QYAiABKARSBnVzZXJJZBInCgRyb2xlGAMgASgOMhMucGIuR3JvdXBNZW1iZXJSb2xlUgRyb2xl'
...
final $typed_data.Uint8List createContributionRequestDescriptor = $convert.base64Decode(
    ...
    'GAsgASgFUgt0b3RhbEN5Y2xlcxIyChVtZW1iZXJfcm90YXRpb25fb3JkZXIYDCADKARSE21lbW'
...
const ListGroupContributionsResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.pb.ContributionPaginationInfo',
      '10': 'pagination'
    },
  ],
};
...
final $typed_data.Uint8List updateContributionRequestDescriptor = $convert.base64Decode(
    ...
    'dGF0dXMYBiABKA4yFi5wYi5Db250cmlidXRpb25TdGF0dXNSBnN0YXR1cw==');
...
final $typed_data.Uint8List makePaymentRequestDescriptor = $convert.base64Decode(
    ...
    'Rpb25JZBIWCgZhbW91bnQYAiABKARSBmFtb3VudBIUCgVub3RlcxgDIAEoCVIFbm90ZXM=');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.pb.ContributionReceiptMessage',
      '10': 'receipt'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.pb.ContributionTranscriptMessage',
      '10': 'transcript'
    },
  ],
};
...
const GetContributionAnalyticsResponse$json = {
  ...
  '2': [
    ...
    {'1': 'target_amount', '3': 7, '4': 1, '5': 4, '10': 'targetAmount'},
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.pb.GetContributionAnalyticsResponse.MemberParticipation',
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.pb.GetContributionAnalyticsResponse.Schedule',
      '10': 'schedule'
    },
    {
      '1': 'payout',
      ...
      '4': 1,
      '5': 11,
      '6': '.pb.GetContributionAnalyticsResponse.Payout',
      '10': 'payout'
    },
...
final $typed_data.Uint8List getContributionAnalyticsResponseDescriptor = $convert.base64Decode(
    ...
    'UGF5b3V0EisKEWN1cnJlbnRfcmVjaXBpZW50GAEgASgEUhBjdXJyZW50UmVjaXBpZW50EkQKEG'
...
const GetGroupActivityLogsResponse$json = {
  ...
  '2': [
    ...
    },
    {
      ...
      '4': 1,
      '5': 11,
      '6': '.pb.ActivityLogPaginationInfo',
      '10': 'pagination'
    },
  ],
};
